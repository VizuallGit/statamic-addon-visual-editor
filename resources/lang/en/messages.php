...
return [
    ...
    'chrome_bar' => 'You are editing the :chrome — pick a design in the library, edit widgets in the panel',
    'chrome_designs' => 'Designs',
    'chrome_library_hint' => 'Click a design to apply it to the header/footer. Widgets are edited in the Theme Settings panel.',
    'chrome_search_placeholder' => 'Search designs…',
