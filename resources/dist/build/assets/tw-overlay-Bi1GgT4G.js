...
${r}}
${a.join("")}`;o.textContent.includes(s)||(o.textContent+=s)}function bo(t,e,n){const o=Ae(t);if(!(!o||!C?.path)){vo(o,n);for(const r of o.querySelectorAll(`[${Ve}="${C.path}"]`))try{e&&r.classList.remove(e),n&&r.classList.add(n)}catch{}}}const pt=new Map,yo=/(^|-)color$|^fill$|^stroke$/;function zt(t){const e=String(t||""),n=e.slice(0,e.indexOf(":")).trim();return yo.test(n)&&/var\(\s*(--[A-Za-z0-9_-]+)\s*\)/.exec(e)?.[1]||""}function Le(t,e){if(!e)return"";if(pt.has(e))return pt.get(e);const n=Ae(t),o=n?.documentElement,r=n?.defaultView;if(!o||!r)return"";let a="",s=e;for(let i=0;i<6&&s;i+=1){try{a=r.getComputedStyle(o).getPropertyValue(s).trim()}catch{return""}if(!a)return"";if(s=zt(a),!s)break}return a&&!a.startsWith("var(")?(pt.set(e,a),a):""}function xo(t,e){return Mn(e,z)||Le(t,zt(xe(e,z)))}function O(t){const e=t?.document.getElementById(E);ot&&(ot.style.removeProperty("anchor-name"),ot=null),bt?.(),bt=null,at="",e&&(e._sveApp?.unmount(),e.remove())}function Ut(t,e,n){const o=e.getBoundingClientRect(),r=n.offsetWidth||176,a=8,s=140,i=e.closest?.("#__sve-tw-strip")?Ro(t):null,c=i?i.top:0,l=i?i.bottom:t.innerHeight,f=i?i.left:0,u=i?i.right:t.innerWidth,d=o.bottom+4,b=l-d-a,g=Math.max(s,Math.min(b,420));n.style.left=`${Math.max(f+a,Math.min(o.left,u-r-a))}px`,n.style.maxHeight=`${g}px`,n.style.top=`${b>=s?d:Math.max(c+a,l-a-g)}px`}function J(t,e,n,o){const r=t.document;O(t),Ee(r);const a=r.createElement("div");a.id=E,r.body.appendChild(a),a._sveApp=Fe(n,a,o);const s=uo&&!!e.closest?.("#__sve-tw-strip");s?(ot=e,e.style.setProperty("anchor-name",Nt),a.style.setProperty("position","absolute"),a.style.setProperty("position-anchor",Nt),a.style.setProperty("position-area","block-end span-inline-start"),a.style.setProperty("position-try-fallbacks","flip-block, flip-inline, flip-block flip-inline"),a.style.setProperty("margin","4px 0 0 0"),a.style.setProperty("max-height","20rem")):Ut(t,e,a);const i=()=>{s||Ut(t,e,a)},c=f=>{!a.contains(f.target)&&!e.contains(f.target)&&(O(t),nt())},l=f=>{f.key==="Escape"&&(O(t),nt())};return r.addEventListener("pointerdown",c,!0),r.addEventListener("keydown",l,!0),t.addEventListener("scroll",i,!0),t.addEventListener("resize",i),bt=()=>{r.removeEventListener("pointerdown",c,!0),r.removeEventListener("keydown",l,!0),t.removeEventListener("scroll",i,!0),t.removeEventListener("resize",i)},a}function Me(t,e,n){return(e||[]).map(o=>({label:o.label,css:o.css,color:o.color||Le(t,zt(o.css)),active:o.label===n}))}function K(){return!C||W("dock:is-locked")===!0}function Z(){const t=W("dock:html");if(!C||typeof t!="string"||t[C.from]!=="<")return null;const e=ue(t,C.from,C.openTo);return{html:t,value:e?e.value:""}}function ko(t){if(!C?.path)return;const n=Tt(St(t),new Set).find(o=>o.path===C.path);n&&(C={from:n.from,openTo:n.openTo,path:n.path,tag:n.tag})}function V(t,e,n,o,r){const a=Sn(e,C,n);a!==e&&(bo(t,o,r),W("dock:set-html",a),ko(a),R(t))}const Yt=["display","position","inset","top","right","bottom","left","z-index","flex-direction","flex-wrap","justify-content","align-items","gap","column-gap","row-gap","margin","margin-inline","margin-block","margin-top","margin-right","margin-bottom","margin-left","padding","padding-inline","padding-block","padding-top","padding-right","padding-bottom","padding-left","width","min-width","max-width","height","min-height","max-height","font-family","font-size","font-weight","line-height","text-align","text-transform","text-decoration-line","font-style","color","background-color","border-color","border-radius","fill","stroke","outline-color","overflow"];function Gt(t){const e=G(t);if(!e)return-1;const n=Yt.indexOf(e);return n===-1?Yt.length:n}function wo(t){if(K())return;const e=Z();if(!e)return;const n=At(e.value),o=n.groups.flatMap(c=>c.items).filter(c=>!c.dynamic);if(o.length<2)return;const r=new Map;n.groups.forEach((c,l)=>r.set(c.key,c.key===""?-1:l));const a=[...o].sort((c,l)=>{const f=r.get(c.variants.join(":"))??0,u=r.get(l.variants.join(":"))??0;return f-u||Gt(c.name)-Gt(l.name)||c.name.localeCompare(l.name)}),s=[...o].sort((c,l)=>c.from-l.from).map(c=>({from:c.from,to:c.to})),i=me(e.value,s,a.map(c=>c.raw));i!==e.value&&V(t,e.html,i,"","")}function G(t){return ye(t,z)?.label||""}function yt(t){return At(t).groups.flatMap(e=>e.items)}function Pe(t){const e=Ot();return yt(t).filter(n=>!n.dynamic&&n.variants.join(":")===e)}function Jt(t,e){if(K()||!e)return;const n=Z();if(!n)return;const o=G(e),r=Pe(n.value).find(s=>s.name===e||o&&G(s.name)===o);if(r?.name===e){V(t,n.html,st(n.value,r,""),e,"");return}if(r){const s=vt({variants:r.variants,name:e,modifier:r.modifier,important:r.important});V(t,n.html,st(n.value,r,s),r.raw,s);return}const a=vt({variants:_e(),name:e,modifier:"",important:""});V(t,n.html,pe(n.value,a),"",a)}function $o(t,e){const n=String(e||"").trim(),o=Ot(),r=o&&!n.includes(":")?`${o}:${n}`:n;if(K()||!n)return;const a=Z();if(!a||yt(a.value).some(d=>d.raw===r))return;const{variants:i,base:c}=de(r),l=G(fe(c).name),f=i.join(":"),u=l?yt(a.value).find(d=>!d.dynamic&&d.variants.join(":")===f&&G(d.name)===l):null;if(u){V(t,a.html,st(a.value,u,r),u.raw,r);return}V(t,a.html,pe(a.value,r),"",r.includes(":")?"":r)}function xt(t,e,n){if(K())return;const o=Z();if(!o||o.value.slice(e.from,e.to)!==e.raw){R(t);return}const r=n?vt({variants:e.variants,name:n,modifier:e.modifier,important:e.important}):"";V(t,o.html,st(o.value,e,r),e.raw,r)}function Co(t,e){if(K()||!C)return;const n=W("dock:html");if(typeof n!="string"||n[C.from]!=="<")return;const o=he(n,C,e);if(o===n)return;const r=C.from;W("dock:set-html",o);const s=Tt(St(o),new Set).find(i=>i.from===r);s&&(C={from:s.from,openTo:s.openTo,path:s.path,tag:s.tag}),R(t),et("tw:changed")}function Uo(t,e,n){n?.tag&&J(t,e,ke,{label:T(t,"tw_tag"),placeholder:T(t,"tw_tag_placeholder"),current:String(n.tag).toLowerCase(),tags:$e,onPick:o=>{_o(t,n,o),O(t)}})}function _o(t,e,n){if(W("dock:is-locked")===!0)return;const o=W("dock:html");if(typeof o!="string"||o[e.from]!=="<")return;const r=he(o,e,n);r!==o&&W("dock:set-html",r)}function So(t,e){J(t,e,ke,{label:T(t,"tw_tag"),placeholder:T(t,"tw_tag_placeholder"),current:(C?.tag||"").toLowerCase(),tags:$e,onPick:n=>{Co(t,n),O(t)}})}function To(t,e){if(K())return;const n=Z();if(!n)return;const o=e.map(s=>Y.get(s)).filter(Boolean);if(o.length<2)return;const r=[...o].sort((s,i)=>s.from-i.from).map(s=>({from:s.from,to:s.to})),a=me(n.value,r,o.map(s=>s.raw));a!==n.value&&V(t,n.html,a,"","")}function Yo(t){Rt(t,C?.path||"")}function Go(){return!!C}function Eo(t,e){const n=Pt[e];n&&(W("lp:set-device",{win:t,key:n.device}),it=!n.all,Ce=n.key,O(t),R(t),et("tw:changed"))}function Ao(t,e){J(t,e,Mt,{title:T(t,"tw_state"),removeLabel:T(t,"tw_state_none"),options:Zt.filter(Boolean).map(n=>({label:n,css:"",color:null,active:n===U})),onPick:n=>{U=Zt.includes(n)?n:"",O(t),R(t),et("tw:changed")},onRemove:()=>{U="",O(t),R(t),et("tw:changed")}})}qe("lp:device",()=>{it=!1,Te(window.document)&&R(window)});function Lo(t){const e=t?Z():null;return e&&Pe(e.value).find(n=>G(n.name)===t)?.name||""}function Jo(t,e,n,o){const r=Ln(n,z);if(!r.length)return;const a=Lo(n);J(t,e,Mt,{title:n,removeLabel:T(t,"tw_classes_remove"),options:Me(t,r,a),onPick:s=>{Jt(t,s),O(t),o?.(s)},onRemove:()=>{a&&Jt(t,a),O(t),o?.("")}})}let Qt=[],mt=!1;function Mo(t){mt||(mt=!0,t.fetch("/!/sve/site-css/classes",{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(e=>e.ok?e.json():{groups:[]}).then(e=>{Qt=Array.isArray(e?.groups)?e.groups:[],v.siteClasses=Qt}).catch(()=>{mt=!1}))}function Po(t,e){Mo(t),J(t,e,ro,{label:T(t,"tw_add_class"),placeholder:T(t,"tw_add_placeholder"),emptyText:T(t,"tw_add_empty"),offText:T(t,"tw_class_not_imported"),sitePlaceholder:T(t,"tw_add_placeholder_site"),siteLabel:T(t,"tw_add_site"),tailwindLabel:T(t,"tw_add_tailwind"),search:n=>{const o=String(n||"").trim(),r=o.toLowerCase();if(!r||!z)return[];const a=z.catalog,s=[],i=[];for(let l=0;l<a.names.length;l++){const f=a.lower[l];f.startsWith(r)?s.length<40&&s.push(a.names[l]):i.length<40&&f.includes(r)&&i.push(a.names[l])}s.sort((l,f)=>l.length-f.length);const c=[...s,...i].slice(0,40);return!c.includes(o)&&a.resolve(o)&&c.unshift(o),a.rows(c).map(l=>({label:l.label,css:l.css,color:l.color,active:!1}))},onAdd:n=>{$o(t,n)}})}function Bo(t,e,n){const o=Y.get(n);if(!o||o.locked)return;if(at===n){O(t),nt();return}const r=ye(o.name,z);J(t,e.currentTarget,Mt,{title:r?.label||"",removeLabel:T(t,"tw_classes_remove"),options:Me(t,r?.options,o.name),onPick:a=>{xt(t,o,a),O(t)},onRemove:()=>{xt(t,o,""),O(t)}}),at=n,nt()}function nt(){for(const t of v.groups)for(const e of t.chips)e.open=e.id===at}function Qo(t,e){if(!e||e.from==null||e.openTo==null){C=null,Y=new Map,O(t),R(t);return}C={from:e.from,openTo:e.openTo,path:e.path,tag:e.tag},R(t)}function R(t){Oo(t);const e=C?Z():null,n=e?At(e.value):{scope:null,groups:[]};Y=new Map,v.baseLabel=T(t,"tw_size_base"),v.scopeTitle=T(t,"tw_classes_scope"),v.dropTitle=T(t,"tw_classes_remove"),v.variant=Ot(),v.onBreakpoint=s=>Eo(t,s),v.onState=s=>Ao(t,s.currentTarget);const o=Se();v.breakpoints=Pt.map((s,i)=>({index:i,label:T(t,s.label),title:s.under?`${s.key}:  ·  < ${s.under}px`:T(t,s.all?"tw_size_all_title":"tw_size_base_title"),active:s.all?!o:o&&s.key===Bt()})),v.state=U,v.stateLabel=U||T(t,"tw_state"),v.canEdit=!K(),v.onChip=(s,i)=>Bo(t,s,i),v.onTag=s=>So(t,s.currentTarget),v.sortTitle=T(t,"tw_sort"),v.onSort=()=>wo(t),v.onDrop=s=>{const i=Y.get(s);i&&!i.locked&&(O(t),xt(t,i,""))},v.tag=C?.tag||"";const r=n.scope?.label||"";v.scope=/^\[\s*\]$/.test(r)?"":r,v.emptyText=T(t,C?n.groups.length?"tw_classes_none_size":"tw_classes_none":"tw_classes_pick"),v.groups=n.groups.filter(s=>ho(s.key)).map(s=>({key:s.key,current:s.key===v.variant,chips:s.items.map((i,c)=>{const l={...i,id:`${s.key}-${c}-${i.from}`,locked:i.dynamic||!v.canEdit,open:!1,color:i.dynamic?"":xo(t,i.name),title:i.dynamic?T(t,"tw_classes_dynamic"):xe(i.name,z)||i.raw};return Y.set(l.id,l),l})}));const a=Te(t.document);a&&(Ee(t.document),We(a,Hn)),nt(),Rt(t,C?.path||""),et("tw:changed")}function Oo(t){z||ft||(ft=!0,Tn(t).then(e=>{z=e,R(t)}).catch(()=>{ft=!1}))}const Be="sve-tw-strip";function zo(t){try{return $t(t,Be)!=="0"}catch{return!0}}function tr(t,e){je(t,Be,e?"1":"0"),e||kt(t)}const k="__sve-tw-strip",te="__sve-tw-strip-style";let ee=null,tt=null;function Dt(t){const e=t.document.getElementById("live-preview-iframe");if(e)return e;for(const n of t.document.querySelectorAll("iframe"))try{const o=n.contentDocument?.getElementById("live-preview-iframe");if(o)return o}catch{}return null}function Do(t){if(t.getElementById(te))return;const e=t.createElement("style");e.id=te,e.textContent=`
    #${k} {
      position: fixed;
      z-index: 99998;
      display: flex;
    ...
    #${k} [data-scroll]::-webkit-scrollbar { display: none; }
    ...
    #${k} [data-group="classes"][data-overflow] [data-fade] { opacity: 1; }
    #${k} [data-sve-tw-strip-tag] {
      flex: 0 0 auto;
      padding: 0 0.2em;
      opacity: .75;
      font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;
    ...
    #${k} button:hover { background: rgba(255,255,255,.2); }
    #${k} button[data-locked] { cursor: default; opacity: .5; }
    #${k} button[data-locked]:hover { background: rgba(255,255,255,.1); }
    #${k} [data-chip-wrap] {
      position: relative;
      display: inline-flex;
      flex: 0 0 auto;
    ...
    #${k} [data-chip-wrap][data-dragging] {
      opacity: .35;
      cursor: grabbing;
    }
    #${k}[data-dragging],
    #${k}[data-dragging] * { cursor: grabbing !important; }
    #${k}[data-dragging] [data-drop] { opacity: 0 !important; }
    #${k} [data-drop] {
      position: absolute;
      top: -0.5em;
      right: -0.5em;
    ...
    #${k} [data-chip-wrap]:hover [data-drop] { opacity: 1; }
    #${k} [data-drop]:hover { background: #f43f5e; }
