...
`)}function Pr(e,t){const o=Z(e,t);return o?String(e).slice(o.brace+1,o.close):""}function nn(e,t,o){const n=jr(Pr(t,e.className)),s="    ".repeat(o),r=[];n.decls&&r.push(Ao(n.decls.replace(/;+\s*$/,";"),o+1));for(const a of n.other)r.push(Ao(a,o+1));for(const a of e.children)r.push(nn(a,t,o+1));const i=r.filter(Boolean).join(`
...
`)+`
`:""}function sn(e){const t=String(e||"").match(/^\s*\.([a-zA-Z_][\w-]*)\s*\{/);return t?t[1]:""}function Rr(e){const t=[],o=/\.([a-zA-Z_][\w-]*)\s*\{/g;let n,s=!0;for(;n=o.exec(String(e||""));){if(s){s=!1;continue}t.push(n[1])}return t}function qr(e,t){const o=String(e).lastIndexOf(`
`,t-1)+1,n=e.slice(o,t);return/^\s*$/.test(n)?n:""}function zr(e,t){return t?e.split(`
`).map((o,n)=>n===0||!o?o:t+o).join(`
`):e}function Nr(e,t){let o=0;for(let n=0;n<t.from;n+=1){if(e.startsWith("/*",n)){n=Kt(e,n)-1;continue}e[n]==="{"?o+=1:e[n]==="}"&&(o-=1)}return o===0}function Zt(e,t,o){const n=sn(t)||o;if(!n)return String(e||"");let s=String(t||"").trim();s?new RegExp(`^\\.${ct(n)}\\s*\\{`).test(s)||(s=`.${n} {
${s}
}`):s=`.${n} {
...
`:""}${s}
`;const l=Z(r,n);if(!l)return r;for(const c of[...new Set(a)].reverse()){const u=new RegExp(`(^|[^\\w-])\\.${ct(c)}\\s*\\{`,"g"),f=[];let p;for(;p=u.exec(r);){const v=p.index+p[1].length,k=r.indexOf("{",v),y=Xt(r,k);y!==-1&&f.push({from:v,to:y+1})}for(const v of f.reverse()){if(v.from>=l.from&&v.to<=l.to||!Nr(r,v))continue;let k=v.from;const y=r.lastIndexOf(`
...
${i}  <li></li>
${i}</ul>`;vt(a,`<ul>
${i}  <li>`.length)}else vt(`<${e}></${e}>`,e.length+2);ne()}function Tt(e){try{ga(e)}catch{}}function ga(e){const t=e?.document?.getElementById(d),n=Qe()?.name||"";if(t)for(const s of Pt){const r=t.querySelector(`[data-sve-html-tool="${s.id}"]`);if(!r)continue;(s.id==="heading"?Wt(n):n===s.tag)?r.setAttribute("data-active",""):r.removeAttribute("data-active")}}function ya(e,t){const o=e.document,n=Qe()?.name||"";w(o),t.setAttribute("data-open","");const s=o.createElement("div");s.id=T,o.body.appendChild(s),Oe(e,t,s),s._sveApp=Me(gt,s,{kind:"choices",choices:Hn.map(r=>({value:r,label:r.toUpperCase(),active:n===r})),onPick:r=>{is(r),w(o)}})}function xa(e){const t=ke(e),o=h.html,n=h.css;if(!t||o?.state.readOnly||n?.state.readOnly)return;const s=Qe();if(s?.open&&o){const r=o.state.doc.sliceString(s.open.from,s.open.to),i=Hr(r,t);i!==r&&o.dispatch({changes:{from:s.open.from,to:s.open.to,insert:i}})}Le(),Z(S,t)||(S=`${String(S||"").trimEnd()}${S?.trim()?`
`:""}.${t} {
}
`),Ct(),St(),Be(),b&&(ce(b),Tt(b),K(b))}function ba(e,t){const o=e.document;if(t.hasAttribute("data-open")){w(o);return}w(o),t.setAttribute("data-open","");const n=o.createElement("div");n.id=T,o.body.appendChild(n),Oe(e,t,n),n._sveApp=Me(Go,n,{label:m(e,"code_dock_css_class_name"),placeholder:m(e,"code_dock_css_class_placeholder"),onAdd:s=>{xa(s),w(o)}})}function ka(e,t){const o=t.querySelector("[data-sve-css-add-class]");!o||o._sveBound||(o._sveBound=!0,o.innerHTML=bi,o.title=m(e,"code_dock_css_add_class"),o.setAttribute("aria-label",o.title),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),O==="tw"){w(e.document),Rs(e,o);return}ba(e,o)}))}function _a(e){const t=Math.max(0,Math.round(Date.now()/1e3-e)),o=new Date(e*1e3).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});let n=o;try{const s=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"});t<90?n=s.format(-t,"second"):t<5400?n=s.format(-Math.round(t/60),"minute"):t<86400?n=s.format(-Math.round(t/3600),"hour"):n=s.format(-Math.round(t/86400),"day")}catch{}return`${n} · ${o}`}function as(e,t){return e.fetch(t,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}})}async function Sa(e,t){const o=e.document,n=go();if(w(o),!n)return;let s=[];try{const i=await as(e,`/!/sve/section-template/history?type=${encodeURIComponent(n)}`);i.ok&&(s=(await i.json())?.entries||[])}catch{s=[]}if(!o.getElementById(d)||!o.contains(t))return;t.setAttribute("data-open","");const r=o.createElement("div");r.id=T,o.body.appendChild(r),Oe(e,t,r),r._sveApp=Me(gt,r,{kind:"choices",choices:s.length?s.map(i=>({value:i.id,label:_a(i.at)})):[{value:"",label:m(e,"code_dock_history_empty")}],onPick:i=>{w(o),i&&$a(e,n,i)}})}async function $a(e,t,o){if(Ce())return;let n=null;try{const s=await as(e,`/!/sve/section-template/history/entry?type=${encodeURIComponent(t)}&id=${encodeURIComponent(o)}`);s.ok&&(n=await s.json())}catch{n=null}!n||Ce()||(Je({html:n.html??"",css:n.css??"",js:n.js??""},M),ce(e),Mt(e))}function Ca(e,t){const o=t.querySelector("[data-sve-code-history]");!o||o._sveBound||(o._sveBound=!0,o.innerHTML=Si,o.title=m(e,"code_dock_history"),o.setAttribute("aria-label",o.title),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),o.hasAttribute("data-open")){w(e.document);return}Sa(e,o)}))}function wa(){return O}function Aa(e){const t=h.html;if(!t||O!=="tw")return null;const o=B&&!!x,n=o?A:t.state.doc.toString(),r=(o?x.from:0)+t.state.selection.main.from,i=Ps(Uo(n),new Set);let a=null;for(const l of i)l.from<=r&&r<l.to&&(a=l);return a}function Mt(e){O==="tw"&&js(e,Aa())}function vo(e){const t=e?.document.getElementById(d);if(!t)return;const o=O==="tw";t.setAttribute("data-sve-style",O);const n=t.querySelector("[data-sve-css-label]");n&&(n.textContent=o?m(e,"code_dock_style_tw"):m(e,"code_dock_css"));const s=t.querySelector("[data-sve-style-mode]");if(!s)return;const r=e.document.createElement("span");r.textContent=o?m(e,"code_dock_style_tw"):m(e,"code_dock_css"),s.innerHTML=o?Ci:$i,s.appendChild(r),s.title=m(e,o?"code_dock_style_to_css":"code_dock_style_to_tw"),s.setAttribute("aria-label",s.title),s.setAttribute("aria-pressed",o?"true":"false")}function ls(e){const t=e?.document.getElementById(d);w(e.document),De(e),re(t)?.removeAttribute("data-sve-css-sub"),vo(e),zt?.(),O==="tw"&&Ft(e,!0),Mt(e),K(e)}function Ea(e,t){O=t==="tw"?"tw":"css",we(e,Ln,O),ls(e)}function Ta(e,t){t._sveStyleModeBound||(t._sveStyleModeBound=!0,O=Te(e,Ln)==="tw"?"tw":"css",t.querySelector("[data-sve-style-mode]")?.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),Ea(e,O==="tw"?"css":"tw")}),ls(e))}function Ma(e,t,o,n){const s=jn[o];if(s){De(e),$o(e,s),K(e);return}const r=Dn[o];if(!(!r||!n)){if(o==="display"){De(e),mt(e,"display");return}if(o==="absolute"){De(e),re(t)?.removeAttribute("data-sve-css-sub"),$o(e,"absolute"),K(e);return}if(o==="padding"||o==="margin"){De(e),mt(e,r);return}re(t)?.removeAttribute("data-sve-css-sub"),Xo(e,n,r)}}function Ba(e){return e==="flex"?"display":e.startsWith("justify-")?"justify-content":e.startsWith("items-")?"align-items":"flex-direction"}function La(e,t){const o=t.querySelector("[data-sve-css-chrome]"),n=o?.getAttribute("data-sve-css-sub")||"",s=n==="padding"||n==="margin"?n:"",r=Lt()&&tt("display")==="flex";for(const i of[o,t.querySelector("[data-sve-css-tools]")])i&&(r?i.setAttribute("data-sve-css-flex-on",""):i.removeAttribute("data-sve-css-flex-on"));for(const[i,a]of Object.entries(jn)){const l=t.querySelector(`[data-sve-css-tool="${i}"]`);l&&(Lt()&&tt(Ba(a))===a?l.setAttribute("data-active",""):l.removeAttribute("data-active"))}for(const i of[...ze,...Pn]){const a=t.querySelector(`[data-sve-css-tool="${i.id}"]`);if(!a)continue;const l=Dn[i.id],c=Lt()&&!!l&&!!tt(l);n===l&&(i.id==="padding"||i.id==="margin")?a.setAttribute("data-open",""):a.removeAttribute("data-open"),c?a.setAttribute("data-active",""):a.removeAttribute("data-active")}for(const i of oo){const a=t.querySelector(`[data-sve-css-box-side="${i.suffix}"]`);if(!a)continue;const l=s?`${s}${Rn[i.suffix]??i.suffix}`:"";l&&tt(l)?a.setAttribute("data-active",""):a.removeAttribute("data-active")}}function Oa(e,t){const o=t.querySelector("[data-sve-css-tools]");if(!o||o._sveBound)return;o._sveBound=!0;const n=[...ze,...Rt,...qt],s=(c,u)=>{if(O==="tw"){Ma(e,t,c,u);return}const f=n.find(p=>p.id===c);if(f){if(f.flexDir){w(e.document),ca(f.flexDir);return}if(f.display){w(e.document),da(f.display);return}if(f.property&&f.value){w(e.document),ua(f.property,f.value);return}if(f.insert){const p=wt(f.insert),v=At(f.insert),k=$e();w(e.document),re(t)?.removeAttribute("data-sve-css-sub"),p&&P(k[p])===P(v)?W([{property:p,value:null}]):W([{property:p,value:v}]);return}if(f.menu==="colors"){re(t)?.removeAttribute("data-sve-css-sub"),va(e,u,f.property);return}if(f.menu==="box"){mt(e,f.property);return}if(f.menu==="display"){mt(e,"display");return}f.menu==="spacing"&&qo(e,u,f.property)}};let r=!1;const i=qt.map((c,u)=>{const f={...c,icon:nt[c.id]||"",sep:u===0||c.group==="align"&&!r};return c.group==="align"&&!r&&(r=!0),f});zt=()=>{const c=O==="tw"?[...ze,...Pn]:ze;re(t)?.removeAttribute("data-sve-css-sub"),ss(t),xe(o,yr,{tools:c.map(u=>({...u,icon:nt[u.id]||_i[u.id]||""})),onTool:u=>s(u,t.querySelector(`[data-sve-css-tool="${u}"]`))})},zt();const a=t.querySelector('[data-sve-css-sub="box"]');a&&!a._sveBound&&(a._sveBound=!0,xe(a,kr,{sides:oo.map(c=>({...c,icon:nt[`box-${c.id}`]||""})),onSide:c=>{const u=re(t)?.getAttribute("data-sve-css-sub"),f=a.querySelector(`[data-sve-css-box-side="${c}"]`),p=`${u}${c}`,v=O==="tw"?{}:$e();if(!(u!=="padding"&&u!=="margin"||!f)){if(O==="tw"){Xo(e,f,`${u}${Rn[c]??c}`);return}if(p in v){w(e.document),W([{property:p,value:null}]);return}qo(e,f,p),K(e)}}}));const l=t.querySelector('[data-sve-css-sub="display"]');l&&!l._sveBound&&(l._sveBound=!0,xe(l,Ar,{items:Rt.map(c=>({...c,icon:nt[c.id]||""})),extras:i,onTool:c=>s(c,t.querySelector(`[data-sve-css-tool="${c}"]`))})),e.document.addEventListener("mousedown",c=>{c.target.closest(`#${T}, [data-sve-css-tools], [data-sve-css-subrow], [data-sve-html-tools], [data-sve-css-add-class]`)||w(e.document)},!0)}function Ia(e,t){const o=t.querySelector("[data-sve-html-tools]");!o||o._sveBound||(o._sveBound=!0,xe(o,ur,{tools:Pt.map(n=>({...n,icon:wi[n.id]||""})),onTool:n=>{const s=Pt.find(i=>i.id===n),r=o.querySelector(`[data-sve-html-tool="${n}"]`);if(s){if(s.menu==="heading"){ya(e,r);return}w(e.document),is(s.tag)}}}),Ha(e,t),ja(e,t))}function Ha(e,t){const o=t.querySelector("[data-sve-antlers-tools]");!o||o._sveBound||(o._sveBound=!0,xe(o,Zo,{label:m(e,"code_dock_antlers"),groups:Fs.map(n=>({id:n.id,label:m(e,n.lang),items:Vs.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>Da(n)}))}function Da(e){const t=Ws(e),o=h.html;if(!t||!o||o.state.readOnly)return;const n=o.state.selection.main.head,s=o.state.doc.lineAt(n),r=s.text.trim()?ve(s.text):Et(o,s)||ve(s.text),{text:i,cursor:a}=lt(t.snippet);vt(Yo(i,r),a),ne()}function ja(e,t){const o=t.querySelector("[data-sve-visual-edit-tools]");!o||o._sveBound||(o._sveBound=!0,xe(o,Zo,{label:m(e,"code_dock_visual_edit"),groups:Ur.map(n=>({id:n.id,label:m(e,n.lang),items:an.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>Ra(n)}))}function Pa(e,t,o,n){if(Yr(o.inner,n.attr)){e.focus();return}const{text:s,cursor:r}=lt(n.attr);let i=o.closeIdx;for(;i>o.openIdx+2&&/\s/.test(t[i-1]);)i--;e.dispatch({changes:{from:i,to:o.closeIdx,insert:` ${s} `},selection:{anchor:i+1+r}}),ne()}function Ra(e){const t=Kr(e),o=h.html;if(!t||!o||o.state.readOnly)return;const n=o.state.doc.toString(),s=Qe();if(s?.open){const f=Xr(n,s.open.from,s.open.to,ot);if(f){t.attr?Pa(o,n,f,t):(o.dispatch({selection:{anchor:f.openIdx+2+ot.length}}),o.focus());return}const p=s.open.from+1+s.name.length,v=t.standalone||`{{ ${ot} ${t.attr} }}`,{text:k,cursor:y}=lt(v);o.dispatch({changes:{from:p,to:p,insert:` ${k}`},selection:{anchor:p+1+y}}),ne();return}const r=o.state.selection.main.head,i=o.state.doc.lineAt(r),a=i.text.trim()?ve(i.text):Et(o,i)||ve(i.text),l=t.standalone||`{{ ${ot} ${t.attr} }}`,{text:c,cursor:u}=lt(l);vt(Yo(c,a),u),ne()}function cs(e){if(!_e||!E||String(E).startsWith("view:")){ko(e);return}const t=Es(_e,e.document);ko(e,t.length?{sectionUids:t}:void 0)}function qa(e,t,o){return Ne=e.fetch("/!/sve/section-template",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":zn(e),"X-Requested-With":"XMLHttpRequest"},body:JSON.stringify({type:t,html:o.html,css:o.css,js:o.js,...typeof o.tw=="string"?{tw:o.tw}:{}})}).then(async n=>{if(n.status===423){M=!0,Se=!0,Ee(e),Je(N,!0),U(e),V(e.document,m(e,"code_dock_locked"));return}if(!n.ok)throw new Error(String(n.status));E===t&&(N=o,V(e.document,m(e,"code_dock_saved")),me(e),e.setTimeout(()=>{const s=e.document.getElementById(d)?.querySelector("[data-sve-code-status]");s&&s.textContent===m(e,"code_dock_saved")&&(s.textContent="")},1800)),cs(e),e.document.getElementById("__sve-section-picker")?.dispatchEvent(new e.CustomEvent("sve-library-stale"))}).catch(()=>{V(e.document,m(e,"code_dock_error"))}).finally(()=>{Ne=null}),Ne}function le(e){Q&&(clearTimeout(Q),Q=null);const t=E,o=b,n=h.html;if(!n||n.state.readOnly||!t||!o)return;const s=po(),r=ut!==null&&Ko(o)&&ds(s.html)===ft;ho(s,N)&&!(r&&pt)||(r&&(s.tw=ut,pt=!1),V(e,m(o,"code_dock_saving")),qa(o,t,s))}function ds(e){return Or(e).sort().join(" ")}function us(){ut=null,ft="",pt=!1}function fs(e,t){if(!e||!Ko(e))return;const o=ds(t);o===ft||rt||(rt=!0,J(()=>import("./tw-compile-DBoOJUOE.js"),__vite__mapDeps([8,9,10,11,12,13,6,0,1,7,4,3,5,2]),import.meta.url).then(n=>n.compileTailwind(e,t)).then(n=>{rt=!1,ut=n,ft=o,pt=!0,ps(e,e.document)}).catch(n=>{rt=!1,console.error("[sve] tailwind compile",n)}))}function ps(e,t){Q&&clearTimeout(Q),Q=e.setTimeout(()=>{Q=null,le(t)},hi)}function ce(e){if(q)return;const t=po();if(ho(t,N)){me(e);return}if(me(e),fs(e,t.html),!fo(e)){V(e.document,m(e,"code_dock_unsaved"));return}V(e.document,m(e,"code_dock_saving")),ps(e,e.document)}let be=null,Ue=null;function za(){return be||(be=si({Decoration:eo,StateField:Gt,StateEffect:Jt,RangeSetBuilder:Qt,EditorView:se})),be}function Na(){return Ue||(Ue=li({Decoration:eo,StateField:Gt,StateEffect:Jt,RangeSetBuilder:Qt,EditorView:se})),Ue}function Fa(e,t,o){h[t]?.destroy();const n=jt.of([{key:"Mod-s",run:()=>(le(e.document),!0)}]);h[t]=new se({state:dt.create({doc:"",extensions:[cn(),dn(),un(),mn(),Ei(t),gn(),vn({tooltipClass:()=>"sve-tw-complete"}),...t==="html"?[_n.data.of({autocomplete:Hs(e)}),Ds(kn,e)]:[],...t==="html"?[...qs(),zs()]:[],jt.of([...fn,...t==="html"?[{key:"Tab",run:Ns}]:[],pn,...hn,...bn,...yn]),n,se.lineWrapping,...t==="html"||t==="css"?za().extensions:[],...t==="html"?Na().extensions:[],Ve[t].of(dt.readOnly.of(!!M)),We[t].of(se.editable.of(!M)),se.updateListener.of(s=>{t==="html"&&s.docChanged&&!q&&(Yi(),Ut("dock:html-changed")),t==="css"&&s.docChanged&&!q&&Zi(),s.docChanged&&ce(e),t==="css"&&(s.docChanged||s.selectionSet)&&K(e),t==="html"&&(s.docChanged||s.selectionSet)&&(Tt(e),q||Mt(e))}),...Ai()]}),parent:o})}function Va(e){if(!e||e.querySelector(".cm-editor"))return;e.replaceChildren();const t=e.ownerDocument.createElement("span");t.style.cssText="width:16px;height:16px;margin:12px;border:2px solid #858585;border-right-color:transparent;border-radius:50%;display:block;animation:sve-cm-wait .6s linear infinite",e.appendChild(t)}let at=null;async function Wa(e){const t=e.document;Hi(t);let o=t.getElementById(d);if(o&&!(o.querySelector('[data-sve-css-chrome="subrow-2"]')&&o.querySelector("[data-sve-css-subrow]")&&o.querySelector("[data-sve-css-add-class]")&&o.querySelector("[data-sve-html-tools]")&&o.querySelector("[data-sve-visual-edit-tools]")&&o.querySelector("[data-sve-html-scope]")&&o.querySelector("[data-sve-code-lock]")&&o.querySelector("[data-sve-code-back]")&&o.querySelector("[data-sve-code-autosave]")&&o.querySelector("[data-sve-code-save]")&&o.getAttribute("data-sve-code-chrome")==="scope-7")){for(const s of z)h[s]?.destroy(),h[s]=null;o.remove(),o=null}if(!o){o=t.createElement("div"),o.id=d,o.setAttribute("data-sve-code-chrome","scope-7"),xe(o,lr,{htmlLabel:m(e,"code_dock_html"),cssLabel:m(e,"code_dock_css"),jsLabel:m(e,"code_dock_js"),treeIcon:In}),Nt(t,o),Io(o),Un(o,Nn(e)),Ni(e,o),Vi(e,o),Fi(e,o),Oa(e,o),ka(e,o),Ta(e,o),Ca(e,o),Ia(e,o),Do(e,o),jo(e,o),Ho(e,o),Po(e,o);for(const n of z){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);Va(s)}_.openHtmlTreePanel?.(e)}if(Nt(t,o),Io(o),Do(e,o),jo(e,o),Ho(e,o),Po(e,o),Ri(e),no(e),Ee(e),U(e),Ye(e),me(e),vo(e),await fi(),!h.html){for(const n of z){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);s?.replaceChildren(),Fa(e,n,s)}for(const n of["html","css"])h[n]&&ri(e,h[n],{onOpen:s=>Ui(e,s),emptyLabel:m(e,"code_dock_partials_empty"),sectionValues:()=>Wi(e),isLocked:()=>Ce(),setHover:(s,r)=>be?.setHover(s,r)});ui(e,h.html,{onRename:n=>Ji(e,n),isLocked:()=>Ce(),setHover:(n,s)=>Ue?.setHover(n,s),title:m(e,"code_dock_css_rename_class")})}return o}function hs(e){return at||(at=Wa(e).finally(()=>{at=null})),at}async function No(e,t){const o=await hs(e);E=t,M=!0,Se=!0,N={html:"",css:"",js:""},uo(),Ee(e),Je(N,!0),Yn(e.document,t),V(e.document,m(e,"code_dock_missing")),U(e),Ye(e),me(e),Xe(e,o)}async function Bt(e,t,o="replace"){o==="replace"?pe=[]:o==="push"&&E&&E!==t&&pe.push(E);const n=++je;E=t,Se=!1,uo(),V(e.document,m(e,"code_dock_loading"));const s=await hs(e);Ee(e),U(e),Ye(e),me(e),vo(e),Xe(e,s),e.fetch(`/!/sve/section-template?type=${encodeURIComponent(t)}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(async r=>{if(n!==je)return;if(r.status===404){No(e,t);return}if(!r.ok)throw new Error(String(r.status));const i=await r.json();n===je&&(N={html:typeof i.html=="string"?i.html:"",css:typeof i.css=="string"?i.css:"",js:typeof i.js=="string"?i.js:""},E=t,M=!!i.locked,Se=!0,us(),Ee(e),Je(N,M),M||fs(e,N.html),Yn(e.document,i.path||t),V(e.document,M?m(e,"code_dock_locked"):""),U(e),Ye(e),me(e),Xe(e,s))}).catch(()=>{n===je&&(No(e,t),V(e.document,m(e,"code_dock_error")))})}function go(){return E||""}function ms(e){return!!e?.getElementById(d)}function Ce(){return M}function vs(e,t){const o=typeof t?.html=="string"?t.html.trim():"",n=typeof t?.css=="string"?t.css.trim():"",s=typeof t?.js=="string"?t.js.trim():"";if(!o&&!n&&!s||!e?.document?.getElementById(d))return!1;let r=!1;return o&&(r=Ua("html",o)||r),n&&(r=Fo("css",n)||r),s&&(r=Fo("js",s)||r),r&&ce(e),r}function Ua(e,t){const o=h[e];if(!o||o.state.readOnly)return!1;const n=o.state.selection.main,s=n.from>0?o.state.doc.sliceString(n.from-1,n.from):`
