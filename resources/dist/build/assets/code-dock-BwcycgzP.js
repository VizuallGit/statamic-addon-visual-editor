...
`,e-1)+1;return(t.slice(o,e).match(/^\s*/)||[""])[0]}function J(t){const e=g.css;if(!e||e.state.readOnly||!t.length)return;const o=Le(),n=t.some(l=>l.value!=null)?ec(e,o):o;if(!n){const l=t.filter(c=>c.value!=null).map(c=>`${c.property}: ${c.value};`).join(`
