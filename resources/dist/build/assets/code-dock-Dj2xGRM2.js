...
`):e}function Rr(e,t){let o=0;for(let n=0;n<t.from;n+=1){if(e.startsWith("/*",n)){n=Wt(e,n)-1;continue}e[n]==="{"?o+=1:e[n]==="}"&&(o-=1)}return o===0}function Xt(e,t,o){const n=on(t)||o;if(!n)return String(e||"");let s=String(t||"").trim();s?new RegExp(`^\\.${at(n)}\\s*\\{`).test(s)||(s=`.${n} {
${s}
}`):s=`.${n} {
...
`:""}${s}
`;const l=Y(r,n);if(!l)return r;for(const c of[...new Set(a)].reverse()){const u=new RegExp(`(^|[^\\w-])\\.${at(c)}\\s*\\{`,"g"),f=[];let p;for(;p=u.exec(r);){const v=p.index+p[1].length,k=r.indexOf("{",v),y=Ut(r,k);y!==-1&&f.push({from:v,to:y+1})}for(const v of f.reverse()){if(v.from>=l.from&&v.to<=l.to||!Rr(r,v))continue;let k=v.from;const y=r.lastIndexOf(`
...
${i}  <li></li>
${i}</ul>`;pt(a,`<ul>
${i}  <li>`.length)}else pt(`<${e}></${e}>`,e.length+2);ne()}function wt(e){try{ha(e)}catch{}}function ha(e){const t=e?.document?.getElementById(d),n=Je()?.name||"";if(t)for(const s of Ht){const r=t.querySelector(`[data-sve-html-tool="${s.id}"]`);if(!r)continue;(s.id==="heading"?Ft(n):n===s.tag)?r.setAttribute("data-active",""):r.removeAttribute("data-active")}}function ma(e,t){const o=e.document,n=Je()?.name||"";w(o),t.setAttribute("data-open","");const s=o.createElement("div");s.id=T,o.body.appendChild(s),Oe(e,t,s),s._sveApp=Me(ht,s,{kind:"choices",choices:On.map(r=>({value:r,label:r.toUpperCase(),active:n===r})),onPick:r=>{os(r),w(o)}})}function va(e){const t=ke(e),o=h.html,n=h.css;if(!t||o?.state.readOnly||n?.state.readOnly)return;const s=Je();if(s?.open&&o){const r=o.state.doc.sliceString(s.open.from,s.open.to),i=Lr(r,t);i!==r&&o.dispatch({changes:{from:s.open.from,to:s.open.to,insert:i}})}Le(),Y(S,t)||(S=`${String(S||"").trimEnd()}${S?.trim()?`
`:""}.${t} {
}
`),_t(),bt(),Be(),b&&(le(b),wt(b),G(b))}function ga(e,t){const o=e.document;if(t.hasAttribute("data-open")){w(o);return}w(o),t.setAttribute("data-open","");const n=o.createElement("div");n.id=T,o.body.appendChild(n),Oe(e,t,n),n._sveApp=Me(Yo,n,{label:m(e,"code_dock_css_class_name"),placeholder:m(e,"code_dock_css_class_placeholder"),onAdd:s=>{va(s),w(o)}})}function ya(e,t){const o=t.querySelector("[data-sve-css-add-class]");!o||o._sveBound||(o._sveBound=!0,o.innerHTML=gi,o.title=m(e,"code_dock_css_add_class"),o.setAttribute("aria-label",o.title),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),O==="tw"){w(e.document),Hs(e,o);return}ga(e,o)}))}function xa(e){const t=Math.max(0,Math.round(Date.now()/1e3-e)),o=new Date(e*1e3).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});let n=o;try{const s=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"});t<90?n=s.format(-t,"second"):t<5400?n=s.format(-Math.round(t/60),"minute"):t<86400?n=s.format(-Math.round(t/3600),"hour"):n=s.format(-Math.round(t/86400),"day")}catch{}return`${n} · ${o}`}function ns(e,t){return e.fetch(t,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}})}async function ba(e,t){const o=e.document,n=mo();if(w(o),!n)return;let s=[];try{const i=await ns(e,`/!/sve/section-template/history?type=${encodeURIComponent(n)}`);i.ok&&(s=(await i.json())?.entries||[])}catch{s=[]}if(!o.getElementById(d)||!o.contains(t))return;t.setAttribute("data-open","");const r=o.createElement("div");r.id=T,o.body.appendChild(r),Oe(e,t,r),r._sveApp=Me(ht,r,{kind:"choices",choices:s.length?s.map(i=>({value:i.id,label:xa(i.at)})):[{value:"",label:m(e,"code_dock_history_empty")}],onPick:i=>{w(o),i&&ka(e,n,i)}})}async function ka(e,t,o){if(Ce())return;let n=null;try{const s=await ns(e,`/!/sve/section-template/history/entry?type=${encodeURIComponent(t)}&id=${encodeURIComponent(o)}`);s.ok&&(n=await s.json())}catch{n=null}!n||Ce()||(Ge({html:n.html??"",css:n.css??"",js:n.js??""},M),le(e),At(e))}function _a(e,t){const o=t.querySelector("[data-sve-code-history]");!o||o._sveBound||(o._sveBound=!0,o.innerHTML=bi,o.title=m(e,"code_dock_history"),o.setAttribute("aria-label",o.title),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),o.hasAttribute("data-open")){w(e.document);return}ba(e,o)}))}function Sa(){return O}function $a(e){const t=h.html;if(!t||O!=="tw")return null;const o=B&&!!x,n=o?A:t.state.doc.toString(),r=(o?x.from:0)+t.state.selection.main.from,i=Is(Vo(n),new Set);let a=null;for(const l of i)l.from<=r&&r<l.to&&(a=l);return a}function At(e){O==="tw"&&Os(e,$a())}function ho(e){const t=e?.document.getElementById(d);if(!t)return;const o=O==="tw";t.setAttribute("data-sve-style",O);const n=t.querySelector("[data-sve-css-label]");n&&(n.textContent=o?m(e,"code_dock_style_tw"):m(e,"code_dock_css"));const s=t.querySelector("[data-sve-style-mode]");if(!s)return;const r=e.document.createElement("span");r.textContent=o?m(e,"code_dock_style_tw"):m(e,"code_dock_css"),s.innerHTML=o?_i:ki,s.appendChild(r),s.title=m(e,o?"code_dock_style_to_css":"code_dock_style_to_tw"),s.setAttribute("aria-label",s.title),s.setAttribute("aria-pressed",o?"true":"false")}function ss(e){const t=e?.document.getElementById(d);w(e.document),Ot(e),xe(t)?.removeAttribute("data-sve-css-sub"),ho(e),jt?.(),O==="tw"&&qt(e,!0),At(e),G(e)}function Ca(e,t){O=t==="tw"?"tw":"css",we(e,Mn,O),ss(e)}function wa(e,t){t._sveStyleModeBound||(t._sveStyleModeBound=!0,O=Te(e,Mn)==="tw"?"tw":"css",t.querySelector("[data-sve-style-mode]")?.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),Ca(e,O==="tw"?"css":"tw")}),ss(e))}function Aa(e,t,o,n){const s=In[o];if(!(!s||!n)){if(o==="absolute"){Ot(e),xe(t)?.removeAttribute("data-sve-css-sub"),Ds(e,"absolute"),G(e);return}if(o==="padding"||o==="margin"){Ot(e),zt(e,s);return}xe(t)?.removeAttribute("data-sve-css-sub"),Uo(e,n,s)}}function Ea(e,t){const o=t.querySelector("[data-sve-css-chrome]"),n=o?.getAttribute("data-sve-css-sub")||"",s=n==="padding"||n==="margin"?n:"";o?.removeAttribute("data-sve-css-flex-on"),t.querySelector("[data-sve-css-tools]")?.removeAttribute("data-sve-css-flex-on");for(const r of[...qe,...Hn]){const i=t.querySelector(`[data-sve-css-tool="${r.id}"]`);if(!i)continue;const a=In[r.id],l=Ps()&&!!a&&!!_o(a);n===a&&(r.id==="padding"||r.id==="margin")?i.setAttribute("data-open",""):i.removeAttribute("data-open"),l?i.setAttribute("data-active",""):i.removeAttribute("data-active")}for(const r of eo){const i=t.querySelector(`[data-sve-css-box-side="${r.suffix}"]`);if(!i)continue;const a=s?`${s}${Dn[r.suffix]??r.suffix}`:"";a&&_o(a)?i.setAttribute("data-active",""):i.removeAttribute("data-active")}}function Ta(e,t){const o=t.querySelector("[data-sve-css-tools]");if(!o||o._sveBound)return;o._sveBound=!0;const n=[...qe,...Dt,...Pt],s=(c,u)=>{if(O==="tw"){Aa(e,t,c,u);return}const f=n.find(p=>p.id===c);if(f){if(f.flexDir){w(e.document),ia(f.flexDir);return}if(f.display){w(e.document),aa(f.display);return}if(f.property&&f.value){w(e.document),la(f.property,f.value);return}if(f.insert){const p=St(f.insert),v=$t(f.insert),k=$e();w(e.document),xe(t)?.removeAttribute("data-sve-css-sub"),p&&j(k[p])===j(v)?W([{property:p,value:null}]):W([{property:p,value:v}]);return}if(f.menu==="colors"){xe(t)?.removeAttribute("data-sve-css-sub"),pa(e,u,f.property);return}if(f.menu==="box"){zt(e,f.property);return}if(f.menu==="display"){zt(e,"display");return}f.menu==="spacing"&&jo(e,u,f.property)}};let r=!1;const i=Pt.map((c,u)=>{const f={...c,icon:tt[c.id]||"",sep:u===0||c.group==="align"&&!r};return c.group==="align"&&!r&&(r=!0),f});jt=()=>{const c=O==="tw"?[...qe,...Hn]:qe;ye(o,mr,{tools:c.map(u=>({...u,icon:tt[u.id]||xi[u.id]||""})),onTool:u=>s(u,t.querySelector(`[data-sve-css-tool="${u}"]`))})},jt();const a=t.querySelector('[data-sve-css-sub="box"]');a&&!a._sveBound&&(a._sveBound=!0,ye(a,yr,{sides:eo.map(c=>({...c,icon:tt[`box-${c.id}`]||""})),onSide:c=>{const u=xe(t)?.getAttribute("data-sve-css-sub"),f=a.querySelector(`[data-sve-css-box-side="${c}"]`),p=`${u}${c}`,v=O==="tw"?{}:$e();if(!(u!=="padding"&&u!=="margin"||!f)){if(O==="tw"){Uo(e,f,`${u}${Dn[c]??c}`);return}if(p in v){w(e.document),W([{property:p,value:null}]);return}jo(e,f,p),G(e)}}}));const l=t.querySelector('[data-sve-css-sub="display"]');l&&!l._sveBound&&(l._sveBound=!0,ye(l,$r,{items:Dt.map(c=>({...c,icon:tt[c.id]||""})),extras:i,onTool:c=>s(c,t.querySelector(`[data-sve-css-tool="${c}"]`))})),e.document.addEventListener("mousedown",c=>{c.target.closest(`#${T}, [data-sve-css-tools], [data-sve-css-subrow], [data-sve-html-tools], [data-sve-css-add-class]`)||w(e.document)},!0)}function Ma(e,t){const o=t.querySelector("[data-sve-html-tools]");!o||o._sveBound||(o._sveBound=!0,ye(o,cr,{tools:Ht.map(n=>({...n,icon:Si[n.id]||""})),onTool:n=>{const s=Ht.find(i=>i.id===n),r=o.querySelector(`[data-sve-html-tool="${n}"]`);if(s){if(s.menu==="heading"){ma(e,r);return}w(e.document),os(s.tag)}}}),Ba(e,t),Oa(e,t))}function Ba(e,t){const o=t.querySelector("[data-sve-antlers-tools]");!o||o._sveBound||(o._sveBound=!0,ye(o,Xo,{label:m(e,"code_dock_antlers"),groups:zs.map(n=>({id:n.id,label:m(e,n.lang),items:Ns.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>La(n)}))}function La(e){const t=Fs(e),o=h.html;if(!t||!o||o.state.readOnly)return;const n=o.state.selection.main.head,s=o.state.doc.lineAt(n),r=s.text.trim()?me(s.text):Ct(o,s)||me(s.text),{text:i,cursor:a}=it(t.snippet);pt(Ko(i,r),a),ne()}function Oa(e,t){const o=t.querySelector("[data-sve-visual-edit-tools]");!o||o._sveBound||(o._sveBound=!0,ye(o,Xo,{label:m(e,"code_dock_visual_edit"),groups:Fr.map(n=>({id:n.id,label:m(e,n.lang),items:sn.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>Ha(n)}))}function Ia(e,t,o,n){if(Ur(o.inner,n.attr)){e.focus();return}const{text:s,cursor:r}=it(n.attr);let i=o.closeIdx;for(;i>o.openIdx+2&&/\s/.test(t[i-1]);)i--;e.dispatch({changes:{from:i,to:o.closeIdx,insert:` ${s} `},selection:{anchor:i+1+r}}),ne()}function Ha(e){const t=Vr(e),o=h.html;if(!t||!o||o.state.readOnly)return;const n=o.state.doc.toString(),s=Je();if(s?.open){const f=Wr(n,s.open.from,s.open.to,et);if(f){t.attr?Ia(o,n,f,t):(o.dispatch({selection:{anchor:f.openIdx+2+et.length}}),o.focus());return}const p=s.open.from+1+s.name.length,v=t.standalone||`{{ ${et} ${t.attr} }}`,{text:k,cursor:y}=it(v);o.dispatch({changes:{from:p,to:p,insert:` ${k}`},selection:{anchor:p+1+y}}),ne();return}const r=o.state.selection.main.head,i=o.state.doc.lineAt(r),a=i.text.trim()?me(i.text):Ct(o,i)||me(i.text),l=t.standalone||`{{ ${et} ${t.attr} }}`,{text:c,cursor:u}=it(l);pt(Ko(c,a),u),ne()}function rs(e){if(!_e||!E||String(E).startsWith("view:")){xo(e);return}const t=$s(_e,e.document);xo(e,t.length?{sectionUids:t}:void 0)}function Da(e,t,o){return ze=e.fetch("/!/sve/section-template",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":jn(e),"X-Requested-With":"XMLHttpRequest"},body:JSON.stringify({type:t,html:o.html,css:o.css,js:o.js,...typeof o.tw=="string"?{tw:o.tw}:{}})}).then(async n=>{if(n.status===423){M=!0,Se=!0,Ee(e),Ge(N,!0),U(e),V(e.document,m(e,"code_dock_locked"));return}if(!n.ok)throw new Error(String(n.status));E===t&&(N=o,V(e.document,m(e,"code_dock_saved")),he(e),e.setTimeout(()=>{const s=e.document.getElementById(d)?.querySelector("[data-sve-code-status]");s&&s.textContent===m(e,"code_dock_saved")&&(s.textContent="")},1800)),rs(e),e.document.getElementById("__sve-section-picker")?.dispatchEvent(new e.CustomEvent("sve-library-stale"))}).catch(()=>{V(e.document,m(e,"code_dock_error"))}).finally(()=>{ze=null}),ze}function ae(e){Q&&(clearTimeout(Q),Q=null);const t=E,o=b,n=h.html;if(!n||n.state.readOnly||!t||!o)return;const s=uo(),r=ct!==null&&Wo(o)&&is(s.html)===dt;fo(s,N)&&!(r&&ut)||(r&&(s.tw=ct,ut=!1),V(e,m(o,"code_dock_saving")),Da(o,t,s))}function is(e){return Mr(e).sort().join(" ")}function as(){ct=null,dt="",ut=!1}function ls(e,t){if(!e||!Wo(e))return;const o=is(t);o===dt||nt||(nt=!0,J(()=>import("./tw-compile-DvOsKqGR.js"),__vite__mapDeps([8,9,10,11,12,13,6,0,1,7,4,3,5,2]),import.meta.url).then(n=>n.compileTailwind(e,t)).then(n=>{nt=!1,ct=n,dt=o,ut=!0,cs(e,e.document)}).catch(n=>{nt=!1,console.error("[sve] tailwind compile",n)}))}function cs(e,t){Q&&clearTimeout(Q),Q=e.setTimeout(()=>{Q=null,ae(t)},ui)}function le(e){if(q)return;const t=uo();if(fo(t,N)){he(e);return}if(he(e),ls(e,t.html),!co(e)){V(e.document,m(e,"code_dock_unsaved"));return}V(e.document,m(e,"code_dock_saving")),cs(e,e.document)}let be=null,We=null;function Pa(){return be||(be=ti({Decoration:Jt,StateField:Yt,StateEffect:Zt,RangeSetBuilder:Gt,EditorView:se})),be}function ja(){return We||(We=ri({Decoration:Jt,StateField:Yt,StateEffect:Zt,RangeSetBuilder:Gt,EditorView:se})),We}function Ra(e,t,o){h[t]?.destroy();const n=It.of([{key:"Mod-s",run:()=>(ae(e.document),!0)}]);h[t]=new se({state:lt.create({doc:"",extensions:[an(),ln(),cn(),pn(),Ci(t),mn(),hn({tooltipClass:()=>"sve-tw-complete"}),...t==="html"?[bn.data.of({autocomplete:Bs(e)}),Ls(xn,e)]:[],...t==="html"?[...js(),Rs()]:[],It.of([...dn,...t==="html"?[{key:"Tab",run:qs}]:[],un,...fn,...yn,...vn]),n,se.lineWrapping,...t==="html"||t==="css"?Pa().extensions:[],...t==="html"?ja().extensions:[],Fe[t].of(lt.readOnly.of(!!M)),Ve[t].of(se.editable.of(!M)),se.updateListener.of(s=>{t==="html"&&s.docChanged&&!q&&(Ui(),Vt("dock:html-changed")),t==="css"&&s.docChanged&&!q&&Ki(),s.docChanged&&le(e),t==="css"&&(s.docChanged||s.selectionSet)&&G(e),t==="html"&&(s.docChanged||s.selectionSet)&&(wt(e),q||At(e))}),...$i()]}),parent:o})}function qa(e){if(!e||e.querySelector(".cm-editor"))return;e.replaceChildren();const t=e.ownerDocument.createElement("span");t.style.cssText="width:16px;height:16px;margin:12px;border:2px solid #858585;border-right-color:transparent;border-radius:50%;display:block;animation:sve-cm-wait .6s linear infinite",e.appendChild(t)}let rt=null;async function za(e){const t=e.document;Li(t);let o=t.getElementById(d);if(o&&!(o.querySelector('[data-sve-css-chrome="subrow-2"]')&&o.querySelector("[data-sve-css-subrow]")&&o.querySelector("[data-sve-css-add-class]")&&o.querySelector("[data-sve-html-tools]")&&o.querySelector("[data-sve-visual-edit-tools]")&&o.querySelector("[data-sve-html-scope]")&&o.querySelector("[data-sve-code-lock]")&&o.querySelector("[data-sve-code-back]")&&o.querySelector("[data-sve-code-autosave]")&&o.querySelector("[data-sve-code-save]")&&o.getAttribute("data-sve-code-chrome")==="scope-7")){for(const s of z)h[s]?.destroy(),h[s]=null;o.remove(),o=null}if(!o){o=t.createElement("div"),o.id=d,o.setAttribute("data-sve-code-chrome","scope-7"),ye(o,ir,{htmlLabel:m(e,"code_dock_html"),cssLabel:m(e,"code_dock_css"),jsLabel:m(e,"code_dock_js"),treeIcon:Ln}),Rt(t,o),Lo(o),Fn(o,Rn(e)),Ri(e,o),zi(e,o),qi(e,o),Ta(e,o),ya(e,o),wa(e,o),_a(e,o),Ma(e,o),Io(e,o),Ho(e,o),Oo(e,o),Do(e,o);for(const n of z){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);qa(s)}_.openHtmlTreePanel?.(e)}if(Rt(t,o),Lo(o),Io(e,o),Ho(e,o),Oo(e,o),Do(e,o),Di(e),to(e),Ee(e),U(e),Xe(e),he(e),ho(e),await ci(),!h.html){for(const n of z){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);s?.replaceChildren(),Ra(e,n,s)}for(const n of["html","css"])h[n]&&oi(e,h[n],{onOpen:s=>Fi(e,s),emptyLabel:m(e,"code_dock_partials_empty"),sectionValues:()=>Ni(e),isLocked:()=>Ce(),setHover:(s,r)=>be?.setHover(s,r)});li(e,h.html,{onRename:n=>Yi(e,n),isLocked:()=>Ce(),setHover:(n,s)=>We?.setHover(n,s),title:m(e,"code_dock_css_rename_class")})}return o}function ds(e){return rt||(rt=za(e).finally(()=>{rt=null})),rt}async function qo(e,t){const o=await ds(e);E=t,M=!0,Se=!0,N={html:"",css:"",js:""},lo(),Ee(e),Ge(N,!0),Un(e.document,t),V(e.document,m(e,"code_dock_missing")),U(e),Xe(e),he(e),Ke(e,o)}async function Et(e,t,o="replace"){o==="replace"?fe=[]:o==="push"&&E&&E!==t&&fe.push(E);const n=++De;E=t,Se=!1,lo(),V(e.document,m(e,"code_dock_loading"));const s=await ds(e);Ee(e),U(e),Xe(e),he(e),ho(e),Ke(e,s),e.fetch(`/!/sve/section-template?type=${encodeURIComponent(t)}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(async r=>{if(n!==De)return;if(r.status===404){qo(e,t);return}if(!r.ok)throw new Error(String(r.status));const i=await r.json();n===De&&(N={html:typeof i.html=="string"?i.html:"",css:typeof i.css=="string"?i.css:"",js:typeof i.js=="string"?i.js:""},E=t,M=!!i.locked,Se=!0,as(),Ee(e),Ge(N,M),M||ls(e,N.html),Un(e.document,i.path||t),V(e.document,M?m(e,"code_dock_locked"):""),U(e),Xe(e),he(e),Ke(e,s))}).catch(()=>{n===De&&(qo(e,t),V(e.document,m(e,"code_dock_error")))})}function mo(){return E||""}function us(e){return!!e?.getElementById(d)}function Ce(){return M}function fs(e,t){const o=typeof t?.html=="string"?t.html.trim():"",n=typeof t?.css=="string"?t.css.trim():"",s=typeof t?.js=="string"?t.js.trim():"";if(!o&&!n&&!s||!e?.document?.getElementById(d))return!1;let r=!1;return o&&(r=Na("html",o)||r),n&&(r=zo("css",n)||r),s&&(r=zo("js",s)||r),r&&le(e),r}function Na(e,t){const o=h[e];if(!o||o.state.readOnly)return!1;const n=o.state.selection.main,s=n.from>0?o.state.doc.sliceString(n.from-1,n.from):`
...
`:n?`
`:""}${t}
`;return o.dispatch({changes:{from:n,insert:r},selection:{anchor:n+r.length}}),!0}function ps(e){if(rs(e),!E||!e.document.getElementById(d))return;const t=E;E=null,Et(e,t,"keep")}function hs(e){De+=1,ae(e),_e=null,E=null,fe=[],N={html:"",css:"",js:""},M=!1,Se=!1,F=null,ge=null,lo(),b=e?.defaultView||b,w(e),te(e),re(e),e?.getElementById(K)?.remove();for(const o of z)h[o]?.destroy(),h[o]=null;e?.getElementById(d)?.remove(),Hi(),e&&oo(e,0);const t=e?.defaultView||b;t?.document.getElementById(_.HTML_TREE_PANEL_ID)&&_.closeHtmlTreePanel?.(t)}function ms(e){if(Ue)return;const t=e.document.getElementById(d);t&&(to(e),Ke(e,t))}function Fa(e,t,o){if(o){const r=bo(o,t)||bo(o,e.document)||o;return String(typeof _.setTypeForUid=="function"&&(_.setTypeForUid(r,t)||_.setTypeForUid(r,e.document))||"").trim()}const n=typeof _.sectionField=="function"?_.sectionField(e):"page_sections",s=typeof _.activeContainers=="function"?_.activeContainers(e.document):[];for(const r of s){const a=(_.unwrapRef?.(r.values)||r.values)?.[n];if(Array.isArray(a))for(const l of a){const c=typeof l?.type=="string"?l.type.trim():"";if(c)return c}}return""}function Va(e){if((e.Statamic?.$config?.get?.("sveFeatures")||{}).collection_templates!==!0)return"";const o=e.Statamic?.$config?.get?.("sveCollectionTemplatesCollection")||"templates";if(!(e.location?.pathname||"").includes(`/collections/${o}/entries/`))return"";const s=typeof _.activeContainers=="function"?_.activeContainers(e.document):[];for(const r of s){const i=_.unwrapRef?.(r.values)||r.values,a=typeof i?.view=="string"?i.view.trim():"";if(!a||a.includes(".."))continue;const l=a.replace(/\.(antlers\.html|blade\.php)$/i,"").replace(/^\/+|\/+$/g,"");if(l)return`view:${l}`}return""}function Wa(e,t){const o=_.chromeInlineKind||_.activeChromeKind;if(o!=="header"&&o!=="footer"||!_.chromeHost?.(t)&&!_.chromeEditorOpen?.(t))return"";const s=(_.unwrapRef?.(_.chromeContainer?.()?.values)||{})[o==="footer"?"footer_style":"header_style"]||"style_1";return`${o}/${s}`}function Ua(e){const t=_.globalSectionHost?.(e)||e.getElementById("__sve-global-section-host");return t&&t.querySelector("[data-replicator-set][data-type]")?.getAttribute("data-type")||""}function vs(e,t,o){if(Ue)return;if(!e||!t||Ai(t)||!No(e)||!Fo(e)){t&&hs(t);return}const n=Wa(e,t)||Ua(t)||Fa(e,t,o)||Va(e)||(o?"":E),s=!!(o&&o!==_e);if(b=e,o&&(_e=o),!!n&&!(n===E&&t.getElementById(d))){if(fe.length&&E&&E!==n){const r=fe[0];if(n===r&&!s)return;fe=[]}ae(t),Et(e,n,"replace")}}Es("tw:changed",()=>{b&&O==="tw"&&G(b)});ee("dock:is-open",e=>us(e));ee("dock:is-locked",()=>Ce());ee("dock:html",()=>xt());ee("dock:reveal-html",({from:e,to:t}={})=>{const o=h.html;if(!o||e==null)return;D=Ze(b),yt(),Le();const n=A.length,s=Math.max(0,Math.min(e,n)),r=Math.max(s,Math.min(t??e,n));if(x=r>s?{from:s,to:r}:null,D&&x){io(),U(b);return}if(B){ao(),U(b);return}o.dispatch({selection:{anchor:s,head:r},scrollIntoView:!0}),o.focus()});ee("dock:insert-snippet",({win:e,parts:t})=>fs(e,t));ee("dock:refresh",e=>ps(e));ee("dock:tw-follow",()=>{b&&At(b)});ee("dock:current-type",()=>mo());ee("dock:current-uid",()=>_e);ee("dock:set-html",e=>{if(typeof e!="string"||Ce())return!1;const t=h.html;if(!t||!b)return!1;if(A=e,B)return kt(Yn()),le(b),Vt("dock:html-changed"),!0;const o=t.state.doc.toString();return o!==e&&t.dispatch({changes:{from:0,to:o.length,insert:e}}),!0});_.syncCodeDock=vs;const Ga=Object.freeze(Object.defineProperty({__proto__:null,ARMED_KEY:Ts,closeCodeDock:hs,closeCodeDockPopups:ua,codeDockStyleMode:Sa,currentTemplateType:mo,insertAiSnippet:fs,isCodeDockArmed:Fo,isCodeDockLocked:Ce,isCodeDockOpen:us,refreshCodeDockFromDisk:ps,relayoutCodeDock:ms,resetTailwindCompile:as,setCodeDockArmed:Ms,syncCodeDock:vs,templateDockAllowed:No},Symbol.toStringTag,{value:"Module"}));export{Mr as a,Ga as c,Za as t};
