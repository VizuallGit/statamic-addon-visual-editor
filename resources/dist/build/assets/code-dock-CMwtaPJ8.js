...
import{v as pr,l as mr}from"./codemirror-BogM0qj9.js";import{o as y,c as b,a as v,t as A,F as P,e as N,al as ct,ae as Rt,ap as yn,aC as Ue,aA as bn,w as Tt,f as L,aB as xn,d as R,b as vr,as as xt,W as kn,aL as ye,af as Sn,r as lo,u as T,m as Re,_ as wn,n as gr,b0 as J,Z as V,p as m,at as yr,a$ as br,aE as $n,ak as xr,b1 as zo,aM as kr,A as tt,B as kt,aZ as Ho,ax as Sr,G as W,aj as co,b2 as _n,au as wr,b3 as $r,aK as Cn,b4 as uo,k as $t,b5 as fo,b6 as _r,b7 as Cr,b8 as Tr,b9 as Ar,ba as Mr,bb as Er,bc as Br,bd as Lr,be as Fr,bf as Ro,bg as je,z as Ke,bh as Ge,bi as Ir,bj as Or,aO as I,aa as Pr,j as Dr,bk as jo,bl as zr}from"./addon-DrHcDUXH.js";import{bm as yu,bn as bu}from"./addon-DrHcDUXH.js";import{B as be,D as Hr,t as Tn,m as Rr,E as An,p as jr,F as Wr,G as qr,I as Nr,J as Wo,K as Vr,f as Mn,L as Ur,M as Kr,N as Gr,g as Xr,O as Yr,P as En,Q as Zr,a as Xe,R as Jr,j as Bn,S as Qr,T as ta,U as ea,d as Ln,V as oa,W as na,X as qo,Y as ae}from"./tw-classes-DKQBP5nG.js";import{t as sa}from"./tw-candidates-wYTeDvRv.js";import{h as ra,a as aa,e as ia,A as la,b as ca,i as ho,c as da,d as ue}from"./html-tag-sync-D4MA50-d.js";import"./ai-text-icon-B7uCWIwa.js";import"./html-pick-align-CK-9iH9_.js";import"./index-Dpuj8sxX.js";import"./index-B5fiB6ig.js";import"./index-QkwZ_wP2.js";import"./index-CY0AOW5Y.js";import"./index-gYg9gdv3.js";import"./index-lzvKgifK.js";import"./index-BBw1nzv2.js";import"./index-DqbOpr3Y.js";import"./index-C_pm8ee_.js";import"./index-B8kpdD8S.js";const Fn=/^\.[a-zA-Z_][\w-]*$/;function po(t){const e=String(t||""),o=/(^|\s)\[/g;let n;for(;n=o.exec(e);){const s=n.index+n[1].length,a=/\](?=\s|$)/g;a.lastIndex=s+1;const i=a.exec(e);if(i)return{from:s,to:i.index+1,innerFrom:s+1,innerTo:i.index}}return null}function In(t){const e=String(t||""),o=po(e);return o?e.slice(o.innerFrom,o.innerTo).replace(/\{\{[\s\S]*?\}\}/g," ").split(/\s+/).filter(n=>/^[a-zA-Z_][\w-]*$/.test(n)):[]}function On(t){const e=String(t||"").match(/\sclass\s*=\s*(["'])([^"']*)\1/i);return e?In(e[2]):[]}function ua(t){return On(t)[0]||""}function xe(t){const e=String(t||""),o=[],n=/\sclass\s*=\s*(["'])/gi;let s;for(;s=n.exec(e);){const a=s[1],i=s.index+s[0].length,l=e.indexOf(a,i);if(l===-1)break;const c=e.slice(i,l),d=po(c);if(d){const f=c.slice(d.innerFrom,d.innerTo),h=i+d.innerFrom,p=f.replace(/\{\{[\s\S]*?\}\}/g,z=>" ".repeat(z.length)),x=/[a-zA-Z_][\w-]*/g;let k;for(;k=x.exec(p);)o.push({name:k[0],from:h+k.index,to:h+k.index+k[0].length})}n.lastIndex=l+1}return o}function No(t,e){return xe(t).find(o=>e>=o.from&&e<=o.to)||null}function Vo(t,e){const o=String(t||""),n=xe(o);let s=o;for(let a=n.length-1;a>=0;a-=1){const i=n[a],l=e(i.name);if(l!==i.name){if(!l){let c=i.from,d=i.to;s[d]===" "?d+=1:c>0&&s[c-1]===" "&&(c-=1),s=s.slice(0,c)+s.slice(d);continue}s=s.slice(0,i.from)+l+s.slice(i.to)}}return s}function Pn(t){const e=[],o=/(^|[^\w-])\.([a-zA-Z_][\w-]*)\s*\{/g;let n;for(;n=o.exec(String(t||""));)e.push(n[2]);return e}function Dn(t,e){const o=[],n=[],s=[];let a=0,i=0;for(;a<t.length&&i<e.length;){if(t[a]===e[i]){a+=1,i+=1;continue}const l=e.indexOf(t[a],i),c=t.indexOf(e[i],a);l===-1&&c===-1?(o.push({from:t[a],to:e[i]}),a+=1,i+=1):l===-1?(s.push(t[a]),a+=1):c===-1||l<=c?(n.push(e[i]),i+=1):(s.push(t[a]),a+=1)}for(;a<t.length;)s.push(t[a]),a+=1;for(;i<e.length;)n.push(e[i]),i+=1;return{renamed:o,added:n,removed:s}}function St(t){let e=String(t||"").trim().replace(/^\.+/,"").replace(/\s+/g,"-").replace(/[^a-zA-Z0-9_-]/g,"");return/^[a-zA-Z_]/.test(e)||(e=e.replace(/^[^a-zA-Z_]+/,"")),Fn.test(`.${e}`)?e:""}function fa(t,e){const o=String(t||""),n=St(e);if(!o||!n)return o;const s=o.match(/\sclass\s*=\s*(["'])([^"']*)\1/i);if(s){const a=s[1];let i=s[2];const l=po(i);if(l){const c=i.slice(l.innerFrom,l.innerTo).trim(),f=In(i).includes(n)?c:`${c} ${n}`.trim();i=`${i.slice(0,l.from)}[ ${f} ]${i.slice(l.to)}`}else i=`[ ${n} ] ${i}`.trim();return o.slice(0,s.index)+` class=${a}${i}${a}`+o.slice(s.index+s[0].length)}return/\/\s*>$/.test(o)?o.replace(/(\s*)(\/\s*>)$/,` class="[ ${n} ]"$1$2`):o.replace(/(\s*)>$/,` class="[ ${n} ]"$1>`)}function ha(t,e){const o=String(t).indexOf(">",e.from);return o===-1?"":t.slice(e.from,o+1)}function zn(t,e){const o=[];for(const n of e){const s=On(ha(t,n)),a=zn(t,n.children||[]);if(s.length){o.push({className:s[0],children:a});for(const i of s.slice(1))o.push({className:i,children:[]})}else o.push(...a)}return o}function ke(t){return zn(t,be(t))}function fe(t){return String(t).replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function mo(t,e){if(t.startsWith("/*",e)){const o=t.indexOf("*/",e+2);return o===-1?t.length:o+2}return e}function Lt(t,e){let o=0;for(let n=e;n<t.length;n+=1){if(t.startsWith("/*",n)){n=mo(t,n)-1;continue}if(t[n]==="{")o+=1;else if(t[n]==="}"&&(o-=1,o===0))return n}return-1}function X(t,e){const o=String(t||""),n=new RegExp(`(^|[^\\w-])\\.${fe(e)}\\s*\\{`,"g");let s;for(;s=n.exec(o);){const a=s.index+s[1].length,i=o.indexOf("{",a);if(i===-1)continue;const l=Lt(o,i);if(l!==-1)return{from:a,brace:i,close:l,to:l+1,name:e}}return null}function pa(t){const e=String(t||""),o=[],n={},s=[];let a=0,i="";const l=()=>{const c=i.trim();c&&o.push(c),i=""};for(;a<e.length;){if(e.startsWith("/*",a)){const c=mo(e,a);i+=e.slice(a,c),a=c;continue}if(e[a]==="{"){const c=i.trim(),d=Lt(e,a);if(d===-1)break;const f=e.slice(a+1,d);i="",Fn.test(c)?n[c.slice(1)]=f:c&&s.push(`${c} {${f}}`),a=d+1;continue}i+=e[a],a+=1}return l(),{decls:o.join(`
...
${i}
${s}}`:`${s}.${t.className} {
${s}}`}function vo(t,e){return e?.length?e.map(o=>Hn(o,t,0)).join(`
...
`):t}function ba(t,e){let o=0;for(let n=0;n<e.from;n+=1){if(t.startsWith("/*",n)){n=mo(t,n)-1;continue}t[n]==="{"?o+=1:t[n]==="}"&&(o-=1)}return o===0}function go(t,e,o){const n=Rn(e)||o;if(!n)return String(t||"");let s=String(e||"").trim();s?new RegExp(`^\\.${fe(n)}\\s*\\{`).test(s)||(s=`.${n} {
${s}
}`):s=`.${n} {
...
`);l&&Nl(l),ln();return}const s=[],a=[],i=ps(e,n);for(const l of t){const c=zl(e,n,l.property);if(l.value==null){if(!c)continue;let d=c.from,f=c.to;e.state.doc.sliceString(f,f+1)===`
...
${l.indent}}${l.suffix}`:`
${c}}
${l.indent}}${l.suffix}`;e.dispatch({changes:{from:l.at,to:l.at,insert:`${f}${h}`},selection:{anchor:l.at+f.length},scrollIntoView:!0})}function Oc(t,e){r.cssValues=!!e,V(t,Do,r.cssValues?"1":"0"),w(t.document),r.cssOpenTool="",Eo(t),lt(),Jt(),r.cssValues&&ws(t),oe(t,!0),Mo(),ne(t),O(t)}function Bo(t){const e=t?.document.getElementById(u);if(!e)return;const o=r.styleMode==="tw";e.setAttribute("data-sve-style",r.styleMode);const n=e.querySelector("[data-sve-css-label]");n&&(n.textContent=o?m(t,"code_dock_style_tw"):m(t,"code_dock_css"));const s=e.querySelector("[data-sve-style-mode]");if(!s)return;const a=t.document.createElement("span");a.textContent=o?m(t,"code_dock_style_tw"):m(t,"code_dock_css"),s.innerHTML=o?Vd:qd,s.appendChild(a),s.title=m(t,o?"code_dock_style_to_css":"code_dock_style_to_tw"),s.setAttribute("aria-label",s.title),s.setAttribute("aria-pressed",o?"true":"false")}function $s(t){t?.document.getElementById(u),w(t.document),Xe(t),r.cssOpenTool="",r.cssOpenMenu="",r.styleMode==="tw"&&r.cssValues&&(r.cssValues=!1,V(t,Do,"0")),Bo(t),Eo(t),Gt(t),r.cssToolRow?.(),r.styleMode==="tw"&&(r.htmlScopePref=!0,V(t,He,"1"),Ye(t,!0)),se(t),Ie(t),O(t)}const Lo="sve-css-size",oo="sve-css-state",Fo=["hover","focus","focus-visible","active","disabled","before","after"];function Pc(t,e){r.styleMode=e==="tw"?"tw":"css",V(t,ir,r.styleMode),$s(t)}function Dc(t,e){if(e._sveStyleModeBound)return;e._sveStyleModeBound=!0,r.styleMode=J(t,ir)==="tw"?"tw":"css";const o=J(t,Lo)||"";r.cssSize=fo(t).some(n=>n.handle===o)?o:"",r.cssState=Fo.includes(J(t,oo))?J(t,oo):"",r.cssValues=J(t,Do)==="1",e.querySelector("[data-sve-style-mode]")?.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Pc(t,r.styleMode==="tw"?"css":"tw")}),e.querySelector("[data-sve-values-mode]")?.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Oc(t,!r.cssValues)}),$s(t),Eo(t)}function zc(t,e){const o=e.querySelector("[data-sve-css-tools]");if(!o||o._sveBound)return;o._sveBound=!0;const n=a=>e.querySelector(`[data-sve-css-tool="${a}"], [data-sve-css-kid="${a}"]`),s=a=>{const i=n(a.id),l=r.cssOpenMenu===a.id;if(w(t.document),l){Xe(t),O(t);return}if(!i)return;const c=r.styleMode==="tw"?!a.twClass&&!!a.tw:!a.kind&&!a.value&&!(a.css in Q())&&!!a.menu,d=()=>{c&&(r.cssOpenMenu=a.id)};if(r.styleMode==="tw"){Xe(t),a.twClass?(Qr(t,a.twClass),O(t)):a.tw&&(ta(t,i,a.tw,()=>O(t)),d(),O(t));return}if(a.kind==="flexDir"){Wl(a.value);return}if(a.kind==="display"){ql(a.value);return}if(a.value){const f=D(Q()[a.css])===D(a.value);Z([{property:a.css,value:f?null:a.value}]);return}if(a.css in Q()){Z([{property:a.css,value:null}]),O(t);return}a.menu==="colors"?Ul(t,i,a.css):a.menu==="spacing"?Gl(t,i,a.css):a.menu==="sizes"?cn(t,i,a.css,Yd):a.menu==="choices"?Kl(t,i,a.css,a.choices):a.menu==="values"&&cn(t,i,a.css),d(),O(t)};dt.onTool=a=>{const i=ge.get(a)?.tool;if(i){if(i.kids?.length){r.cssOpenTool=r.cssOpenTool===i.id?"":i.id,w(t.document),O(t);return}s(i)}},dt.onKid=(a,i)=>{const l=ge.get(i);l?.kid&&s(l.kid)},r.cssToolRow=()=>{$t(o,Hi),O(t)},r.cssToolRow(),t.document.addEventListener("mousedown",a=>{a.target.closest(`#${_}, [data-sve-css-tools], [data-sve-html-tools], [data-sve-css-add-class]`)||w(t.document)},!0)}function Hc(t,e){const o=e.querySelector("[data-sve-html-tidy]");o&&(o.innerHTML=Bn.tidy,o.title=m(t,"code_dock_html_tidy"),o.setAttribute("aria-label",o.title),o.setAttribute("data-tip",o.title))}function Rc(t,e){const o=e.querySelector("[data-sve-html-tidy]");Hc(t,e),!(!o||o._sveBound)&&(o._sveBound=!0,o.addEventListener("mousedown",n=>n.preventDefault()),o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),ls()}))}function jc(t,e){const o=e.querySelector("[data-sve-html-tools]");!o||o._sveBound||(o._sveBound=!0,$t(o,Fi,{tools:io.map(n=>({...n,icon:Bn[n.id]||""})),onTool:n=>{const s=io.find(i=>i.id===n),a=o.querySelector(`[data-sve-html-tool="${n}"]`);if(s){if(s.menu==="heading"){rn(t,a,dr);return}if(s.menu==="text"){rn(t,a,ea);return}if(s.tidy){ls();return}if(s.menu==="component"){Fl(t,a);return}if(w(t.document),s.snippet){Bt(s.snippet,s.caret??s.snippet.length,s.select),q();return}cs(s.tag)}}}),rd(t,e),id(t,e),sd(t,e))}let ce=null;async function Wc(t){const e=t.document;vd(e);let o=e.getElementById(u);if(o&&!(o.querySelector('[data-sve-css-chrome="subrow-2"]')&&o.querySelector("[data-sve-css-add-class]")&&o.querySelector("[data-sve-html-tools]")&&o.querySelector("[data-sve-html-tidy]")&&o.querySelector("[data-sve-data-vars]")&&o.querySelector("[data-sve-visual-edit-tools]")&&o.querySelector("[data-sve-html-scope]")&&o.querySelector("[data-sve-code-lock]")&&o.querySelector("[data-sve-code-back]")&&o.querySelector("[data-sve-code-autosave]")&&o.querySelector("[data-sve-code-save]")&&o.getAttribute("data-sve-code-chrome")==="scope-9")){for(const s of at)g[s]?.destroy(),g[s]=null;o.remove(),o=null}if(!o){o=e.createElement("div"),o.id=u,o.setAttribute("data-sve-code-chrome","scope-9"),$t(o,_i,{htmlLabel:m(t,"code_dock_html"),cssLabel:m(t,"code_dock_css"),jsLabel:m(t,"code_dock_js"),alpineLabel:m(t,"code_dock_alpine"),treeIcon:cr,dataIcon:Od,dataLabel:m(t,"data_vars_title")}),Ge(e,o),pn(o),Is(o,Es(t)),wd(t,o),_d(t,o),$d(t,o),zc(t,o),Pl(t,o),Dc(t,o),Fc(t,o),Lc(t,o),Ir(t,o),jc(t,o),en(t,o),Qo(t,o),mn(t,o),tn(t,o);for(const n of at){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);wc(s)}Or(t)}if(Ge(e,o),pn(o),Rc(t,o),en(t,o),Qo(t,o),mn(t,o),tn(t,o),xd(t),Io(t),Et(t),K(t),Yt(t),ft(t),Bo(t),Gt(t),await Td(),!g.html){for(const n of at){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);s?.replaceChildren(),Sc(t,n,s)}for(const n of["html","css"])g[n]&&oa(t,g[n],{onOpen:s=>es(t,s),emptyLabel:m(t,"code_dock_partials_empty"),openLabel:s=>m(t,"component_open_named",{name:s}),sectionValues:()=>ts(t),isLocked:()=>ht(),setHover:(s,a)=>r.htmlPartialUi?.setHover(s,a)});Ta(t,g.html,{onRename:n=>_l(t,n),isLocked:()=>ht(),setHover:(n,s)=>r.htmlClassTokenUi?.setHover(n,s),title:m(t,"code_dock_css_rename_class")})}return o}function _s(t){return ce||(ce=Wc(t).finally(()=>{ce=null})),ce}async function fn(t,e){const o=await _s(t);r.lastType=e,r.lastLocked=!0,r.lockReady=!0,r.lastParts={html:"",css:"",js:""},Ee(),Et(t),te(r.lastParts,!0),Ds(t.document,e),U(t.document,m(t,"code_dock_missing")),K(t),Yt(t),ft(t),Xt(t,o)}async function Pe(t,e,o="replace"){o==="replace"?r.typeStack=[]:o==="push"&&r.lastType&&r.lastType!==e&&r.typeStack.push(r.lastType);const n=++r.loadGen;r.lastType=e,r.lockReady=!1,Ee(),U(t.document,m(t,"code_dock_loading"));const s=await _s(t);Et(t),K(t),Yt(t),ft(t),Bo(t),Gt(t),Xt(t,s),t.fetch(`/!/sve/section-template?type=${encodeURIComponent(e)}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(async a=>{if(n!==r.loadGen)return;if(a.status===404){fn(t,e);return}if(!a.ok)throw new Error(String(a.status));const i=await a.json();n===r.loadGen&&(r.lastParts={html:typeof i.html=="string"?i.html:"",css:typeof i.css=="string"?i.css:"",js:typeof i.js=="string"?i.js:""},r.lastProps=Array.isArray(i.props)?i.props:[],r.propsDirty=!1,r.lastType=e,r.lastLocked=!!i.locked,r.lockReady=!0,xl(),Et(t),te(r.lastParts,r.lastLocked),Ln(t),r.lastLocked||Jn(t,r.lastParts.html),Ds(t.document,i.path||e),U(t.document,r.lastLocked?m(t,"code_dock_locked"):""),Gn(t),Ei(t),yo(t),K(t),Yt(t),ft(t),Xt(t,s))}).catch(()=>{n===r.loadGen&&(fn(t,e),U(t.document,m(t,"code_dock_error")))})}function Ct(){return r.lastType||""}function Cs(t){return!!t?.getElementById(u)}function ht(){return r.lastLocked}function qc(t,e){const o=typeof e?.html=="string"?e.html.trim():"",n=typeof e?.css=="string"?e.css.trim():"",s=typeof e?.js=="string"?e.js.trim():"";if(!o&&!n&&!s||!t?.document?.getElementById(u))return!1;let a=!1;return o&&(a=Nc("html",o)||a),n&&(a=hn("css",n)||a),s&&(a=hn("js",s)||a),a&&nt(t),a}function Nc(t,e){const o=g[t];if(!o||o.state.readOnly)return!1;const n=o.state.selection.main,s=n.from>0?o.state.doc.sliceString(n.from-1,n.from):`
...
`:n?`
`:""}${e}
`;return o.dispatch({changes:{from:n,insert:a},selection:{anchor:n+a.length}}),!0}function Vc(t){if(So(t),!r.lastType||!t.document.getElementById(u))return;const e=r.lastType;r.lastType=null,Pe(t,e,"keep")}function Ts(t){bt(t),r.loadGen+=1,et(t),r.lastUid=null,r.lastType=null,r.typeStack=[],r.lastParts={html:"",css:"",js:""},r.lastLocked=!1,r.lockReady=!1,r.lastBracketNames=null,r.lastCssSelectorNames=null,Ee(),r.lastWin=t?.defaultView||r.lastWin,w(t),An(t),rt(t),t?.getElementById(G)?.remove();for(const o of at)g[o]?.destroy(),g[o]=null;t?.getElementById(u)?.remove(),bd(),t&&Oo(t,0);const e=t?.defaultView||r.lastWin;e?.document.getElementById(Cn)&&_n(e),e&&(Gn(e),yo(e),Ln(e))}function Uc(t){if(r.dragging)return;const e=t.document.getElementById(u);e&&(Io(t),Xt(t,e))}function Kc(t,e,o){if(o){const a=Ro(o,e)||Ro(o,t.document)||o;return String(typeof je=="function"&&(je(a,e)||je(a,t.document))||"").trim()}const n=typeof Ke=="function"?Ke(t):"page_sections",s=typeof tt=="function"?tt(t.document):[];for(const a of s){const l=(kt(a.values)||a.values)?.[n];if(Array.isArray(l))for(const c of l){const d=typeof c?.type=="string"?c.type.trim():"";if(d)return d}}return""}function As(t){if((t.Statamic?.$config?.get?.("sveFeatures")||{}).collection_templates!==!0)return"";const o=t.Statamic?.$config?.get?.("sveCollectionTemplatesCollection")||"templates";if(!(t.location?.pathname||"").includes(`/collections/${o}/entries/`))return"";const s=typeof tt=="function"?tt(t.document):[];for(const a of s){const i=kt(a.values)||a.values,l=typeof i?.view=="string"?i.view.trim():"";if(!l||l.includes(".."))continue;const c=l.replace(/\.(antlers\.html|blade\.php)$/i,"").replace(/^\/+|\/+$/g,"");if(c)return`view:${c}`}return""}function Gc(t,e){const o=Br||Lr;if(o!=="header"&&o!=="footer"||!Ar(e)&&!Mr(e))return"";const s=(kt(Er()?.values)||{})[o==="footer"?"footer_style":"header_style"]||"style_1";return`${o}/${s}`}function Xc(t){const e=Fr(t)||t.getElementById("__sve-global-section-host");return e&&e.querySelector("[data-replicator-set][data-type]")?.getAttribute("data-type")||""}function Yc(t,e,o){if(r.dragging)return;if(!t||!e||ud(e)||!Cr(t)||!Tr(t)){e&&Ts(e);return}const n=Gc(t,e)||Xc(e)||Kc(t,e,o)||As(t)||(o?"":r.lastType),s=!!(o&&o!==r.lastUid);if(r.lastWin=t,o&&(r.lastUid=o),!!n&&!(n===r.lastType&&e.getElementById(u))){if(r.typeStack.length&&r.lastType&&r.lastType!==n){const a=r.typeStack[0];if(n===a&&!s)return;r.typeStack=[]}et(e),Pe(t,n,"replace")}}ye("tw:changed",()=>{r.lastWin&&r.styleMode==="tw"&&O(r.lastWin)});I("dock:is-open",t=>Cs(t));I("dock:is-locked",()=>ht());I("dock:html",()=>It());I("dock:reveal-html",({from:t,to:e,caret:o}={})=>{const n=g.html;if(!n||t==null)return;r.htmlScopePref=Zt(r.lastWin),Ce(),lt();const s=r.htmlFull.length,a=Math.max(0,Math.min(t,s)),i=Math.max(a,Math.min(e??t,s));r.htmlFocus=i>a?{from:a,to:i}:null;const l=o==null?null:Math.max(0,Math.min(o,s));if(r.htmlScopePref&&r.htmlFocus){$o(l),K(r.lastWin);return}if(r.htmlScopeActive){_o(!0,l),K(r.lastWin);return}n.dispatch({selection:l==null?{anchor:a,head:i}:{anchor:l},scrollIntoView:!0}),n.focus()});I("dock:insert-snippet",({win:t,parts:e})=>qc(t,e));I("dock:refresh",t=>Vc(t));I("dock:tw-follow",()=>{r.lastWin&&se(r.lastWin)});I("dock:css",()=>(lt(),r.cssFull));I("dock:set-css",t=>typeof t!="string"||ht()||!g.css||!r.lastWin?!1:(lt(),r.cssFull=t,Ae("css",ds()),nt(r.lastWin),!0));I("dock:data-menu",({anchor:t,onPick:e,at:o}={})=>!t||!r.lastWin?!1:(bt(r.lastWin.document),w(r.lastWin.document),Ms(r.lastWin,t,e,o),!0));I("dock:props",()=>r.lastProps.map(t=>({...t})));I("dock:set-props",({win:t,props:e}={})=>!Array.isArray(e)||ht()?!1:(r.lastProps=e,r.propsDirty=!0,na(De(Ct())),et((t||r.lastWin)?.document),!0));function De(t){const e=/^view:partials\/(components\/[A-Za-z0-9_-]+)$/.exec(String(t||""));return e?e[1]:""}I("dock:component-src",()=>De(Ct()));I("dock:component-exit-state",()=>{const t=De(Ct());return{open:!!t,name:t?t.split("/").pop():"",back:r.typeStack.length>0}});I("dock:exit-component",()=>!r.lastWin||!De(Ct())?!1:(r.typeStack.length?os(r.lastWin):Ts(r.lastWin.document),!0));I("dock:current-type",()=>Ct());I("dock:current-uid",()=>r.lastUid);I("dock:reset-data-vars",t=>(Xa(typeof t=="string"&&t?t:void 0),!0));I("dock:refresh-preview",()=>r.lastWin?(So(r.lastWin),!0):!1);I("dock:open-template",t=>typeof t!="string"||!t||!r.lastWin?!1:(es(r.lastWin,t),!0));I("dock:set-html",t=>{if(typeof t!="string"||ht())return!1;const e=g.html;if(!e||!r.lastWin)return!1;if(t===""){r.saveTimer&&(clearTimeout(r.saveTimer),r.saveTimer=null),r.twDirty=!1,r.twCss=null,r.twKey="",r.lastType=null,r.lastUid=null,r.lastParts={html:"",css:"",js:""},r.cssFull="",r.htmlFull="",r.applying=!0;try{Ee();for(const s of at){const a=g[s];if(!a)continue;const i=a.state.doc.toString();i!==""&&a.dispatch({changes:{from:0,to:i.length,insert:""}})}}finally{r.applying=!1}return!0}const o=r.htmlFull;if(r.htmlFull=t,r.htmlScopeActive)return r.htmlFocus=Zc(r.htmlFocus,o,t),Me(rs()),nt(r.lastWin),uo("dock:html-changed"),!0;const n=e.state.doc.toString();return n!==t&&e.dispatch({changes:{from:0,to:n.length,insert:t}}),!0});I("dock:show-empty",()=>xt("dock:set-html",""));ye("row:removed",({parentPath:t,remaining:e,win:o})=>{e===0&&t===Ke(o)&&xt("dock:show-empty")});function Zc(t,e,o){const n=o.length-e.length;if(!t||!n)return t;let s=0;for(;s<e.length&&s<o.length&&e[s]===o[s];)s+=1;return s>=t.to?t:s<t.from?{from:Math.max(0,t.from+n),to:Math.max(0,t.to+n)}:{from:t.from,to:Math.max(t.from,t.to+n)}}Pr.syncCodeDock=Yc;const F="__sve-data-menu";let no=null;function bt(t){const e=t?.getElementById(F);no?.(),no=null,e?._sveApp?.unmount(),e?.remove(),t?.querySelector("[data-sve-data-vars][data-open]")?.removeAttribute("data-open")}function Jc(t){if(!As(t))return{view:"",kind:""};const e=typeof tt=="function"?tt(t.document):[];for(const o of e){const n=kt(o.values)||o.values,s=typeof n?.source_collection=="string"?n.source_collection.trim():"";if(s)return{view:s,kind:String(n?.kind||"").trim()}}return{view:"",kind:""}}function Qc(t,e){const o=It();if(Number.isFinite(e))return qo(o,e);const n=g.html;if(!n)return[];const s=r.htmlScopeActive&&r.htmlFocus?r.htmlFocus.from:0;return qo(o,s+n.state.selection.main.from)}function td(t,e){const{view:o,kind:n}=Jc(t);return{collection:Na(t)||"",set:Va(Ct()),view:o,kind:n,scope:Ua(Qc(t,e))}}function ed(t){const e=typeof tt=="function"?tt(t.document):[];for(const o of e){const n=kt(o.values)||o.values;if(n&&typeof n=="object")return n}return null}function od(t,e){return{scope:e?.scope?.groups||[],section:Nn(e?.section||[],ts(t)),page:Ja(e?.page||[],ed(t)),site:e?.site||[]}}function nd(t,e){const o=Qa(t,e),n=g.html;if(!o||!n||n.state.readOnly)return;const s=n.state.selection.main,a=n.state.doc.lineAt(s.from),i=it(a.text),l=ho(o.text,i);n.dispatch({changes:{from:s.from,to:s.to,insert:l},selection:{anchor:s.from+o.cursor+(o.text.includes(`
`)?i.length:0)}}),q()}function Ne(t,e,o){const n=e.getBoundingClientRect(),s=8,a=o.offsetWidth||368,i=o.offsetHeight||240,l=t.innerHeight-n.bottom-s,c=n.top-s,d=l>=i||l>=c?n.bottom+4:n.top-i-4;o.style.left=`${Math.max(s,Math.min(n.left,t.innerWidth-a-s))}px`,o.style.top=`${Math.max(s,Math.min(d,t.innerHeight-i-s))}px`}function Ms(t,e,o,n){const s=t.document;bt(s),e.setAttribute("data-open","");const a=s.createElement("div");a.id=F,s.body.appendChild(a);const i=td(t,n),l=p=>[p?.scope?.groups?.length?{id:"scope",label:p.scope.label||m(t,"data_vars_tab_loop")}:null,{id:"section",label:m(t,"data_vars_tab_section")},{id:"page",label:m(t,"data_vars_tab_page")},{id:"site",label:m(t,"data_vars_tab_site")}].filter(Boolean),c=p=>{s.getElementById(F)&&(a._sveApp?.unmount(),a._sveApp=W(qa,a,{title:m(t,"data_vars_title"),placeholder:m(t,"data_vars_placeholder"),emptyText:m(t,"data_vars_empty"),noSectionText:m(t,"data_vars_no_section"),loopText:m(t,"data_vars_loop"),tabs:l(p),data:od(t,p),onPick:(x,k)=>o?o(x,k):nd(x,k)}),Ne(t,e,a))};c(Ka(qn(i))||{scope:null,section:[],page:[],site:[]}),Ga(t,i).then(c),Ne(t,e,a);const d=()=>Ne(t,e,a),f=p=>{!a.contains(p.target)&&!e.contains(p.target)&&bt(s)},h=p=>{p.key==="Escape"&&bt(s)};s.addEventListener("pointerdown",f,!0),s.addEventListener("keydown",h,!0),t.addEventListener("scroll",d,!0),t.addEventListener("resize",d),no=()=>{s.removeEventListener("pointerdown",f,!0),s.removeEventListener("keydown",h,!0),t.removeEventListener("scroll",d,!0),t.removeEventListener("resize",d)}}function sd(t,e){const o=e.querySelector("[data-sve-data-vars]");!o||o._sveBound||(o._sveBound=!0,o.addEventListener("mousedown",n=>n.preventDefault()),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),t.document.getElementById(F)){bt(t.document);return}w(t.document),Ms(t,o)}))}function rd(t,e){const o=e.querySelector("[data-sve-antlers-tools]");!o||o._sveBound||(o._sveBound=!0,$t(o,Wn,{label:m(t,"code_dock_antlers"),groups:la.map(n=>({id:n.id,label:m(t,n.lang),items:ca.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>ad(n)}))}function ad(t){const e=da(t),o=g.html;if(!e||!o||o.state.readOnly)return;const n=o.state.selection.main.head,s=o.state.doc.lineAt(n),a=s.text.trim()?it(s.text):Fe(o,s)||it(s.text),{text:i,cursor:l}=ue(e.snippet);Bt(ho(i,a),l),q()}function id(t,e){const o=e.querySelector("[data-sve-visual-edit-tools]");!o||o._sveBound||(o._sveBound=!0,$t(o,Wn,{label:m(t,"code_dock_visual_edit"),groups:ti.map(n=>({id:n.id,label:m(t,n.lang),items:Vn.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>cd(n)}))}function ld(t,e,o,n){if(ni(o.inner,n.attr)){t.focus();return}const{text:s,cursor:a}=ue(n.attr);let i=o.closeIdx;for(;i>o.openIdx+2&&/\s/.test(e[i-1]);)i--;t.dispatch({changes:{from:i,to:o.closeIdx,insert:` ${s} `},selection:{anchor:i+1+a}}),q()}function cd(t){const e=ei(t),o=g.html;if(!e||!o||o.state.readOnly)return;const n=o.state.doc.toString(),s=Qt();if(s?.open){const h=oi(n,s.open.from,s.open.to,ie);if(h){e.attr?ld(o,n,h,e):(o.dispatch({selection:{anchor:h.openIdx+2+ie.length}}),o.focus());return}const p=s.open.from+1+s.name.length,x=e.standalone||`{{ ${ie} ${e.attr} }}`,{text:k,cursor:z}=ue(x);o.dispatch({changes:{from:p,to:p,insert:` ${k}`},selection:{anchor:p+1+z}}),q();return}const a=o.state.selection.main.head,i=o.state.doc.lineAt(a),l=i.text.trim()?it(i.text):Fe(o,i)||it(i.text),c=e.standalone||`{{ ${ie} ${e.attr} }}`,{text:d,cursor:f}=ue(c);Bt(ho(d,l),f),q()}function dd(t){return t==="css"?Qs():t==="js"?tr():Js({autoCloseTags:!0})}function pn(t){if(t._sveShield)return;t._sveShield=!0;const e=o=>o.stopPropagation();for(const o of["keydown","keypress","keyup","pointerdown","pointerup","mousedown","mouseup","click","focusin"])t.addEventListener(o,e)}function ud(t){try{return new URLSearchParams(t.defaultView?.location?.search||"").has("sve-panel")}catch{return!1}}function fd(t){const e=parseInt(J(t,nr)??"",10);return Number.isFinite(e)&&e>=lr?e:Ed}function hd(t,e){V(t,nr,String(e))}function Es(t){try{const e=JSON.parse(J(t,sr)||"null");if(e&&typeof e=="object")return{html:e.html!==!1,css:e.css!==!1,js:e.js===!0,alpine:e.alpine===!0}}catch{}return{html:!0,css:!0,js:!1,alpine:!1}}function pd(t,e){V(t,sr,JSON.stringify(e))}function Bs(t){try{const e=JSON.parse(J(t,rr)||"null");if(e&&typeof e=="object"){const o=s=>Number.isFinite(s)&&s>0?s:1,n={};for(const s of wt)n[s]=o(e[s]);return n}}catch{}return Object.fromEntries(wt.map(e=>[e,1]))}function md(t,e){V(t,rr,JSON.stringify(e))}function vd(t){Dr(t,Md,`
