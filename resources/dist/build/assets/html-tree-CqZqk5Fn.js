...
${s}`),e.slice(0,i)+s+e.slice(i)):e}function nt(e,t){if(!e||!t)return e;const{from:r,to:i}=C(e,t);return e.slice(0,r)+e.slice(i)}const ie="sve-html-tree-labels";function se(){try{const e=globalThis.localStorage?.getItem(ie);if(!e)return{};const t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function rt(e){try{globalThis.localStorage?.setItem(ie,JSON.stringify(e))}catch{}}function le(e){return String(e||"_")}function ot(e){const t=se()[le(e)];return t&&typeof t=="object"?{...t}:{}}function it(e,t,r){const i=r?.[t];return typeof i=="string"&&i.trim()?i.replace(/\s+/g," ").trim():String(e||"").trim()}function st(e,t,r,i){if(!t)return;const s=le(e),o=se(),l={...o[s]||{}},a=String(r||"").replace(/\s+/g," ").trim(),h=String(i||"").trim();!a||a===h?delete l[t]:l[t]=a,Object.keys(l).length?o[s]=l:delete o[s],rt(o)}const b={div:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4"><rect x="2.5" y="3.5" width="11" height="9" rx="1.2"/></svg>',section:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4"><rect x="2" y="2.5" width="12" height="11" rx="1.2"/><path d="M2 6.5h12"/></svg>',ul:'<svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><circle cx="3.2" cy="4" r="1"/><circle cx="3.2" cy="8" r="1"/><circle cx="3.2" cy="12" r="1"/><rect x="5.5" y="3.2" width="8" height="1.5" rx=".4"/><rect x="5.5" y="7.2" width="8" height="1.5" rx=".4"/><rect x="5.5" y="11.2" width="8" height="1.5" rx=".4"/></svg>',li:'<svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><circle cx="3.2" cy="8" r="1.1"/><rect x="5.5" y="7.2" width="8" height="1.6" rx=".4"/></svg>',a:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"><path d="M6.2 8.8 4.8 10.2a2.2 2.2 0 0 0 3.1 3.1l1.8-1.8"/><path d="M9.8 7.2l1.4-1.4a2.2 2.2 0 0 0-3.1-3.1L6.3 4.5"/></svg>',img:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4"><rect x="2" y="3" width="12" height="10" rx="1.2"/><circle cx="5.5" cy="6.2" r="1.1"/><path d="M2.8 12.2 6.2 9l2.2 2.2 2-1.8 2.8 2.8"/></svg>',other:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"><path d="M5.2 3.5 2.8 8l2.4 4.5"/><path d="M10.8 3.5 13.2 8l-2.4 4.5"/></svg>'};function lt(e){return/^h[1-6]$/.test(e)?{letter:"H"}:e==="p"?{letter:"P"}:e==="div"?{svg:b.div}:e==="section"||e==="article"||e==="header"||e==="footer"||e==="main"||e==="nav"||e==="aside"?{svg:b.section}:e==="ul"||e==="ol"?{svg:b.ul}:e==="li"?{svg:b.li}:e==="a"?{svg:b.a}:e==="img"||e==="picture"||e==="svg"?{svg:b.img}:{svg:b.other}}const M="__sve-html-tree-panel",Z="__sve-html-tree-style",_=new Set;let F=null,S=null,R=0,W=[],H=null,I=null,$=null,B=null,U=null,j=!1;function T(e){return e.getElementById(M)}function at(e){let t=e.getElementById(Z);t||(t=e.createElement("style"),t.id=Z,e.head.appendChild(t)),t.textContent=`
  ...
  `}function X(){const e=v("dock:html");return typeof e=="string"?e:""}function ae(e){return!!v("dock:is-open",e)}function de(e){return v("dock:set-html",e)===!0}function y(e){const t=e.document,i=T(t)?.querySelector("[data-sve-html-tree-list]");if(!i)return;at(t);const s=X(),o=Pe(s);W=o;const l=_e(o,_),a=v("dock:current-type")||"",h=ot(a);!s.trim()&&!ae(t)?n.emptyText=x(e,"html_tree_need_dock"):n.emptyText=x(e,"html_tree_empty"),n.renameTitle=x(e,"html_tree_rename"),n.hideTitle=x(e,"html_tree_hide"),n.showTitle=x(e,"html_tree_show"),n.duplicateTitle=x(e,"html_tree_duplicate"),n.deleteTitle=x(e,"html_tree_delete"),n.canEdit=!v("dock:is-locked"),n.onSelect=d=>ce(e,d,l),n.onTwist=d=>{_.has(d)?_.delete(d):_.add(d),y(e)},n.onRename=d=>ut(e,d),n.onRenameCommit=()=>Q(e,!0),n.onRenameCancel=()=>Q(e,!1),n.onHide=d=>ht(e,d),n.onDuplicate=d=>ft(e,d),n.onDelete=d=>pt(e,d),n.onPointerDown=(d,g)=>mt(e,d,g),n.rows=l.map(d=>{const g=lt(d.tag);return{...d,name:it(d.klass,d.path,h),current:d.id===F,letter:g.letter||"",svg:g.svg||""}}),q(i,Ge),dt(e,o)}function dt(e,t){if(!T(e.document))return;const r=t[0];K({source:"statamic-visual-editor",type:"sve-html-pick",on:!0,uid:v("dock:current-uid")||"",tag:r?.tag||"",klass:r?.klass||"",nodes:Ee(t)},e)}function ct(e){if(!e)return;const t=[],r=String(e).split("/");for(let s=0;s<r.length;s+=1)t.push(r.slice(0,s+1).join("/"));const i=s=>{for(const o of s||[])t.includes(o.path)&&_.delete(o.id),i(o.children)};i(W)}function ut(e,t){if(j)return;const r=n.rows.find(i=>i.id===t);r&&(F=t,n.rows.forEach(i=>{i.current=i.id===t}),n.editingId=t,n.draft=r.name,e.setTimeout(()=>{const i=T(e.document)?.querySelector("[data-sve-ht-rename]");i?.focus(),i?.select()},0))}function Q(e,t){const r=n.editingId;if(!r)return;const i=n.rows.find(s=>s.id===r);n.editingId=null,t&&i&&st(v("dock:current-type")||"",i.path,n.draft,i.klass),n.draft="",y(e)}function ht(e,t){G(e,t,Qe)}function ft(e,t){G(e,t,tt)}function pt(e,t){G(e,t,nt)}function G(e,t,r){if(v("dock:is-locked"))return;const i=X(),s=n.rows.find(l=>l.id===t);if(!s)return;const o=r(i,s);o!==i&&de(o)}function mt(e,t,r){if(t.button!==0||v("dock:is-locked")||n.editingId||t.target?.closest?.("button, input"))return;J(),H=r,I={x:t.clientX,y:t.clientY},$=t.currentTarget,B=t.pointerId;const i=o=>vt(e,o),s=o=>gt(e,o);U=()=>{e.document.removeEventListener("pointermove",i,!0),e.document.removeEventListener("pointerup",s,!0),e.document.removeEventListener("pointercancel",s,!0),U=null},e.document.addEventListener("pointermove",i,!0),e.document.addEventListener("pointerup",s,!0),e.document.addEventListener("pointercancel",s,!0)}function vt(e,t){if(!H||!I)return;const r=t.clientX-I.x,i=t.clientY-I.y;if(!n.dragging&&r*r+i*i<25)return;if(!n.dragging){n.dragging=!0;try{$?.setPointerCapture?.(B)}catch{}}t.preventDefault();const s=e.document.elementFromPoint(t.clientX,t.clientY)?.closest?.("[data-sve-ht-row]"),o=s?.getAttribute("data-sve-ht-id");if(!o||o===H){n.dropId=null,n.dropPlace=null;return}const l=n.rows.find(d=>d.id===o),a=n.rows.find(d=>d.id===H);if(!l||a&&l.path.startsWith(`${a.path}/`)){n.dropId=null,n.dropPlace=null;return}const h=s.getBoundingClientRect();n.dropId=o,n.dropPlace=et(t.clientY-h.top,h.height,!ne(l.tag))}function gt(e,t){const r=H,i=n.dropId,s=n.dropPlace||"after",o=n.dragging;if(J(),o&&(j=!0,e.setTimeout(()=>{j=!1},0)),!o||v("dock:is-locked")||!r||!i||r===i)return;t?.preventDefault?.();const l=X(),a=Ze(l,W,r,i,s);a!==l&&de(a)}function J(){try{$?.releasePointerCapture?.(B)}catch{}U?.(),H=null,I=null,$=null,B=null,n.dragging=!1,n.dropId=null,n.dropPlace=null}function ce(e,t,r){if(j)return;const i=(r||n.rows).find(s=>s.id===t);i&&(F=t,n.rows.forEach(s=>{s.current=s.id===t}),v("dock:reveal-html",{from:i.from,to:i.to}),K({source:"statamic-visual-editor",type:"sve-html-pick-focus",path:i.path},e))}function kt(e,t){if(!t||!T(e.document))return;ct(t),y(e);const r=n.rows.find(i=>i.path===t);r&&ce(e,r.id,n.rows)}function V(e){if(S)return;S=ye("dock:html-changed",()=>{n.editingId||n.dragging||(e.clearTimeout(R),R=e.setTimeout(()=>{T(e.document)&&y(e)},80))})}function xt(e){S?.(),S=null,e?.clearTimeout?.(R),R=0}function N(e){const t=T(e.document);if(K({source:"statamic-visual-editor",type:"sve-html-pick",on:!1},e),xt(e),J(),F=null,n.editingId=null,n.draft="",!t){f.syncPreviewInset(e);return}t.remove(),be.headerTab==="html_tree"&&we(e,null),ke(e),f.persistDockedPanel(e),te(e),f.syncPreviewInset(e)}function Tt(e,t){t.querySelector("[data-sve-html-tree-list]")||(t.id=M,q(t,re,{title:x(e,"html_tree")}),t.querySelector("[data-sve-close]")?.addEventListener("click",()=>N(e)))}function yt(e){V(e),y(e)}function ue(e){const t=e.document;if(!f.featureOn(e,"html_tree"))return;if(T(t)){V(e),y(e);return}if(!ae(t))return;f.closeRightPanels(e,[M]);const r=t.createElement("div");r.id=M,r.style.cssText=xe,q(r,re,{title:x(e,"html_tree")}),r.querySelector("[data-sve-close]")?.addEventListener("click",()=>N(e)),Te(e,r),f.persistDockedPanel(e),te(e),f.syncPreviewInset(e),V(e),y(e)}function bt(e){if(T(e.document)){N(e);return}ue(e)}He("html-tree:from-preview",({path:e}={})=>{kt(window,e)});f.HTML_TREE_PANEL_ID=M;f.htmlTreePanel=T;f.closeHtmlTreePanel=N;f.fillHtmlTreePane=Tt;f.showHtmlTreePane=yt;f.openHtmlTreePanel=ue;f.toggleHtmlTreePanel=bt;f.renderHtmlTree=y;export{M as HTML_TREE_PANEL_ID,Z as HTML_TREE_STYLE_ID,N as closeHtmlTreePanel,at as ensureHtmlTreeStyles,Tt as fillHtmlTreePane,F as htmlTreeActiveId,_ as htmlTreeCollapsed,T as htmlTreePanel,R as htmlTreeTimer,S as htmlTreeUnhook,ue as openHtmlTreePanel,y as renderHtmlTree,yt as showHtmlTreePane,xt as stopWatchHtmlTreeDock,bt as toggleHtmlTreePanel,V as watchHtmlTreeDock};
