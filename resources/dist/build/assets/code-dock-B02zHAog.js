...
`):e}function Rr(e,t){let o=0;for(let n=0;n<t.from;n+=1){if(e.startsWith("/*",n)){n=Vt(e,n)-1;continue}e[n]==="{"?o+=1:e[n]==="}"&&(o-=1)}return o===0}function Kt(e,t,o){const n=tn(t)||o;if(!n)return String(e||"");let s=String(t||"").trim();s?new RegExp(`^\\.${at(n)}\\s*\\{`).test(s)||(s=`.${n} {
${s}
}`):s=`.${n} {
...
`:""}${s}
`;const l=Y(r,n);if(!l)return r;for(const c of[...new Set(a)].reverse()){const u=new RegExp(`(^|[^\\w-])\\.${at(c)}\\s*\\{`,"g"),f=[];let p;for(;p=u.exec(r);){const g=p.index+p[1].length,k=r.indexOf("{",g),y=Wt(r,k);y!==-1&&f.push({from:g,to:y+1})}for(const g of f.reverse()){if(g.from>=l.from&&g.to<=l.to||!Rr(r,g))continue;let k=g.from;const y=r.lastIndexOf(`
`,k-1)+1;/^\s*$/.test(r.slice(y,k))&&(k=y);let I=g.to;r[I]===`
`&&(I+=1),r=r.slice(0,k)+r.slice(I)}}return r}function Et(e,t){const o=String(e||"");return`${o.trimEnd()}${o.trim()?`
`:""}.${t} {
}
...
`}function Oi(e){const t=e.querySelector(".live-preview-editor");if(!t)return 0;const o=t.getBoundingClientRect();return o.width<40||o.right<40?0:Math.round(o.right)}function Ii(e){let t=0;for(const o of["__sve-section-picker","__sve-outline-panel","__sve-html-tree-panel","__sve-listview-panel","__sve-right-dock","__sve-chrome-designs","__sve-global-section-panel","__sve-ai-panel"]){const n=e.getElementById(o);if(!n||n.hasAttribute("data-sve-chrome-hidden")||n.hasAttribute("data-sve-right-closed")||n.style.display==="none")continue;const s=n.getBoundingClientRect();s.width>40&&s.right>e.documentElement.clientWidth-8&&(t=Math.max(t,Math.round(s.width)))}return t}function eo(e){const t=e.document;if(Ne=e,typeof e.ResizeObserver!="function")return;de||(de=new e.ResizeObserver(()=>{Ne&&hs(Ne)}));const o=t.querySelector(".live-preview-editor"),n=t.getElementById("__sve-right-dock");o!==Pe&&(Pe&&de.unobserve(Pe),Pe=o,o&&de.observe(o)),n!==je&&(je&&de.unobserve(je),je=n,n&&de.observe(n))}function Hi(){de?.disconnect(),de=null,Ne=null,Pe=null,je=null}function Di(e){Mo||(Mo=!0,e.addEventListener("sve-right-dock-change",()=>eo(e)))}function to(e,t){const o=e.querySelector(".live-preview-contents");o&&(o.style.paddingBottom=t?`${t}px`:"")}function oo(e){if(!e)return;const t=e.clientHeight,o=e.querySelector("[data-sve-code-bar]"),n=e.querySelector("[data-sve-code-lock-banner]"),s=n&&Pi(e)?.getComputedStyle(n).display!=="none"?n.offsetHeight:0,r=Math.max(64,t-(o?.offsetHeight||0)-s),i=e.querySelector("[data-sve-code-panes]");i&&(i.style.height=`${r}px`,i.style.minHeight="0",i.style.overflow="hidden"),e.querySelectorAll("[data-sve-code-host]").forEach(a=>{const l=a.closest("[data-sve-code-pane]");if(!l||l.style.display==="none")return;let c=0;for(const f of l.children)f!==a&&(c+=f.offsetHeight);const u=Math.max(64,r-c);a.style.height=`${u}px`,a.style.maxHeight=`${u}px`,a.style.minHeight="0",a.style.overflow="auto",ji(a)})}function Pi(e){return e.ownerDocument?.defaultView||b}function ji(e){e._sveWheelBound||(e._sveWheelBound=!0,e.addEventListener("wheel",t=>{const o=e.scrollHeight-e.clientHeight,n=e.scrollWidth-e.clientWidth;let s=!1;if(t.deltaY&&o>0){const r=Math.min(o,Math.max(0,e.scrollTop+t.deltaY));r!==e.scrollTop&&(e.scrollTop=r,s=!0)}if(t.deltaX&&n>0){const r=Math.min(n,Math.max(0,e.scrollLeft+t.deltaX));r!==e.scrollLeft&&(e.scrollLeft=r,s=!0)}s&&(t.preventDefault(),t.stopPropagation())},{passive:!1}))}function qn(){const e=(Ne||b)?.document?.getElementById(d);e&&oo(e);for(const t of z)h[t]?.requestMeasure()}function zn(e,t){const o=jn(e),n={};for(const s of z){const r=t.querySelector(`[data-sve-code-pane-btn="${s}"]`);n[s]=r?r.getAttribute("aria-pressed")==="true":o[s]}return n}function Nn(e,t){for(const n of z){const s=e.querySelector(`[data-sve-code-pane-btn="${n}"]`),r=e.querySelector(`[data-sve-code-pane="${n}"]`);s&&s.setAttribute("aria-pressed",t[n]?"true":"false"),r&&(r.style.display=t[n]?"flex":"none")}const o=z.filter(n=>t[n]);e.querySelectorAll("[data-sve-code-split]").forEach(n=>{const s=n.getAttribute("data-sve-code-split-after"),r=o.indexOf(s);n.style.display=r>=0&&r<o.length-1?"block":"none"}),Fn(e.ownerDocument.defaultView,e),oo(e)}function Fn(e,t){const o=Rn(e);for(const n of z){const s=t.querySelector(`[data-sve-code-pane="${n}"]`);s&&(s.style.flex=`${o[n]} 1 0`)}}function Ke(e,t){if(Ue)return;const o=e.document;jt(o,t);const n=Ei(e),s=Oi(o),r=Ii(o);t.style.left=`${s}px`,t.style.right=`${r}px`,t.style.bottom="0",t.style.height=`${n}px`,to(o,n),oo(t)}function Vn(e,t,o,n){const s=e.document,r=[...s.querySelectorAll("iframe")];r.forEach(u=>{u.style.pointerEvents="none"});const i=s.createElement("div");i.setAttribute("data-sve-code-drag-shield",""),i.style.cssText=`position:fixed;inset:0;z-index:2147483646;cursor:${t};user-select:none;`,s.body.appendChild(i),Ue=!0;let a=!1;const l=u=>{o(u)},c=()=>{a||(a=!0,Ue=!1,s.removeEventListener("mousemove",l),s.removeEventListener("mouseup",c),e.removeEventListener("blur",c),r.forEach(u=>{u.style.pointerEvents=""}),i.remove(),n?.())};s.addEventListener("mousemove",l),s.addEventListener("mouseup",c),e.addEventListener("blur",c)}function Ri(e,t){if(t._sveResizeBound)return;t._sveResizeBound=!0;const o=n=>{if(n.button!==0||n.target.closest("[data-sve-code-pane-btn], [data-sve-code-back], [data-sve-style-mode], [data-sve-html-scope], [data-sve-code-lock], [data-sve-code-autosave], [data-sve-code-save], .cm-editor"))return;n.preventDefault();const s=n.clientY,r=t.getBoundingClientRect().height;let i=r;Vn(e,"ns-resize",a=>{i=Math.min(Math.max(Mn,r+(s-a.clientY)),Math.round(e.innerHeight*.7)),t.style.height=`${i}px`,to(e.document,i),qn()},()=>{Ti(e,i),Ke(e,t),e.dispatchEvent(new Event("resize"))})};t.querySelector("[data-sve-code-bar]")?.addEventListener("mousedown",o),t.querySelector("[data-sve-code-grip]")?.addEventListener("mousedown",o)}function qi(e,t){t._sveSplitBound||(t._sveSplitBound=!0,t.querySelectorAll("[data-sve-code-split]").forEach(o=>{o.addEventListener("mousedown",n=>{if(n.button!==0)return;n.preventDefault(),n.stopPropagation();const s=o.getAttribute("data-sve-code-split-after"),r=z.filter(y=>zn(e,t)[y]),i=r.indexOf(s),a=r[i],l=r[i+1];if(!a||!l)return;const c=t.querySelector(`[data-sve-code-pane="${a}"]`),u=t.querySelector(`[data-sve-code-pane="${l}"]`),f=n.clientX,p=c.getBoundingClientRect().width,g=u.getBoundingClientRect().width,k=p+g;o.setAttribute("data-active",""),Vn(e,"col-resize",y=>{const I=y.clientX-f;let H=Math.max(Mt,Math.min(k-Mt,p+I)),ce=k-H;k<Mt*2&&(H=p,ce=g);const Ie=Rn(e);Ie[a]=H,Ie[l]=ce,Bi(e,Ie),Fn(e,t),qn()},()=>{o.removeAttribute("data-active")})})}))}function zi(e,t){t._svePaneBound||(t._svePaneBound=!0,t.querySelectorAll("[data-sve-code-pane-btn]").forEach(o=>{o.addEventListener("click",n=>{n.stopPropagation();const s=o.getAttribute("data-sve-code-pane-btn"),r=zn(e,t),i={...r,[s]:!r[s]};!i.html&&!i.css&&!i.js&&(i[s]=!0),Mi(e,i),Nn(t,i)})}))}function V(e,t){const o=e.getElementById(d)?.querySelector("[data-sve-code-status]");o&&(o.textContent=t||"")}function Wn(e,t){const o=e.getElementById(d)?.querySelector("[data-sve-code-path]");o&&(o.textContent=t||"",o.title=t||"")}function Xe(e){const t=e?.document?.getElementById(d)?.querySelector("[data-sve-code-back]");t&&(t.hidden=fe.length===0,t.title=v(e,"code_dock_back"),t.setAttribute("aria-label",t.title),t.innerHTML=hi)}function Lo(e,t){const o=t.querySelector("[data-sve-code-back]");!o||o._sveBound||(o._sveBound=!0,o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Vi(e)}))}function Ni(e){const t=_e,o=typeof _.activeContainers=="function"?_.activeContainers(e.document):[];for(const n of o){const s=_.unwrapRef?.(n.values)||n.values;if(!(!s||typeof s!="object")&&t&&typeof _.findPathByUid=="function"){const r=_.findPathByUid(s,t);if(r){const i=r.split("."),a=_.dataGet?.(s,i.slice(0,2).join("."));if(a&&typeof a=="object")return a}}}for(const n of o){const s=_.unwrapRef?.(n.values)||n.values;if(s&&typeof s=="object")return s}return null}function Fi(e,t){!t||t===E||(ie(e.document),At(e,t,"push"))}function Vi(e){const t=fe.pop();if(!t){Xe(e);return}ie(e.document),At(e,t,"keep")}function Ee(e){const t=e.document.getElementById(d),o=t?.querySelector("[data-sve-code-lock]"),n=t?.querySelector("[data-sve-code-lock-banner]");if(!t||!o)return;const s=M;t.toggleAttribute("data-sve-code-locked",s),s&&(ee(e.document),se(e.document),be&&(be.setHover(h.html,null),be.setHover(h.css,null)),We?.setHover(h.html,null)),o.hidden=!Se,o.setAttribute("aria-pressed",M?"true":"false"),o.title=v(e,M?"code_dock_unlock":"code_dock_lock"),o.setAttribute("aria-label",o.title),o.innerHTML=M?fi:pi,n&&(n.textContent=v(e,"code_dock_locked_banner"))}function Ze(e){return e?Te(e,Jt)!=="0":D}function gt(e,t,o){return e!=null&&t!=null&&e>=0&&t>e&&t<=o}function yt(){const e=h.html?.state.doc.toString()??"";if(!B||!x){A=e;return}if(x.from<0||x.from>A.length||x.to<x.from){B=!1,A=e,x=null;return}A=A.slice(0,x.from)+e+A.slice(x.to),x={from:x.from,to:x.from+e.length}}function xt(){return yt(),B?A:h.html?.state.doc.toString()??N.html??""}function bt(){F=mt(xt()).map(e=>e.name)}function Be(){ge=Go(h.css?.state.doc.toString()??S)}function Un(e,t){return Array.isArray(e)&&Array.isArray(t)&&e.length===t.length&&e.every((o,n)=>o===t[n])}function Wi(){const e=B?so():xt(),t=vt(e);t.length&&(S=Kt(S,Ut(S,t),t[0].className))}function Kn(e,t){S=zr(S,e,t),Wi(),S=Nr(S,t,e)}function Ui(e){if(q||M||F==null)return;const t=mt(xt()).map(o=>o.name);Un(F,t)||(Kn(F,t),F=t,_t(),Be())}function Ki(){if(q||M||ge==null||F==null||Z==="empty")return;const e=h.html,t=Go(h.css?.state.doc.toString()??"");if(!e||Un(ge,t))return;const o=new Set(F),{renamed:n,removed:s}=Jo(ge,t);let r=e.state.doc.toString();const i=r;for(const a of n){const l=ke(a.to);!o.has(a.from)||!l||(r=So(r,c=>c===a.from?l:c))}for(const a of s)!o.has(a)||t.includes(a)||(r=So(r,l=>l===a?"":l));if(r!==i){q=!0;try{kt(r)}finally{q=!1}}bt(),ge=t}function Xi(e,t){const o=ke(t),n=h.html;if(!o||!n||n.state.readOnly||o===e.name)return;q=!0;try{n.dispatch({changes:{from:e.from,to:e.to,insert:o}})}finally{q=!1}const s=F==null?[]:F.slice();bt(),Kn(s,F),_t(),Be(),b&&(le(b),G(b))}function Yi(e,t){const o=e.document,s=h.html?.coordsAtPos(t.from);w(o),se(o);const r=o.createElement("div"),i={getBoundingClientRect:()=>({left:s?.left??12,right:s?.right??12,top:s?.top??12,bottom:s?.bottom??12,width:0,height:0})};r.id=T,o.body.appendChild(r),Oe(e,i,r),r._sveApp=Me(Xo,r,{label:v(e,"code_dock_css_rename_class"),placeholder:v(e,"code_dock_css_class_placeholder"),initial:t.name,onAdd:a=>{Xi(t,a),w(o)}})}function Xn(){return D&&gt(x?.from,x?.to,A.length)?(B=!0,A.slice(x.from,x.to)):(B=!1,A)}function no(e,t,o){const n=h[e];if(!n)return;const s=n.state.doc.toString();q=!0;try{s!==t?n.dispatch({changes:{from:0,to:s.length,insert:t},...o?{selection:o,scrollIntoView:!0}:{}}):o&&n.dispatch({selection:o,scrollIntoView:!0})}finally{q=!1}}function kt(e,t){no("html",e,t)}function so(){return B?h.html?.state.doc.toString()??"":gt(x?.from,x?.to,A.length)?A.slice(x.from,x.to):""}function Le(){const e=h.css?.state.doc.toString()??"";if(Z==="tree"){if(e===pe)return;const t=vt(so())[0]?.className||tn(e);S=Kt(S,e,t),pe=e}else Z==="full"&&(S=e)}function Yn(e,t){for(const o of t||[])if(!Y(e,o.className)||Yn(e,o.children))return!0;return!1}function _t(){let e=S,t=[],o=!1;!D||!B?(Z="full",e=S):(t=vt(so()),t.length?(Z="tree",e=Ut(S,t),Yn(S,t)&&(S=Kt(S,e,t[0].className),o=!0)):(Z="empty",e="")),pe=e,no("css",e),Be(),b&&(G(b),o&&le(b))}function ro(){const e=h.html;if(!e||!x)return;B||(A=e.state.doc.toString());const t=A.length,o=Math.max(0,Math.min(x.from,t)),n=Math.max(o,Math.min(x.to,t));n<=o||(x={from:o,to:n},B=!0,kt(A.slice(o,n),{anchor:0,head:0}),_t(),e.focus())}function io(e=!0){const t=h.html;if(!t)return;Le(),yt(),B=!1;const o=A||t.state.doc.toString(),n=e&&gt(x?.from,x?.to,o.length)?{anchor:x.from,head:x.to}:null;A=o,kt(o,n),Z="full",pe=S,no("css",S),Be()}function ao(){x=null,B=!1,A="",S="",Z="full",pe="",F=null,ge=null}let Ye=!1;function Ae(e){return!!e?.document.getElementById(_.HTML_TREE_PANEL_ID)}function Rt(e,t){if(!(!e||_.featureOn?.(e,"html_tree")===!1)){if(!t){Ae(e)&&_.closeHtmlTreePanel?.(e);return}Ae(e)||(Ye=!0,Cs("html_tree").then(()=>{Ae(e)||_.toggleHtmlTreePanel?.(e)}).catch(()=>{}).finally(()=>{Ye=!1,U(e)}))}}function U(e){const t=e?.document.getElementById(d)?.querySelector("[data-sve-html-scope]");if(!t)return;D=Ze(e);const o=_.featureOn?.(e,"html_tree")===!1?D:Ae(e)||Ye;t.setAttribute("aria-pressed",o?"true":"false"),t.title=v(e,o?"code_dock_html_scope_off":"code_dock_html_scope"),t.setAttribute("aria-label",t.title),t.innerHTML=Bn,e.document.getElementById(d)?.toggleAttribute("data-sve-html-scoped",B)}function Oo(e,t){t._sveHtmlScopeBound||(t._sveHtmlScopeBound=!0,D=Ze(e),Zi(e,t),Rt(e,D),t.querySelector("[data-sve-html-scope]")?.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),D=!(Ae(e)||Ye),we(e,Jt,D?"1":"0"),D?x&&(Le(),ro()):B&&io(),Rt(e,D),U(e)}))}function Zi(e,t){t._sveTreeWatchBound||(t._sveTreeWatchBound=!0,e.addEventListener("sve-right-dock-change",()=>{if(Ye||_.featureOn?.(e,"html_tree")===!1||!e.document.getElementById(d))return;const o=Ae(e);o!==Ze(e)&&(D=o,we(e,Jt,o?"1":"0"),o?x&&(Le(),ro()):B&&io(),U(e))}))}function Io(e,t){t._sveLockBound||(t._sveLockBound=!0,t.querySelector("[data-sve-code-lock]")?.addEventListener("click",o=>{if(o.preventDefault(),o.stopPropagation(),!(!Se||!E)){if(M){Ji(e);return}Zn(e,!0)}}))}function lo(e){return e?Te(e,En)!=="0":!0}function Gi(){const e=h.html;return!e||e.state.readOnly||!E?!1:!uo(co(),N)}function he(e){const t=e?.document.getElementById(d),o=t?.querySelector("[data-sve-code-autosave]"),n=t?.querySelector("[data-sve-code-save]");if(!o||!n)return;const s=lo(e),r=Gi();o.setAttribute("aria-pressed",s?"true":"false"),o.title=v(e,s?"code_dock_autosave_on":"code_dock_autosave_off"),o.setAttribute("aria-label",o.title),o.innerHTML=mi,n.hidden=s,n.title=v(e,"code_dock_save"),n.setAttribute("aria-label",n.title),n.innerHTML=vi,r?n.setAttribute("data-dirty",""):n.removeAttribute("data-dirty")}function Ho(e,t){t._sveAutosaveBound||(t._sveAutosaveBound=!0,t.querySelector("[data-sve-code-autosave]")?.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const n=!lo(e);we(e,En,n?"1":"0"),n?ie(e.document):Q&&(clearTimeout(Q),Q=null),he(e)}),t.querySelector("[data-sve-code-save]")?.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),ie(e.document)}))}function Ji(e){e.document.getElementById(K)?.remove();const t=ws(e.document,As,{title:v(e,"code_dock_unlock_title"),body:v(e,"code_dock_unlock_body"),buttons:[{value:"cancel",label:v(e,"cancel"),variant:"ghost"},{value:"ok",label:v(e,"code_dock_unlock_confirm"),variant:"primary"}],onPick:o=>{t.dismiss(),o==="ok"&&Zn(e,!1)}});t.host.id=K}function Zn(e,t){const o=E;if(!o)return;const n=()=>{E===o&&e.fetch("/!/sve/section-template/lock",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":Pn(e),"X-Requested-With":"XMLHttpRequest"},body:JSON.stringify({type:o,locked:t})}).then(async s=>{if(!s.ok)throw new Error(String(s.status));E===o&&(M=t,Ee(e),Ge(N,t),U(e),V(e.document,t?v(e,"code_dock_locked"):""))}).catch(()=>{V(e.document,v(e,"code_dock_error"))})};if(t&&(ie(e.document),ze)){ze.finally(n);return}n()}function co(){const e={html:"",css:"",js:""};yt(),Le();for(const t of z)t==="html"?e.html=B?A:h.html?.state.doc.toString()??"":t==="css"?e.css=S:e[t]=h[t]?.state.doc.toString()??"";return e}function Qi(){if(!(D&&gt(x?.from,x?.to,A.length)))return Z="full",pe=S,S;const e=vt(A.slice(x.from,x.to));if(!e.length)return Z="empty",pe="","";Z="tree";const t=Ut(S,e);return pe=t,t}function Ge(e,t){q=!0;try{b&&(D=Ze(b)),A=e.html??"",S=e.css??"";for(const o of z){const n=h[o];let s=e[o]??"";try{s=o==="html"?Xn():o==="css"?Qi():s}catch{s=o==="html"?A||e.html||"":o==="css"?S||e.css||"":s}if(!n)continue;const r=n.state.doc.toString(),i=[Fe[o].reconfigure(lt.readOnly.of(!!t)),Ve[o].reconfigure(ne.editable.of(!t))];r!==s?n.dispatch({changes:{from:0,to:r.length,insert:s},effects:i}):n.dispatch({effects:i})}}finally{q=!1}bt(),Be(),Ft("dock:html-changed"),b&&(G(b),wt(b),U(b))}function uo(e,t){return e.html===t.html&&e.css===t.css&&e.js===t.js}function Gn(e){return String(e||"").replace(/\/\*[\s\S]*?\*\//g,"").trim().replace(/\s*:\s*/g,": ").replace(/\s*;\s*/g,";").replace(/\s+/g," ").replace(/;+$/,";")}function St(e){const t=Gn(e).match(/^([a-z-]+)\s*:/i);return t?t[1].toLowerCase():""}function ea(e,t){return e===t||e.startsWith(`${t}-`)}function $t(e){const t=Gn(e),o=t.indexOf(":");return o===-1?"":t.slice(o+1).replace(/;$/,"").trim().toLowerCase()}function j(e){const t=String(e||"").trim().toLowerCase();return t==="start"||t==="flex-start"||t==="left"||t==="top"?"flex-start":t==="end"||t==="flex-end"||t==="right"||t==="bottom"?"flex-end":t==="row-reverse"?"row-reverse":t==="column-reverse"?"column-reverse":t}function ft(e){const t=j(e);return t==="flex"||t==="inline-flex"}function fo(){const e=h.css;if(!e)return null;const t=e.state.selection.main.head,o=e.state.doc.toString(),n=[],s=[];for(let i=0;i<o.length;i+=1){if(o[i]==="{"&&o[i+1]==="{"){const a=o.indexOf("}}",i+2);if(a===-1)break;i=a+1;continue}if(o[i]==="{")n.push(i);else if(o[i]==="}"){const a=n.pop();a!=null&&s.push({from:a+1,to:i,text:o.slice(a+1,i),open:a})}}let r=null;for(const i of s)t<i.open||t>i.to||(!r||i.to-i.open<r.to-r.open)&&(r=i);return r}function ta(e){const t=String(e||"");let o="",n=0;for(let s=0;s<t.length;s+=1){if(t[s]==="{"&&t[s+1]==="{"){const r=t.indexOf("}}",s+2);if(r===-1)break;n===0&&(o+=t.slice(s,r+2)),s=r+1;continue}if(t[s]==="{"){n+=1;continue}if(t[s]==="}"){n=Math.max(0,n-1);continue}n===0&&(o+=t[s])}return o}function oa(e){const t={};for(const o of ta(e).split(";")){const n=St(o);n&&(t[n]=$t(`${o};`))}return t}function na(e,t,o){if(!t||t.from>=t.to)return null;let n=e.state.doc.lineAt(t.from),s=0;for(;n.from<=t.to;){const r=Math.max(n.from,t.from),i=Math.min(n.to,t.to),a=e.state.doc.sliceString(r,i);if(s===0&&St(a)===o)return{from:r,to:i,text:a};if(s+=sa(a),n.to>=e.state.doc.length||n.to>=t.to)break;n=e.state.doc.lineAt(n.to+1)}return null}function sa(e){let t=0;const o=String(e);for(let n=0;n<o.length;n+=1){if(o[n]==="{"&&o[n+1]==="{"){const s=o.indexOf("}}",n+2);n=s===-1?o.length:s+1;continue}o[n]==="{"?t+=1:o[n]==="}"&&(t-=1)}return t}function me(e){return(String(e).match(/^\s*/)||[""])[0]}function Ct(e,t,o){for(let n=t.number-1;n>=1;n-=1){const s=e.state.doc.line(n),r=s.text.trim();if(!r)continue;const i=me(s.text);if(o&&(r==="{"||r.endsWith("{")))return`${i}  `;if(!(r==="}"||r.startsWith("}")))return i}return""}function ra(e,t){const o=e.state.doc.lineAt(t);if(o.text.trim())return me(o.text);const n=Ct(e,o,!0);if(n)return n;const s=fo();return s?Jn(e,s):"  "}function Jn(e,t){const o=e.state.doc.lineAt(t.from),n=e.state.doc.lineAt(Math.max(t.from,t.to));for(let r=n.number;r>=o.number;r-=1){const i=e.state.doc.line(r),a=Math.max(i.from,t.from),l=Math.min(i.to,t.to),c=e.state.doc.sliceString(a,l);if(c.trim())return(c.match(/^\s*/)||[""])[0]||"  "}return`${(e.state.doc.lineAt(Math.max(0,t.from-1)).text.match(/^\s*/)||[""])[0]}  `}function Do(){h.css?.focus(),b&&(le(b),G(b))}function W(e){const t=h.css;if(!t||t.state.readOnly||!e.length)return;const o=fo();if(!o){const i=e.filter(a=>a.value!=null).map(a=>`${a.property}: ${a.value};`).join(`
