...
import{o as k,a as _,b,t as A,k as Qa,l as ot,s as No,p as Se,F as R,d as st,w as L,f as qo,r as gn,u as w,q as Ue,g as j,_ as Vo,n as tr,h as m,v as Jn,x as er,y as nr,c as Ke,z as or,A as Qn,B as sr,D as X,E as q,j as ar,C as rr,i as Uo,G as ir,H as to,I as lr,J as H,K as at,L as eo,M as cr,m as z,O as vn,P as Ko,Q as dr,R as ur,S as Go,T as yn,U as fr,V as Zt,W as bn,X as hr,Y as pr,Z as mr,$ as gr,a0 as tn,a1 as xn,a2 as kn,a3 as Xo,a4 as vr,a5 as no,a6 as Ge,a7 as _t,a8 as yr,a9 as br,aa as en,ab as xr,ac as kr,ad as Zo,ae as Yo,af as T,ag as _r,ah as Sr,ai as oo,aj as wr,ak as $r}from"./addon-C7g4HUhN.js";import{al as jf,am as Rf}from"./addon-C7g4HUhN.js";import{v as Cr,l as Tr}from"./codemirror-CK8W7efq.js";import{p as we,f as Jo,h as Ar,t as Qo,c as Mr,a as ts,b as Er,d as Lr,e as Br,g as Fr,i as so,j as Ir,k as Or,l as es,m as Pr,n as Dr,o as zr,q as jr,s as Rr,r as ns,u as Hr,v as nn,w as Wr,H as os,x as Nr,y as qr,z as ss,A as Vr,B as Ur,_ as as,C as ao,P as re}from"./tw-classes-_4NKdqbJ.js";import{t as Kr}from"./tw-candidates-wYTeDvRv.js";import{h as Gr,a as Xr,e as Zr,A as ro,b as Yr,i as _n,c as Jr,d as he}from"./html-tag-sync-5k6AYspZ.js";import{M as rs,S as is}from"./protocol-hRcIeZuP.js";import"./ai-text-icon-B7uCWIwa.js";import"./index-Dpuj8sxX.js";import"./index-B5fiB6ig.js";import"./index-QkwZ_wP2.js";import"./index-CY0AOW5Y.js";import"./index-gYg9gdv3.js";import"./index-lzvKgifK.js";import"./index-BBw1nzv2.js";import"./index-DqbOpr3Y.js";import"./index-C_pm8ee_.js";import"./index-B8kpdD8S.js";const ls=/^\.[a-zA-Z_][\w-]*$/;function $e(t){const e=String(t||""),n=/(^|\s)\[/g;let o;for(;o=n.exec(e);){const s=o.index+o[1].length,a=/\](?=\s|$)/g;a.lastIndex=s+1;const i=a.exec(e);if(i)return{from:s,to:i.index+1,innerFrom:s+1,innerTo:i.index}}return null}function cs(t){const e=String(t||""),n=$e(e);return n?e.slice(n.innerFrom,n.innerTo).replace(/\{\{[\s\S]*?\}\}/g," ").split(/\s+/).filter(o=>/^[a-zA-Z_][\w-]*$/.test(o)):[]}function ds(t){const e=String(t||"").match(/\sclass\s*=\s*(["'])([^"']*)\1/i);return e?cs(e[2]):[]}function Qr(t){return ds(t)[0]||""}function Yt(t){const e=String(t||""),n=[],o=/\sclass\s*=\s*(["'])/gi;let s;for(;s=o.exec(e);){const a=s[1],i=s.index+s[0].length,l=e.indexOf(a,i);if(l===-1)break;const c=e.slice(i,l),d=$e(c);if(d){const f=c.slice(d.innerFrom,d.innerTo),h=i+d.innerFrom,p=f.replace(/\{\{[\s\S]*?\}\}/g,E=>" ".repeat(E.length)),y=/[a-zA-Z_][\w-]*/g;let v;for(;v=y.exec(p);)n.push({name:v[0],from:h+v.index,to:h+v.index+v[0].length})}o.lastIndex=l+1}return n}function io(t,e){return Yt(t).find(n=>e>=n.from&&e<=n.to)||null}function lo(t,e){const n=String(t||""),o=Yt(n);let s=n;for(let a=o.length-1;a>=0;a-=1){const i=o[a],l=e(i.name);if(l!==i.name){if(!l){let c=i.from,d=i.to;s[d]===" "?d+=1:c>0&&s[c-1]===" "&&(c-=1),s=s.slice(0,c)+s.slice(d);continue}s=s.slice(0,i.from)+l+s.slice(i.to)}}return s}function us(t){const e=[],n=/(^|[^\w-])\.([a-zA-Z_][\w-]*)\s*\{/g;let o;for(;o=n.exec(String(t||""));)e.push(o[2]);return e}function fs(t,e){const n=[],o=[],s=[];let a=0,i=0;for(;a<t.length&&i<e.length;){if(t[a]===e[i]){a+=1,i+=1;continue}const l=e.indexOf(t[a],i),c=t.indexOf(e[i],a);l===-1&&c===-1?(n.push({from:t[a],to:e[i]}),a+=1,i+=1):l===-1?(s.push(t[a]),a+=1):c===-1||l<=c?(o.push(e[i]),i+=1):(s.push(t[a]),a+=1)}for(;a<t.length;)s.push(t[a]),a+=1;for(;i<e.length;)o.push(e[i]),i+=1;return{renamed:n,added:o,removed:s}}function rt(t){let e=String(t||"").trim().replace(/^\.+/,"").replace(/\s+/g,"-").replace(/[^a-zA-Z0-9_-]/g,"");return/^[a-zA-Z_]/.test(e)||(e=e.replace(/^[^a-zA-Z_]+/,"")),ls.test(`.${e}`)?e:""}function ti(t,e){const n=String(t||""),o=rt(e);if(!n||!o)return n;const s=n.match(/\sclass\s*=\s*(["'])([^"']*)\1/i);if(s){const a=s[1];let i=s[2];const l=$e(i);if(l){const c=i.slice(l.innerFrom,l.innerTo).trim(),f=cs(i).includes(o)?c:`${c} ${o}`.trim();i=`${i.slice(0,l.from)}[ ${f} ]${i.slice(l.to)}`}else i=`[ ${o} ] ${i}`.trim();return n.slice(0,s.index)+` class=${a}${i}${a}`+n.slice(s.index+s[0].length)}return/\/\s*>$/.test(n)?n.replace(/(\s*)(\/\s*>)$/,` class="[ ${o} ]"$1$2`):n.replace(/(\s*)>$/,` class="[ ${o} ]"$1>`)}function ei(t,e){const n=String(t).indexOf(">",e.from);return n===-1?"":t.slice(e.from,n+1)}function hs(t,e){const n=[];for(const o of e){const s=ds(ei(t,o)),a=hs(t,o.children||[]);if(s.length){n.push({className:s[0],children:a});for(const i of s.slice(1))n.push({className:i,children:[]})}else n.push(...a)}return n}function Ce(t){return hs(t,we(t))}function pe(t){return String(t).replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Sn(t,e){if(t.startsWith("/*",e)){const n=t.indexOf("*/",e+2);return n===-1?t.length:n+2}return e}function Lt(t,e){let n=0;for(let o=e;o<t.length;o+=1){if(t.startsWith("/*",o)){o=Sn(t,o)-1;continue}if(t[o]==="{")n+=1;else if(t[o]==="}"&&(n-=1,n===0))return o}return-1}function W(t,e){const n=String(t||""),o=new RegExp(`(^|[^\\w-])\\.${pe(e)}\\s*\\{`,"g");let s;for(;s=o.exec(n);){const a=s.index+s[1].length,i=n.indexOf("{",a);if(i===-1)continue;const l=Lt(n,i);if(l!==-1)return{from:a,brace:i,close:l,to:l+1,name:e}}return null}function ni(t){const e=String(t||""),n=[],o={},s=[];let a=0,i="";const l=()=>{const c=i.trim();c&&n.push(c),i=""};for(;a<e.length;){if(e.startsWith("/*",a)){const c=Sn(e,a);i+=e.slice(a,c),a=c;continue}if(e[a]==="{"){const c=i.trim(),d=Lt(e,a);if(d===-1)break;const f=e.slice(a+1,d);i="",ls.test(c)?o[c.slice(1)]=f:c&&s.push(`${c} {${f}}`),a=d+1;continue}i+=e[a],a+=1}return l(),{decls:n.join(`
...
`)}function oi(t,e){const n=W(t,e);return n?String(t).slice(n.brace+1,n.close):""}function ps(t,e,n){const o=ni(oi(e,t.className)),s="    ".repeat(n),a=[];o.decls&&a.push(co(o.decls.replace(/;+\s*$/,";"),n+1));for(const l of o.other)a.push(co(l,n+1));for(const l of t.children)a.push(ps(l,e,n+1));const i=a.filter(Boolean).join(`
...
`):t}function ii(t,e){let n=0;for(let o=0;o<e.from;o+=1){if(t.startsWith("/*",o)){o=Sn(t,o)-1;continue}t[o]==="{"?n+=1:t[o]==="}"&&(n-=1)}return n===0}function $n(t,e,n){const o=ms(e)||n;if(!o)return String(t||"");let s=String(e||"").trim();s?new RegExp(`^\\.${pe(o)}\\s*\\{`).test(s)||(s=`.${o} {
${s}
}`):s=`.${o} {
}`;let a=String(t||"");const i=W(a,o),l=si(s);if(i){const d=ai(a,i.from);a=a.slice(0,i.from)+ri(s,d)+a.slice(i.to)}else a=`${a.trimEnd()}${a.trim()?`
`:""}${s}
`;const c=W(a,o);if(!c)return a;for(const d of[...new Set(l)].reverse()){const f=new RegExp(`(^|[^\\w-])\\.${pe(d)}\\s*\\{`,"g"),h=[];let p;for(;p=f.exec(a);){const y=p.index+p[1].length,v=a.indexOf("{",y),E=Lt(a,v);E!==-1&&h.push({from:y,to:E+1})}for(const y of h.reverse()){if(y.from>=c.from&&y.to<=c.to||!ii(a,y))continue;let v=y.from;const E=a.lastIndexOf(`
`,v-1)+1;/^\s*$/.test(a.slice(E,v))&&(v=E);let Pt=y.to;a[Pt]===`
`&&(Pt+=1),a=a.slice(0,v)+a.slice(Pt)}}return a}function Xe(t,e){const n=String(t||"");return`${n.trimEnd()}${n.trim()?`
`:""}.${e} {
}
...
${l}
${f??""}${c.slice(d)}`}function jl(t,e){const n=ge(t).find(o=>o.prelude.includes(e));return n?n.bodyTo:ge(t)[0]?.bodyTo??-1}function Rl(t,e,n){let o=e,s=n;const a=t.lastIndexOf(`
...
`)}const Nl={"data-sve-css-add-label":""},ql=["placeholder","onKeydown"],Vl={key:0,"data-sve-css-add-hint":""},Ul={"data-sve-css-add-existing":""},Kl={"data-sve-css-add-list":""},Gl=["onClick"],Xl={"data-sve-css-add-name":""},Zl={"data-sve-css-add-detail":""},Yl={key:0,"data-sve-css-add-none":""},Jl=["disabled"],Bn={__name:"CodeDockAddClass",props:{label:{type:String,required:!0},placeholder:{type:String,default:""},initial:{type:String,default:""},onAdd:{type:Function,required:!0},options:{type:Array,default:()=>[]},onPick:{type:Function,default:null},takenText:{type:Function,default:null},existingLabel:{type:String,default:""},createLabel:{type:String,default:""},onClose:{type:Function,default:null}},setup(t){const e=t,n=Jn(e.initial||""),o=Jn(null);er(()=>nr(()=>{o.value?.focus(),o.value?.select()}));const s=Ke(()=>n.value.trim().toLowerCase()),a=Ke(()=>{if(!e.options.length)return[];const c=s.value,d=[],f=[];for(const h of e.options){const p=h.name.toLowerCase();!c||p.startsWith(c)?d.push(h):p.includes(c)&&f.push(h)}return[...d,...f].slice(0,8)}),i=Ke(()=>e.takenText&&s.value?e.takenText(n.value.trim()):"");function l(){const c=n.value.trim();if(!c){o.value?.focus();return}if(i.value&&e.onPick){e.onPick(c);return}e.onAdd(c)}return(c,d)=>(k(),_(R,null,[b("label",Nl,A(t.label),1),or(b("input",{ref_key:"input",ref:o,"data-sve-css-add-input":"","onUpdate:modelValue":d[0]||(d[0]=f=>n.value=f),type:"text",placeholder:t.placeholder,onKeydown:[Qn(L(l,["prevent"]),["enter"]),d[1]||(d[1]=Qn(L(f=>t.onClose?.(),["stop","prevent"]),["escape"]))]},null,40,ql),[[sr,n.value]]),i.value?(k(),_("div",Vl,A(i.value),1)):j("",!0),t.options.length?(k(),_(R,{key:1},[b("div",Ul,A(t.existingLabel),1),b("div",Kl,[(k(!0),_(R,null,st(a.value,f=>(k(),_("button",{key:f.name,type:"button","data-sve-css-add-option":"",onMousedown:d[2]||(d[2]=L(()=>{},["prevent"])),onClick:L(h=>t.onPick?.(f.name),["prevent","stop"])},[b("span",Xl,A(f.name),1),b("span",Zl,A(f.detail),1)],40,Gl))),128)),a.value.length?j("",!0):(k(),_("div",Yl,"—"))]),b("button",{type:"button","data-sve-css-add-create":"",disabled:!!i.value||!s.value,onMousedown:d[3]||(d[3]=L(()=>{},["prevent"])),onClick:L(l,["prevent","stop"])},A(t.createLabel),41,Jl)],64)):j("",!0)],64))}};function yo(t,e){e._sveLockBound||(e._sveLockBound=!0,e.querySelector("[data-sve-code-lock]")?.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),!(!r.lockReady||!r.lastType)){if(r.lastLocked){tc(t);return}Ls(t,!0)}}))}function Fn(t){return t?X(t,Ua)!=="0":!0}function Ql(){const t=g.html;return!t||t.state.readOnly||!r.lastType?!1:!jn(zn(),r.lastParts)}function it(t){const e=t?.document.getElementById(u),n=e?.querySelector("[data-sve-code-autosave]"),o=e?.querySelector("[data-sve-code-save]");if(!n||!o)return;const s=Fn(t),a=Ql();n.setAttribute("aria-pressed",s?"true":"false"),n.title=m(t,s?"code_dock_autosave_on":"code_dock_autosave_off"),n.setAttribute("aria-label",n.title),n.innerHTML=ef,o.hidden=s,o.title=m(t,"code_dock_save"),o.setAttribute("aria-label",o.title),o.innerHTML=nf,a?o.setAttribute("data-dirty",""):o.removeAttribute("data-dirty")}function bo(t,e){e._sveAutosaveBound||(e._sveAutosaveBound=!0,e.querySelector("[data-sve-code-autosave]")?.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation();const o=!Fn(t);q(t,Ua,o?"1":"0"),o?V(t.document):r.saveTimer&&(clearTimeout(r.saveTimer),r.saveTimer=null),it(t)}),e.querySelector("[data-sve-code-save]")?.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),V(t.document)}))}function tc(t){t.document.getElementById(K)?.remove();const e=ar(t.document,rr,{title:m(t,"code_dock_unlock_title"),body:m(t,"code_dock_unlock_body"),buttons:[{value:"cancel",label:m(t,"cancel"),variant:"ghost"},{value:"ok",label:m(t,"code_dock_unlock_confirm"),variant:"primary"}],onPick:n=>{e.dismiss(),n==="ok"&&Ls(t,!1)}});e.host.id=K}function Ls(t,e){const n=r.lastType;if(!n)return;const o=()=>{r.lastType===n&&t.fetch("/!/sve/section-template/lock",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":Uo(t),"X-Requested-With":"XMLHttpRequest"},body:JSON.stringify({type:n,locked:e})}).then(async s=>{if(!s.ok)throw new Error(String(s.status));r.lastType===n&&(r.lastLocked=e,At(t),ee(r.lastParts,e),U(t),O(t.document,e?m(t,"code_dock_locked"):""))}).catch(()=>{O(t.document,m(t,"code_dock_error"))})};if(e&&(V(t.document),r.saveInFlight)){r.saveInFlight.finally(o);return}o()}function Bs(t,e){const n=String(e||"");if(/^(header|footer)\//.test(n))return!0;const o=t?.Statamic?.$config?.get?.("sveChromeTemplates")||{};return Object.values(o).some(s=>s&&s.type===n)}function ve(t){const e=r.lastType;if(!r.lastUid||!e||String(e).startsWith("view:")||Bs(t,e)){to(t);return}const n=lr(r.lastUid,t.document);to(t,n.length?{sectionUids:n}:void 0)}function ec(t,e,n){return r.saveInFlight=t.fetch("/!/sve/section-template",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":Uo(t),"X-Requested-With":"XMLHttpRequest"},body:JSON.stringify({type:e,html:n.html,css:n.css,js:n.js,...typeof n.tw=="string"?{tw:n.tw}:{},...Mr(t)?{props:r.lastProps}:{}})}).then(async o=>{if(o.status===423){r.lastLocked=!0,r.lockReady=!0,At(t),ee(r.lastParts,!0),U(t),O(t.document,m(t,"code_dock_locked"));return}const s=await o.json().catch(()=>({}));if(!o.ok)throw new Error(s?.error==="not_writable"?"not_writable":String(o.status));if(r.lastType===e){if(r.lastParts=n,s?.tw_written===!1){r.twDirty=!0,O(t.document,m(t,"code_dock_tw_not_writable")),it(t),ve(t);return}O(t.document,m(t,"code_dock_saved")),it(t),t.setTimeout(()=>{const a=t.document.getElementById(u)?.querySelector("[data-sve-code-status]");a&&a.textContent===m(t,"code_dock_saved")&&(a.textContent="")},1800)}ve(t),t.document.getElementById("__sve-section-picker")?.dispatchEvent(new t.CustomEvent("sve-library-stale"))}).catch(o=>{O(t.document,m(t,o?.message==="not_writable"?"code_dock_not_writable":"code_dock_error"))}).finally(()=>{r.saveInFlight=null}),r.saveInFlight}function V(t){r.saveTimer&&(clearTimeout(r.saveTimer),r.saveTimer=null);const e=r.lastType,n=r.lastWin,o=g.html;if(!o||o.state.readOnly||!e||!n||!r.lockReady)return;const s=zn(),a=r.twCss!==null&&Qo(n)&&In(s.html)===r.twKey;jn(s,r.lastParts)&&!(a&&r.twDirty)&&!r.propsDirty||(r.propsDirty=!1,a&&(s.tw=r.twCss,r.twDirty=!1),O(t,m(n,"code_dock_saving")),ec(n,e,s))}function In(t){return Kr(t).sort().join(" ")}function nc(){r.twCss=null,r.twKey="",r.twDirty=!1}function oc(t,e){r.twCss=e,r.twKey=In(t),r.twDirty=!1}function Fs(t,e){if(!t||!Qo(t))return;const n=In(e);n===r.twKey||r.twBusy||(r.twBusy=!0,ir(()=>import("./tw-compile-C_hT6KCx.js"),__vite__mapDeps([0,1]),import.meta.url).then(o=>o.compileTailwind(t,e)).then(o=>{r.twBusy=!1,r.twCss=o,r.twKey=n,r.twDirty=!0,Is(t,t.document)}).catch(o=>{r.twBusy=!1,console.error("[sve] tailwind compile",o)}))}function Is(t,e){r.saveTimer&&clearTimeout(r.saveTimer),r.saveTimer=t.setTimeout(()=>{r.saveTimer=null,V(e)},Zu)}function J(t){if(r.applying)return;const e=zn();if(jn(e,r.lastParts)){it(t);return}if(it(t),Fs(t,e.html),!Fn(t)){O(t.document,m(t,"code_dock_unsaved"));return}O(t.document,m(t,"code_dock_saving")),Is(t,t.document)}function Os(t,e){let n=0;const o=Math.min(t.length,e.length);for(;n<o&&t[n]===e[n];)n+=1;let s=t.length,a=e.length;for(;s>n&&a>n&&t[s-1]===e[a-1];)s-=1,a-=1;return[n,s,e.slice(n,a)]}function Ps(t){const e=r.lastUid,n=typeof H=="function"?H(t.document):[];for(const o of n){const s=at(o.values)||o.values;if(!(!s||typeof s!="object")&&e&&typeof eo=="function"){const a=eo(s,e);if(a){const i=a.split("."),l=cr(s,i.slice(0,2).join("."));if(l&&typeof l=="object")return l}}}for(const o of n){const s=at(o.values)||o.values;if(s&&typeof s=="object")return s}return null}function Ds(t,e){!e||e===r.lastType||(V(t.document),Mt(t,e,"push"))}function zs(t){const e=r.typeStack.pop();if(!e){Xt(t);return}V(t.document),Mt(t,e,"keep")}function At(t){const e=t.document.getElementById(u),n=e?.querySelector("[data-sve-code-lock]"),o=e?.querySelector("[data-sve-code-lock-banner]");if(!e||!n)return;const s=r.lastLocked;e.toggleAttribute("data-sve-code-locked",s),s&&(ts(t.document),tt(t.document),r.htmlPartialUi&&(r.htmlPartialUi.setHover(g.html,null),r.htmlPartialUi.setHover(g.css,null)),r.htmlClassTokenUi?.setHover(g.html,null)),n.hidden=!r.lockReady,n.setAttribute("aria-pressed",r.lastLocked?"true":"false"),n.title=m(t,r.lastLocked?"code_dock_unlock":"code_dock_lock"),n.setAttribute("aria-label",n.title),n.innerHTML=r.lastLocked?Yu:Ju,o&&(o.textContent=m(t,"code_dock_locked_banner"))}function Jt(t){return t?X(t,Ne)!=="0":r.htmlScopePref}function Le(t,e,n){return t!=null&&e!=null&&t>=0&&e>t&&e<=n}function et(){const t=globalThis.document?.getElementById(u);t&&(t.__sveHtmlScope=r.htmlScopeActive&&r.htmlFocus?{full:r.htmlFull,from:r.htmlFocus.from,to:r.htmlFocus.to,css:r.cssFull}:null)}function Be(){const t=g.html?.state.doc.toString()??"";if(!r.htmlScopeActive||!r.htmlFocus){r.htmlFull=t,et();return}if(r.htmlFocus.from<0||r.htmlFocus.from>r.htmlFull.length||r.htmlFocus.to<r.htmlFocus.from){r.htmlScopeActive=!1,r.htmlFull=t,r.htmlFocus=null,et();return}r.htmlFull=r.htmlFull.slice(0,r.htmlFocus.from)+t+r.htmlFull.slice(r.htmlFocus.to),r.htmlFocus={from:r.htmlFocus.from,to:r.htmlFocus.from+t.length},et()}function Ft(){return Be(),r.htmlScopeActive?r.htmlFull:g.html?.state.doc.toString()??r.lastParts.html??""}function Fe(){r.lastBracketNames=Yt(Ft()).map(t=>t.name)}function It(){r.lastCssSelectorNames=us(g.css?.state.doc.toString()??r.cssFull)}function js(t,e){return Array.isArray(t)&&Array.isArray(e)&&t.length===e.length&&t.every((n,o)=>n===e[o])}function sc(){const t=r.htmlScopeActive?On():Ft(),e=Ce(t);e.length&&(r.cssFull=$n(r.cssFull,wn(r.cssFull,e),e[0].className))}function Rs(t,e){r.cssFull=di(r.cssFull,t,e),sc(),r.cssFull=ui(r.cssFull,e,t)}function ac(t){if(r.applying||r.lastLocked||r.lastBracketNames==null)return;const e=Yt(Ft()).map(n=>n.name);js(r.lastBracketNames,e)||(Rs(r.lastBracketNames,e),r.lastBracketNames=e,Qt(),It())}function rc(){if(r.applying||r.lastLocked||r.lastCssSelectorNames==null||r.lastBracketNames==null||r.cssPane==="empty")return;const t=g.html,e=us(g.css?.state.doc.toString()??"");if(!t||js(r.lastCssSelectorNames,e))return;const n=new Set(r.lastBracketNames),{renamed:o,removed:s}=fs(r.lastCssSelectorNames,e);let a=t.state.doc.toString();const i=a;for(const l of o){const c=rt(l.to);!n.has(l.from)||!c||(a=lo(a,d=>d===l.from?c:d))}for(const l of s)!n.has(l)||e.includes(l)||(a=lo(a,c=>c===l?"":c));if(a!==i){r.applying=!0;try{Oe(a)}finally{r.applying=!1}}Fe(),r.lastCssSelectorNames=e}function ic(t,e){const n=rt(e),o=g.html;if(!n||!o||o.state.readOnly||n===t.name)return;r.applying=!0;try{o.dispatch({changes:{from:t.from,to:t.to,insert:n}})}finally{r.applying=!1}const s=r.lastBracketNames==null?[]:r.lastBracketNames.slice();Fe(),Rs(s,r.lastBracketNames),Qt(),It(),r.lastWin&&(J(r.lastWin),B(r.lastWin))}function lc(t,e){const n=t.document,s=g.html?.coordsAtPos(e.from);S(n),tt(n);const a=n.createElement("div"),i={getBoundingClientRect:()=>({left:s?.left??12,right:s?.right??12,top:s?.top??12,bottom:s?.bottom??12,width:0,height:0})};a.id=x,n.body.appendChild(a),D(t,i,a),a._sveApp=z(Bn,a,{label:m(t,"code_dock_css_rename_class"),placeholder:m(t,"code_dock_css_class_placeholder"),initial:e.name,onAdd:l=>{ic(e,l),S(n)}})}function Hs(){return r.htmlScopePref&&Le(r.htmlFocus?.from,r.htmlFocus?.to,r.htmlFull.length)?(r.htmlScopeActive=!0,et(),r.htmlFull.slice(r.htmlFocus.from,r.htmlFocus.to)):(r.htmlScopeActive=!1,et(),r.htmlFull)}function Ie(t,e,n){const o=g[t];if(!o)return;const s=o.state.doc.toString();r.applying=!0;try{if(s!==e){const[a,i,l]=Os(s,e);o.dispatch({changes:{from:a,to:i,insert:l},...n?{selection:n,scrollIntoView:!0}:{}})}else n&&o.dispatch({selection:n,scrollIntoView:!0})}finally{r.applying=!1}}function Oe(t,e){Ie("html",t,e)}function On(){return r.htmlScopeActive?g.html?.state.doc.toString()??"":Le(r.htmlFocus?.from,r.htmlFocus?.to,r.htmlFull.length)?r.htmlFull.slice(r.htmlFocus.from,r.htmlFocus.to):""}function dt(){const t=g.css?.state.doc.toString()??"";if(r.cssPane==="tree"){if(t===r.cssScopeSnapshot)return;const e=Ce(On())[0]?.className||ms(t);r.cssFull=$n(r.cssFull,t,e),r.cssScopeSnapshot=t}else r.cssPane==="full"&&(r.cssFull=t)}function Ws(t,e){for(const n of e||[])if(!W(t,n.className)||Ws(t,n.children))return!0;return!1}function Qt(){let t=r.cssFull,e=[],n=!1;r.cssValues||!r.htmlScopePref||!r.htmlScopeActive?(r.cssPane="full",t=r.cssFull):(e=Ce(On()),e.length?(r.cssPane="tree",t=wn(r.cssFull,e),Ws(r.cssFull,e)&&(r.cssFull=$n(r.cssFull,t,e[0].className),n=!0)):(r.cssPane="empty",t="")),r.cssScopeSnapshot=t,Ie("css",t),It(),r.lastWin&&(oe(r.lastWin,!0),B(r.lastWin),n&&J(r.lastWin))}function Pn(t){const e=g.html;if(!e||!r.htmlFocus)return;r.htmlScopeActive||(r.htmlFull=e.state.doc.toString());const n=r.htmlFull.length,o=Math.max(0,Math.min(r.htmlFocus.from,n)),s=Math.max(o,Math.min(r.htmlFocus.to,n));if(s<=o)return;r.htmlFocus={from:o,to:s},r.htmlScopeActive=!0,et();const a=t==null?0:Math.max(0,Math.min(t-o,s-o));Oe(r.htmlFull.slice(o,s),{anchor:a,head:a}),Qt(),e.focus()}function Dn(t=!0,e=null){const n=g.html;if(!n)return;dt(),Be(),r.htmlScopeActive=!1,et();const o=r.htmlFull||n.state.doc.toString(),s=e!=null?{anchor:Math.max(0,Math.min(e,o.length))}:t&&Le(r.htmlFocus?.from,r.htmlFocus?.to,o.length)?{anchor:r.htmlFocus.from,head:r.htmlFocus.to}:null;r.htmlFull=o,Oe(o,s),r.cssPane="full",r.cssScopeSnapshot=r.cssFull,Ie("css",r.cssFull),It()}function Pe(){r.htmlFocus=null,r.htmlScopeActive=!1,r.htmlFull="",r.cssFull="",r.cssPane="full",r.cssScopeSnapshot="",r.lastBracketNames=null,r.lastCssSelectorNames=null,et()}let qt=!1;function Tt(t){return!!t?.document.getElementById(Go)}function on(t,e){if(!(!t||vn(t,"html_tree")===!1)){if(!e){Tt(t)&&Ko(t);return}Tt(t)||(qt=!0,dr("html_tree").then(()=>{Tt(t)||ur(t)}).catch(()=>{}).finally(()=>{qt=!1,U(t)}))}}function U(t){const e=t?.document.getElementById(u)?.querySelector("[data-sve-html-scope]");if(!e)return;r.htmlScopePref=Jt(t);const n=vn(t,"html_tree")===!1?r.htmlScopePref:Tt(t)||qt;e.setAttribute("aria-pressed",n?"true":"false"),e.title=m(t,n?"code_dock_html_scope_off":"code_dock_html_scope"),e.setAttribute("aria-label",e.title),e.innerHTML=Xa,t.document.getElementById(u)?.toggleAttribute("data-sve-html-scoped",r.htmlScopeActive),et()}function xo(t,e){e._sveHtmlScopeBound||(e._sveHtmlScopeBound=!0,r.htmlScopePref=Jt(t),cc(t,e),on(t,r.htmlScopePref),e.querySelector("[data-sve-html-scope]")?.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation();const o=Tt(t)||qt;r.htmlScopePref=!o,q(t,Ne,r.htmlScopePref?"1":"0"),r.htmlScopePref?r.htmlFocus&&(dt(),Pn()):r.htmlScopeActive&&Dn(),on(t,r.htmlScopePref),U(t)}))}function cc(t,e){e._sveTreeWatchBound||(e._sveTreeWatchBound=!0,t.addEventListener("sve-right-dock-change",()=>{if(qt||vn(t,"html_tree")===!1||!t.document.getElementById(u))return;const n=Tt(t);n!==Jt(t)&&(r.htmlScopePref=n,q(t,Ne,n?"1":"0"),n?r.htmlFocus&&(dt(),Pn()):r.htmlScopeActive&&Dn(),U(t))}))}const dc=new Set(["pre","textarea","script","style"]),uc=/^(<\/|\{\{\s*\/)/;function fc(t){let e=0;for(const n of t.split(`
...
${p}}
`},selection:{anchor:i.bodyFrom+y.length},scrollIntoView:!0});return}const l=ia(e,o),c=`${l.indent}    `,d=me(o,n,"").some(p=>l.at>p.bodyFrom&&l.at<=p.bodyTo),f=d?`
...
`:o?`
`:""}${e}
`;return n.dispatch({changes:{from:o,insert:a},selection:{anchor:o+a.length}}),!0}function eu(t){if(ve(t),!r.lastType||!t.document.getElementById(u))return;const e=r.lastType;r.lastType=null,Mt(t,e,"keep")}function ha(t){N(t),r.loadGen+=1,V(t),r.lastUid=null,r.lastType=null,r.typeStack=[],r.lastParts={html:"",css:"",js:""},r.lastLocked=!1,r.lockReady=!1,r.lastBracketNames=null,r.lastCssSelectorNames=null,Pe(),r.lastWin=t?.defaultView||r.lastWin,S(t),ts(t),tt(t),t?.getElementById(K)?.remove();for(const n of nt)g[n]?.destroy(),g[n]=null;t?.getElementById(u)?.remove(),zu(),t&&Gn(t,0);const e=t?.defaultView||r.lastWin;e?.document.getElementById(Go)&&Ko(e),e&&($s(e),Tn(e),ss(e))}function nu(t){if(r.dragging)return;const e=t.document.getElementById(u);e&&(Kn(t),Gt(t,e))}function ou(t,e,n){if(n){const a=no(n,e)||no(n,t.document)||n;return String(typeof Ge=="function"&&(Ge(a,e)||Ge(a,t.document))||"").trim()}const o=typeof _t=="function"?_t(t):"page_sections",s=typeof H=="function"?H(t.document):[];for(const a of s){const l=(at(a.values)||a.values)?.[o];if(Array.isArray(l))for(const c of l){const d=typeof c?.type=="string"?c.type.trim():"";if(d)return d}}return""}function We(t){if((t.Statamic?.$config?.get?.("sveFeatures")||{}).collection_templates!==!0)return"";const n=t.Statamic?.$config?.get?.("sveCollectionTemplatesCollection")||"templates";if(!(t.location?.pathname||"").includes(`/collections/${n}/entries/`))return"";const s=typeof H=="function"?H(t.document):[];for(const a of s){const i=at(a.values)||a.values,l=typeof i?.view=="string"?i.view.trim():"";if(!l||l.includes(".."))continue;const c=l.replace(/\.(antlers\.html|blade\.php)$/i,"").replace(/^\/+|\/+$/g,"");if(c)return`view:${c}`}return""}function su(t,e,n){const o=t.Statamic?.$config?.get?.("sveChromeTemplates")||{},s=o[e]&&typeof o[e].type=="string"?o[e]:null,a=t.Statamic?.$config?.get?.("sveChromeStyles")||{},i=`${e}/${typeof a[e]=="string"&&a[e]!==""?a[e]:"style_1"}`,l=s?.type||i,c=n?.[`${e}_style`];return(!s||s.styled)&&typeof c=="string"&&c!==""?`${e}/${c}`:l}function au(){const t=mt();if(!t)return"";if(t===tn)return"main";if(r.lastWin&&t===We(r.lastWin))return"template";const e=t.match(/^(header|footer)\//);if(e)return e[1];const n=r.lastWin?.Statamic?.$config?.get?.("sveChromeTemplates")||{};return["header","footer"].find(o=>n[o]?.type===t)||""}function ru(t){const e=Zo||Yo;return e!=="header"&&e!=="footer"?"":xn(t)||kn(t)?e:""}function iu(t,e){const n=Zo||Yo;return n!=="header"&&n!=="footer"||!xn(e)&&!kn(e)?"":su(t,n,at(vr()?.values)||{})}function lu(t){const e=typeof _t=="function"?_t(t):"page_sections",n=typeof H=="function"?H(t.document):[];for(const o of n){const a=(at(o.values)||o.values)?.[e];if(Array.isArray(a)&&a.length)return!0}return!1}function cu(t,e){if(!e||String(e).startsWith("view:")||Bs(t,e))return!1;const n=typeof _t=="function"?_t(t):"page_sections",o=typeof H=="function"?H(t.document):[];for(const s of o){const i=(at(s.values)||s.values)?.[n];if(Array.isArray(i)&&i.some(l=>l?.type===e))return!0}return!1}function du(t){const e=Xo(t)||t.getElementById("__sve-global-section-host");return e&&e.querySelector("[data-replicator-set][data-type]")?.getAttribute("data-type")||""}function Pf(t,e,n){if(r.dragging)return;if(!t||!e||Eu(e)||!mr(t)||!gr(t)){e&&ha(e);return}const o=iu(t,e)||du(e)||ou(t,e,n)||We(t)||(n?"":r.lastType),s=!o&&!n&&!lu(t)?tn:"",a=o||s,i=!!(n&&n!==r.lastUid);if(r.onEmptyPage=!!s,r.lastWin=t,n&&(r.lastUid=n),!a){r.lastType&&!xn(e)&&!kn(e)&&!Xo(e)&&!cu(t,r.lastType)&&(r.lastUid=null,V(e),Mt(t,tn,"replace"));return}if(!(a===r.lastType&&e.getElementById(u))){if(r.typeStack.length&&r.lastType&&r.lastType!==a){const l=r.typeStack[0];if(a===l&&!i)return;r.typeStack=[]}V(e),Mt(t,a,"replace")}}Se("tw:changed",()=>{r.lastWin&&r.styleMode==="tw"&&B(r.lastWin)});T("dock:is-open",t=>fa(t));T("dock:is-locked",()=>ht());T("dock:html",()=>Ft());T("dock:reveal-html",({from:t,to:e,caret:n}={})=>{const o=g.html;if(!o||t==null)return;r.htmlScopePref=Jt(r.lastWin),Be(),dt();const s=r.htmlFull.length,a=Math.max(0,Math.min(t,s)),i=Math.max(a,Math.min(e??t,s));r.htmlFocus=i>a?{from:a,to:i}:null;const l=n==null?null:Math.max(0,Math.min(n,s));if(r.htmlScopePref&&r.htmlFocus){Pn(l),U(r.lastWin);return}if(r.htmlScopeActive){Dn(!0,l),U(r.lastWin);return}o.dispatch({selection:l==null?{anchor:a,head:i}:{anchor:l},scrollIntoView:!0}),o.focus()});T("dock:insert-snippet",({win:t,parts:e})=>Qd(t,e));T("dock:refresh",t=>eu(t));T("dock:tw-follow",()=>{r.lastWin&&se(r.lastWin)});T("dock:css",()=>(dt(),r.cssFull));T("dock:set-css",t=>typeof t!="string"||ht()||!g.css||!r.lastWin?!1:(dt(),r.cssFull=t,Ie("css",Gs()),J(r.lastWin),!0));T("dock:data-menu",({anchor:t,onPick:e,at:n}={})=>!t||!r.lastWin?!1:(N(r.lastWin.document),S(r.lastWin.document),pa(r.lastWin,t,e,n),!0));T("dock:props",()=>r.lastProps.map(t=>({...t})));T("dock:set-props",({win:t,props:e}={})=>!Array.isArray(e)||ht()?!1:(r.lastProps=e,r.propsDirty=!0,Ur(ae(mt())),V((t||r.lastWin)?.document),!0));function ae(t){const e=/^view:partials\/(components\/[A-Za-z0-9_-]+)$/.exec(String(t||""));return e?e[1]:""}T("dock:component-src",()=>ae(mt()));T("dock:type-stack",()=>r.typeStack.map(t=>({type:t,src:ae(t)})));T("dock:component-exit-state",()=>{const t=ae(mt());return{open:!!t,name:t?t.split("/").pop():"",back:r.typeStack.length>0}});T("dock:exit-component",(t=1)=>{if(!r.lastWin||!ae(mt()))return!1;if(r.typeStack.length){for(let e=Number(t)||1;e>1&&r.typeStack.length>1;e-=1)r.typeStack.pop();zs(r.lastWin)}else ha(r.lastWin.document);return!0});T("dock:current-type",()=>mt());T("dock:on-empty-page",()=>!!r.onEmptyPage);T("dock:current-uid",()=>r.lastUid);T("dock:chrome-kind",()=>au());T("dock:collection-view",()=>r.lastWin?We(r.lastWin):"");T("dock:chrome-open",t=>ru(t));T("dock:save-settled",()=>r.saveInFlight||null);T("dock:load-settled",()=>r.loadInFlight||null);T("dock:reset-data-vars",t=>(yi(typeof t=="string"&&t?t:void 0),!0));T("dock:refresh-preview",()=>r.lastWin?(ve(r.lastWin),!0):!1);T("dock:open-file",t=>typeof t!="string"||!t||!r.lastWin?!1:(t===r.lastType||(V(r.lastWin.document),Mt(r.lastWin,t,"replace")),!0));T("dock:open-template",t=>typeof t!="string"||!t||!r.lastWin?!1:(Ds(r.lastWin,t),!0));T("dock:set-html",t=>{if(typeof t!="string"||ht())return!1;const e=g.html;if(!e||!r.lastWin)return!1;if(t===""){r.saveTimer&&(clearTimeout(r.saveTimer),r.saveTimer=null),r.twDirty=!1,r.twCss=null,r.twKey="",r.lastType=null,r.lastUid=null,r.lastParts={html:"",css:"",js:""},r.cssFull="",r.htmlFull="",r.applying=!0;try{Pe();for(const s of nt){const a=g[s];if(!a)continue;const i=a.state.doc.toString();i!==""&&a.dispatch({changes:{from:0,to:i.length,insert:""}})}}finally{r.applying=!1}return!0}const n=r.htmlFull;if(r.htmlFull=t,r.htmlScopeActive)return r.htmlFocus=uu(r.htmlFocus,n,t),Oe(Hs()),J(r.lastWin),yn("dock:html-changed"),!0;const o=e.state.doc.toString();if(o!==t){const[s,a,i]=Os(o,t);e.dispatch({changes:{from:s,to:a,insert:i}})}return!0});T("dock:show-empty",()=>ot("dock:set-html",""));Se("row:removed",({parentPath:t,remaining:e,win:n})=>{e===0&&t===_t(n)&&ot("dock:show-empty")});function uu(t,e,n){const o=n.length-e.length;if(!t||!o)return t;let s=0;for(;s<e.length&&s<n.length&&e[s]===n[s];)s+=1;return s>=t.to?t:s<t.from?{from:Math.max(0,t.from+o),to:Math.max(0,t.to+o)}:{from:t.from,to:Math.max(t.from,t.to+o)}}const Et="__sve-data-menu";let be=null;function N(t){const e=t?.getElementById(Et);be?.(),be=null,e?._sveApp?.unmount(),e?.remove(),t?.querySelectorAll("[data-sve-data-vars][data-open], [data-sve-antlers-btn][data-open], [data-sve-visual-edit-btn][data-open]").forEach(n=>n.removeAttribute("data-open"))}function fu(t){if(!We(t))return{view:"",kind:""};const e=typeof H=="function"?H(t.document):[];for(const n of e){const o=at(n.values)||n.values,s=typeof o?.source_collection=="string"?o.source_collection.trim():"";if(s)return{view:s,kind:String(o?.kind||"").trim()}}return{view:"",kind:""}}function hu(t,e){const n=Ft();if(Number.isFinite(e))return ao(n,e);const o=g.html;if(!o)return[];const s=r.htmlScopeActive&&r.htmlFocus?r.htmlFocus.from:0;return ao(n,s+o.state.selection.main.from)}function pu(t,e){const{view:n,kind:o}=fu(t);return{collection:vs(t)||"",set:ys(mt()),view:n,kind:o,scope:vi(hu(t,e))}}function mu(t){const e=typeof H=="function"?H(t.document):[];for(const n of e){const o=at(n.values)||n.values;if(o&&typeof o=="object")return o}return null}function gu(t,e){return{scope:e?.scope?.groups||[],section:ks(e?.section||[],Ps(t)),page:ki(e?.page||[],mu(t)),site:e?.site||[]}}function vu(t){const e=t.state.selection.main,n=t.state.doc.lineAt(e.from),o=n.text.slice(0,e.from-n.from);return/(?:^|\s)(?::|x-bind:)[\w.:-]+\s*=\s*(["'])(?:(?!\1).)*$/.test(o)}function yu(t,e){const n=g.html;if(!n||n.state.readOnly)return;if(vu(n)){const c=String(t?.var||"").trim(),d=n.state.selection.main;n.dispatch({changes:{from:d.from,to:d.to,insert:c},selection:{anchor:d.from+c.length}}),I();return}const o=_i(t,e);if(!o)return;const s=n.state.selection.main,a=n.state.doc.lineAt(s.from),i=lt(a.text),l=_n(o.text,i);n.dispatch({changes:{from:s.from,to:s.to,insert:l},selection:{anchor:s.from+o.cursor+(o.text.includes(`
`)?i.length:0)}}),I()}function Ht(t,e,n){const o=e.getBoundingClientRect(),s=8,a=n.offsetWidth||368,i=n.offsetHeight||240,l=t.innerHeight-o.bottom-s,c=o.top-s,d=l>=i||l>=c?o.bottom+4:o.top-i-4;n.style.left=`${Math.max(s,Math.min(o.left,t.innerWidth-a-s))}px`,n.style.top=`${Math.max(s,Math.min(d,t.innerHeight-i-s))}px`}function pa(t,e,n,o){const s=t.document;N(s),e.setAttribute("data-open","");const a=s.createElement("div");a.id=Et,a.setAttribute("data-sve-data-menu",""),s.body.appendChild(a);const i=pu(t,o),l=p=>[p?.scope?.groups?.length?{id:"scope",label:p.scope.label||m(t,"data_vars_tab_loop")}:null,{id:"section",label:m(t,"data_vars_tab_section")},{id:"page",label:m(t,"data_vars_tab_page")},{id:"site",label:m(t,"data_vars_tab_site")}].filter(Boolean),c=p=>{s.getElementById(Et)&&(a._sveApp?.unmount(),a._sveApp=z(as,a,{title:m(t,"data_vars_title"),placeholder:m(t,"data_vars_placeholder"),emptyText:m(t,"data_vars_empty"),noSectionText:m(t,"data_vars_no_section"),loopText:m(t,"data_vars_loop"),tabs:l(p),data:gu(t,p),onPick:(y,v)=>n?n(y,v):yu(y,v)}),Ht(t,e,a))};c(bs(Cn(i))||{scope:null,section:[],page:[],site:[]}),xs(t,i).then(c),Ht(t,e,a);const d=()=>Ht(t,e,a),f=p=>{!a.contains(p.target)&&!e.contains(p.target)&&N(s)},h=p=>{p.key==="Escape"&&N(s)};s.addEventListener("pointerdown",f,!0),s.addEventListener("keydown",h,!0),t.addEventListener("scroll",d,!0),t.addEventListener("resize",d),be=()=>{s.removeEventListener("pointerdown",f,!0),s.removeEventListener("keydown",h,!0),t.removeEventListener("scroll",d,!0),t.removeEventListener("resize",d)}}function ma(t,e,{title:n,placeholder:o,tabs:s,data:a,onPick:i}){const l=t.document;N(l),S(l),e.setAttribute("data-open","");const c=l.createElement("div");c.id=Et,c.setAttribute("data-sve-data-menu",""),l.body.appendChild(c),c._sveApp=z(as,c,{title:n,placeholder:o,emptyText:m(t,"data_vars_empty"),noSectionText:m(t,"data_vars_empty"),loopText:"",tabs:s,data:a,onPick:(d,f)=>{N(l),i(d,f)}}),Ht(t,e,c),bu(t,e,c)}function bu(t,e,n){const o=t.document,s=()=>Ht(t,e,n),a=l=>{!n.contains(l.target)&&!e.contains(l.target)&&N(o)},i=l=>{l.key==="Escape"&&N(o)};o.addEventListener("pointerdown",a,!0),o.addEventListener("keydown",i,!0),t.addEventListener("scroll",s,!0),t.addEventListener("resize",s),be=()=>{o.removeEventListener("pointerdown",a,!0),o.removeEventListener("keydown",i,!0),t.removeEventListener("scroll",s,!0),t.removeEventListener("resize",s)}}const xu='<svg width="21" height="11" viewBox="0 0 150 77" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" clip-rule="evenodd" d="M69.999 55.827a13.8 13.8 0 0 0-.812-3.799 15.4 15.4 0 0 0-1.687-3.55 18.16 18.16 0 0 0-5.686-5.418 37.7 37.7 0 0 0 3.936-6.228 18.6 18.6 0 0 0 1.812-6.228 9.88 9.88 0 0 0-1.248-5.57 9.9 9.9 0 0 0-4.125-3.959 10.46 10.46 0 0 0-10.684 1.183 13.8 13.8 0 0 0-4.061 5.107 39 39 0 0 0-1.812 4.92 49.5 49.5 0 0 1-5.436-6.227 16.9 16.9 0 0 1-2.562-5.606 28.7 28.7 0 0 1-.624-6.85c.003-2-.357-3.983-1.063-5.855a10.66 10.66 0 0 0-4.56-5.231 13.9 13.9 0 0 0-10.684-1.37 10.13 10.13 0 0 0-4.94 2.755 10.1 10.1 0 0 0-2.683 4.967 24.4 24.4 0 0 0 0 10.214 22.4 22.4 0 0 0 3.374 7.35h-1.062a23 23 0 0 1-4.124 0 19.2 19.2 0 0 0-6.248 0 6.74 6.74 0 0 0-3.374 2.74 9.45 9.45 0 0 0-.75 9.341 11.23 11.23 0 0 0 5.811 6.228 25.1 25.1 0 0 0 10.622 1.495 17.9 17.9 0 0 0 9.809-3.425 104 104 0 0 1 10.496 7.162 22.4 22.4 0 0 1 5.249 6.54 15.5 15.5 0 0 1 1.437 5.106 35 35 0 0 0 1.437 6.789 13.2 13.2 0 0 0 4.373 5.73 15.6 15.6 0 0 0 10.372 2.802 9.9 9.9 0 0 0 5.429-1.987 9.84 9.84 0 0 0 3.38-4.677A61.6 61.6 0 0 0 70 55.827m-5.061 12.456a5.05 5.05 0 0 1-1.971 2.157 5.07 5.07 0 0 1-2.84.708 9.45 9.45 0 0 1-6.248-2.367 6.6 6.6 0 0 1-2.124-2.989 50 50 0 0 1-1.625-6.788 18.7 18.7 0 0 0-2.249-5.73 28.7 28.7 0 0 0-7.435-7.35A129 129 0 0 0 27.95 38.95c-.812-.498-2.686 0-2.749 0a14.03 14.03 0 0 1-7.872 1.62 19.5 19.5 0 0 1-7.935-2.056 4.86 4.86 0 0 1-2.375-2.49 3.35 3.35 0 0 1 0-2.99 1.18 1.18 0 0 1 .875-.748c1.25 0 2.687 0 3.936-.435a33 33 0 0 0 4.749-1.122 17.6 17.6 0 0 0 4.498-2.18 1.68 1.68 0 0 0 .838-1.68 1.7 1.7 0 0 0-.213-.624 2.2 2.2 0 0 0-.937-.747 18.65 18.65 0 0 1-2.812-7.35 19.5 19.5 0 0 1 .938-7.97 4.55 4.55 0 0 1 1.326-1.834 4.57 4.57 0 0 1 2.048-.97 7.52 7.52 0 0 1 5.498.997 5.12 5.12 0 0 1 2.499 3.488 87 87 0 0 0 1.874 10.587 22.4 22.4 0 0 0 4.436 6.789 78 78 0 0 0 8.372 7.286 1.8 1.8 0 0 0 1.188 1.246 2.005 2.005 0 0 0 2.499-1.308 33.4 33.4 0 0 1 3.249-6.54 8.8 8.8 0 0 1 2.811-2.677 4.63 4.63 0 0 1 4.561 0 4 4 0 0 1 1.612 1.494c.387.638.586 1.372.575 2.118a14.7 14.7 0 0 1-.75 5.792 36.6 36.6 0 0 1-2.561 6.228v.311a2.05 2.05 0 0 0 .5 2.74 13.6 13.6 0 0 1 3.248 4.92c.375.873.563 1.745.875 2.617s.937 2.678 1.312 4.048c1.625 5.916 2.5 7.536.875 10.961zM148.848 29.42a6.6 6.6 0 0 0-3.062-2.74 16.7 16.7 0 0 0-6.248 0c-1.227.09-2.459.09-3.686 0h-.937a24.2 24.2 0 0 0 3.186-7.536c.659-3.31.659-6.716 0-10.027a9.95 9.95 0 0 0-2.072-5.336 10 10 0 0 0-4.676-3.32 12.53 12.53 0 0 0-10.184 1.556 10.78 10.78 0 0 0-4.498 5.668 16.8 16.8 0 0 0-.875 5.667 32.7 32.7 0 0 1 0 6.602 17.2 17.2 0 0 1-2.499 5.543 52 52 0 0 1-4.748 5.792 32 32 0 0 0-1.5-4.547 14.4 14.4 0 0 0-3.811-5.231 9.522 9.522 0 0 0-10.56-.996 10.16 10.16 0 0 0-3.64 4.024 10.1 10.1 0 0 0-1.045 5.317c.21 2.156.78 4.26 1.687 6.228a38.3 38.3 0 0 0 3.748 6.228 17.5 17.5 0 0 0-5.435 5.668 15 15 0 0 0-1.562 3.55 18.3 18.3 0 0 0-.75 3.674v10.09c.068 1.417.32 2.82.75 4.172a9.46 9.46 0 0 0 3.062 4.609 9.5 9.5 0 0 0 5.123 2.118 14.1 14.1 0 0 0 9.871-2.927 12.76 12.76 0 0 0 4.124-5.792 34 34 0 0 0 1.562-6.727 17.6 17.6 0 0 1 1.375-5.107 21.1 21.1 0 0 1 4.623-6.228 83 83 0 0 1 8.935-7.349 16.34 16.34 0 0 0 8.997 3.301 22.24 22.24 0 0 0 9.746-1.557 10.777 10.777 0 0 0 5.499-6.228 9.88 9.88 0 0 0-.5-8.158m-5.623 6.229a4.43 4.43 0 0 1-2.062 2.553 16.16 16.16 0 0 1-7.06 2.18 11.7 11.7 0 0 1-7.123-1.869s-1.999-.81-2.812 0a123 123 0 0 0-11.558 7.038 26.9 26.9 0 0 0-6.811 7.224 79 79 0 0 0-3.623 12.456 6.23 6.23 0 0 1-2 3.052 7.88 7.88 0 0 1-5.373 2.305 4.63 4.63 0 0 1-2.523-.809 4.6 4.6 0 0 1-1.663-2.056 9.8 9.8 0 0 1-.812-3.488c.25-2.711.881-5.373 1.874-7.91.375-1.37.75-2.678 1.187-4.048s.438-1.806.812-2.616a13.26 13.26 0 0 1 2.937-5.044 2.054 2.054 0 0 0 .375-2.74 44 44 0 0 1-2.25-6.228 17.3 17.3 0 0 1-.687-5.792 4.22 4.22 0 0 1 1.937-3.675 3.57 3.57 0 0 1 3.811 0 8.3 8.3 0 0 1 2.625 2.678 40.5 40.5 0 0 1 3.061 6.228 1.93 1.93 0 0 0 1.664 1.441c.26.029.522.005.773-.07a1.82 1.82 0 0 0 1.187-1.309 80 80 0 0 0 7.872-7.411 22.5 22.5 0 0 0 3.999-6.664 75.4 75.4 0 0 0 1.749-10.525 5.17 5.17 0 0 1 1.937-3.176 5.76 5.76 0 0 1 4.749-.935 4.11 4.11 0 0 1 3.186 2.927c.751 2.609.985 5.338.687 8.035a19 19 0 0 1-2.561 7.473s-.625 0-.75.56a1.68 1.68 0 0 0 .5 2.367c1.27.908 2.657 1.641 4.123 2.18 1.468.49 2.972.865 4.499 1.121 1.125 0 2.374 0 3.561.436s.438.311.625.623c.235.52.351 1.087.341 1.657a3.9 3.9 0 0 1-.403 1.644z"/></svg>',ku='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m9 9 5 12 1.8-5.2L21 14Z"/><path d="M7.2 2.2 8 5.1"/><path d="m5.1 8-2.9-.8"/><path d="M14 4.1 12 6"/><path d="m6 12-1.9 2"/></svg>';function ga(t,e,n,o,s){const a=t.document.createElement("button");return a.type="button",a.setAttribute(n,""),a.title=s,a.setAttribute("aria-label",s),a.innerHTML=`<span>${o}</span>`,a.addEventListener("mousedown",i=>i.preventDefault()),e.replaceChildren(a),a}function _u(t){return String(t||"").replace(/\|/g,"").split(`
`)[0].trim()}function Su(t,e){const n=e.querySelector("[data-sve-data-vars]");!n||n._sveBound||(n._sveBound=!0,n.addEventListener("mousedown",o=>o.preventDefault()),n.addEventListener("click",o=>{if(o.preventDefault(),o.stopPropagation(),t.document.getElementById(Et)){N(t.document);return}S(t.document),pa(t,n)}))}function wu(t,e){const n=e.querySelector("[data-sve-antlers-tools]");if(!n||n._sveBound)return;n._sveBound=!0;const o=ga(t,n,"data-sve-antlers-btn",xu,m(t,"code_dock_antlers"));o.addEventListener("click",s=>{if(s.preventDefault(),s.stopPropagation(),o.hasAttribute("data-open")){N(t.document);return}const a={};for(const i of ro)a[i.id]=Yr.filter(l=>l.group===i.id).map(l=>({id:l.id,var:l.label,value:l.inline?"":_u(l.snippet)}));ma(t,o,{title:m(t,"code_dock_antlers"),placeholder:m(t,"code_dock_antlers_search"),tabs:ro.map(i=>({id:i.id,label:m(t,i.lang)})),data:a,onPick:i=>$u(i.id)})})}function $u(t){const e=Jr(t),n=g.html;if(!e||!n||n.state.readOnly)return;const o=n.state.selection.main.head;if(e.inline){const c=e.snippet,d=n.state.selection.main;n.dispatch({changes:{from:d.from,to:d.to,insert:c},selection:{anchor:d.from+c.length}}),I();return}const s=n.state.doc.lineAt(o),a=s.text.trim()?lt(s.text):je(n,s)||lt(s.text),{text:i,cursor:l}=he(e.snippet);Vt(_n(i,a),l),I()}function Cu(t,e){const n=e.querySelector("[data-sve-visual-edit-tools]");if(!n||n._sveBound)return;n._sveBound=!0;const o=ga(t,n,"data-sve-visual-edit-btn",ku,m(t,"code_dock_visual_edit"));o.addEventListener("click",s=>{if(s.preventDefault(),s.stopPropagation(),o.hasAttribute("data-open")){N(t.document);return}const a={};for(const i of fo)a[i.id]=_s.filter(l=>l.group===i.id).map(l=>({id:l.id,var:l.label,value:l.attr?l.attr.replace(/\|/g,""):""}));ma(t,o,{title:m(t,"code_dock_visual_edit"),placeholder:m(t,"code_dock_visual_edit_search"),tabs:fo.map(i=>({id:i.id,label:m(t,i.lang)})),data:a,onPick:i=>Au(i.id)})})}function Tu(t,e,n,o){if($i(n.inner,o.attr)){t.focus();return}const{text:s,cursor:a}=he(o.attr);let i=n.closeIdx;for(;i>n.openIdx+2&&/\s/.test(e[i-1]);)i--;t.dispatch({changes:{from:i,to:n.closeIdx,insert:` ${s} `},selection:{anchor:i+1+a}}),I()}function Au(t){const e=Si(t),n=g.html;if(!e||!n||n.state.readOnly)return;const o=n.state.doc.toString(),s=te();if(s?.open){const h=wi(o,s.open.from,s.open.to,ie);if(h){e.attr?Tu(n,o,h,e):(n.dispatch({selection:{anchor:h.openIdx+2+ie.length}}),n.focus());return}const p=s.open.from+1+s.name.length,y=e.standalone||`{{ ${ie} ${e.attr} }}`,{text:v,cursor:E}=he(y);n.dispatch({changes:{from:p,to:p,insert:` ${v}`},selection:{anchor:p+1+E}}),I();return}const a=n.state.selection.main.head,i=n.state.doc.lineAt(a),l=i.text.trim()?lt(i.text):je(n,i)||lt(i.text),c=e.standalone||`{{ ${ie} ${e.attr} }}`,{text:d,cursor:f}=he(c);Vt(_n(d,l),f),I()}function Mu(t){return t==="css"?ja():t==="js"?Ra():za({autoCloseTags:!0})}function jo(t){if(t._sveShield)return;t._sveShield=!0;const e=n=>n.stopPropagation();for(const n of["keydown","keypress","keyup","pointerdown","pointerup","mousedown","mouseup","click","focusin"])t.addEventListener(n,e)}function Eu(t){try{return new URLSearchParams(t.defaultView?.location?.search||"").has("sve-panel")}catch{return!1}}function Lu(t){const e=parseInt(X(t,Na)??"",10);return Number.isFinite(e)&&e>=Ga?e:Xu}function Bu(t,e){q(t,Na,String(e))}function va(t){try{const e=JSON.parse(X(t,qa)||"null");if(e&&typeof e=="object")return{html:e.html!==!1,css:e.css!==!1,js:e.js===!0,alpine:e.alpine===!0}}catch{}return{html:!0,css:!0,js:!1,alpine:!1}}function Fu(t,e){q(t,qa,JSON.stringify(e))}function ya(t){try{const e=JSON.parse(X(t,Va)||"null");if(e&&typeof e=="object"){const n=s=>Number.isFinite(s)&&s>0?s:1,o={};for(const s of wt)o[s]=n(e[s]);return o}}catch{}return Object.fromEntries(wt.map(e=>[e,1]))}function Iu(t,e){q(t,Va,JSON.stringify(e))}function Ou(t){_r(t,Gu,`
