...
`,n+1);return t.slice(n+1,o===-1?t.length:o).trim()!==""?t:t.slice(0,n)+t.slice(o===-1?t.length:o)}function te(t,e){const n=String(t||"");return n.trim()?`${n.replace(/\s+$/,"")} ${e}`:e}function ee(t,e,n){const o=String(t||""),s=String(n||"").trim().toLowerCase();if(!/^[a-z][a-z0-9-]*$/.test(s)||!e?.tag||s===e.tag.toLowerCase())return o;const a=e.tag.toLowerCase(),r=o.slice(e.from,e.openTo);if(!new RegExp(`^<${a}(?=[\\s/>])`,"i").test(r))return o;let i=o;const c=i.toLowerCase().lastIndexOf(`</${a}`,e.to);return c>e.from&&c<e.to&&(i=i.slice(0,c)+`</${s}`+i.slice(c+2+a.length)),i.slice(0,e.from)+`<${s}`+i.slice(e.from+1+a.length)}function Ne(t,e,n){const o=Qt(t,e.from,e.openTo);if(o)return t.slice(0,o.from)+n+t.slice(o.to);const s=String(t).slice(e.from,e.openTo),a=/^<([a-zA-Z][a-zA-Z0-9:-]*)/.exec(s);if(!a||!n)return t;const r=e.from+a[0].length;return`${t.slice(0,r)} class="${n}"${t.slice(r)}`}const Ve=[...Object.keys(Xt),...Object.keys(Yt),"text","leading","font","rounded"].sort((t,e)=>e.length-t.length);let st=null;function Ue(t){return st||(st=yt(t).then(Ke)),st}function ne(t){const e=String(t||"");if(e.includes(";"))return"";const n=e.indexOf(":");return n===-1?"":e.slice(0,n).trim()}function Ke(t){const e=new Map,n=new Map,o=new Map;for(const s of t.items){const a=ne(s.css);a&&(e.has(a)||e.set(a,[]),e.get(a).push(s),n.set(s.label,a));const r=oe(s.label);r&&(o.has(r)||o.set(r,[]),o.get(r).push(s))}return{catalog:t,byProperty:e,propertyOfUtility:n,byPrefix:o}}function oe(t){for(const e of Ve)if(String(t).startsWith(`${e}-`))return e;return""}function se(t,e){if(!e||!t)return null;const n=e.propertyOfUtility.get(t);if(n)return{label:n,options:e.byProperty.get(n)||[]};const o=oe(t),s=o?e.byPrefix.get(o):null;return s?.length?{label:ne(s[0].css)||o,options:s}:null}function re(t,e){return e?.catalog?.byUtility?.get(t)?.css||""}function Ze(t,e){return e?.catalog?.byUtility?.get(t)?.color||""}const Xe={class:"sve-tw"},Ye={key:0,class:"sve-tw-head"},Ge=["disabled"],Qe=["title","data-active","disabled","onClick"],Je=["data-active","disabled"],tn={key:1,class:"sve-tw-empty"},en=["data-sve-tw-base","data-current"],nn={class:"sve-tw-chips"},on=["title","onClick"],sn=["title","onClick"],rn={__name:"TwClassList",setup(t){function e(n){const o={"data-sve-tw-chip":n.id};return n.locked&&(o["data-sve-tw-locked"]=""),n.open&&(o["data-open"]=""),o}return(n,o)=>(w(),x("div",Xe,[S(f).tag?(w(),x("div",Ye,[v("button",{type:"button",class:"sve-tw-tag",disabled:!S(f).canEdit,onClick:o[0]||(o[0]=_(s=>S(f).onTag?.(s),["prevent","stop"]))},"<"+E(S(f).tag)+">",9,Ge),(w(!0),x(P,null,q(S(f).breakpoints,s=>(w(),x("button",{key:s.index,type:"button","data-sve-tw-bp":"",title:s.title,"data-active":s.active?"":void 0,disabled:!S(f).canEdit,onClick:_(a=>S(f).onBreakpoint?.(s.index),["prevent","stop"])},E(s.label),9,Qe))),128)),v("button",{type:"button","data-sve-tw-state":"","data-active":S(f).state?"":void 0,disabled:!S(f).canEdit,onClick:o[1]||(o[1]=_(s=>S(f).onState?.(s),["prevent","stop"]))},[lt(E(S(f).stateLabel)+" ",1),o[2]||(o[2]=v("svg",{width:"8",height:"8",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"3","stroke-linecap":"round","stroke-linejoin":"round"},[v("path",{d:"m6 9 6 6 6-6"})],-1))],8,Je),o[3]||(o[3]=v("span",{class:"sve-tw-gap"},null,-1))])):R("",!0),S(f).groups.length?R("",!0):(w(),x("div",tn,E(S(f).emptyText),1)),(w(!0),x(P,null,q(S(f).groups,s=>(w(),x("div",{key:s.key,class:"sve-tw-group"},[v("span",{class:"sve-tw-variant","data-sve-tw-base":s.key===""?"":void 0,"data-current":s.current?"":void 0},E(s.key===""?S(f).baseLabel:s.key),9,en),v("div",nn,[(w(!0),x(P,null,q(s.chips,a=>(w(),x("button",$e({key:a.id,type:"button"},{ref_for:!0},e(a),{title:a.title,onClick:_(r=>S(f).onChip?.(r,a.id),["prevent","stop"])}),[a.color?(w(),x("span",{key:0,class:"sve-tw-dot",style:vt({background:a.color})},null,4)):R("",!0),lt(" "+E(a.raw)+" ",1),a.locked?R("",!0):(w(),x("span",{key:1,class:"sve-tw-drop",role:"button",title:S(f).dropTitle,onClick:_(r=>S(f).onDrop?.(a.id),["prevent","stop"])},"−",8,sn))],16,on))),128))])]))),128))]))}},an=ke(rn,[["__scopeId","data-v-2566bb69"]]),ln={key:0,"data-sve-tw-menu-title":""},cn={"data-sve-tw-menu-list":""},un=["data-active","title","onClick"],dn={"data-sve-tw-tick":""},fn={"data-sve-tw-label":""},xt={__name:"TwClassMenu",props:{title:{type:String,default:""},options:{type:Array,default:()=>[]},removeLabel:{type:String,default:""},onPick:{type:Function,required:!0},onRemove:{type:Function,required:!0}},setup(t){return(e,n)=>(w(),x(P,null,[t.title?(w(),x("div",ln,E(t.title),1)):R("",!0),v("div",cn,[(w(!0),x(P,null,q(t.options,o=>(w(),x("button",{key:o.label,type:"button","data-sve-tw-option":"","data-active":o.active?"":void 0,title:o.css,onClick:_(s=>t.onPick(o.label),["prevent","stop"])},[v("span",dn,E(o.active?"✓":""),1),o.color?(w(),x("span",{key:0,"data-sve-tw-dot":"",style:vt({background:o.color})},null,4)):R("",!0),v("span",fn,E(o.label),1)],8,un))),128))]),v("button",{type:"button","data-sve-tw-remove":"",onClick:n[0]||(n[0]=_(o=>t.onRemove(),["prevent","stop"]))},[n[1]||(n[1]=v("span",{"data-sve-tw-tick":""},"✕",-1)),lt(E(t.removeLabel),1)])],64))}},pn={"data-sve-tw-search":""},mn=["placeholder","aria-label","onKeydown"],hn={"data-sve-tw-tabs":""},vn=["data-active"],gn=["data-active"],bn={key:0,"data-sve-tw-add-empty":""},yn=["data-cursor","data-active","data-sve-tw-off","title","onMouseenter","onClick"],wn={"data-sve-tw-label":""},xn={__name:"TwAddClass",props:{label:{type:String,default:""},placeholder:{type:String,default:""},sitePlaceholder:{type:String,default:""},emptyText:{type:String,default:""},offText:{type:String,default:""},siteLabel:{type:String,default:""},tailwindLabel:{type:String,default:""},search:{type:Function,required:!0},onAdd:{type:Function,required:!0}},setup(t){const e=t,n=M(""),o=M(null),s=M("tailwind"),a=M(null),r=M(-1),i=M(!1),c=I(()=>n.value.trim().toLowerCase()),p=I(()=>(f.siteClasses||[]).flatMap(k=>k.items).filter(k=>!c.value||k.name.toLowerCase().includes(c.value))),m=I(()=>e.search(n.value)),l=I(()=>s.value==="site"?p.value:m.value),u=I(()=>s.value==="site"?e.sitePlaceholder:e.placeholder);jt(()=>ct(()=>o.value?.focus()));function h(k){return k?.name||k?.label||""}function T(k){i.value=!0;const d=l.value.length;if(!d){r.value=-1;return}const g=r.value+k;r.value=g<0?-1:Math.min(g,d-1),ct(()=>W())}function W(){const k=a.value?.querySelector("[data-cursor]");if(!k)return;let d=k.parentElement;for(;d&&d.scrollHeight<=d.clientHeight;)d=d.parentElement;if(!d)return;const g=k.offsetTop,z=g+k.offsetHeight;g<d.scrollTop?d.scrollTop=g:z>d.scrollTop+d.clientHeight&&(d.scrollTop=z-d.clientHeight)}function j(k){i.value||(r.value=k)}function D(){r.value=-1}function et(){const k=r.value>=0?l.value[r.value]:null,d=k?h(k):n.value.trim();d&&e.onAdd(d)}return(k,d)=>(w(),x(P,null,[v("div",pn,[d[7]||(d[7]=v("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.4","stroke-linecap":"round","aria-hidden":"true"},[v("circle",{cx:"11",cy:"11",r:"7"}),v("path",{d:"m20 20-3.5-3.5"})],-1)),Dt(v("input",{ref_key:"input",ref:o,"data-sve-tw-add-input":"","onUpdate:modelValue":d[0]||(d[0]=g=>n.value=g),type:"text",placeholder:u.value,"aria-label":t.label,onInput:D,onKeydown:[d[1]||(d[1]=F(_(g=>T(1),["prevent"]),["down"])),d[2]||(d[2]=F(_(g=>T(-1),["prevent"]),["up"])),F(_(et,["prevent"]),["enter"]),d[3]||(d[3]=F(_(()=>{},["stop"]),["escape"]))]},null,40,mn),[[qt,n.value]])]),v("div",hn,[v("button",{type:"button","data-sve-tw-tab":"","data-active":s.value==="tailwind"?"":void 0,onClick:d[4]||(d[4]=_(g=>{s.value="tailwind",D()},["prevent","stop"]))},E(t.tailwindLabel),9,vn),v("button",{type:"button","data-sve-tw-tab":"","data-active":s.value==="site"?"":void 0,onClick:d[5]||(d[5]=_(g=>{s.value="site",D()},["prevent","stop"]))},E(t.siteLabel),9,gn)]),l.value.length?R("",!0):(w(),x("div",bn,E(t.emptyText),1)),v("div",{ref_key:"rowsEl",ref:a,onMousemove:d[6]||(d[6]=g=>i.value=!1)},[(w(!0),x(P,null,q(l.value,(g,z)=>(w(),x("button",{key:g.name||g.label,type:"button","data-sve-tw-option":"","data-cursor":z===r.value?"":void 0,"data-active":z===r.value?"":void 0,"data-sve-tw-off":g.loaded===!1?"":void 0,title:g.loaded===!1?t.offText:g.file||g.css,onMouseenter:nt=>j(z),onClick:_(nt=>t.onAdd(g.name||g.label),["prevent","stop"])},[g.color?(w(),x("span",{key:0,"data-sve-tw-dot":"",style:vt({background:g.color})},null,4)):R("",!0),v("span",wn,E(g.name||g.label),1)],40,yn))),128))],544)],64))}},kn={"data-sve-tw-search":""},$n=["placeholder","aria-label","onKeydown"],Cn=["data-active","onMouseenter","onClick"],_n={"data-sve-tw-tick":""},Tn={"data-sve-tw-label":""},ae={__name:"TwTagMenu",props:{label:{type:String,default:""},placeholder:{type:String,default:""},current:{type:String,default:""},tags:{type:Array,default:()=>[]},onPick:{type:Function,required:!0}},setup(t){const e=t,n=M(""),o=M(null),s=M(-1),a=M(!1),r=I(()=>n.value.trim().toLowerCase()),i=I(()=>{if(!r.value)return e.tags;const m=e.tags.filter(l=>l.includes(r.value));return m.sort((l,u)=>(l.startsWith(r.value)?0:1)-(u.startsWith(r.value)?0:1)),m});jt(()=>ct(()=>o.value?.focus()));function c(m){a.value=!0;const l=i.value.length;s.value=l?Math.min(Math.max(s.value+m,-1),l-1):-1}function p(){const m=s.value>=0?i.value[s.value]:n.value.trim().toLowerCase();m&&e.onPick(m)}return(m,l)=>(w(),x(P,null,[v("div",kn,[l[6]||(l[6]=v("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.4","stroke-linecap":"round","aria-hidden":"true"},[v("circle",{cx:"11",cy:"11",r:"7"}),v("path",{d:"m20 20-3.5-3.5"})],-1)),Dt(v("input",{ref_key:"input",ref:o,"data-sve-tw-add-input":"","onUpdate:modelValue":l[0]||(l[0]=u=>n.value=u),type:"text",placeholder:t.placeholder,"aria-label":t.label,onInput:l[1]||(l[1]=u=>s.value=-1),onKeydown:[l[2]||(l[2]=F(_(u=>c(1),["prevent"]),["down"])),l[3]||(l[3]=F(_(u=>c(-1),["prevent"]),["up"])),F(_(p,["prevent"]),["enter"]),l[4]||(l[4]=F(_(()=>{},["stop"]),["escape"]))]},null,40,$n),[[qt,n.value]])]),v("div",{onMousemove:l[5]||(l[5]=u=>a.value=!1)},[(w(!0),x(P,null,q(i.value,(u,h)=>(w(),x("button",{key:u,type:"button","data-sve-tw-option":"","data-active":h===s.value||s.value===-1&&u===t.current?"":void 0,onMouseenter:T=>a.value?null:s.value=h,onClick:_(T=>t.onPick(u),["prevent","stop"])},[v("span",_n,E(u===t.current?"✓":""),1),v("span",Tn,"<"+E(u)+">",1)],40,Cn))),128))],32)],64))}},$="__sve-tw-menu",Ot="--sve-tw-anchor",Sn=typeof CSS<"u"&&CSS.supports?.("anchor-name: --x");let Q=null;const zt="__sve-tw-style",kt=[{key:"",all:!0,device:"Responsive",label:"tw_size_all"},{key:"",device:"Laptop",label:"tw_size_laptop",prefix:""},{key:"max-lg",device:"Tablet",label:"responsive_tablet",under:1024},{key:"max-md",device:"Mobile",label:"responsive_mobile",under:768}],Pt=["","dark","hover","focus","active","before","after"],ie={Mobile:"max-md",Tablet:"max-lg",Laptop:"",Desktop:""},le=["div","section","article","header","footer","main","aside","nav","h1","h2","h3","h4","h5","h6","p","span","a","button","label","ul","ol","li","figure","figcaption","blockquote","strong","em","small","picture","img","video","form","table","tr","td","th"];let ce="",H="",tt=!1;function En(){try{return ie[gt(window,"sve-lp-device")]??""}catch{return""}}function $t(){return tt?ce:En()}function ue(){return[$t(),H].filter(Boolean)}function Ct(){return ue().join(":")}const Ln=/^(max-)?(sm|md|lg|xl|2xl)$/;function Mn(t){return String(t||"").split(":").find(e=>Ln.test(e))||""}function de(){if(tt)return!0;try{return Object.prototype.hasOwnProperty.call(ie,gt(window,"sve-lp-device"))}catch{return!1}}function An(t){if(!de())return!0;const e=Mn(t);return e===$t()?!0:!kt.some(n=>n.key===e)}let b=null,V=new Map,A=null,rt=!1,J="",ft=null;function fe(t){return t?.querySelector?.('[data-sve-style="tw"] [data-sve-tw-host]')||null}function pe(t){if(t.getElementById(zt))return;const e=t.createElement("style");e.id=zt,e.textContent=`
  ...
  `,t.head.appendChild(e)}function me(t){const e=t.document.getElementById("live-preview-iframe");if(e)return e.contentDocument;for(const n of t.document.querySelectorAll("iframe"))try{const o=n.contentDocument?.getElementById("live-preview-iframe");if(o)return o.contentDocument}catch{}return null}function On(t,e,n){const o=me(t);if(!(!o||!b?.path))for(const s of o.querySelectorAll(`[${Ee}="${b.path}"]`))try{e&&s.classList.remove(e),n&&s.classList.add(n)}catch{}}const at=new Map,zn=/(^|-)color$|^fill$|^stroke$/;function _t(t){const e=String(t||""),n=e.slice(0,e.indexOf(":")).trim();return zn.test(n)&&/var\(\s*(--[A-Za-z0-9_-]+)\s*\)/.exec(e)?.[1]||""}function he(t,e){if(!e)return"";if(at.has(e))return at.get(e);const n=me(t),o=n?.documentElement,s=n?.defaultView;if(!o||!s)return"";let a="",r=e;for(let i=0;i<6&&r;i+=1){try{a=s.getComputedStyle(o).getPropertyValue(r).trim()}catch{return""}if(!a)return"";if(r=_t(a),!r)break}return a&&!a.startsWith("var(")?(at.set(e,a),a):""}function Pn(t,e){return Ze(e,A)||he(t,_t(re(e,A)))}function L(t){const e=t?.document.getElementById($);Q&&(Q.style.removeProperty("anchor-name"),Q=null),ft?.(),ft=null,J="",e&&(e._sveApp?.unmount(),e.remove())}function Bt(t,e,n){const o=e.getBoundingClientRect(),s=n.offsetWidth||176,a=8,r=140,i=e.closest?.("#__sve-tw-strip")?Xn(t):null,c=i?i.top:0,p=i?i.bottom:t.innerHeight,m=i?i.left:0,l=i?i.right:t.innerWidth,u=o.bottom+4,h=p-u-a,T=Math.max(r,Math.min(h,420));n.style.left=`${Math.max(m+a,Math.min(o.left,l-s-a))}px`,n.style.maxHeight=`${T}px`,n.style.top=`${h>=r?u:Math.max(c+a,p-a-T)}px`}function N(t,e,n,o){const s=t.document;L(t),pe(s);const a=s.createElement("div");a.id=$,s.body.appendChild(a),a._sveApp=Ce(n,a,o);const r=Sn&&!!e.closest?.("#__sve-tw-strip");r?(Q=e,e.style.setProperty("anchor-name",Ot),a.style.setProperty("position","absolute"),a.style.setProperty("position-anchor",Ot),a.style.setProperty("position-area","block-end span-inline-start"),a.style.setProperty("position-try-fallbacks","flip-block, flip-inline, flip-block flip-inline"),a.style.setProperty("margin","4px 0 0 0"),a.style.setProperty("max-height","20rem")):Bt(t,e,a);const i=()=>{r||Bt(t,e,a)},c=m=>{!a.contains(m.target)&&!e.contains(m.target)&&(L(t),X())},p=m=>{m.key==="Escape"&&(L(t),X())};return s.addEventListener("pointerdown",c,!0),s.addEventListener("keydown",p,!0),t.addEventListener("scroll",i,!0),t.addEventListener("resize",i),ft=()=>{s.removeEventListener("pointerdown",c,!0),s.removeEventListener("keydown",p,!0),t.removeEventListener("scroll",i,!0),t.removeEventListener("resize",i)},a}function ve(t,e,n){return(e||[]).map(o=>({label:o.label,css:o.css,color:o.color||he(t,_t(o.css)),active:o.label===n}))}function Y(){return!b||B("dock:is-locked")===!0}function G(){const t=B("dock:html");if(!b||typeof t!="string"||t[b.from]!=="<")return null;const e=Qt(t,b.from,b.openTo);return{html:t,value:e?e.value:""}}function Bn(t){if(!b?.path)return;const n=bt(Kt(t),new Set).find(o=>o.path===b.path);n&&(b={from:n.from,openTo:n.openTo,path:n.path,tag:n.tag})}function U(t,e,n,o,s){const a=Ne(e,b,n);a!==e&&(On(t,o,s),B("dock:set-html",a),Bn(a),O(t))}function pt(t){return se(t,A)?.label||""}function ge(t){return Jt(t).groups.flatMap(e=>e.items)}function be(t){const e=Ct();return ge(t).filter(n=>!n.dynamic&&n.variants.join(":")===e)}function Rt(t,e){if(Y()||!e)return;const n=G();if(!n)return;const o=pt(e),s=be(n.value).find(r=>r.name===e||o&&pt(r.name)===o);if(s?.name===e){U(t,n.html,dt(n.value,s,""),e,"");return}if(s){const r=ut({variants:s.variants,name:e,modifier:s.modifier,important:s.important});U(t,n.html,dt(n.value,s,r),s.raw,r);return}const a=ut({variants:ue(),name:e,modifier:"",important:""});U(t,n.html,te(n.value,a),"",a)}function Rn(t,e){const n=String(e||"").trim(),o=Ct(),s=o&&!n.includes(":")?`${o}:${n}`:n;if(Y()||!n)return;const a=G();!a||ge(a.value).some(i=>i.raw===s)||U(t,a.html,te(a.value,s),"",s.includes(":")?"":s)}function mt(t,e,n){if(Y())return;const o=G();if(!o||o.value.slice(e.from,e.to)!==e.raw){O(t);return}const s=n?ut({variants:e.variants,name:n,modifier:e.modifier,important:e.important}):"";U(t,o.html,dt(o.value,e,s),e.raw,s)}function Fn(t,e){if(Y()||!b)return;const n=B("dock:html");if(typeof n!="string"||n[b.from]!=="<")return;const o=ee(n,b,e);if(o===n)return;const s=b.from;B("dock:set-html",o);const r=bt(Kt(o),new Set).find(i=>i.from===s);r&&(b={from:r.from,openTo:r.openTo,path:r.path,tag:r.tag}),O(t),Z("tw:changed")}function oo(t,e,n){n?.tag&&N(t,e,ae,{label:C(t,"tw_tag"),placeholder:C(t,"tw_tag_placeholder"),current:String(n.tag).toLowerCase(),tags:le,onPick:o=>{In(t,n,o),L(t)}})}function In(t,e,n){if(B("dock:is-locked")===!0)return;const o=B("dock:html");if(typeof o!="string"||o[e.from]!=="<")return;const s=ee(o,e,n);s!==o&&B("dock:set-html",s)}function Wn(t,e){N(t,e,ae,{label:C(t,"tw_tag"),placeholder:C(t,"tw_tag_placeholder"),current:(b?.tag||"").toLowerCase(),tags:le,onPick:n=>{Fn(t,n),L(t)}})}function so(t){St(t,b?.path||"")}function ro(){return!!b}function jn(t,e){const n=kt[e];n&&(B("lp:set-device",{win:t,key:n.device}),tt=!n.all,ce=n.key,L(t),O(t),Z("tw:changed"))}function Dn(t,e){N(t,e,xt,{title:C(t,"tw_state"),removeLabel:C(t,"tw_state_none"),options:Pt.filter(Boolean).map(n=>({label:n,css:"",color:null,active:n===H})),onPick:n=>{H=Pt.includes(n)?n:"",L(t),O(t),Z("tw:changed")},onRemove:()=>{H="",L(t),O(t),Z("tw:changed")}})}Te("lp:device",()=>{tt=!1,fe(window.document)&&O(window)});function qn(t){const e=t?G():null;return e&&be(e.value).find(n=>pt(n.name)===t)?.name||""}function ao(t,e,n,o){const s=A?.byProperty.get(n)||[];if(!s.length)return;const a=qn(n);N(t,e,xt,{title:n,removeLabel:C(t,"tw_classes_remove"),options:ve(t,s,a),onPick:r=>{Rt(t,r),L(t),o?.(r)},onRemove:()=>{a&&Rt(t,a),L(t),o?.("")}})}let Ft=[],it=!1;function Hn(t){it||(it=!0,t.fetch("/!/sve/site-css/classes",{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(e=>e.ok?e.json():{groups:[]}).then(e=>{Ft=Array.isArray(e?.groups)?e.groups:[],f.siteClasses=Ft}).catch(()=>{it=!1}))}function Nn(t,e){Hn(t),N(t,e,xn,{label:C(t,"tw_add_class"),placeholder:C(t,"tw_add_placeholder"),emptyText:C(t,"tw_add_empty"),offText:C(t,"tw_class_not_imported"),sitePlaceholder:C(t,"tw_add_placeholder_site"),siteLabel:C(t,"tw_add_site"),tailwindLabel:C(t,"tw_add_tailwind"),search:n=>{const o=String(n||"").trim().toLowerCase();if(!o||!A)return[];const s=A.catalog.items.filter(a=>a.label.toLowerCase().includes(o));return s.sort((a,r)=>{const i=a.label.toLowerCase().startsWith(o)?0:1,c=r.label.toLowerCase().startsWith(o)?0:1;return i-c||a.label.length-r.label.length}),s.slice(0,40).map(a=>({label:a.label,css:a.css,color:a.color,active:!1}))},onAdd:n=>{Rn(t,n)}})}function Vn(t,e,n){const o=V.get(n);if(!o||o.locked)return;if(J===n){L(t),X();return}const s=se(o.name,A);N(t,e.currentTarget,xt,{title:s?.label||"",removeLabel:C(t,"tw_classes_remove"),options:ve(t,s?.options,o.name),onPick:a=>{mt(t,o,a),L(t)},onRemove:()=>{mt(t,o,""),L(t)}}),J=n,X()}function X(){for(const t of f.groups)for(const e of t.chips)e.open=e.id===J}function io(t,e){if(!e||e.from==null||e.openTo==null){b=null,V=new Map,L(t),O(t);return}b={from:e.from,openTo:e.openTo,path:e.path,tag:e.tag},O(t)}function O(t){Un(t);const e=b?G():null,n=e?Jt(e.value):{scope:null,groups:[]};V=new Map,f.baseLabel=C(t,"tw_size_base"),f.scopeTitle=C(t,"tw_classes_scope"),f.dropTitle=C(t,"tw_classes_remove"),f.variant=Ct(),f.onBreakpoint=r=>jn(t,r),f.onState=r=>Dn(t,r.currentTarget);const o=de();f.breakpoints=kt.map((r,i)=>({index:i,label:C(t,r.label),title:r.under?`${r.key}:  ·  < ${r.under}px`:C(t,r.all?"tw_size_all_title":"tw_size_base_title"),active:r.all?!o:o&&r.key===$t()})),f.state=H,f.stateLabel=H||C(t,"tw_state"),f.canEdit=!Y(),f.onChip=(r,i)=>Vn(t,r,i),f.onTag=r=>Wn(t,r.currentTarget),f.onDrop=r=>{const i=V.get(r);i&&!i.locked&&(L(t),mt(t,i,""))},f.tag=b?.tag||"";const s=n.scope?.label||"";f.scope=/^\[\s*\]$/.test(s)?"":s,f.emptyText=C(t,b?n.groups.length?"tw_classes_none_size":"tw_classes_none":"tw_classes_pick"),f.groups=n.groups.filter(r=>An(r.key)).map(r=>({key:r.key,current:r.key===f.variant,chips:r.items.map((i,c)=>{const p={...i,id:`${r.key}-${c}-${i.from}`,locked:i.dynamic||!f.canEdit,open:!1,color:i.dynamic?"":Pn(t,i.name),title:i.dynamic?C(t,"tw_classes_dynamic"):re(i.name,A)||i.raw};return V.set(p.id,p),p})}));const a=fe(t.document);a&&(pe(t.document),_e(a,an)),X(),St(t,b?.path||""),Z("tw:changed")}function Un(t){A||rt||(rt=!0,Ue(t).then(e=>{A=e,O(t)}).catch(()=>{rt=!1}))}const ye="sve-tw-strip";function Kn(t){try{return gt(t,ye)!=="0"}catch{return!0}}function lo(t,e){Se(t,ye,e?"1":"0"),e||ht(t)}const y="__sve-tw-strip",It="__sve-tw-strip-style";let Wt=null,K=null;function Tt(t){const e=t.document.getElementById("live-preview-iframe");if(e)return e;for(const n of t.document.querySelectorAll("iframe"))try{const o=n.contentDocument?.getElementById("live-preview-iframe");if(o)return o}catch{}return null}function Zn(t){if(t.getElementById(It))return;const e=t.createElement("style");e.id=It,e.textContent=`
    ...
    #${y} button:hover [data-drop] { opacity: 1; }
    #${y} [data-drop]:hover { background: #e11d48; }
