...
import{r as we,_ as X,u as d,o as p,c as f,a as S,t as _,F as H,e as A,d as T,f as g,w as I,b as Ie,K as Le,m as O,L as Ae,M as De,N as ce,O as Re,P as Be,n as je,Q as v,S as ge,j as h,T as Oe,J as ze,x as ee,s as x,h as Ke,B as ve,i as te,R as Ne,C as Ze,U as Fe,E as qe,G as Ve,V as Ue}from"./addon-DtkAZIQW.js";import{i as ne,t as Xe,c as Ye,p as We,f as Je,a as Ge}from"./tw-overlay-BA_rIS8q.js";import{a as Qe}from"./html-pick-align-BQgDq65Q.js";const r=we({emptyText:"",rows:[],editingId:null,draft:"",renameTitle:"",hideTitle:"",showTitle:"",duplicateTitle:"",deleteTitle:"",canEdit:!1,dragging:!1,dropId:null,dropPlace:null,onSelect:null,onTwist:null,tagTitle:"",onTagChange:null,onRename:null,onRenameCommit:null,onRenameCancel:null,onHide:null,onDuplicate:null,onDelete:null,onPointerDown:null,onContext:null,slotText:"",inspect:null,onInspectCommit:null,onLoopKind:null,onAddBranch:null}),et={key:0,class:"sve-ht-inspect"},tt={class:"sve-ht-inspect__head"},nt={key:0,class:"sve-ht-inspect__note"},ot={key:0,class:"sve-ht-inspect__seg"},rt=["data-active","disabled","onClick"],it=["value","disabled"],st={key:0,value:""},lt=["value"],at=["value","placeholder","disabled","onKeydown"],ct={key:3,class:"sve-ht-inspect__add"},dt=["disabled","onClick"],ut={__name:"HtmlTreeInspector",setup(e){function t(o){r.onInspectCommit?.(o.target.value)}return(o,n)=>d(r).inspect?(p(),f("div",et,[S("div",tt,_(d(r).inspect.title),1),d(r).inspect.mode==="note"?(p(),f("div",nt,_(d(r).inspect.note),1)):(p(),f(H,{key:1},[d(r).inspect.mode==="loop"?(p(),f("div",ot,[(p(!0),f(H,null,A(d(r).inspect.kinds,i=>(p(),f("button",{key:i.id,type:"button","data-active":i.id===d(r).inspect.loopKind?"":void 0,disabled:!d(r).canEdit,onClick:l=>d(r).onLoopKind?.(i.id)},_(i.label),9,rt))),128))])):T("",!0),d(r).inspect.mode==="loop"&&d(r).inspect.loopKind==="collection"?(p(),f("select",{key:d(r).inspect.key+":select",value:d(r).inspect.value,disabled:!d(r).canEdit,onChange:t},[d(r).inspect.value?T("",!0):(p(),f("option",st,_(d(r).inspect.placeholder),1)),(p(!0),f(H,null,A(d(r).inspect.collections,i=>(p(),f("option",{key:i.handle,value:i.handle},_(i.title),9,lt))),128))],40,it)):(p(),f("input",{key:d(r).inspect.key,type:"text",value:d(r).inspect.value,placeholder:d(r).inspect.placeholder,disabled:!d(r).canEdit,spellcheck:"false",onKeydown:[n[0]||(n[0]=g(()=>{},["stop"])),I(g(t,["prevent"]),["enter"])],onBlur:t},null,40,at)),d(r).inspect.branches?.length?(p(),f("div",ct,[(p(!0),f(H,null,A(d(r).inspect.branches,i=>(p(),f("button",{key:i.id,type:"button",disabled:!d(r).canEdit,onClick:l=>d(r).onAddBranch?.(i.id)},_(i.label),9,dt))),128))])):T("",!0)],64))])):T("",!0)}},pt=X(ut,[["__scopeId","data-v-2e1b20d6"]]),ft={class:"sve-html-tree"},ht={class:"sve-pane-bar","data-sve-pane-bar":""},mt={"data-sve-right-title":""},gt={__name:"HtmlTreePane",props:{title:{type:String,default:""}},setup(e){return(t,o)=>(p(),f("div",ft,[S("div",ht,[S("div",mt,_(e.title),1),o[0]||(o[0]=Ie('<div data-sve-right-actions data-v-0bfee450><button type="button" data-sve-right-pin aria-pressed="false" data-v-0bfee450></button><button type="button" data-sve-close aria-label="Close" data-v-0bfee450><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" data-v-0bfee450><path d="M18 6 6 18" data-v-0bfee450></path><path d="m6 6 12 12" data-v-0bfee450></path></svg></button></div>',1))]),o[1]||(o[1]=S("div",{"data-sve-html-tree-list":""},null,-1)),Le(pt)]))}},ke=X(gt,[["__scopeId","data-v-0bfee450"]]),vt={key:0,class:"sve-ht-empty"},kt=["title","onClick","onDblclick","onKeydown","onPointerdown","onContextmenu"],yt=["onClick"],xt={key:1,"data-sve-ht-letter":""},_t=["innerHTML"],bt=["title"],Tt=["title","onClick"],Ct={key:1,"data-sve-ht-kind":""},$t={key:3,"data-sve-ht-name":""},Pt={key:3,"data-sve-ht-actions":""},Ht=["title","innerHTML","onClick"],Et=["title","onClick"],St=["title","onClick"],Mt=["data-sve-ht-id"],wt='<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',It='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>',Lt='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3l18 18"/><path d="M10.6 10.6a2 2 0 0 0 2.8 2.8"/><path d="M9.9 5.1A10.8 10.8 0 0 1 12 5c6 0 10 7 10 7a17.6 17.6 0 0 1-3.1 3.9"/><path d="M6.1 6.1A17.6 17.6 0 0 0 2 12s4 7 10 7a10.8 10.8 0 0 0 3.1-.5"/></svg>',At='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="8" y="8" width="12" height="12" rx="2"/><path d="M4 16V6a2 2 0 0 1 2-2h10"/></svg>',Dt='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6"/><path d="M10 11v6M14 11v6"/></svg>',Rt={__name:"HtmlTreeList",setup(e){function t(i){return i.kind==="component"?i.src?`partial:${i.src}`:i.tag:i.name?`${i.tag} ${i.name}`:i.tag}function o(i){const l={"data-sve-ht-id":i.id};return i.current&&(l["data-sve-ht-current"]=""),i.hidden&&(l["data-sve-ht-hidden"]=""),r.dropId===i.id&&r.dropPlace&&(l["data-sve-ht-drop"]=r.dropPlace),l}function n(i){return!i.hidden||i.wrapFrom!=null}return(i,l)=>(p(),f("div",O({class:"sve-ht-root"},d(r).dragging?{"data-sve-ht-dragging":""}:{}),[d(r).rows.length?T("",!0):(p(),f("div",vt,_(d(r).emptyText),1)),(p(!0),f(H,null,A(d(r).rows,s=>(p(),f(H,{key:s.id},[S("div",O({"data-sve-ht-row":""},{ref_for:!0},o(s),{role:"button",tabindex:"0",title:t(s),style:{marginLeft:s.depth*12+"px"},onClick:a=>d(r).onSelect?.(s.id),onDblclick:g(a=>d(r).onRename?.(s.id),["prevent"]),onKeydown:[I(g(a=>d(r).onSelect?.(s.id),["prevent"]),["enter"]),I(g(a=>d(r).onSelect?.(s.id),["prevent"]),["space"])],onPointerdown:a=>d(r).onPointerDown?.(a,s.id),onContextmenu:g(a=>d(r).onContext?.(a,s.id),["prevent","stop"])}),[s.hasChildren||s.emptyBlock?(p(),f("button",O({key:0,type:"button","data-sve-ht-twist":""},{ref_for:!0},s.shut?{"data-sve-ht-shut":""}:{},{innerHTML:wt,onClick:g(a=>d(r).onTwist?.(s.id),["stop","prevent"]),onPointerdown:l[0]||(l[0]=g(()=>{},["stop"])),onDblclick:l[1]||(l[1]=g(()=>{},["stop"]))}),null,16,yt)):T("",!0),s.letter?(p(),f("span",xt,_(s.letter),1)):(p(),f("span",{key:2,"data-sve-ht-icon":"",innerHTML:s.svg},null,8,_t)),S("span",{"data-sve-ht-text":"",title:d(r).renameTitle},[s.kind!=="component"?(p(),f("button",{key:0,type:"button","data-sve-ht-tag":"",title:d(r).tagTitle,onClick:g(a=>d(r).onTagChange?.(a,s.id),["stop","prevent"]),onPointerdown:l[2]||(l[2]=g(()=>{},["stop"])),onDblclick:l[3]||(l[3]=g(()=>{},["stop"]))},_(s.tag),41,Tt)):(p(),f("span",Ct,_(s.tag),1)),d(r).editingId===s.id?Ae((p(),f("input",{key:2,"data-sve-ht-rename":"","onUpdate:modelValue":l[4]||(l[4]=a=>d(r).draft=a),onMousedown:l[5]||(l[5]=g(()=>{},["stop"])),onPointerdown:l[6]||(l[6]=g(()=>{},["stop"])),onClick:l[7]||(l[7]=g(()=>{},["stop"])),onDblclick:l[8]||(l[8]=g(()=>{},["stop"])),onKeydown:[l[9]||(l[9]=g(()=>{},["stop"])),l[10]||(l[10]=I(g(a=>d(r).onRenameCommit?.(),["prevent"]),["enter"])),l[11]||(l[11]=I(g(a=>d(r).onRenameCancel?.(),["prevent"]),["escape"]))],onBlur:l[12]||(l[12]=a=>d(r).onRenameCommit?.())},null,544)),[[De,d(r).draft]]):(p(),f("span",$t,_(s.name),1))],8,bt),d(r).canEdit?(p(),f("span",Pt,[d(r).canEdit&&n(s)?(p(),f("button",{key:0,type:"button","data-sve-ht-eye":"",title:s.hidden?d(r).showTitle:d(r).hideTitle,innerHTML:s.hidden?Lt:It,onClick:g(a=>d(r).onHide?.(s.id),["stop","prevent"]),onPointerdown:l[13]||(l[13]=g(()=>{},["stop"])),onDblclick:l[14]||(l[14]=g(()=>{},["stop"]))},null,40,Ht)):T("",!0),d(r).canEdit?(p(),f("button",{key:1,type:"button","data-sve-ht-dup":"",title:d(r).duplicateTitle,innerHTML:At,onClick:g(a=>d(r).onDuplicate?.(s.id),["stop","prevent"]),onPointerdown:l[15]||(l[15]=g(()=>{},["stop"])),onDblclick:l[16]||(l[16]=g(()=>{},["stop"]))},null,40,Et)):T("",!0),d(r).canEdit?(p(),f("button",{key:2,type:"button","data-sve-ht-del":"",title:d(r).deleteTitle,innerHTML:Dt,onClick:g(a=>d(r).onDelete?.(s.id),["stop","prevent"]),onPointerdown:l[17]||(l[17]=g(()=>{},["stop"])),onDblclick:l[18]||(l[18]=g(()=>{},["stop"]))},null,40,St)):T("",!0)])):T("",!0)],16,kt),s.emptyBlock&&!s.shut?(p(),f("div",O({key:0,"data-sve-ht-slot":"","data-sve-ht-id":s.id},{ref_for:!0},d(r).dropId===s.id&&d(r).dropPlace==="inside"?{"data-sve-ht-over":""}:{},{style:{marginLeft:(s.depth+1)*12+"px"}}),_(d(r).slotText),17,Mt)):T("",!0)],64))),128))],16))}},Bt=X(Rt,[["__scopeId","data-v-4543c8d2"]]);function J(e,t){for(const o of e||[]){if(o.id===t)return o;const n=J(o.children,t);if(n)return n}return null}function ye(e,t){return(e.children||[]).some(o=>o.id===t||ye(o,t))}function M(e,t){let o=t.wrapFrom??t.from,n=t.wrapTo??t.to;return o>0&&e[o-1]===`
`&&(o-=1),{from:o,to:n}}function xe(e,t){const o=e.slice(t.from,t.to);if(t.kind==="antlers"){const l=o.match(/\{\{\s*(?:\/[A-Za-z_][A-Za-z0-9_.:-]*|endif)\s*\}\}\s*$/);return l?t.from+l.index:t.to}const n=`</${t.tag}`,i=o.toLowerCase().lastIndexOf(n);return i===-1?t.to:t.from+i}function W(e,t,o){return e>=t+o?e-o:e>t?t:e}function jt(e,t,o,n,i){const l=J(t,o),s=J(t,n);if(!e||!l||!s||o===n||ye(l,n))return e;let a=i;a==="inside"&&(ne(s.tag)||s.wrapFrom!=null)&&(a="after");const u=M(e,l),c=e.slice(u.from,u.to);if(!c)return e;const m=e.slice(0,u.from)+e.slice(u.to),k=u.to-u.from;let y;a==="before"?y=W(M(e,s).from,u.from,k):a==="inside"?y=W(xe(e,s),u.from,k):y=W(M(e,s).to,u.from,k),y=Math.max(0,Math.min(y,m.length));let b=c;if(y>0&&m[y-1]!==`
`&&b[0]!==`
`&&(b=`
