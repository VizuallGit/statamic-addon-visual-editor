...
`)}function Ra(t,e){const o=Y(t,e);return o?String(t).slice(o.brace+1,o.close):""}function ts(t,e,o){const n=Ha(Ra(e,t.className)),s="    ".repeat(o),r=[];n.decls&&r.push(Qo(n.decls.replace(/;+\s*$/,";"),o+1));for(const l of n.other)r.push(Qo(l,o+1));for(const l of t.children)r.push(ts(l,e,o+1));const i=r.filter(Boolean).join(`
...
`)+`
`:""}function es(t){const e=String(t||"").match(/^\s*\.([a-zA-Z_][\w-]*)\s*\{/);return e?e[1]:""}function ja(t){const e=[],o=/\.([a-zA-Z_][\w-]*)\s*\{/g;let n,s=!0;for(;n=o.exec(String(t||""));){if(s){s=!1;continue}e.push(n[1])}return e}function Na(t,e){const o=String(t).lastIndexOf(`
`,e-1)+1,n=t.slice(o,e);return/^\s*$/.test(n)?n:""}function Wa(t,e){return e?t.split(`
`).map((o,n)=>n===0||!o?o:e+o).join(`
`):t}function qa(t,e){let o=0;for(let n=0;n<e.from;n+=1){if(t.startsWith("/*",n)){n=xo(t,n)-1;continue}t[n]==="{"?o+=1:t[n]==="}"&&(o-=1)}return o===0}function So(t,e,o){const n=es(e)||o;if(!n)return String(t||"");let s=String(e||"").trim();s?new RegExp(`^\\.${ye(n)}\\s*\\{`).test(s)||(s=`.${n} {
${s}
}`):s=`.${n} {
}`;let r=String(t||"");const i=Y(r,n),l=ja(s);if(i){const d=Na(r,i.from);r=r.slice(0,i.from)+Wa(s,d)+r.slice(i.to)}else r=`${r.trimEnd()}${r.trim()?`
`:""}${s}
`;const c=Y(r,n);if(!c)return r;for(const d of[...new Set(l)].reverse()){const h=new RegExp(`(^|[^\\w-])\\.${ye(d)}\\s*\\{`,"g"),f=[];let p;for(;p=h.exec(r);){const y=p.index+p[1].length,b=r.indexOf("{",y),B=Pt(r,b);B!==-1&&f.push({from:y,to:B+1})}for(const y of f.reverse()){if(y.from>=c.from&&y.to<=c.to||!qa(r,y))continue;let b=y.from;const B=r.lastIndexOf(`
...
`}function Va(t,e,o){const n=wt(o);return!e||!n||e===n?String(t||""):Y(t,n)?os(t,e):String(t||"").replace(new RegExp(`(^|[^\\w-])\\.${ye(e)}(\\s*\\{)`,"g"),`$1.${n}$2`)}function os(t,e){let o=String(t||"");for(;;){const n=Y(o,e);if(!n)break;let s=n.from;const r=o.lastIndexOf(`
`,s-1)+1;/^\s*$/.test(o.slice(r,s))&&(s=r);let i=n.to;o[i]===`
`&&(i+=1),o=o.slice(0,s)+o.slice(i)}return o}function Ua(t,e,o){const n=Array.isArray(e)?e:[],s=Array.isArray(o)?o:[],{renamed:r,added:i}=Jn(n,s),l=new Set(s);let c=String(t||"");for(const d of r){const h=wt(d.to);if(h){if(l.has(d.from)){Y(c,h)||(c=Ke(c,h));continue}Y(c,d.from)?c=Va(c,d.from,h):Y(c,h)||(c=Ke(c,h))}}for(const d of i){const h=wt(d);!h||Y(c,h)||(c=Ke(c,h))}return c}function Ka(t,e,o){const n=new Set(Array.isArray(e)?e:[]),s=new Set(Array.isArray(o)?o:[]);let r=String(t||"");for(const i of s)n.has(i)||(r=os(r,i));return r}const st="__sve-css-rename-chip",Ga='<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>';function Xa(t){const e=t.Decoration.mark({class:"sve-cm-css-token"}),o=t.StateEffect.define();return{extensions:[t.StateField.define({create(){return t.Decoration.none},update(s,r){let i;for(const c of r.effects)c.is(o)&&(i=c.value);if(i===void 0)return r.docChanged?t.Decoration.none:s;if(!i)return t.Decoration.none;const l=new t.RangeSetBuilder;return l.add(i.from,i.to,e),l.finish()},provide:s=>t.EditorView.decorations.from(s)})],setHover(s,r){s&&s.dispatch({effects:o.of(r)})}}}function rt(t){t?.getElementById(st)?.remove()}function Za(t,e,o,n){e.style.left=`${Math.max(6,Math.min(o,t.innerWidth-28))}px`,e.style.top=`${Math.max(6,n)}px`}function Ya(t,e,o,{onRename:n,title:s}){const r=t.document,i=e.coordsAtPos(o.to);if(!i)return;rt(r);const l=r.createElement("button");l.id=st,l.type="button",l.innerHTML=Ga,l.title=s,l.setAttribute("aria-label",s),l.addEventListener("mousedown",c=>{c.preventDefault(),c.stopPropagation(),rt(r),n?.(o)}),l.addEventListener("mouseleave",()=>{t.setTimeout(()=>{e.dom.matches(":hover")||l.matches(":hover")||rt(r)},120)}),r.body.appendChild(l),Za(t,l,i.right+2,i.top-1)}function Ja(t,e,{onRename:o,isLocked:n,setHover:s,title:r}){if(!e?.dom||e.dom._sveClassTokenBound)return;e.dom._sveClassTokenBound=!0;let i=null,l="";const c=()=>!!n?.(),d=()=>{t.clearTimeout(i),i=null,l="",s?.(e,null),rt(t.document)},h=f=>{if(c()){d();return}d(),o?.(f)};e.dom.addEventListener("mousemove",f=>{if(c()){d();return}if(f.target?.closest?.(`#${st}`))return;const p=e.posAtCoords({x:f.clientX,y:f.clientY});if(p==null)return;const y=Yo(e.state.doc.toString(),p);if(!y){t.clearTimeout(i),i=null,l="",s?.(e,null);return}const b=`${y.from}:${y.to}:${y.name}`;s?.(e,{from:y.from,to:y.to}),!(l===b&&(i||t.document.getElementById(st)))&&(t.clearTimeout(i),l=b,i=t.setTimeout(()=>{i=null,Ya(t,e,y,{onRename:h,title:r||"Rename class"})},160))}),e.dom.addEventListener("mouseleave",f=>{f.relatedTarget?.closest?.(`#${st}`)||t.setTimeout(()=>{t.document.getElementById(st)?.matches(":hover")||d()},160)}),e.dom.addEventListener("dblclick",f=>{if(c())return;const p=e.posAtCoords({x:f.clientX,y:f.clientY});if(p==null)return;const y=Yo(e.state.doc.toString(),p);y&&(f.preventDefault(),f.stopPropagation(),h(y))},!0),e.scrollDOM?.addEventListener("scroll",d),t.document._sveClassTokenDismiss||(t.document._sveClassTokenDismiss=!0,t.document.addEventListener("mousedown",f=>{f.target.closest(`#${st}`)||rt(t.document)}))}const a={cssColorsPromise:null,lastUid:null,lastType:null,typeStack:[],lastParts:{html:"",css:"",js:""},lastProps:[],propsDirty:!1,lastLocked:!1,lockReady:!1,lastWin:null,loadGen:0,saveTimer:null,lastBracketNames:null,lastCssSelectorNames:null,saveInFlight:null,loadInFlight:null,dragging:!1,applying:!1,htmlScopePref:!0,htmlScopeActive:!1,styleMode:"css",cssToolRow:null,cssOpenTool:"",cssOpenMenu:"",cssValues:!1,twCss:null,twKey:"",twBusy:!1,twDirty:!1,htmlFocus:null,htmlFull:"",cssFull:"",cssPane:"full",cssScopeSnapshot:"",layoutObserver:null,layoutWin:null,observedEditor:null,observedRight:null,layoutWatchBound:!1,cssSize:"",cssState:"",cssOwnFolds:new Set,cssFoldSig:"",htmlPartialUi:null,htmlAntlersUi:null,htmlClassTokenUi:null,htmlLintUi:null,cssGhostUi:null},Qa=["aria-label"],ti={value:""},ei=["label"],oi=["value"],ns={__name:"CodeDockAntlersSelect",props:{label:{type:String,required:!0},groups:{type:Array,required:!0},onPick:{type:Function,required:!0}},setup(t){const e=t;function o(n){const s=n.target.value;n.target.value="",s&&e.onPick(s)}return(n,s)=>(x(),k("select",{"data-sve-antlers-select":"","aria-label":t.label,onChange:o},[g("option",ti,A(t.label),1),(x(!0),k(D,null,U(t.groups,r=>(x(),k("optgroup",{key:r.id,label:r.label},[(x(!0),k(D,null,U(r.items,i=>(x(),k("option",{key:i.id,value:i.id},A(i.label),9,oi))),128))],8,ei))),128))],40,Qa))}},ni={"data-sve-data-search":""},si=["placeholder","aria-label","onKeydown"],ri={"data-sve-data-tabs":""},ai=["data-active","onClick"],ii={key:0,"data-sve-data-empty":""},li={key:0,"data-sve-data-group":""},ci=["data-cursor","title","onMouseenter","onClick"],di={"data-sve-data-name":""},ui={key:0,"data-sve-data-parent":""},fi={key:1,"data-sve-data-loop":""},hi={key:2,"data-sve-data-value":""},pi={__name:"CodeDockDataVars",props:{title:{type:String,default:""},placeholder:{type:String,default:""},emptyText:{type:String,default:""},noSectionText:{type:String,default:""},loopText:{type:String,default:""},tabs:{type:Array,required:!0},data:{type:Object,required:!0},onPick:{type:Function,required:!0}},setup(t){const e=t,o=ut(""),n=ut(null),s=ut(e.tabs[0]?.id||"section"),r=ut(null),i=ut(-1),l=ut(!1),c=jt(()=>o.value.trim().toLowerCase()),d=jt(()=>{const _=e.data[s.value]||[];return Array.isArray(_)&&_.length&&_[0]?.items?_:[{handle:s.value,label:"",items:_,bare:!0}]}),h=jt(()=>{const _=c.value;return d.value.map(S=>({...S,items:(S.items||[]).filter(M=>!_||M.var.toLowerCase().includes(_)||String(M.label||"").toLowerCase().includes(_)||String(M.parent||"").toLowerCase().includes(_))})).filter(S=>S.items.length)}),f=jt(()=>h.value.flatMap(_=>_.items.map(S=>({row:S,group:_})))),p=jt(()=>!f.value.length);En(()=>Je(()=>n.value?.focus()));function y(_){l.value=!0;const S=f.value.length;if(!S){i.value=-1;return}const M=i.value+_;i.value=M<0?-1:Math.min(M,S-1),Je(()=>b())}function b(){const _=r.value?.querySelector("[data-cursor]");if(!_)return;let S=_.parentElement;for(;S&&S.scrollHeight<=S.clientHeight;)S=S.parentElement;if(!S)return;const M=_.offsetTop,H=M+_.offsetHeight;M<S.scrollTop?S.scrollTop=M:H>S.scrollTop+S.clientHeight&&(S.scrollTop=H-S.clientHeight)}function B(_){return f.value.findIndex(S=>S.row===_)}function vt(_){l.value||(i.value=B(_))}function Rt(){const _=i.value>=0?f.value[i.value]:null;_&&e.onPick(_.row,_.group)}function ce(_){s.value=_,i.value=-1}return(_,S)=>(x(),k(D,null,[g("div",ni,[S[6]||(S[6]=g("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.4","stroke-linecap":"round","aria-hidden":"true"},[g("circle",{cx:"11",cy:"11",r:"7"}),g("path",{d:"m20 20-3.5-3.5"})],-1)),Bn(g("input",{ref_key:"input",ref:n,"data-sve-data-input":"","onUpdate:modelValue":S[0]||(S[0]=M=>o.value=M),type:"text",placeholder:t.placeholder,"aria-label":t.title,onInput:S[1]||(S[1]=M=>i.value=-1),onKeydown:[S[2]||(S[2]=Bt(I(M=>y(1),["prevent"]),["down"])),S[3]||(S[3]=Bt(I(M=>y(-1),["prevent"]),["up"])),Bt(I(Rt,["prevent"]),["enter"]),S[4]||(S[4]=Bt(I(()=>{},["stop"]),["escape"]))]},null,40,si),[[Ln,o.value]])]),g("div",ri,[(x(!0),k(D,null,U(t.tabs,M=>(x(),k("button",{key:M.id,type:"button","data-sve-data-tab":"","data-active":s.value===M.id?"":void 0,onClick:I(H=>ce(M.id),["prevent","stop"])},A(M.label),9,ai))),128))]),p.value?(x(),k("div",ii,A(s.value==="section"&&!(t.data.section||[]).length?t.noSectionText:t.emptyText),1)):j("",!0),g("div",{ref_key:"rowsEl",ref:r,onMousemove:S[5]||(S[5]=M=>l.value=!1)},[(x(!0),k(D,null,U(h.value,M=>(x(),k(D,{key:M.handle},[M.bare?j("",!0):(x(),k("div",li,A(M.label),1)),(x(!0),k(D,null,U(M.items,H=>(x(),k("button",{key:M.handle+"::"+H.var+"::"+(H.parent||""),type:"button","data-sve-data-option":"","data-cursor":B(H)===i.value?"":void 0,title:H.label,onMouseenter:Lr=>vt(H),onClick:I(Lr=>t.onPick(H,M),["prevent","stop"])},[g("span",di,A(H.var),1),H.parent?(x(),k("span",ui,A(H.parent),1)):j("",!0),H.loop?(x(),k("span",fi,A(t.loopText),1)):H.value?(x(),k("span",hi,A(H.value),1)):j("",!0)],40,ci))),128))],64))),128))],544)],64))}},Lt=new Map,tn={scope:null,section:[],page:[],site:[]};function ss(t){const e=t?.location?.pathname?.match(/\/collections\/([^/]+)\//);return e?e[1]:""}function rs(t){const e=String(t||"").trim();return!e||/^(header|footer)\//.test(e)?"":e}function mi(t){return(Array.isArray(t)?t:[]).filter(e=>e?.handle).map(e=>`${e.kind==="collection"?"collection":"field"}:${e.handle}`).join("|")}function wo({collection:t,set:e,view:o,scope:n}){return`${t}::${e}::${o||""}::${n||""}`}function as(t){return Lt.get(t)||null}function is(t,{collection:e,set:o,view:n,scope:s}){const r=wo({collection:e,set:o,view:n,scope:s}),i=Lt.get(r);if(i)return Promise.resolve(i);const l=new URLSearchParams;return e&&l.set("collection",e),o&&l.set("set",o),n&&l.set("view",n),s&&l.set("scope",s),t.fetch(`/!/sve/data-vars?${l.toString()}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(c=>c.ok?c.json():null).then(c=>{const d=c&&typeof c=="object"?c:tn;return Lt.set(r,d),d}).catch(()=>tn)}function gi(t){if(!t){Lt.clear();return}const e=`::${t}::`;for(const o of[...Lt.keys()])o.includes(e)&&Lt.delete(o)}function vi(t){if(t==null||t==="")return"";if(typeof t=="boolean")return t?"true":"false";if(Array.isArray(t))return t.length?`${t.length} ×`:"";if(typeof t=="object"){const o=Object.keys(t).length;return o?`${o} ×`:""}const e=String(t).replace(/\s+/g," ").trim();return e.length>60?`${e.slice(0,60)}…`:e}function yi(t,e){return e.split(".").reduce((o,n)=>o&&typeof o=="object"?o[n]:void 0,t)}function ls(t,e){return!Array.isArray(t)||!e||typeof e!="object"?t||[]:t.map(o=>{if(o.parent||o.value!=null||o.var.includes(":"))return o;const n=vi(yi(e,o.var));return n?{...o,value:n}:o})}function bi(t,e){return Array.isArray(t)?t.map(o=>({...o,items:ls(o.items,e)})):[]}function xi(t,e){const o=String(t?.var||"").trim();if(!o)return null;if(t.loop)return{text:`{{ ${o} }}
  
{{ /${o} }}`,cursor:`{{ ${o} }}
  `.length};if(e?.loop&&!t.parent){const n=e.loop;return{text:`{{ ${n} }}
  {{ ${o} }}
{{ /${n} }}`,cursor:`{{ ${n} }}
  {{ ${o} }}`.length}}return{text:`{{ ${o} }}`,cursor:`{{ ${o} }}`.length}}const ue="visual_edit",ki=[{id:"base",lang:"code_dock_visual_edit_base"},{id:"field",lang:"code_dock_visual_edit_field"}],cs=[{id:"tag",group:"base",label:"{{ visual_edit }}",standalone:"{{ visual_edit| }}"},{id:"ve_popup",group:"base",label:"popup",attr:'popup="true"'},{id:"ve_orderable",group:"base",label:"orderable",attr:'orderable="true"'},{id:"ve_section_orderable",group:"base",label:"section_orderable",attr:'section_orderable="true"'},{id:"ve_outline_inside",group:"base",label:"outline_inside",attr:'outline_inside="true"'},{id:"ve_field",group:"field",label:"field",attr:'field="|"'},{id:"ve_inline_edit",group:"field",label:"inline_edit",attr:'inline_edit="true"'},{id:"ve_insertable",group:"field",label:"insertable",attr:'insertable="true"'},{id:"ve_toolbar",group:"field",label:"toolbar",attr:'toolbar="true"'},{id:"ve_scope",group:"field",label:"scope",attr:'scope="|"'},{id:"ve_controls",group:"field",label:"controls",attr:'controls="|"'}];function Si(t){return cs.find(e=>e.id===t)||null}function wi(t,e,o,n){let s=e;for(;s<o;){const r=t.indexOf("{{",s);if(r===-1||r>=o)return null;const i=t.indexOf("}}",r+2);if(i===-1||i+2>o)return null;const l=t.slice(r+2,i);if((l.trim().split(/\s+/)[0]||"")===n)return{openIdx:r,closeIdx:i,inner:l};s=i+2}return null}function _i(t,e){const o=String(e).split("=")[0].trim();return new RegExp(`(^|\\s)${o}(=|\\s|$)`).test(t)}const $i={class:"sve-code-dock"},Ci={"data-sve-code-bar":""},Ti={type:"button","data-sve-code-pane-btn":"html"},Ai={type:"button","data-sve-code-pane-btn":"css"},Mi={type:"button","data-sve-code-pane-btn":"alpine"},Ei={type:"button","data-sve-code-pane-btn":"js"},Bi={type:"button","data-sve-html-scope":"","aria-pressed":"true"},Li=["innerHTML"],Fi={"data-sve-code-panes":""},Ii={"data-sve-code-pane":"html"},Oi={"data-sve-code-pane-label":""},Pi=["title","aria-label"],Di=["innerHTML"],zi={"data-sve-code-pane":"css"},Hi={"data-sve-css-chrome":"subrow-2"},Ri={"data-sve-code-pane-label":""},ji={"data-sve-css-label":""},Ni={"data-sve-code-pane":"alpine"},Wi={"data-sve-code-pane-label":""},qi={"data-sve-code-pane":"js"},Vi={"data-sve-code-pane-label":""},Ui={__name:"CodeDockChrome",props:{htmlLabel:{type:String,required:!0},cssLabel:{type:String,required:!0},jsLabel:{type:String,required:!0},alpineLabel:{type:String,required:!0},treeIcon:{type:String,required:!0},dataIcon:{type:String,required:!0},dataLabel:{type:String,required:!0}},setup(t){return(e,o)=>(x(),k("div",$i,[o[20]||(o[20]=g("div",{"data-sve-code-grip":"","aria-hidden":"true"},null,-1)),g("div",Ci,[g("button",Ti,A(t.htmlLabel),1),g("button",Ai,A(t.cssLabel),1),g("button",Mi,A(t.alpineLabel),1),g("button",Ei,A(t.jsLabel),1),o[0]||(o[0]=Fr('<button type="button" data-sve-code-back hidden></button><span data-sve-code-path></span><span data-sve-code-status></span><button type="button" data-sve-code-strip></button><button type="button" data-sve-code-history></button><button type="button" data-sve-style-mode></button><button type="button" data-sve-values-mode></button>',7)),g("button",Bi,[g("span",{innerHTML:t.treeIcon},null,8,Li)]),o[1]||(o[1]=g("button",{type:"button","data-sve-code-autosave":"","aria-pressed":"true"},null,-1)),o[2]||(o[2]=g("button",{type:"button","data-sve-code-save":"",hidden:""},null,-1)),o[3]||(o[3]=g("button",{type:"button","data-sve-code-lock":"",hidden:""},null,-1))]),o[21]||(o[21]=g("div",{"data-sve-code-lock-banner":""},null,-1)),g("div",Fi,[g("div",Ii,[g("div",Oi,[g("span",null,A(t.htmlLabel),1),o[4]||(o[4]=g("div",{"data-sve-html-tools":""},null,-1)),o[5]||(o[5]=g("button",{type:"button","data-sve-html-tidy":""},null,-1)),g("button",{type:"button","data-sve-data-vars":"",title:t.dataLabel,"aria-label":t.dataLabel},[g("span",{innerHTML:t.dataIcon},null,8,Di)],8,Pi),o[6]||(o[6]=g("div",{"data-sve-visual-edit-tools":""},null,-1)),o[7]||(o[7]=g("div",{"data-sve-antlers-tools":""},null,-1))]),o[8]||(o[8]=g("div",{"data-sve-html-problems":"",hidden:""},null,-1)),o[9]||(o[9]=g("div",{"data-sve-code-host":""},null,-1))]),o[17]||(o[17]=g("div",{"data-sve-code-split":"","data-sve-code-split-after":"html"},null,-1)),g("div",zi,[g("div",Hi,[g("div",Ri,[g("span",ji,A(t.cssLabel),1),o[10]||(o[10]=g("button",{type:"button","data-sve-css-add-class":""},null,-1)),o[11]||(o[11]=g("div",{"data-sve-css-tools":""},null,-1))])]),o[12]||(o[12]=g("div",{"data-sve-css-head":""},null,-1)),o[13]||(o[13]=g("div",{"data-sve-code-host":""},null,-1)),o[14]||(o[14]=g("div",{"data-sve-tw-host":""},null,-1))]),o[18]||(o[18]=g("div",{"data-sve-code-split":"","data-sve-code-split-after":"css"},null,-1)),g("div",Ni,[g("div",Wi,[g("span",null,A(t.alpineLabel),1)]),o[15]||(o[15]=g("div",{"data-sve-alpine-host":""},null,-1))]),o[19]||(o[19]=g("div",{"data-sve-code-split":"","data-sve-code-split-after":"alpine"},null,-1)),g("div",qi,[g("div",Vi,[g("span",null,A(t.jsLabel),1)]),o[16]||(o[16]=g("div",{"data-sve-code-host":""},null,-1))])])]))}},en="view:",on="partials/";function ds(t){const e=String(t||"");if(!e.startsWith(en))return null;const o=e.slice(en.length);return o.startsWith(on)?o.slice(on.length):o}function Ki(t){const e=String(t||"").match(/\sclass\s*=\s*(["'])([\s\S]*?)\1/i);return e?e[2].replace(/\{\{[\s\S]*?\}\}/g,"\0").split(/[\s[\]]+/).filter(o=>o&&!o.includes("\0")&&/^[A-Za-z_][\w:./%!#-]*$/.test(o)):[]}const Gi=t=>globalThis.CSS?.escape?globalThis.CSS.escape(t):t.replace(/([^\w-])/g,"\\$1");function us(t){const e=Ce(t)[0];if(!e)return null;const o=Ki(String(t).slice(e.from,e.openTo));return!o.length&&!/^(header|footer|main|nav|aside|figure|form|table)$/.test(e.tag)?null:e.tag+o.map(n=>`.${Gi(n)}`).join("")}const qt=new Map;let Nt=null,nn=0,sn=0,rn=!1;async function Xi(t,e){if(qt.has(e))return qt.get(e);const o=`view:partials/${e}`;let n=null;try{const s=await t.fetch(`/!/sve/section-template?type=${encodeURIComponent(o)}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}});if(s.ok){const r=await s.json();n=typeof r.html=="string"?us(r.html):null}}catch{}return qt.set(e,n),n}function Zi(t){t?qt.delete(t):qt.clear()}function fs(t){const e=ds(St("dock:current-type")),o=e?St("dock:html"):"",n=e&&typeof o=="string"?us(o):null;Fn({source:Kn,type:Un.SVE_COMPONENT_FOCUS,on:!!n,name:e?String(e).split("/").pop():"",selector:n||""},t)}async function _o(t){const e=++sn,o=St("dock:html"),n=[...new Set((typeof o=="string"?Hn(o):[]).map(r=>r.src).filter(r=>r&&!da(r)))],s=await Promise.all(n.map(r=>Xi(t,r)));e===sn&&Fn({source:Kn,type:Un.SVE_COMPONENT_MAP,items:n.map((r,i)=>({src:r,name:r.split("/").pop(),selector:s[i]})).filter(r=>r.selector)},t)}function Yi(t){Nt=t,!rn&&(rn=!0,$e("dock:html-changed",()=>{Nt&&(Zi(ds(St("dock:current-type"))),Nt.clearTimeout(nn),nn=Nt.setTimeout(()=>{_o(Nt)},400))}))}const Ji=["data-sve-html-tool","data-tip","aria-label","data-letter","onClick","onContextmenu"],Qi=["innerHTML"],tl={__name:"CodeDockHtmlTools",props:{tools:{type:Array,required:!0},onTool:{type:Function,required:!0}},setup(t){return(e,o)=>(x(!0),k(D,null,U(t.tools,n=>(x(),k("button",{key:n.id,type:"button","data-sve-html-tool":n.id,"data-tip":n.title,"aria-label":n.title,"data-letter":n.letter?"":void 0,onClick:I(s=>t.onTool(n.id),["prevent","stop"]),onContextmenu:I(s=>t.onTool(n.id),["prevent"])},[n.letter?(x(),k(D,{key:0},[In(A(n.letter),1)],64)):(x(),k("span",{key:1,innerHTML:n.icon},null,8,Qi))],40,Ji))),128))}},ft=po({tools:[],onTool:null,onKid:null}),el=["data-sve-css-item"],ol=["data-sve-css-tool","data-tip","aria-label","innerHTML","onClick","onContextmenu"],nl={key:0,"data-sve-css-kids":""},sl={key:0,"data-sve-css-sep":"","aria-hidden":"true"},rl=["data-sve-css-kid","data-sve-css-box-side","data-tip","aria-label","innerHTML","onClick","onContextmenu"],al={__name:"CodeDockCssTools",setup(t){return(e,o)=>(x(!0),k(D,null,U(T(ft).tools,n=>(x(),k("li",Ve({key:n.id,"data-sve-css-item":n.id},{ref_for:!0},n.open?{"data-sve-css-open":""}:{}),[g("button",Ve({type:"button","data-sve-css-tool":n.id,"data-tip":n.title,"aria-label":n.title},{ref_for:!0},{...n.active?{"data-active":""}:{},...n.open?{"data-open":""}:{}},{innerHTML:n.icon,onClick:I(s=>T(ft).onTool?.(n.id),["prevent","stop"]),onContextmenu:I(s=>T(ft).onTool?.(n.id),["prevent"])}),null,16,ol),n.open&&n.kids.length?(x(),k("div",nl,[(x(!0),k(D,null,U(n.kids,s=>(x(),k(D,{key:s.id},[s.sep?(x(),k("span",sl)):j("",!0),g("button",Ve({type:"button","data-sve-css-kid":s.id,"data-sve-css-box-side":s.id,"data-tip":s.title,"aria-label":s.title},{ref_for:!0},s.active?{"data-active":""}:{},{innerHTML:s.icon,onClick:I(r=>T(ft).onKid?.(n.id,s.id),["prevent","stop"]),onContextmenu:I(r=>T(ft).onKid?.(n.id,s.id),["prevent"])}),null,16,rl)],64))),128))])):j("",!0)],16,el))),128))}},il=1.5,ll=16;function me(t,e){const o=parseFloat(t);return Number.isFinite(o)?e==="em"||e==="rem"?o*ll:o:null}function cl(t){const e=String(t||"").toLowerCase();if(/\bmin-width\b|\bwidth\s*>=?/.test(e))return null;let o=e.match(/\bmax-width\s*:\s*([\d.]+)(px|em|rem)/);return o||(o=e.match(/\bwidth\s*<=?\s*([\d.]+)(px|em|rem)/),o)?me(o[1],o[2]):(o=e.match(/([\d.]+)(px|em|rem)\s*>=?\s*width\b/),o?me(o[1],o[2]):null)}function ht(t,e){const o=cl(t);if(o===null)return"";for(const n of e||[]){if(n.base)continue;const s=me(String(n.max||"").replace(/[a-z]+$/i,""),(String(n.max||"").match(/[a-z]+$/i)||[""])[0]);if(s!==null&&Math.abs(s-o)<=il)return n.handle}return""}function Me(t){let e="",o=0;for(;o<t.length;){const n=Ee(t,o);if(n!==o){e+=" ".repeat(n-o),o=n;continue}e+=t[o],o+=1}return e}function Ee(t,e){if(t.startsWith("/*",e)){const o=t.indexOf("*/",e+2);return o===-1?t.length:o+2}if(t.startsWith("{{",e)){const o=t.indexOf("}}",e+2);return o===-1?t.length:o+2}if(t[e]==='"'||t[e]==="'"){const o=t[e];for(let n=e+1;n<t.length;n+=1)if(t[n]==="\\")n+=1;else if(t[n]===o)return n+1;return t.length}return e}function Be(t){const e=String(t||""),o=[],n=(s,r,i=0)=>{let l=s,c=l;for(;l<r;){const d=Ee(e,l);if(d!==l){l=d;continue}if(e[l]===";"){l+=1,c=l;continue}if(e[l]==="}")return;if(e[l]!=="{"){l+=1;continue}const h=Me(e.slice(c,l)),f=h.trim(),p=hs(e,l,r);if(p===-1)return;/^@media\b/i.test(f)?o.push({query:f.replace(/^@media\s*/i,"").trim(),from:c+h.search(/\S/),to:p+1,bodyFrom:l+1,bodyTo:p,depth:i}):/^@(?:import|charset|use)\b/i.test(f)||n(l+1,p,i+1),l=p+1,c=l}};return n(0,e.length,0),o}function hs(t,e,o){let n=0;for(let s=e;s<o;s+=1){const r=Ee(t,s);if(r!==s){s=r-1;continue}if(t[s]==="{")n+=1;else if(t[s]==="}"&&(n-=1,n===0))return s}return-1}function Dt(t){const e=String(t||""),o=(n,s)=>{const r=[];let i=n,l=i;for(;i<s;){const c=Ee(e,i);if(c!==i){i=c;continue}if(e[i]===";"){i+=1,l=i;continue}if(e[i]==="}")return r;if(e[i]!=="{"){i+=1;continue}const d=Me(e.slice(l,i)),h=d.trim(),f=hs(e,i,s);if(f===-1)return r;r.push({prelude:h,media:/^@media\b/i.test(h),query:h.replace(/^@media\s*/i,"").trim(),from:l+d.search(/\S/),to:f+1,bodyFrom:i+1,bodyTo:f,children:/^@(?:import|charset|use)\b/i.test(h)?[]:o(i+1,f)}),i=f+1,l=i}return r};return o(0,e.length)}function dl(t,e,o){const n=String(t||"");if(!o)return[];const s=(e||[]).find(d=>d.base),r=Dt(n),i=[],l=d=>d.media?ht(d.query,e)===o:d.children.some(l);if(s&&o===s.handle){const d=h=>{for(const f of h){if(f.media&&ht(f.query,e)){i.push({from:f.from,to:f.to});continue}d(f.children)}};return d(r),i}const c=(d,h,f)=>{const p=[];for(const b of d){if(b.media&&ht(b.query,e)===o){p.push({from:b.from,to:b.to,into:null});continue}l(b)&&p.push({from:b.from,to:b.to,into:b})}if(!p.length){f>h&&i.push({from:h,to:f});return}let y=h;for(const b of p)b.from>y&&i.push({from:y,to:b.from}),b.into&&c(b.into.children,b.into.bodyFrom,b.into.bodyTo),y=b.to;f>y&&i.push({from:y,to:f})};return c(r,0,n.length),i.filter(d=>n.slice(d.from,d.to).trim()!=="")}function ul(t,e){const o=String(t||""),n=[],s=i=>{for(const l of i){if((l.media&&ht(l.query,e)||/^#id-/.test(l.prelude))&&Me(o.slice(l.bodyFrom,l.bodyTo)).trim()===""){n.push(l);continue}s(l.children)}};if(s(Dt(o)),!n.length)return o;let r=o;for(const i of n.sort((l,c)=>c.from-l.from)){let l=i.from,c=i.to;const d=r.lastIndexOf(`
`,l-1)+1;for(r.slice(d,l).trim()===""&&(l=d);r[c]===" "||r[c]==="	";)c+=1;r[c]===`
`&&(c+=1),r=r.slice(0,l)+r.slice(c)}return r}function fl(t,e){const o=String(t||""),n=[],s=i=>Me(o.slice(i.bodyFrom,i.bodyTo)).trim()==="",r=i=>{for(const l of i){if((l.media&&ht(l.query,e)||/^#id-/.test(l.prelude))&&s(l)){n.push({from:l.from,to:l.to});continue}r(l.children)}};return r(Dt(o)),n}function be(t,e,o){const n=e||[],s=n.find(d=>d.base),r=[],i=d=>/^#id-/.test(d.prelude)||/^#\s*$/.test(d.prelude),l=(d,h)=>{for(const f of d){if(!f.media){l(f.children,h);continue}const p=ht(f.query,n)||h;if(o===p){r.push(f);continue}l(f.children,p)}},c=(d,h)=>{for(const f of d){if(f.media){c(f.children,ht(f.query,n)||h);continue}if(i(f)){const p=h||(s?s.handle:"");!o||o===p?r.push(f):l(f.children,p);continue}c(f.children,h)}};return c(Dt(String(t||"")),""),r.sort((d,h)=>d.from-h.from)}function $o(t,e,o){return Be(t).filter(n=>ht(n.query,e)===o)}const F=po({tag:"",scope:"",onTag:null,sizes:[],onSize:null,state:"",stateLabel:"",onState:null,canEdit:!1,note:""}),hl={class:"sve-css-head"},pl=["disabled"],ml={key:1,class:"sve-css-scope"},gl=["title","data-active","disabled","onClick"],vl=["data-active","disabled"],yl={key:2,class:"sve-css-note"},bl={__name:"CodeDockCssHead",setup(t){return(e,o)=>(x(),k("div",hl,[T(F).tag?(x(),k("button",{key:0,type:"button",class:"sve-css-tag",disabled:!T(F).canEdit,onClick:o[0]||(o[0]=I(()=>{},["prevent","stop"])),onDblclick:o[1]||(o[1]=I(n=>T(F).onTag?.(n),["prevent","stop"]))},"<"+A(T(F).tag)+">",41,pl)):j("",!0),T(F).scope?(x(),k("span",ml,A(T(F).scope),1)):j("",!0),(x(!0),k(D,null,U(T(F).sizes,n=>(x(),k("button",{key:n.key,type:"button","data-sve-css-size":"",title:n.title,"data-active":n.active?"":void 0,disabled:!T(F).canEdit,onClick:I(s=>T(F).onSize?.(n.key),["prevent","stop"])},A(n.label),9,gl))),128)),g("button",{type:"button","data-sve-css-state":"","data-active":T(F).state?"":void 0,disabled:!T(F).canEdit,onClick:o[2]||(o[2]=I(n=>T(F).onState?.(n),["prevent","stop"]))},[In(A(T(F).stateLabel)+" ",1),o[3]||(o[3]=g("svg",{width:"8",height:"8",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"3","stroke-linecap":"round","stroke-linejoin":"round"},[g("path",{d:"m6 9 6 6 6-6"})],-1))],8,vl),o[4]||(o[4]=g("span",{class:"sve-css-gap"},null,-1)),T(F).note?(x(),k("span",yl,A(T(F).note),1)):j("",!0)]))}},xl=On(bl,[["__scopeId","data-v-43bc76ce"]]),kl={key:0,"data-sve-css-swatches":""},Sl=["data-sve-css-token","title","data-active","onClick"],wl={key:0,"data-sve-css-head-row":""},_l={key:1,"data-sve-css-note-row":""},$l=["data-sve-css-token","data-active","onClick"],Cl={"data-sve-css-choice-label":""},Tl={key:0,"data-sve-css-choice-hint":""},ot={__name:"CodeDockMenu",props:{kind:{type:String,required:!0},swatches:{type:Array,default:()=>[]},choices:{type:Array,default:()=>[]},onClear:{type:Function,default:null},onPick:{type:Function,required:!0}},setup(t){return(e,o)=>t.kind==="colors"?(x(),k("div",kl,[g("button",{type:"button","data-sve-css-clear":"",title:"Clear",onClick:o[0]||(o[0]=I((...n)=>t.onClear&&t.onClear(...n),["prevent","stop"]))},[...o[1]||(o[1]=[g("svg",{width:"10",height:"10",viewBox:"0 0 10 10",fill:"none",stroke:"currentColor","stroke-width":"1.5"},[g("path",{d:"M2 2l6 6M8 2L2 8"})],-1)])]),(x(!0),k(D,null,U(t.swatches,n=>(x(),k("button",{key:n.name,type:"button","data-sve-css-swatch":"","data-sve-css-token":n.name,title:n.name,"data-active":n.active?"":void 0,style:Ir({background:n.hex||"transparent"}),onClick:I(s=>t.onPick(n.name),["prevent","stop"])},null,12,Sl))),128))])):(x(!0),k(D,{key:1},U(t.choices,n=>(x(),k(D,{key:n.value},[n.heading?(x(),k("span",wl,A(n.label),1)):n.note?(x(),k("span",_l,A(n.label),1)):(x(),k("button",{key:2,type:"button","data-sve-css-choice":"","data-sve-css-token":n.token||void 0,"data-active":n.active?"":void 0,onClick:I(s=>t.onPick(n.value),["prevent","stop"])},[g("span",Cl,A(n.label),1),n.hint?(x(),k("span",Tl,A(n.hint),1)):j("",!0)],8,$l))],64))),128))}},Al=/^\.[a-zA-Z_][\w-]*$/;function Ml(t,e,o){return String(e||"").includes(o)?xe(t).length===1:!1}function xe(t){return Dt(t).filter(e=>/^@scope\b/i.test(e.prelude))}function El(t){const e=String(t||"");return Dt(e).filter(o=>Al.test(o.prelude)?!e.slice(o.from,o.bodyFrom-1).includes("{{"):!1).map(o=>({from:o.from,to:o.to,name:o.prelude.slice(1)}))}function Bl(t,e,o){const n=String(t||"");if(!Ml(n,e,o))return n;const s=El(n);if(!s.length)return n;const r=xe(n)[0],i=Il(n,r),l=s.map(p=>Ol(n.slice(p.from,p.to),n,p.from,i)).join(`

`);let c=n;for(const p of[...s].sort((y,b)=>b.from-y.from))c=Fl(c,p.from,p.to);const d=Ll(c,o);if(d===-1)return n;const h=(c.slice(0,d).match(/\n([^\S\n]*)$/)||[null,null])[1],f=h===null?d:d-h.length;return`${c.slice(0,f)}
${l}
${h??""}${c.slice(d)}`}function Ll(t,e){const o=xe(t).find(n=>n.prelude.includes(e));return o?o.bodyTo:xe(t)[0]?.bodyTo??-1}function Fl(t,e,o){let n=e,s=o;const r=t.lastIndexOf(`
`,n-1)+1;for(t.slice(r,n).trim()===""&&(n=r);t[s]===" "||t[s]==="	";)s+=1;return t[s]===`
`&&(s+=1),t.slice(0,n)+t.slice(s)}function Il(t,e){const o=t.slice(e.bodyFrom,e.bodyTo).match(/\n([^\S\n]+)\S/);return o?o[1]:`${(t.slice(0,e.from).match(/\n([^\S\n]*)$/)||[null,""])[1]}    `}function Ol(t,e,o,n){const s=(e.slice(0,o).match(/\n([^\S\n]*)$/)||[null,""])[1];return t.split(`
`).map((r,i)=>i===0?n+r.trim():r.startsWith(s)?n+r.slice(s.length):n+r.trimStart()).join(`
`)}const Pl={"data-sve-css-add-label":""},Dl=["placeholder","onKeydown"],Co={__name:"CodeDockAddClass",props:{label:{type:String,required:!0},placeholder:{type:String,default:""},initial:{type:String,default:""},onAdd:{type:Function,required:!0}},setup(t){const e=t,o=ut(e.initial||""),n=ut(null);En(()=>Je(()=>{n.value?.focus(),n.value?.select()}));function s(){const r=o.value.trim();if(!r){n.value?.focus();return}e.onAdd(r)}return(r,i)=>(x(),k(D,null,[g("label",Pl,A(t.label),1),Bn(g("input",{ref_key:"input",ref:n,"data-sve-css-add-input":"","onUpdate:modelValue":i[0]||(i[0]=l=>o.value=l),type:"text",placeholder:t.placeholder,onKeydown:[Bt(I(s,["prevent"]),["enter"]),i[1]||(i[1]=Bt(I(()=>{},["stop"]),["escape"]))]},null,40,Dl),[[Ln,o.value]])],64))}};function an(t,e){e._sveLockBound||(e._sveLockBound=!0,e.querySelector("[data-sve-code-lock]")?.addEventListener("click",o=>{if(o.preventDefault(),o.stopPropagation(),!(!a.lockReady||!a.lastType)){if(a.lastLocked){Hl(t);return}ps(t,!0)}}))}function To(t){return t?tt(t,$r)!=="0":!0}function zl(){const t=v.html;return!t||t.state.readOnly||!a.lastType?!1:!Fo(Lo(),a.lastParts)}function lt(t){const e=t?.document.getElementById(u),o=e?.querySelector("[data-sve-code-autosave]"),n=e?.querySelector("[data-sve-code-save]");if(!o||!n)return;const s=To(t),r=zl();o.setAttribute("aria-pressed",s?"true":"false"),o.title=m(t,s?"code_dock_autosave_on":"code_dock_autosave_off"),o.setAttribute("aria-label",o.title),o.innerHTML=Mu,n.hidden=s,n.title=m(t,"code_dock_save"),n.setAttribute("aria-label",n.title),n.innerHTML=Eu,r?n.setAttribute("data-dirty",""):n.removeAttribute("data-dirty")}function ln(t,e){e._sveAutosaveBound||(e._sveAutosaveBound=!0,e.querySelector("[data-sve-code-autosave]")?.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const n=!To(t);K(t,$r,n?"1":"0"),n?J(t.document):a.saveTimer&&(clearTimeout(a.saveTimer),a.saveTimer=null),lt(t)}),e.querySelector("[data-sve-code-save]")?.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),J(t.document)}))}function Hl(t){t.document.getElementById(Z)?.remove();const e=Or(t.document,Pr,{title:m(t,"code_dock_unlock_title"),body:m(t,"code_dock_unlock_body"),buttons:[{value:"cancel",label:m(t,"cancel"),variant:"ghost"},{value:"ok",label:m(t,"code_dock_unlock_confirm"),variant:"primary"}],onPick:o=>{e.dismiss(),o==="ok"&&ps(t,!1)}});e.host.id=Z}function ps(t,e){const o=a.lastType;if(!o)return;const n=()=>{a.lastType===o&&t.fetch("/!/sve/section-template/lock",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":Pn(t),"X-Requested-With":"XMLHttpRequest"},body:JSON.stringify({type:o,locked:e})}).then(async s=>{if(!s.ok)throw new Error(String(s.status));a.lastType===o&&(a.lastLocked=e,It(t),oe(a.lastParts,e),X(t),R(t.document,e?m(t,"code_dock_locked"):""))}).catch(()=>{R(t.document,m(t,"code_dock_error"))})};if(e&&(J(t.document),a.saveInFlight)){a.saveInFlight.finally(n);return}n()}function ke(t){if(!a.lastUid||!a.lastType||String(a.lastType).startsWith("view:")){Vo(t);return}const e=zr(a.lastUid,t.document);Vo(t,e.length?{sectionUids:e}:void 0)}function Rl(t,e,o){return a.saveInFlight=t.fetch("/!/sve/section-template",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":Pn(t),"X-Requested-With":"XMLHttpRequest"},body:JSON.stringify({type:e,html:o.html,css:o.css,js:o.js,...typeof o.tw=="string"?{tw:o.tw}:{},...ua(t)?{props:a.lastProps}:{}})}).then(async n=>{if(n.status===423){a.lastLocked=!0,a.lockReady=!0,It(t),oe(a.lastParts,!0),X(t),R(t.document,m(t,"code_dock_locked"));return}const s=await n.json().catch(()=>({}));if(!n.ok)throw new Error(s?.error==="not_writable"?"not_writable":String(n.status));if(a.lastType===e){if(a.lastParts=o,s?.tw_written===!1){a.twDirty=!0,R(t.document,m(t,"code_dock_tw_not_writable")),lt(t),ke(t);return}R(t.document,m(t,"code_dock_saved")),lt(t),t.setTimeout(()=>{const r=t.document.getElementById(u)?.querySelector("[data-sve-code-status]");r&&r.textContent===m(t,"code_dock_saved")&&(r.textContent="")},1800)}ke(t),t.document.getElementById("__sve-section-picker")?.dispatchEvent(new t.CustomEvent("sve-library-stale"))}).catch(n=>{R(t.document,m(t,n?.message==="not_writable"?"code_dock_not_writable":"code_dock_error"))}).finally(()=>{a.saveInFlight=null}),a.saveInFlight}function J(t){a.saveTimer&&(clearTimeout(a.saveTimer),a.saveTimer=null);const e=a.lastType,o=a.lastWin,n=v.html;if(!n||n.state.readOnly||!e||!o||!a.lockReady)return;const s=Lo(),r=a.twCss!==null&&Rn(o)&&Ao(s.html)===a.twKey;Fo(s,a.lastParts)&&!(r&&a.twDirty)&&!a.propsDirty||(a.propsDirty=!1,r&&(s.tw=a.twCss,a.twDirty=!1),R(t,m(o,"code_dock_saving")),Rl(o,e,s))}function Ao(t){return Ma(t).sort().join(" ")}function jl(){a.twCss=null,a.twKey="",a.twDirty=!1}function Nl(t,e){a.twCss=e,a.twKey=Ao(t),a.twDirty=!1}function ms(t,e){if(!t||!Rn(t))return;const o=Ao(e);o===a.twKey||a.twBusy||(a.twBusy=!0,Dr(()=>import("./tw-compile-CV7No16T.js"),__vite__mapDeps([0,1]),import.meta.url).then(n=>n.compileTailwind(t,e)).then(n=>{a.twBusy=!1,a.twCss=n,a.twKey=o,a.twDirty=!0,gs(t,t.document)}).catch(n=>{a.twBusy=!1,console.error("[sve] tailwind compile",n)}))}function gs(t,e){a.saveTimer&&clearTimeout(a.saveTimer),a.saveTimer=t.setTimeout(()=>{a.saveTimer=null,J(e)},_u)}function nt(t){if(a.applying)return;const e=Lo();if(Fo(e,a.lastParts)){lt(t);return}if(lt(t),ms(t,e.html),!To(t)){R(t.document,m(t,"code_dock_unsaved"));return}R(t.document,m(t,"code_dock_saving")),gs(t,t.document)}function vs(t,e){let o=0;const n=Math.min(t.length,e.length);for(;o<n&&t[o]===e[o];)o+=1;let s=t.length,r=e.length;for(;s>o&&r>o&&t[s-1]===e[r-1];)s-=1,r-=1;return[o,s,e.slice(o,r)]}function ys(t){const e=a.lastUid,o=typeof G=="function"?G(t.document):[];for(const n of o){const s=pt(n.values)||n.values;if(!(!s||typeof s!="object")&&e&&typeof Uo=="function"){const r=Uo(s,e);if(r){const i=r.split("."),l=Hr(s,i.slice(0,2).join("."));if(l&&typeof l=="object")return l}}}for(const n of o){const s=pt(n.values)||n.values;if(s&&typeof s=="object")return s}return null}function bs(t,e){!e||e===a.lastType||(J(t.document),We(t,e,"push"))}function xs(t){const e=a.typeStack.pop();if(!e){Jt(t);return}J(t.document),We(t,e,"keep")}function It(t){const e=t.document.getElementById(u),o=e?.querySelector("[data-sve-code-lock]"),n=e?.querySelector("[data-sve-code-lock-banner]");if(!e||!o)return;const s=a.lastLocked;e.toggleAttribute("data-sve-code-locked",s),s&&(jn(t.document),rt(t.document),a.htmlPartialUi&&(a.htmlPartialUi.setHover(v.html,null),a.htmlPartialUi.setHover(v.css,null)),a.htmlClassTokenUi?.setHover(v.html,null)),o.hidden=!a.lockReady,o.setAttribute("aria-pressed",a.lastLocked?"true":"false"),o.title=m(t,a.lastLocked?"code_dock_unlock":"code_dock_lock"),o.setAttribute("aria-label",o.title),o.innerHTML=a.lastLocked?$u:Cu,n&&(n.textContent=m(t,"code_dock_locked_banner"))}function Qt(t){return t?tt(t,qe)!=="0":a.htmlScopePref}function Le(t,e,o){return t!=null&&e!=null&&t>=0&&e>t&&e<=o}function at(){const t=globalThis.document?.getElementById(u);t&&(t.__sveHtmlScope=a.htmlScopeActive&&a.htmlFocus?{full:a.htmlFull,from:a.htmlFocus.from,to:a.htmlFocus.to,css:a.cssFull}:null)}function Fe(){const t=v.html?.state.doc.toString()??"";if(!a.htmlScopeActive||!a.htmlFocus){a.htmlFull=t,at();return}if(a.htmlFocus.from<0||a.htmlFocus.from>a.htmlFull.length||a.htmlFocus.to<a.htmlFocus.from){a.htmlScopeActive=!1,a.htmlFull=t,a.htmlFocus=null,at();return}a.htmlFull=a.htmlFull.slice(0,a.htmlFocus.from)+t+a.htmlFull.slice(a.htmlFocus.to),a.htmlFocus={from:a.htmlFocus.from,to:a.htmlFocus.from+t.length},at()}function zt(){return Fe(),a.htmlScopeActive?a.htmlFull:v.html?.state.doc.toString()??a.lastParts.html??""}function Ie(){a.lastBracketNames=Te(zt()).map(t=>t.name)}function Ht(){a.lastCssSelectorNames=Yn(v.css?.state.doc.toString()??a.cssFull)}function ks(t,e){return Array.isArray(t)&&Array.isArray(e)&&t.length===e.length&&t.every((o,n)=>o===e[n])}function Wl(){const t=a.htmlScopeActive?Mo():zt(),e=Ae(t);e.length&&(a.cssFull=So(a.cssFull,ko(a.cssFull,e),e[0].className))}function Ss(t,e){a.cssFull=Ua(a.cssFull,t,e),Wl(),a.cssFull=Ka(a.cssFull,e,t)}function ql(t){if(a.applying||a.lastLocked||a.lastBracketNames==null)return;const e=Te(zt()).map(o=>o.name);ks(a.lastBracketNames,e)||(Ss(a.lastBracketNames,e),a.lastBracketNames=e,te(),Ht())}function Vl(){if(a.applying||a.lastLocked||a.lastCssSelectorNames==null||a.lastBracketNames==null||a.cssPane==="empty")return;const t=v.html,e=Yn(v.css?.state.doc.toString()??"");if(!t||ks(a.lastCssSelectorNames,e))return;const o=new Set(a.lastBracketNames),{renamed:n,removed:s}=Jn(a.lastCssSelectorNames,e);let r=t.state.doc.toString();const i=r;for(const l of n){const c=wt(l.to);!o.has(l.from)||!c||(r=Jo(r,d=>d===l.from?c:d))}for(const l of s)!o.has(l)||e.includes(l)||(r=Jo(r,c=>c===l?"":c));if(r!==i){a.applying=!0;try{Pe(r)}finally{a.applying=!1}}Ie(),a.lastCssSelectorNames=e}function Ul(t,e){const o=wt(e),n=v.html;if(!o||!n||n.state.readOnly||o===t.name)return;a.applying=!0;try{n.dispatch({changes:{from:t.from,to:t.to,insert:o}})}finally{a.applying=!1}const s=a.lastBracketNames==null?[]:a.lastBracketNames.slice();Ie(),Ss(s,a.lastBracketNames),te(),Ht(),a.lastWin&&(nt(a.lastWin),P(a.lastWin))}function Kl(t,e){const o=t.document,s=v.html?.coordsAtPos(e.from);w(o),rt(o);const r=o.createElement("div"),i={getBoundingClientRect:()=>({left:s?.left??12,right:s?.right??12,top:s?.top??12,bottom:s?.bottom??12,width:0,height:0})};r.id=$,o.body.appendChild(r),W(t,i,r),r._sveApp=q(Co,r,{label:m(t,"code_dock_css_rename_class"),placeholder:m(t,"code_dock_css_class_placeholder"),initial:e.name,onAdd:l=>{Ul(e,l),w(o)}})}function ws(){return a.htmlScopePref&&Le(a.htmlFocus?.from,a.htmlFocus?.to,a.htmlFull.length)?(a.htmlScopeActive=!0,at(),a.htmlFull.slice(a.htmlFocus.from,a.htmlFocus.to)):(a.htmlScopeActive=!1,at(),a.htmlFull)}function Oe(t,e,o){const n=v[t];if(!n)return;const s=n.state.doc.toString();a.applying=!0;try{if(s!==e){const[r,i,l]=vs(s,e);n.dispatch({changes:{from:r,to:i,insert:l},...o?{selection:o,scrollIntoView:!0}:{}})}else o&&n.dispatch({selection:o,scrollIntoView:!0})}finally{a.applying=!1}}function Pe(t,e){Oe("html",t,e)}function Mo(){return a.htmlScopeActive?v.html?.state.doc.toString()??"":Le(a.htmlFocus?.from,a.htmlFocus?.to,a.htmlFull.length)?a.htmlFull.slice(a.htmlFocus.from,a.htmlFocus.to):""}function dt(){const t=v.css?.state.doc.toString()??"";if(a.cssPane==="tree"){if(t===a.cssScopeSnapshot)return;const e=Ae(Mo())[0]?.className||es(t);a.cssFull=So(a.cssFull,t,e),a.cssScopeSnapshot=t}else a.cssPane==="full"&&(a.cssFull=t)}function _s(t,e){for(const o of e||[])if(!Y(t,o.className)||_s(t,o.children))return!0;return!1}function te(){let t=a.cssFull,e=[],o=!1;a.cssValues||!a.htmlScopePref||!a.htmlScopeActive?(a.cssPane="full",t=a.cssFull):(e=Ae(Mo()),e.length?(a.cssPane="tree",t=ko(a.cssFull,e),_s(a.cssFull,e)&&(a.cssFull=So(a.cssFull,t,e[0].className),o=!0)):(a.cssPane="empty",t="")),a.cssScopeSnapshot=t,Oe("css",t),Ht(),a.lastWin&&(se(a.lastWin,!0),P(a.lastWin),o&&nt(a.lastWin))}function Eo(t){const e=v.html;if(!e||!a.htmlFocus)return;a.htmlScopeActive||(a.htmlFull=e.state.doc.toString());const o=a.htmlFull.length,n=Math.max(0,Math.min(a.htmlFocus.from,o)),s=Math.max(n,Math.min(a.htmlFocus.to,o));if(s<=n)return;a.htmlFocus={from:n,to:s},a.htmlScopeActive=!0,at();const r=t==null?0:Math.max(0,Math.min(t-n,s-n));Pe(a.htmlFull.slice(n,s),{anchor:r,head:r}),te(),e.focus()}function Bo(t=!0,e=null){const o=v.html;if(!o)return;dt(),Fe(),a.htmlScopeActive=!1,at();const n=a.htmlFull||o.state.doc.toString(),s=e!=null?{anchor:Math.max(0,Math.min(e,n.length))}:t&&Le(a.htmlFocus?.from,a.htmlFocus?.to,n.length)?{anchor:a.htmlFocus.from,head:a.htmlFocus.to}:null;a.htmlFull=n,Pe(n,s),a.cssPane="full",a.cssScopeSnapshot=a.cssFull,Oe("css",a.cssFull),Ht()}function De(){a.htmlFocus=null,a.htmlScopeActive=!1,a.htmlFull="",a.cssFull="",a.cssPane="full",a.cssScopeSnapshot="",a.lastBracketNames=null,a.lastCssSelectorNames=null,at()}let Gt=!1;function Ft(t){return!!t?.document.getElementById(zn)}function eo(t,e){if(!(!t||mo(t,"html_tree")===!1)){if(!e){Ft(t)&&Dn(t);return}Ft(t)||(Gt=!0,Rr("html_tree").then(()=>{Ft(t)||jr(t)}).catch(()=>{}).finally(()=>{Gt=!1,X(t)}))}}function X(t){const e=t?.document.getElementById(u)?.querySelector("[data-sve-html-scope]");if(!e)return;a.htmlScopePref=Qt(t);const o=mo(t,"html_tree")===!1?a.htmlScopePref:Ft(t)||Gt;e.setAttribute("aria-pressed",o?"true":"false"),e.title=m(t,o?"code_dock_html_scope_off":"code_dock_html_scope"),e.setAttribute("aria-label",e.title),e.innerHTML=Ar,t.document.getElementById(u)?.toggleAttribute("data-sve-html-scoped",a.htmlScopeActive),at()}function cn(t,e){e._sveHtmlScopeBound||(e._sveHtmlScopeBound=!0,a.htmlScopePref=Qt(t),Gl(t,e),eo(t,a.htmlScopePref),e.querySelector("[data-sve-html-scope]")?.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const n=Ft(t)||Gt;a.htmlScopePref=!n,K(t,qe,a.htmlScopePref?"1":"0"),a.htmlScopePref?a.htmlFocus&&(dt(),Eo()):a.htmlScopeActive&&Bo(),eo(t,a.htmlScopePref),X(t)}))}function Gl(t,e){e._sveTreeWatchBound||(e._sveTreeWatchBound=!0,t.addEventListener("sve-right-dock-change",()=>{if(Gt||mo(t,"html_tree")===!1||!t.document.getElementById(u))return;const o=Ft(t);o!==Qt(t)&&(a.htmlScopePref=o,K(t,qe,o?"1":"0"),o?a.htmlFocus&&(dt(),Eo()):a.htmlScopeActive&&Bo(),X(t))}))}const Xl=new Set(["pre","textarea","script","style"]),Zl=/^(<\/|\{\{\s*\/)/;function Yl(t){let e=0;for(const o of t.split(`
`)){if(!o.trim())continue;const n=o.length-o.trimStart().length;n>0&&(e===0||n<e)&&(e=n)}return" ".repeat(e===2||e===3?e:4)}function Jl(t){const e=String(t||"");if(!e.trim())return e;const o=[],n=l=>{for(const c of l||[])o.push(c),n(c.children)};n(fa(e));const s=Yl(e),r=[];let i=0;for(const l of e.split(`
`)){const c=i,d=l.trim();if(i+=l.length+1,!d){r.push("");continue}const h=c+(l.length-l.trimStart().length),f=o.filter(y=>y.from<h&&h<y.to);if(f.some(y=>Xl.has(y.tag))){r.push(l);continue}const p=f.length-(Zl.test(d)?1:0);r.push(s.repeat(Math.max(p,0))+d)}return r.join(`
`)}function $s(t,e){if(t.startsWith("{{",e)){const o=t.indexOf("}}",e+2);return o===-1?t.length:o+2}if(t.startsWith("<!--",e)){const o=t.indexOf("-->",e+4);return o===-1?t.length:o+3}return e}function oo(t,e){if(t[e]!=="<")return null;const o=t.indexOf(">",e+1);if(o===-1)return null;const n=t.slice(e,o+1),s=n.match(/^<\/([A-Za-z][A-Za-z0-9:-]*)\s*>/);if(s)return{kind:"close",name:s[1].toLowerCase(),from:e,to:o+1};const r=n.match(/^<([A-Za-z][A-Za-z0-9:-]*)/);if(!r)return{kind:"other",from:e,to:o+1};const i=r[1].toLowerCase();return{kind:/\/\s*>$/.test(n)||["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"].includes(i)?"void":"open",name:i,from:e,to:o+1}}function dn(t,e,o){let n=1,s=o;for(;s<t.length;){const r=$s(t,s);if(r!==s){s=r;continue}if(t[s]!=="<"){s+=1;continue}const i=oo(t,s);if(!i)break;if(i.kind==="open"&&i.name===e)n+=1;else if(i.kind==="close"&&i.name===e&&(n-=1,n===0))return i;s=i.to}return null}function ee(){const t=v.html;if(!t)return null;const e=t.state.selection.main.head,o=t.state.doc.toString(),n=[];let s=0;for(;s<e;){const c=$s(o,s);if(c!==s){s=c;continue}if(o[s]!=="<"){s+=1;continue}const d=oo(o,s);if(!d||d.from>=e)break;if(d.kind==="open")n.push(d);else if(d.kind==="close"){for(let h=n.length-1;h>=0;h-=1)if(n[h].name===d.name){n.splice(h);break}}s=d.to}const r=o.lastIndexOf("<",Math.max(0,e-1));if(r!==-1&&o.indexOf(">",r)>=e){const c=oo(o,r);if(c?.kind==="open"||c?.kind==="void"){const d=c.kind==="void"?null:dn(o,c.name,c.to);return d?{name:c.name,open:c,close:d}:{name:c.name,open:c,close:null}}}const i=n[n.length-1];if(!i)return null;const l=dn(o,i.name,i.to);return{name:i.name,open:i,close:l}}function no(t){return Mr.includes(t)}function V(){v.html?.focus(),a.lastWin&&(nt(a.lastWin),ze(a.lastWin))}function bt(t,e,o){const n=[...e].sort((s,r)=>r.from-s.from||r.to-s.to);t.dispatch({changes:n,selection:o})}function Ot(t,e,o){const n=v.html;if(!n||n.state.readOnly)return;const s=n.state.selection.main.head,r=n.state.doc.lineAt(s),i=r.text.slice(0,s-r.from),l=r.text.trim()?ct(r.text):Re(n,r)||ct(r.text);let c=t,d=0;if(i.trim()!=="")c=`
${l}${t}`,d=1+l.length;else if(!r.text.trim()){c=`${l}${t}`,d=l.length,n.dispatch({changes:{from:r.from,to:r.to,insert:c},selection:un(r.from+d+e,o)});return}n.dispatch({changes:{from:s,to:n.state.selection.main.to,insert:c},selection:un(s+d+e,o)})}function un(t,e){return e?{anchor:t,head:t+e}:{anchor:t}}const Ql=new Set(["section","article","header","footer","main","nav","aside"]);function fn(t){if(t!=="section")return`<${t}>`;const e=a.lastWin?.Statamic?.$config?.get?.("sveSectionTag");return typeof e=="string"&&e.trim()?`<${t} ${e.trim()}>`:`<${t}>`}function Cs(){const t=v.html;if(!t||t.state.readOnly)return;const e=t.state.doc.toString(),o=(e.match(/^[ \t]*/)||[""])[0],n=Jl(e).split(`
`).map(s=>s&&o+s).join(`
...
`,e-1)+1;return(t.slice(o,e).match(/^\s*/)||[""])[0]}function Q(t){const e=v.css;if(!e||e.state.readOnly||!t.length)return;const o=He(),n=t.some(l=>l.value!=null)?cc(e,o):o;if(!n){const l=t.filter(c=>c.value!=null).map(c=>`${c.property}: ${c.value};`).join(`
`);l&&fc(l),mn();return}const s=[],r=[],i=Ls(e,n);for(const l of t){const c=ac(e,n,l.property);if(l.value==null){if(!c)continue;let d=c.from,h=c.to;e.state.doc.sliceString(h,h+1)===`
...
`)}
${h}`})}s.length&&(s.sort((l,c)=>c.from-l.from||c.to-l.to),e.dispatch({changes:s})),mn()}function et(){const t=v.css,e=He();if(!e)return{};if(a.cssState&&t){const o=Is(t,e);return o?pn(o.text):{}}return pn(e.text)}function Is(t,e){const o=Fs(t,e),n=Ne();if(!o||o.startsWith("@"))return null;if(o.endsWith(n))return e;const s=t.state.doc.toString(),r=i=>{const l=Pt(s,i);return l===-1?null:{from:i+1,to:l,text:s.slice(i+1,l),open:i}};for(const i of[`&${n}`,`${o}${n}`]){const l=new RegExp(`(^|[^\\w-])${i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}\\s*\\{`,"g");let c;for(;c=l.exec(s);){const d=s.indexOf("{",c.index);if(i.startsWith("&")&&(d<e.from||d>e.to))continue;const h=r(d);if(h)return h}}return null}function dc(t){const e=et(),o=Xt(e.display),n=z(e["flex-direction"])||(o?"row":"");if(o&&n===t){const s=[];e["flex-direction"]&&s.push({property:"flex-direction",value:null}),Xt(e.display)&&s.push({property:"display",value:null}),Q(s);return}Q([{property:"display",value:"flex"},{property:"flex-direction",value:t}])}function uc(t){const e=et();if(t==="flex"&&Xt(e.display)){Q([{property:"justify-content",value:null},{property:"align-items",value:null},{property:"flex-direction",value:null},{property:"display",value:null}]);return}Q([{property:"display",value:t}])}function fc(t){const e=v.css;if(!e||e.state.readOnly)return;const o=e.state.selection.main.head,n=e.state.doc.lineAt(o),s=n.text.slice(0,o-n.from),r=n.text.slice(o-n.from),i=lc(e,o),l=t.replace(/;?$/,";");if(s.trim()===""&&r.trim()===""){const d=`${i}${l}
${i}`;e.dispatch({changes:{from:n.from,to:n.to,insert:d},selection:{anchor:n.from+d.length}});return}const c=`
${i}${l}
${i}`;e.dispatch({changes:{from:o,to:e.state.selection.main.to,insert:c},selection:{anchor:o+c.length}})}function P(t){try{hc(t),re(t)}catch{}}function hc(t){const e=a.styleMode==="tw",o=e?{}:et(),n=Xt(e?Xo("display"):o.display),s=z(o["flex-direction"])||(n?"row":""),r=i=>e?ga()&&!!i.tw&&!!Xo(i.tw):!!i.css&&i.css in o;ft.tools=Br.map(i=>{const l=(i.kids||[]).filter(c=>c.when!=="flex"||n).map(c=>({id:c.id,title:c.title,icon:Mn[c.icon]||"",sep:!!c.sep,open:a.cssOpenMenu===c.id,active:e?r(c):c.kind==="display"?n:c.kind==="flexDir"?n&&s===c.value:c.value?z(o[c.css])===z(c.value):r(c)}));return{id:i.id,title:i.title,icon:Mn[i.id]||Fu[i.id]||"",open:a.cssOpenTool===i.id||a.cssOpenMenu===i.id,kids:l,active:i.value?!e&&z(o[i.css])===z(i.value):r(i)||l.some(c=>c.active)}})}function w(t){const e=t?.getElementById($);a.cssOpenMenu="",e?._sveApp?.unmount(),e?.remove(),t?.querySelectorAll("[data-sve-css-tool][data-open], [data-sve-html-tool][data-open], [data-sve-css-add-class][data-open], [data-sve-code-history][data-open]").forEach(o=>o.removeAttribute("data-open"))}function lf(t){w(t),kt(t),rt(t);for(const e of it)v[e]&&pr?.(v[e])}function Os(t){if(a.cssColorsPromise)return a.cssColorsPromise;const e=t.Statamic?.$config?.get?.("cpUrl")||`/${t.Statamic?.$config?.get?.("cpRoute")||"cp"}`;return a.cssColorsPromise=t.fetch(`${e}/color-scheme/swatches`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(async o=>{if(!o.ok)return[];const n=await o.json().catch(()=>[]);return Array.isArray(n)?n:[]}).catch(()=>[]).then(o=>{const n=new Set,s=[];for(const r of o){const i=r.var||r.value||r.handle,l=String(i||"").trim().replace(/^var\((.+)\)$/,"$1");!l||n.has(l)||(n.add(l),s.push({name:l,hex:r.hex||r.color||""}))}for(const[r,i]of Er)n.has(r)||(n.add(r),s.push({name:r,hex:i}));return s}),a.cssColorsPromise}function Ps(t,e){const o=et()[e]||"",n=String(o).match(/^var\(\s*([^)]+?)\s*\)$/i),s=n?n[1].trim():"";for(const r of t.querySelectorAll("[data-sve-css-token]"))s&&r.getAttribute("data-sve-css-token")===s?r.setAttribute("data-active",""):r.removeAttribute("data-active")}function W(t,e,o){const n=e.getBoundingClientRect(),s=8;o.style.left=`${Math.max(s,Math.min(n.left,t.innerWidth-220))}px`,o.style.top=`${Math.max(s,n.bottom+4)}px`}function pc(t,e,o){const n=t.document;w(n),e.setAttribute("data-open","");const s=n.createElement("div");s.id=$,n.body.appendChild(s),W(t,e,s);const r=i=>{s._sveApp?.unmount(),s._sveApp=q(ot,s,{kind:"colors",swatches:i,onClear:()=>{Q([{property:o,value:null}]),w(n)},onPick:l=>{Q([{property:o,value:`var(${l})`}]),w(n)}}),Ps(s,o)};r(Er.map(([i,l])=>({name:i,hex:l}))),Os(t).then(i=>{n.getElementById($)&&r(i.map(l=>({name:l.name,hex:l.hex})))})}function mc(t,e,o,n){const s=t.document;w(s),e.setAttribute("data-open","");const r=s.createElement("div"),i=et()[o]||"";r.id=$,s.body.appendChild(r),W(t,e,r),r._sveApp=q(ot,r,{kind:"choices",choices:(n||[]).map(l=>({value:l,label:l,active:z(l)===z(i)})),onPick:l=>{const c=z(l)===z(et()[o]||"");Q([{property:o,value:c?null:l}]),w(s)}})}function gn(t,e,o,n=[]){const s=t.document;w(s),e.setAttribute("data-open",""),pa(t);const r=s.createElement("div");r.id=$,s.body.appendChild(r),W(t,e,r);const i=()=>{const l=[...n.map(d=>({value:d,label:d})),...ma(t,o).map(d=>({value:d.value,label:d.value}))],c=et()[o]||"";r._sveApp?.unmount(),r._sveApp=q(ot,r,{kind:"choices",choices:l.map(d=>({...d,active:z(d.value)===z(c)})),onPick:d=>{Q([{property:o,value:d||null}]),w(s)}})};i(),Os(t).then(()=>{s.getElementById($)===r&&i()})}function gc(t,e,o){const n=t.document;w(n),e.setAttribute("data-open","");const s=n.createElement("div");s.id=$,n.body.appendChild(s),W(t,e,s),s._sveApp=q(ot,s,{kind:"choices",choices:Lu.map(r=>({value:r,token:r,label:r})),onPick:r=>{Q([{property:o,value:`var(${r})`}]),w(n)}}),Ps(s,o)}const vn=/\{\{#[\s\S]*?#\}\}|\{\{[\s\S]*?\}\}/g,yn=/<!--[\s\S]*?-->/g,bn=/<(\/?)([A-Za-z][A-Za-z0-9-]*)/g,Ds=/^\{\{\s*(?:\/|endif\b|endunless\b)/,vc=/^\{\{\s*(?:\/\s*(?:if|unless)\b|endif\b|endunless\b)/,yc=/^\{\{\s*\/\s*partial\b/;function Ge(t,e,o){return t.some(n=>e<n.to&&o>n.from)}function bc(t){const e=new Map;for(const o of va(t)){const n=o.kind==="loop"?"loop":"if";e.set(o.from,n);const s=t.lastIndexOf("{{",o.to-2);s>=o.openTo&&Ds.test(t.slice(s,o.to))&&e.set(s,n)}for(const o of Hn(t))e.set(o.from,"component");return e}function xc(t){const e=String(t||""),o=[],n=[];yn.lastIndex=0;let s;for(;s=yn.exec(e);)o.push({from:s.index,to:s.index+s[0].length});const r=bc(e),i=[];for(vn.lastIndex=0;s=vn.exec(e);){const l=s.index,c=l+s[0].length,d=s[0];if(Ge(o,l,c))continue;if(i.push({from:l,to:c}),d.startsWith("{{#")){n.push({from:l,to:c,cls:"comment"});continue}const h=Ds.test(d),f=r.get(l)||(h&&vc.test(d)?"if":"")||(h&&yc.test(d)?"component":"");n.push({from:l,to:c,cls:(f?`fam-${f}`:"antlers")+(h?"-close":"")})}for(bn.lastIndex=0;s=bn.exec(e);){const l=s.index+1+s[1].length,c=l+s[2].length;Ge(o,l,c)||Ge(i,l,c)||n.push({from:l,to:c,cls:`fam-${Nr(s[2])}`})}return n.sort((l,c)=>l.from-c.from),n}function xn(t,e,o){const n=new e.RangeSetBuilder;let s=0;for(const r of xc(t.doc.toString()))r.from<s||(n.add(r.from,r.to,o(r.cls)),s=r.to);return n.finish()}function kc(t){const e=new Map,o=r=>r==="comment"?"sve-cm-antlers-comment":r==="antlers"?"sve-cm-antlers":r==="antlers-close"?"sve-cm-antlers sve-cm-antlers-close":r.endsWith("-close")?`sve-cm-${r.slice(0,-6)} sve-cm-antlers-close`:`sve-cm-${r}`,n=r=>(e.has(r)||e.set(r,t.Decoration.mark({class:o(r)})),e.get(r));return{extensions:[t.StateField.define({create(r){return xn(r,t,n)},update(r,i){return i.docChanged?xn(i.state,t,n):r},provide:r=>t.EditorView.decorations.from(r)})]}}const L=po({tag:"",emptyText:"",addLabel:"",dropTitle:"",chips:[],states:[],canEdit:!1,onAdd:null,onChip:null,onDrop:null}),Sc={class:"sve-al"},wc={class:"sve-al-head"},_c={key:0,class:"sve-al-tag"},$c=["title","disabled"],Cc={key:0,class:"sve-al-empty"},Tc={class:"sve-al-chips"},Ac=["data-sve-al-chip","title","disabled","onClick"],Mc={class:"sve-al-name"},Ec={key:0,class:"sve-al-value"},Bc=["title","onClick"],Lc={__name:"AlpinePanel",setup(t){return(e,o)=>(x(),k("div",Sc,[g("div",wc,[T(L).tag?(x(),k("span",_c,"<"+A(T(L).tag)+">",1)):j("",!0),(x(!0),k(D,null,U(T(L).states,n=>(x(),k("span",{key:n,class:"sve-al-state"},A(n),1))),128)),o[1]||(o[1]=g("span",{class:"sve-al-gap"},null,-1)),g("button",{type:"button","data-sve-al-add":"",title:T(L).addLabel,disabled:!T(L).canEdit,onClick:o[0]||(o[0]=I(n=>T(L).onAdd?.(n),["prevent","stop"]))},"+",8,$c)]),T(L).chips.length?j("",!0):(x(),k("div",Cc,A(T(L).emptyText),1)),g("div",Tc,[(x(!0),k(D,null,U(T(L).chips,n=>(x(),k("span",{key:n.id,class:"sve-al-chip-wrap"},[g("button",{type:"button","data-sve-al-chip":n.id,title:n.title,disabled:!T(L).canEdit,onClick:I(s=>T(L).onChip?.(s,n.id),["prevent","stop"])},[g("span",Mc,A(n.name),1),n.value?(x(),k("span",Ec,A(n.value),1)):j("",!0)],8,Ac),T(L).canEdit?(x(),k("button",{key:0,type:"button",class:"sve-al-drop",title:T(L).dropTitle,onClick:I(s=>T(L).onDrop?.(n.id),["prevent","stop"])},"−",8,Bc)):j("",!0)]))),128))])]))}},Fc=On(Lc,[["__scopeId","data-v-15add965"]]),Ic=[{id:"state",lang:"alpine_group_state"},{id:"act",lang:"alpine_group_act"},{id:"react",lang:"alpine_group_react"}],kn=[{id:"state",group:"state",label:"alpine_state",icon:"state",needsName:!0,attrs:[{name:"x-data",value:"{ :name: false }"}]},{id:"state_text",group:"state",label:"alpine_state_text",icon:"state",needsName:!0,attrs:[{name:"x-data",value:"{ :name: '|' }"}]},{id:"toggle",group:"act",label:"alpine_toggle",icon:"toggle",needsName:!0,attrs:[{name:"@click",value:":name = !:name"}]},{id:"open",group:"act",label:"alpine_open",icon:"open",needsName:!0,attrs:[{name:"@click",value:":name = true"}]},{id:"close",group:"act",label:"alpine_close",icon:"close",needsName:!0,attrs:[{name:"@click",value:":name = false"}]},{id:"open_hover",group:"act",label:"alpine_open_hover",icon:"open",needsName:!0,attrs:[{name:"@mouseenter",value:":name = true"}]},{id:"close_leave",group:"act",label:"alpine_close_leave",icon:"close",needsName:!0,attrs:[{name:"@mouseleave",value:":name = false"}]},{id:"open_focus",group:"act",label:"alpine_open_focus",icon:"open",needsName:!0,attrs:[{name:"@focusin",value:":name = true"}]},{id:"close_blur",group:"act",label:"alpine_close_blur",icon:"close",needsName:!0,attrs:[{name:"@focusout",value:":name = false"}]},{id:"close_outside",group:"act",label:"alpine_close_outside",icon:"outside",needsName:!0,attrs:[{name:"@click.outside",value:":name = false"}]},{id:"close_escape",group:"act",label:"alpine_close_escape",icon:"escape",needsName:!0,attrs:[{name:"@keydown.escape.window",value:":name = false"}]},{id:"show",group:"react",label:"alpine_show",icon:"show",needsName:!0,attrs:[{name:"x-show",value:":name"}]},{id:"show_smooth",group:"react",label:"alpine_show_smooth",icon:"show",needsName:!0,attrs:[{name:"x-show",value:":name"},{name:"x-transition",value:""}]},{id:"hide_until_ready",group:"react",label:"alpine_hide_until_ready",icon:"cloak",attrs:[{name:"x-cloak",value:""}]},{id:"class_when",group:"react",label:"alpine_class_when",icon:"klass",needsName:!0,attrs:[{name:":class",value:":name ? '|' : ''"}]},{id:"text",group:"react",label:"alpine_text",icon:"text",needsName:!0,attrs:[{name:"x-text",value:":name"}]}];function Oc(t){return(t?.attrs||[]).map(e=>e.name).join(" ")}const Pc=/^(x-[\w:.-]+|@[\w:.-]+|:[\w-]+)$/;function Dc(t){return Pc.test(String(t||""))}function ne(t){const e=String(t||""),o=[],n=/([@:a-zA-Z_][\w:.@-]*)(\s*=\s*(["'])([\s\S]*?)\3)?/g;let s,r=!0;for(;s=n.exec(e);){if(r){r=!1;continue}s[0].trim()&&o.push({name:s[1],value:s[4]??"",from:s.index,to:s.index+s[0].length,alpine:Dc(s[1])})}return o}function zs(t){const e=String(t||"").trim().replace(/^\{|\}$/g,""),o=[],n=/(^|,)\s*([a-zA-Z_$][\w$]*)\s*:/g;let s;for(;s=n.exec(e);)o.push(s[2]);return o}function zc(t,e){return t.map(o=>({name:o.name,value:String(o.value).replaceAll(":name:",`${e}:`).replaceAll(":name",e)}))}function Io(t,e,o){const n=v.html,s=Ct();if(!n||n.state.readOnly||!s)return;const r=a.htmlScopeActive&&!!a.htmlFocus,i=r?a.htmlFocus.from:0,c=(r?a.htmlFull:n.state.doc.toString()).slice(s.from,s.openTo),d=o===""?e:`${e}="${o}"`,h=ne(c).find(p=>p.name===e);let f;if(h)f=c.slice(0,h.from)+d+c.slice(h.to);else{const p=c.search(/\s|\/?>$/);f=p===-1?c:`${c.slice(0,p)} ${d}${c.slice(p)}`}f!==c&&(bt(n,[{from:s.from-i,to:s.openTo-i,insert:f}],null),je(t))}function Hc(t,e){const o=v.html,n=Ct();if(!o||o.state.readOnly||!n)return;const s=a.htmlScopeActive&&!!a.htmlFocus,r=s?a.htmlFocus.from:0,l=(s?a.htmlFull:o.state.doc.toString()).slice(n.from,n.openTo),c=ne(l).find(f=>f.name===e);if(!c)return;let d=c.from;for(;d>0&&/\s/.test(l[d-1]);)d-=1;const h=l.slice(0,d)+l.slice(c.to);bt(o,[{from:n.from-r,to:n.openTo-r,insert:h}],null),je(t)}function so(t){const e=v.html;if(!e)return[];const n=a.htmlScopeActive&&!!a.htmlFocus?a.htmlFull:e.state.doc.toString(),s=Ct(),r=[],i=Nn(Ce(n),new Set);for(const l of i){if(!s||l.from>s.from||l.to<s.to)continue;const c=ne(n.slice(l.from,l.openTo)).find(d=>d.name==="x-data");c&&r.push(...zs(c.value))}return[...new Set(r)]}function Rc(t){const e=v.html,o=Ct();if(!e||!o)return[];const s=a.htmlScopeActive&&!!a.htmlFocus?a.htmlFull:e.state.doc.toString(),r=ne(s.slice(o.from,o.openTo)).find(i=>i.name==="x-data");return r?zs(r.value):[]}function jc(t,e){const o=t.document;w(o),e.setAttribute("data-open","");const n=so(),s=o.createElement("div");s.id=$,o.body.appendChild(s),W(t,e,s);const r=!n.length,i=!r&&!Rc().length,c=Ic.filter(d=>d.id==="state"?!i:!r).flatMap(d=>{const h=kn.filter(f=>f.group===d.id);return h.length?[{value:`\0${d.id}`,label:m(t,r&&d.id==="state"?"alpine_group_state_first":d.lang),heading:!0},...h.map(f=>({value:f.id,label:m(t,f.label),hint:Oc(f)}))]:[]});r&&c.push({value:"\0note",label:m(t,"alpine_needs_state"),note:!0}),s._sveApp=q(ot,s,{kind:"choices",choices:c,onPick:d=>{const h=kn.find(f=>f.id===d);if(w(o),!!h){if(!h.needsName){for(const f of h.attrs)Io(t,f.name,f.value);return}Nc(t,e,h,n)}}})}function Nc(t,e,o,n){const s=t.document,r=l=>{const c=String(l||"").trim().replace(/[^\w$]/g,"");if(w(s),!!c)for(const d of zc(o.attrs,c))Io(t,d.name,d.value.replace("|",""))};if(!n.length){ro(t,e,r);return}const i=s.createElement("div");i.id=$,s.body.appendChild(i),W(t,e,i),i._sveApp=q(ot,i,{kind:"choices",choices:[{value:"\0head",label:m(t,"alpine_name"),heading:!0},...n.map(l=>({value:l,label:l})),{value:"\0new",label:m(t,"alpine_new_name")}],onPick:l=>{if(l==="\0new"){ro(t,e,r);return}r(l)}})}function ro(t,e,o){const n=t.document;w(n),e.setAttribute("data-open","");const s=n.createElement("div");s.id=$,n.body.appendChild(s),W(t,e,s),s._sveApp=q(Co,s,{label:m(t,"alpine_name"),placeholder:m(t,"alpine_name_placeholder"),onAdd:r=>o(r)})}function je(t){const o=t?.document.getElementById(u)?.querySelector("[data-sve-alpine-host]");if(!o)return;const n=Ct(),s=v.html,r=a.htmlScopeActive&&!!a.htmlFocus,i=s?r?a.htmlFull:s.state.doc.toString():"",l=n?ne(i.slice(n.from,n.openTo)):[];L.tag=n?.tag||"",L.canEdit=!a.lastLocked&&!!n,L.emptyText=m(t,n?so().length?"alpine_none_ready":"alpine_none":"alpine_pick"),L.addLabel=m(t,"alpine_add"),L.dropTitle=m(t,"alpine_remove"),L.states=so(),L.chips=l.filter(c=>c.alpine).map(c=>({id:c.name,name:c.name,value:c.value,title:c.value?`${c.name}="${c.value}"`:c.name})),L.onAdd=c=>jc(t,c.currentTarget),L.onDrop=c=>Hc(t,c),L.onChip=(c,d)=>{L.chips.find(f=>f.id===d)&&ro(t,c.currentTarget,f=>Io(t,d,f))},o._sveMounted||(o._sveMounted=!0,$t(o,Fc))}const Wc=new Set(["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"]),qc=new Set(["html","head","body"]),Sn=new Set(["if","unless","style_push","script_push","sve_defaults","once","noparse","foreach","forelse","loop","cache","nocache","scope","collection","nav","structure","taxonomy","users","search:results","form:create","form:errors"]),Vc=new Set(["collection:count"]);function wn(t){return Vc.has(t)?!1:Sn.has(t)||Sn.has(t.split(":")[0])}const Uc=new Set(["CloseTag","MismatchedCloseTag","IncompleteCloseTag"]),Kc=/^\s*(\/?)\s*([A-Za-z_][A-Za-z0-9_.:-]*)([\s\S]*)$/,Gc=/^\{\{\s*\/?\s*([A-Za-z_][A-Za-z0-9_.:-]*)/,Xc=3e5;function Zc(t){const e=String(t||""),o=[],n=[];let s=0;for(;s<e.length;){const r=e.indexOf("{{",s);if(r===-1)break;if(e.startsWith("{{#",r)){const d=e.indexOf("#}}",r+3);if(d===-1){n.push(r);break}o.push({from:r,to:d+3,comment:!0,body:""}),s=d+3;continue}let i=0,l=r,c=-1;for(;l<e.length;){if(e.startsWith("{{",l)){i+=1,l+=2;continue}if(e.startsWith("}}",l)){if(i-=1,l+=2,i===0){c=l;break}continue}l+=1}if(c===-1){n.push(r),s=r+2;continue}o.push({from:r,to:c,comment:!1,body:e.slice(r+2,c-2)}),s=c}return{tags:o,unclosed:n}}function Yc(t,e){let o=t;for(const n of e)o=o.slice(0,n.from)+" ".repeat(n.to-n.from)+o.slice(n.to);return o}function Jc(t,e){return t===e||t.startsWith(`${e}:`)}function fe(t,e){return(t.slice(e,e+80).match(/^<\/?([A-Za-z][A-Za-z0-9:-]*)/)?.[1]||"").toLowerCase()}function Qc(t,e,o,n,s){const r=c=>s.has(c.name)&&!/\||\?\?/.test(c.rest);for(const c of o){const d=t.slice(c,c+80).match(Gc)?.[1]||"…";n.push({from:c,to:c+2,key:"code_dock_problem_antlers_unclosed",args:{name:d}})}const i=[],l=[];for(const c of e){if(c.comment)continue;const d=c.body.match(Kc);if(!d)continue;const h=!!d[1],f=d[2].toLowerCase(),p=d[3];if(!h&&(f==="elseif"||f==="else")){let y=-1;for(let b=i.length-1;b>=0;b-=1)if(i[b].name==="if"||i[b].name==="unless"){y=b;break}if(y===-1){n.push({from:c.from,to:c.to,key:"code_dock_problem_branch_stray",args:{name:f}});continue}l.push({from:i[y].to,to:c.from}),i[y]={...i[y],to:c.to},i.length=y+1;continue}if(h||f==="endif"||f==="endunless"){const y=f==="endif"?"if":f==="endunless"?"unless":f;let b=-1;for(let B=i.length-1;B>=0;B-=1)if(Jc(i[B].name,y)){b=B;break}if(b===-1){n.push({from:c.from,to:c.to,key:"code_dock_problem_pair_stray",args:{name:y}});continue}for(const B of i.slice(b+1))wn(B.name)&&n.push({from:B.from,to:B.to,key:"code_dock_problem_pair_unclosed",args:{name:B.name}});(y==="if"||y==="unless")&&l.push({from:i[b].to,to:c.from}),i.length=b;continue}p.trim().startsWith("=")||i.push({name:f,rest:p,from:c.from,to:c.to})}for(const c of i)wn(c.name)?n.push({from:c.from,to:c.to,key:"code_dock_problem_pair_unclosed",args:{name:c.name}}):r(c)&&n.push({from:c.from,to:c.to,key:"code_dock_problem_list_unclosed",args:{name:c.name}});return l}function td(t,e,o,n){const s=e.parse(t),r=new Set,i=[];s.iterate({enter(l){if(l.name==="MismatchedCloseTag"){i.push({from:l.from,to:l.to,key:"code_dock_problem_tag_stray",args:{tag:fe(t,l.from)}});return}if(l.name==="IncompleteCloseTag"){i.push({from:l.from,to:l.to,key:"code_dock_problem_tag_unfinished",args:{tag:fe(t,l.from)}});return}if(l.type.isError){const f=l.node.parent;f&&(f.name==="OpenTag"||f.name==="CloseTag")&&(r.add(f.from),i.push({from:f.from,to:Math.max(f.from+1,l.from),key:"code_dock_problem_tag_unfinished",args:{tag:fe(t,f.from)}}));return}if(l.name!=="Element")return;let c=null,d=!1;for(let f=l.node.firstChild;f;f=f.nextSibling)f.name==="OpenTag"&&(c=f),Uc.has(f.name)&&(d=!0);if(!c||d)return;const h=fe(t,c.from);!h||Wc.has(h)||qc.has(h)||o.some(f=>c.from>=f.from&&c.from<f.to&&l.to>f.to)||i.push({from:c.from,to:c.to,key:"code_dock_problem_tag_unclosed",args:{tag:h}})}});for(const l of i)l.key==="code_dock_problem_tag_unclosed"&&r.has(l.from)||l.args.tag&&n.push(l)}function ed(t,e,o={}){const n=String(t||"");if(!n.trim()||n.length>Xc)return[];const s=[];try{const{tags:i,unclosed:l}=Zc(n),c=Qc(n,i,l,s,new Set(o.lists||[]));e&&td(Yc(n,i),e,c,s)}catch{return[]}const r=new Set;return s.sort((i,l)=>i.from-l.from||i.to-l.to).filter(i=>{const l=`${i.from}:${i.key}`;return r.has(l)?!1:(r.add(l),!0)})}function od(t,e,o=()=>({})){const n=t.Decoration.mark({class:"sve-cm-problem"}),s=t.StateEffect.define(),r=l=>{const c=ed(l.doc.toString(),e,o()),d=new t.RangeSetBuilder;let h=0;for(const f of c)f.from<h||f.to<=f.from||(d.add(f.from,f.to,n),h=f.to);return{problems:c,decorations:d.finish()}},i=t.StateField.define({create(l){return r(l)},update(l,c){return c.docChanged||c.effects.some(d=>d.is(s))?r(c.state):l},provide:l=>t.EditorView.decorations.from(l,c=>c.decorations)});return{field:i,relint:s,extensions:[i]}}const nd=new Set(["replicator","grid","list","array","table"]);let ge=new Set,Xe=null;function Hs(t){return t.document.getElementById(u)?.querySelector("[data-sve-html-problems]")||null}function sd(t,e,o){const n=Hs(t);if(!n)return;const s=e.state.doc,r=o.map(c=>({from:c.from,line:s.lineAt(Math.min(c.from,s.length)).number,text:m(t,c.key,c.args)})),i=r.map(c=>`${c.line}:${c.text}`).join(`
`);if(n.dataset.sveSignature===i||(n.dataset.sveSignature=i,n.hidden=r.length===0,n.replaceChildren(),!r.length))return;const l=t.document.createElement("span");l.setAttribute("data-sve-problems-title",""),l.textContent=m(t,"code_dock_problems_title"),n.appendChild(l);for(const c of r){const d=t.document.createElement("button"),h=t.document.createElement("b");d.type="button",d.dataset.sveProblemAt=String(c.from),h.textContent=m(t,"code_dock_problem_line",{line:c.line}),d.append(h,t.document.createTextNode(` ${c.text}`)),n.appendChild(d)}}function rd(t){const e=Hs(t);!e||e._sveBound||(e._sveBound=!0,e.addEventListener("mousedown",o=>o.preventDefault()),e.addEventListener("click",o=>{const n=o.target.closest("[data-sve-problem-at]"),s=v.html;if(!n||!s)return;o.preventDefault(),o.stopPropagation();const r=Math.min(Number(n.dataset.sveProblemAt)||0,s.state.doc.length);s.dispatch({selection:{anchor:r},effects:N.scrollIntoView(r,{y:"center"})}),s.focus()}))}function ad(t){const e=[],o=n=>{for(const s of n||[])s?.loop&&nd.has(s.type)&&s.var&&!s.parent&&e.push(s.var)};o(t?.section);for(const n of t?.page||[])o(n?.items);return e}function id(t,e,o){const n={collection:ss(t),set:rs(a.lastType),view:"",scope:""},s=n.set?wo(n):"";if(s===Xe)return;Xe=s;const r=l=>{if(Xe!==s)return;const c=new Set(ad(l)),d=c.size===ge.size&&[...c].every(h=>ge.has(h));ge=c,!d&&v.html===e&&t.queueMicrotask(()=>{v.html===e&&e.dispatch({effects:o.of(null)})})};if(!s){r(null);return}const i=as(s);if(i){r(i);return}is(t,n).then(r)}function ld(t){if(!a.htmlLintUi){const{field:e,relint:o}=od({Decoration:Et,StateField:At,StateEffect:le,RangeSetBuilder:Mt,EditorView:N},Wo.parser,()=>({lists:ge})),n=N.updateListener.of(s=>{const r=s.transactions.some(i=>i.effects.some(l=>l.is(o)));!s.docChanged&&!r||(s.docChanged&&id(t,s.view,o),sd(t,s.view,s.state.field(e).problems))});a.htmlLintUi={extensions:[e,n]}}return rd(t),a.htmlLintUi}function cd(){if(a.cssGhostUi)return a.cssGhostUi;const t=Et.mark({class:"sve-css-ghost"}),e=o=>{const n=new Mt;if(!a.lastWin)return n.finish();try{for(const s of fl(o.doc.toString(),gt(a.lastWin)))n.add(s.from,s.to,t)}catch{}return n.finish()};return a.cssGhostUi=At.define({create:o=>e(o),update:(o,n)=>n.docChanged?e(n.state):o,provide:o=>N.decorations.from(o)}),a.cssGhostUi}let he=null,Se=null;function dd(){if(he)return he;Se=le.define();const t=Et.line({class:"sve-css-id"}),e=o=>{const n=new Mt;if(!a.lastWin||!a.cssValues)return n.finish();try{const s=o.doc;for(const r of be(s.toString(),gt(a.lastWin),a.cssSize)){const i=s.lineAt(Math.min(r.from,s.length)).number,l=s.lineAt(Math.min(Math.max(r.to-1,r.from),s.length)).number;for(let c=i;c<=l;c+=1)n.add(s.line(c).from,s.line(c).from,t)}}catch{}return n.finish()};return he=At.define({create:o=>e(o),update:(o,n)=>n.docChanged||n.effects.some(s=>s.is(Se))?e(n.state):o,provide:o=>N.decorations.from(o)}),he}function Oo(){Se&&v.css&&v.css.dispatch({effects:Se.of(null)})}function ud(){return a.htmlPartialUi||(a.htmlPartialUi=xa({Decoration:Et,StateField:At,StateEffect:le,RangeSetBuilder:Mt,EditorView:N})),a.htmlPartialUi}function fd(){return a.htmlAntlersUi||(a.htmlAntlersUi=kc({Decoration:Et,StateField:At,RangeSetBuilder:Mt,EditorView:N})),a.htmlAntlersUi}function hd(){return a.htmlClassTokenUi||(a.htmlClassTokenUi=Xa({Decoration:Et,StateField:At,StateEffect:le,RangeSetBuilder:Mt,EditorView:N})),a.htmlClassTokenUi}function pd(t,e,o){v[e]?.destroy();const n=co.of([{key:"Mod-s",run:()=>(J(t.document),!0)}]);v[e]=new N({state:we.create({doc:"",extensions:[sr(),rr(),ar(),dr(),nu(e),fr(),ur({tooltipClass:()=>"sve-tw-complete"}),...e==="html"?[Wo.data.of({autocomplete:ya(t)}),ba(gr,t)]:[],...e==="html"?[...Ea(),Ba()]:[],...e==="css"?[xr(),cd(),dd()]:[],co.of([...ir,...e==="html"?[{key:"Tab",run:La}]:[],lr,...cr,...mr,...hr]),n,N.lineWrapping,...e==="html"||e==="css"?ud().extensions:[],...e==="html"?fd().extensions:[],...e==="html"?ld(t).extensions:[],...e==="html"?hd().extensions:[],Vt[e].of(we.readOnly.of(!!a.lastLocked)),Ut[e].of(N.editable.of(!a.lastLocked)),N.updateListener.of(s=>{e==="html"&&s.docChanged&&!a.applying&&(ql(),go("dock:html-changed")),e==="css"&&s.docChanged&&!a.applying&&Vl(),s.docChanged&&nt(t),e==="css"&&(s.docChanged||s.selectionSet)&&P(t),e==="css"&&s.docChanged&&!a.applying&&se(t),e==="html"&&(s.docChanged||s.selectionSet)&&(ze(t),je(t),a.applying||ae(t))}),...la(C,{height:"auto",background:"#1E1E21",scroller:{overflow:"visible",height:"auto",minHeight:0},extraTags:s=>[{tag:s.tagName,color:"#4ec9b0"},{tag:s.attributeName,color:"#9cdcfe"},{tag:s.attributeValue,color:"#ce9178"},{tag:s.angleBracket,color:"#808080"}]})]}),parent:o})}function md(t){if(!t||t.querySelector(".cm-editor"))return;t.replaceChildren();const e=t.ownerDocument.createElement("span");e.style.cssText="width:16px;height:16px;margin:12px;border:2px solid #858585;border-right-color:transparent;border-radius:50%;display:block;animation:sve-cm-wait .6s linear infinite",t.appendChild(e)}function gt(t){return vo(t).map(e=>({handle:e.handle,base:e.base,max:e.max,media:e.media,media_px:e.media_px,label:e.label}))}function Rs(t,e){return gt(t).find(o=>o.handle===e)||null}function Ne(t=a.cssState){return t?t==="before"||t==="after"?`::${t}`:`:${t}`:""}function se(t,e=!1){const o=v.css;if(!o||!uo||!fo)return;const n=o.state.doc.toString(),s=`${a.cssValues?"1":"0"}|${a.cssSize}|${Be(n).map(h=>`${h.from}-${h.to}`).join(",")}`;if(!e&&s===a.cssFoldSig)return;a.cssFoldSig=s;const r=gt(t),i=new Map,l=[...dl(n,r,a.cssSize),...a.cssValues?[]:be(n,r,a.cssSize).map(h=>({from:h.from,to:h.to}))];for(const h of l)h.to>h.from&&i.set(`${h.from}:${h.to}`,{from:h.from,to:h.to});const c=[],d=new Set;kr(o.state).between(0,n.length,(h,f)=>{const p=`${h}:${f}`;d.add(p),!i.has(p)&&a.cssOwnFolds.has(p)&&c.push(fo.of({from:h,to:f}))});for(const[h,f]of i)d.has(h)||c.push(uo.of(f));a.cssOwnFolds=new Set(i.keys()),c.length&&o.dispatch({effects:c})}function ao(t,e){const o=a.cssFull||e;return/max-width/i.test(o)&&!/width\s*</i.test(o)&&t.media_px||t.media}function gd(t,e){const o=v.css;if(!o||o.state.readOnly)return;const n=gt(t),s=Rs(t,e),r=o.state.doc.toString();if(!s||s.base){const h=o.state.selection.main.head,f=Be(r).find(p=>h>=p.from&&h<=p.to);f&&o.dispatch({selection:{anchor:f.from},scrollIntoView:!0});return}const i=$o(r,n,e);if(i.length){const h=i[0],f=Math.min(h.bodyTo,h.bodyFrom+(r.slice(h.bodyFrom).match(/^[^\S\n]*\n?/)||[""])[0].length);o.dispatch({selection:{anchor:f},scrollIntoView:!0});return}const l=ao(s,r),c=js(o,r),d=`
...
${xt(e,i.open)}`}),s=He();if(s)return n(s);const r=vd(e);return r?n(r):{at:e.length,indent:"",suffix:""}}function vd(t){const e=String(t||"");let o=null,n=0,s=0;for(;n<e.length;){if(e[n]==="}"||e[n]===";"){n+=1,s=n;continue}if(e[n]!=="{"){n+=1;continue}const r=Pt(e,n);if(r===-1||o||(o=e.slice(s,n).trim().startsWith("@")?null:{from:s,open:n,to:r},!o))return null;n=r+1,s=n}return o}function yd(t,e){const o=e===a.cssSize?"":e;a.cssSize=o,K(t,zo,o),St("lp:set-device",{win:t,key:o?Wr(o,t):"Responsive"}),o&&gd(t,o),a.cssValues&&Ws(t),se(t,!0),Oo(),re(t),P(t)}function bd(t,e){a.cssState=Ho.includes(e)?e:"",K(t,io,a.cssState),w(t.document),re(t),P(t)}function xd(t,e){const o=t.document;w(o),e.setAttribute("data-open","");const n=o.createElement("div");n.id=$,o.body.appendChild(n),W(t,e,n),n._sveApp=q(ot,n,{kind:"choices",choices:[{value:"",label:m(t,"css_state_none"),active:!a.cssState},...Ho.map(s=>({value:s,label:Ne(s),active:s===a.cssState}))],onPick:s=>bd(t,s)})}function re(t){const o=t?.document.getElementById(u)?.querySelector("[data-sve-css-head]");if(!o)return;const n=Ct(),s=gt(t),r=v.css?.state.doc.toString()??"";F.tag=n?.tag||"",F.scope=Pa(n?zt().slice(n.from,n.openTo):"")||"",F.canEdit=!a.lastLocked,F.onTag=i=>ka(t,i.currentTarget,n),F.state=a.cssState,F.stateLabel=a.cssState?Ne(a.cssState):m(t,"css_state"),F.onState=i=>xd(t,i.currentTarget),F.onSize=i=>yd(t,i),F.sizes=[{key:"",label:m(t,"tw_size_all"),title:m(t,"css_size_all_title"),active:!a.cssSize},...s.map(i=>{const l=i.base||$o(r,s,i.handle).length>0;return{key:i.handle,label:i.label,title:i.base?m(t,"css_size_base_title"):`@media ${i.media}${l?"":`  ·  ${m(t,"css_size_new")}`}`,active:a.cssSize===i.handle}})],o._sveMounted||(o._sveMounted=!0,$t(o,xl))}$e("lp:device",t=>{const e=a.lastWin;if(!e||!Us(e.document))return;const o=vo(e).find(n=>n.device===t)?.handle||"";o!==a.cssSize&&(a.cssSize=o,K(e,zo,o),se(e,!0),Oo(),re(e),P(e))});function kd(t){const e=Math.max(0,Math.round(Date.now()/1e3-t)),o=new Date(t*1e3).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});let n=o;try{const s=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"});e<90?n=s.format(-e,"second"):e<5400?n=s.format(-Math.round(e/60),"minute"):e<86400?n=s.format(-Math.round(e/3600),"hour"):n=s.format(-Math.round(e/86400),"day")}catch{}return`${n} · ${o}`}function Ns(t,e){return t.fetch(e,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}})}async function Sd(t,e){const o=t.document,n=Tt();if(w(o),!n)return;let s=[];try{const i=await Ns(t,`/!/sve/section-template/history?type=${encodeURIComponent(n)}`);i.ok&&(s=(await i.json())?.entries||[])}catch{s=[]}if(!o.getElementById(u)||!o.contains(e))return;e.setAttribute("data-open","");const r=o.createElement("div");r.id=$,o.body.appendChild(r),W(t,e,r),r._sveApp=q(ot,r,{kind:"choices",choices:s.length?s.map(i=>({value:i.id,label:kd(i.at)})):[{value:"",label:m(t,"code_dock_history_empty")}],onPick:i=>{w(o),i&&wd(t,n,i)}})}async function wd(t,e,o){if(mt())return;let n=null;try{const s=await Ns(t,`/!/sve/section-template/history/entry?type=${encodeURIComponent(e)}&id=${encodeURIComponent(o)}`);s.ok&&(n=await s.json())}catch{n=null}!n||mt()||(oe({html:n.html??"",css:n.css??"",js:n.js??""},a.lastLocked),nt(t),ae(t))}function Zt(t){const e=t?.document.getElementById(u)?.querySelector("[data-sve-code-strip]");if(!e)return;e.hidden=a.styleMode!=="tw";const o=Wn(t);e.innerHTML=Iu,e.title=m(t,o?"tw_strip_on":"tw_strip_off"),e.setAttribute("aria-label",e.title),e.setAttribute("aria-pressed",o?"true":"false")}function _d(t,e){const o=e.querySelector("[data-sve-code-strip]");!o||o._sveBound||(o._sveBound=!0,o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Sa(t,!Wn(t)),Zt(t),wa(t)}),Zt(t))}function $d(t,e){const o=e.querySelector("[data-sve-code-history]");!o||o._sveBound||(o._sveBound=!0,o.innerHTML=Ou,o.title=m(t,"code_dock_history"),o.setAttribute("aria-label",o.title),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),o.hasAttribute("data-open")){w(t.document);return}Sd(t,o)}))}function cf(){return a.styleMode}function Cd(t){return a.styleMode==="tw"?Ct():null}function Ct(t){const e=v.html;if(!e)return null;const o=a.htmlScopeActive&&!!a.htmlFocus,n=o?a.htmlFull:e.state.doc.toString(),r=(o?a.htmlFocus.from:0)+e.state.selection.main.from,i=Nn(Ce(n),new Set);let l=null;for(const c of i)c.from<=r&&r<c.to&&(l=c);return l}function ae(t){a.styleMode==="tw"&&_a(t,Cd())}function Po(t){const e=t?.document.getElementById(u),o=e?.querySelector("[data-sve-values-mode]");if(!e||!o)return;e.setAttribute("data-sve-values",a.cssValues?"on":"off");const n=t.document.createElement("span");n.textContent=m(t,"code_dock_values"),o.innerHTML=Du,o.appendChild(n),o.title=m(t,a.cssValues?"code_dock_values_off":"code_dock_values_on"),o.setAttribute("aria-label",o.title),o.setAttribute("aria-pressed",a.cssValues?"true":"false")}function Ws(t){const e=v.css;if(!e||e.state.readOnly)return;const o=gt(t),n=e.state.doc.toString(),s=be(n,o,a.cssSize);if(e.focus(),s.length){const p=s[0],y=Math.min(p.bodyTo,p.bodyFrom+(n.slice(p.bodyFrom).match(/^[^\S\n]*\n?/)||[""])[0].length);e.dispatch({selection:{anchor:y},scrollIntoView:!0});return}const r=Rs(t,a.cssSize);if(!r||r.base){const p=`#id-{{ id }} {
...
${l.indent}}${l.suffix}`:`
${c}}
${l.indent}}${l.suffix}`;e.dispatch({changes:{from:l.at,to:l.at,insert:`${h}${f}`},selection:{anchor:l.at+h.length},scrollIntoView:!0})}function Td(t,e){a.cssValues=!!e,K(t,qo,a.cssValues?"1":"0"),w(t.document),a.cssOpenTool="",Po(t),dt(),te(),a.cssValues&&Ws(t),se(t,!0),Oo(),re(t),P(t)}function Do(t){const e=t?.document.getElementById(u);if(!e)return;const o=a.styleMode==="tw";e.setAttribute("data-sve-style",a.styleMode);const n=e.querySelector("[data-sve-css-label]");n&&(n.textContent=o?m(t,"code_dock_style_tw"):m(t,"code_dock_css"));const s=e.querySelector("[data-sve-style-mode]");if(!s)return;const r=t.document.createElement("span");r.textContent=o?m(t,"code_dock_style_tw"):m(t,"code_dock_css"),s.innerHTML=o?zu:Pu,s.appendChild(r),s.title=m(t,o?"code_dock_style_to_css":"code_dock_style_to_tw"),s.setAttribute("aria-label",s.title),s.setAttribute("aria-pressed",o?"true":"false")}function qs(t){t?.document.getElementById(u),w(t.document),to(t),a.cssOpenTool="",a.cssOpenMenu="",a.styleMode==="tw"&&a.cssValues&&(a.cssValues=!1,K(t,qo,"0")),Do(t),Po(t),Zt(t),a.cssToolRow?.(),a.styleMode==="tw"&&(a.htmlScopePref=!0,K(t,qe,"1"),eo(t,!0)),ae(t),je(t),P(t)}const zo="sve-css-size",io="sve-css-state",Ho=["hover","focus","focus-visible","active","disabled","before","after"];function Ad(t,e){a.styleMode=e==="tw"?"tw":"css",K(t,Cr,a.styleMode),qs(t)}function Md(t,e){if(e._sveStyleModeBound)return;e._sveStyleModeBound=!0,a.styleMode=tt(t,Cr)==="tw"?"tw":"css";const o=tt(t,zo)||"";a.cssSize=vo(t).some(n=>n.handle===o)?o:"",a.cssState=Ho.includes(tt(t,io))?tt(t,io):"",a.cssValues=tt(t,qo)==="1",e.querySelector("[data-sve-style-mode]")?.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Ad(t,a.styleMode==="tw"?"css":"tw")}),e.querySelector("[data-sve-values-mode]")?.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Td(t,!a.cssValues)}),qs(t),Po(t)}function Ed(t,e){const o=e.querySelector("[data-sve-css-tools]");if(!o||o._sveBound)return;o._sveBound=!0;const n=r=>e.querySelector(`[data-sve-css-tool="${r}"], [data-sve-css-kid="${r}"]`),s=r=>{const i=n(r.id),l=a.cssOpenMenu===r.id;if(w(t.document),l){to(t),P(t);return}if(!i)return;const c=a.styleMode==="tw"?!r.twClass&&!!r.tw:!r.kind&&!r.value&&!(r.css in et())&&!!r.menu,d=()=>{c&&(a.cssOpenMenu=r.id)};if(a.styleMode==="tw"){to(t),r.twClass?($a(t,r.twClass),P(t)):r.tw&&(Ca(t,i,r.tw,()=>P(t)),d(),P(t));return}if(r.kind==="flexDir"){dc(r.value);return}if(r.kind==="display"){uc(r.value);return}if(r.value){const h=z(et()[r.css])===z(r.value);Q([{property:r.css,value:h?null:r.value}]);return}if(r.css in et()){Q([{property:r.css,value:null}]),P(t);return}r.menu==="colors"?pc(t,i,r.css):r.menu==="spacing"?gc(t,i,r.css):r.menu==="sizes"?gn(t,i,r.css,Wu):r.menu==="choices"?mc(t,i,r.css,r.choices):r.menu==="values"&&gn(t,i,r.css),d(),P(t)};ft.onTool=r=>{const i=_e.get(r)?.tool;if(i){if(i.kids?.length){a.cssOpenTool=a.cssOpenTool===i.id?"":i.id,w(t.document),P(t);return}s(i)}},ft.onKid=(r,i)=>{const l=_e.get(i);l?.kid&&s(l.kid)},a.cssToolRow=()=>{$t(o,al),P(t)},a.cssToolRow(),t.document.addEventListener("mousedown",r=>{r.target.closest(`#${$}, [data-sve-css-tools], [data-sve-html-tools], [data-sve-css-add-class]`)||w(t.document)},!0)}function Bd(t,e){const o=e.querySelector("[data-sve-html-tidy]");o&&(o.innerHTML=qn.tidy,o.title=m(t,"code_dock_html_tidy"),o.setAttribute("aria-label",o.title),o.setAttribute("data-tip",o.title))}function Ld(t,e){const o=e.querySelector("[data-sve-html-tidy]");Bd(t,e),!(!o||o._sveBound)&&(o._sveBound=!0,o.addEventListener("mousedown",n=>n.preventDefault()),o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Cs()}))}function Fd(t,e){const o=e.querySelector("[data-sve-html-tools]");!o||o._sveBound||(o._sveBound=!0,$t(o,tl,{tools:ho.map(n=>({...n,icon:qn[n.id]||""})),onTool:n=>{const s=ho.find(i=>i.id===n),r=o.querySelector(`[data-sve-html-tool="${n}"]`);if(s){if(s.menu==="heading"){hn(t,r,Mr);return}if(s.menu==="text"){hn(t,r,qr);return}if(s.tidy){Cs();return}if(s.menu==="component"){ec(t,r);return}if(w(t.document),s.snippet){Ot(s.snippet,s.caret??s.snippet.length,s.select),V();return}Ts(s.tag)}}}),Jd(t,e),tu(t,e),Yd(t,e))}E("dock:save-now",()=>(J(a.lastWin?.document),!0));let pe=null;async function Id(t){const e=t.document;cu(e);let o=e.getElementById(u);if(o&&!(o.querySelector('[data-sve-css-chrome="subrow-2"]')&&o.querySelector("[data-sve-css-add-class]")&&o.querySelector("[data-sve-html-tools]")&&o.querySelector("[data-sve-html-tidy]")&&o.querySelector("[data-sve-data-vars]")&&o.querySelector("[data-sve-visual-edit-tools]")&&o.querySelector("[data-sve-html-scope]")&&o.querySelector("[data-sve-code-lock]")&&o.querySelector("[data-sve-code-back]")&&o.querySelector("[data-sve-code-autosave]")&&o.querySelector("[data-sve-code-save]")&&o.getAttribute("data-sve-code-chrome")==="scope-9")){for(const s of it)v[s]?.destroy(),v[s]=null;o.remove(),o=null}if(!o){o=e.createElement("div"),o.id=u,o.setAttribute("data-sve-code-chrome","scope-9"),ta(o,ea(t)),$t(o,Ui,{htmlLabel:m(t,"code_dock_html"),cssLabel:m(t,"code_dock_css"),jsLabel:m(t,"code_dock_js"),alpineLabel:m(t,"code_dock_alpine"),treeIcon:Ar,dataIcon:Au,dataLabel:m(t,"data_vars_title")}),Qe(e,o),Cn(o),tr(o,Zs(t)),gu(t,o),yu(t,o),vu(t,o),Ed(t,o),sc(t,o),Md(t,o),$d(t,o),_d(t,o),oa(t,o),Fd(t,o),cn(t,o),an(t,o),Tn(t,o),ln(t,o);for(const n of it){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);md(s)}na(t)}if(Qe(e,o),Cn(o),Ld(t,o),cn(t,o),an(t,o),Tn(t,o),ln(t,o),hu(t),Ro(t),It(t),X(t),Jt(t),lt(t),Do(t),Zt(t),await xu(),!v.html){for(const n of it){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);s?.replaceChildren(),pd(t,n,s)}for(const n of["html","css"])v[n]&&Ta(t,v[n],{onOpen:s=>bs(t,s),emptyLabel:m(t,"code_dock_partials_empty"),openLabel:s=>m(t,"component_open_named",{name:s}),sectionValues:()=>ys(t),isLocked:()=>mt(),setHover:(s,r)=>a.htmlPartialUi?.setHover(s,r)});Ja(t,v.html,{onRename:n=>Kl(t,n),isLocked:()=>mt(),setHover:(n,s)=>a.htmlClassTokenUi?.setHover(n,s),title:m(t,"code_dock_css_rename_class")})}return o}function Vs(t){return pe||(pe=Id(t).finally(()=>{pe=null})),pe}async function _n(t,e){const o=await Vs(t);a.lastType=e,a.lastLocked=!0,a.lockReady=!0,a.lastParts={html:"",css:"",js:""},De(),It(t),oe(a.lastParts,!0),nr(t.document,e),R(t.document,m(t,"code_dock_missing")),X(t),Jt(t),lt(t),Yt(t,o)}async function We(t,e,o="replace"){o==="replace"?a.typeStack=[]:o==="push"&&a.lastType&&a.lastType!==e&&a.typeStack.push(a.lastType);const n=++a.loadGen;a.lastType=e,a.lockReady=!1,De(),R(t.document,m(t,"code_dock_loading"));let s=()=>{};a.loadInFlight=new Promise(i=>{s=i});const r=await Vs(t);It(t),X(t),Jt(t),lt(t),Do(t),Zt(t),Yt(t,r),t.fetch(`/!/sve/section-template?type=${encodeURIComponent(e)}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(async i=>{if(n!==a.loadGen)return;if(i.status===404){_n(t,e);return}if(!i.ok)throw new Error(String(i.status));const l=await i.json();n===a.loadGen&&(a.lastParts={html:typeof l.html=="string"?l.html:"",css:typeof l.css=="string"?l.css:"",js:typeof l.js=="string"?l.js:""},a.lastProps=Array.isArray(l.props)?l.props:[],a.propsDirty=!1,a.lastType=e,a.lastLocked=!!l.locked,a.lockReady=!0,jl(),typeof l.tw=="string"&&l.tw!==""&&Nl(a.lastParts.html,l.tw),It(t),oe(a.lastParts,a.lastLocked),Vn(t),a.lastLocked||ms(t,a.lastParts.html),nr(t.document,l.path||e),R(t.document,a.lastLocked?m(t,"code_dock_locked"):""),l.writable?.template===!1?R(t.document,m(t,"code_dock_not_writable")):l.writable?.tw===!1&&R(t.document,m(t,"code_dock_tw_not_writable")),fs(t),Yi(t),_o(t),X(t),Jt(t),lt(t),Yt(t,r))}).catch(()=>{n===a.loadGen&&(_n(t,e),R(t.document,m(t,"code_dock_error")))}).finally(()=>{n===a.loadGen&&(a.loadInFlight=null),s()})}function Tt(){return a.lastType||""}function Us(t){return!!t?.getElementById(u)}function mt(){return a.lastLocked}function Od(t,e){const o=typeof e?.html=="string"?e.html.trim():"",n=typeof e?.css=="string"?e.css.trim():"",s=typeof e?.js=="string"?e.js.trim():"";if(!o&&!n&&!s||!t?.document?.getElementById(u))return!1;let r=!1;return o&&(r=Pd("html",o)||r),n&&(r=$n("css",n)||r),s&&(r=$n("js",s)||r),r&&nt(t),r}function Pd(t,e){const o=v[t];if(!o||o.state.readOnly)return!1;const n=o.state.selection.main,s=n.from>0?o.state.doc.sliceString(n.from-1,n.from):`
...
`:n?`
`:""}${e}
`;return o.dispatch({changes:{from:n,insert:r},selection:{anchor:n+r.length}}),!0}function Dd(t){if(ke(t),!a.lastType||!t.document.getElementById(u))return;const e=a.lastType;a.lastType=null,We(t,e,"keep")}function Ks(t){kt(t),a.loadGen+=1,J(t),a.lastUid=null,a.lastType=null,a.typeStack=[],a.lastParts={html:"",css:"",js:""},a.lastLocked=!1,a.lockReady=!1,a.lastBracketNames=null,a.lastCssSelectorNames=null,De(),a.lastWin=t?.defaultView||a.lastWin,w(t),jn(t),rt(t),t?.getElementById(Z)?.remove();for(const o of it)v[o]?.destroy(),v[o]=null;t?.getElementById(u)?.remove(),fu(),t&&jo(t,0);const e=t?.defaultView||a.lastWin;e?.document.getElementById(zn)&&Dn(e),e&&(fs(e),_o(e),Vn(e))}function zd(t){if(a.dragging)return;const e=t.document.getElementById(u);e&&(Ro(t),Yt(t,e))}function Hd(t,e,o){if(o){const r=Ko(o,e)||Ko(o,t.document)||o;return String(typeof Ue=="function"&&(Ue(r,e)||Ue(r,t.document))||"").trim()}const n=typeof Kt=="function"?Kt(t):"page_sections",s=typeof G=="function"?G(t.document):[];for(const r of s){const l=(pt(r.values)||r.values)?.[n];if(Array.isArray(l))for(const c of l){const d=typeof c?.type=="string"?c.type.trim():"";if(d)return d}}return""}function Gs(t){if((t.Statamic?.$config?.get?.("sveFeatures")||{}).collection_templates!==!0)return"";const o=t.Statamic?.$config?.get?.("sveCollectionTemplatesCollection")||"templates";if(!(t.location?.pathname||"").includes(`/collections/${o}/entries/`))return"";const s=typeof G=="function"?G(t.document):[];for(const r of s){const i=pt(r.values)||r.values,l=typeof i?.view=="string"?i.view.trim():"";if(!l||l.includes(".."))continue;const c=l.replace(/\.(antlers\.html|blade\.php)$/i,"").replace(/^\/+|\/+$/g,"");if(c)return`view:${c}`}return""}function Rd(t,e){const o=Zr||Yr;if(o!=="header"&&o!=="footer"||!Kr(e)&&!Gr(e))return"";const s=(pt(Xr()?.values)||{})[o==="footer"?"footer_style":"header_style"]||"style_1";return`${o}/${s}`}function jd(t){const e=typeof Kt=="function"?Kt(t):"page_sections",o=typeof G=="function"?G(t.document):[];for(const n of o){const r=(pt(n.values)||n.values)?.[e];if(Array.isArray(r)&&r.length)return!0}return!1}function Nd(t){const e=Qr(t);if(!e)return"";const o=["header","footer"].find(r=>e.querySelector(`[data-sve-chrome="${r}"]`));if(!o)return"";const n=t.Statamic?.$config?.get?.("sveChromeStyles")||{},s=typeof n[o]=="string"&&n[o]!==""?n[o]:"style_1";return`${o}/${s}`}function Wd(t){const e=Jr(t)||t.getElementById("__sve-global-section-host");return e&&e.querySelector("[data-replicator-set][data-type]")?.getAttribute("data-type")||""}function df(t,e,o){if(a.dragging)return;if(!t||!e||su(e)||!Vr(t)||!Ur(t)){e&&Ks(e);return}const n=Rd(t,e)||Wd(e)||Hd(t,e,o)||Gs(t)||(o?"":a.lastType),s=!n&&!o&&!jd(t)?Nd(t):"",r=n||s,i=!!(o&&o!==a.lastUid);if(a.onEmptyPage=!!s,a.lastWin=t,o&&(a.lastUid=o),!!r&&!(r===a.lastType&&e.getElementById(u))){if(a.typeStack.length&&a.lastType&&a.lastType!==r){const l=a.typeStack[0];if(r===l&&!i)return;a.typeStack=[]}J(e),We(t,r,"replace")}}$e("tw:changed",()=>{a.lastWin&&a.styleMode==="tw"&&P(a.lastWin)});E("dock:is-open",t=>Us(t));E("dock:is-locked",()=>mt());E("dock:html",()=>zt());E("dock:reveal-html",({from:t,to:e,caret:o}={})=>{const n=v.html;if(!n||t==null)return;a.htmlScopePref=Qt(a.lastWin),Fe(),dt();const s=a.htmlFull.length,r=Math.max(0,Math.min(t,s)),i=Math.max(r,Math.min(e??t,s));a.htmlFocus=i>r?{from:r,to:i}:null;const l=o==null?null:Math.max(0,Math.min(o,s));if(a.htmlScopePref&&a.htmlFocus){Eo(l),X(a.lastWin);return}if(a.htmlScopeActive){Bo(!0,l),X(a.lastWin);return}n.dispatch({selection:l==null?{anchor:r,head:i}:{anchor:l},scrollIntoView:!0}),n.focus()});E("dock:insert-snippet",({win:t,parts:e})=>Od(t,e));E("dock:refresh",t=>Dd(t));E("dock:tw-follow",()=>{a.lastWin&&ae(a.lastWin)});E("dock:css",()=>(dt(),a.cssFull));E("dock:set-css",t=>typeof t!="string"||mt()||!v.css||!a.lastWin?!1:(dt(),a.cssFull=t,Oe("css",As()),nt(a.lastWin),!0));E("dock:data-menu",({anchor:t,onPick:e,at:o}={})=>!t||!a.lastWin?!1:(kt(a.lastWin.document),w(a.lastWin.document),Xs(a.lastWin,t,e,o),!0));E("dock:props",()=>a.lastProps.map(t=>({...t})));E("dock:set-props",({win:t,props:e}={})=>!Array.isArray(e)||mt()?!1:(a.lastProps=e,a.propsDirty=!0,Aa(ie(Tt())),J((t||a.lastWin)?.document),!0));function ie(t){const e=/^view:partials\/(components\/[A-Za-z0-9_-]+)$/.exec(String(t||""));return e?e[1]:""}E("dock:component-src",()=>ie(Tt()));E("dock:type-stack",()=>a.typeStack.map(t=>({type:t,src:ie(t)})));E("dock:component-exit-state",()=>{const t=ie(Tt());return{open:!!t,name:t?t.split("/").pop():"",back:a.typeStack.length>0}});E("dock:exit-component",(t=1)=>{if(!a.lastWin||!ie(Tt()))return!1;if(a.typeStack.length){for(let e=Number(t)||1;e>1&&a.typeStack.length>1;e-=1)a.typeStack.pop();xs(a.lastWin)}else Ks(a.lastWin.document);return!0});E("dock:current-type",()=>Tt());E("dock:on-empty-page",()=>!!a.onEmptyPage);E("dock:current-uid",()=>a.lastUid);E("dock:save-settled",()=>a.saveInFlight||null);E("dock:load-settled",()=>a.loadInFlight||null);E("dock:reset-data-vars",t=>(gi(typeof t=="string"&&t?t:void 0),!0));E("dock:refresh-preview",()=>a.lastWin?(ke(a.lastWin),!0):!1);E("dock:open-template",t=>typeof t!="string"||!t||!a.lastWin?!1:(bs(a.lastWin,t),!0));E("dock:set-html",t=>{if(typeof t!="string"||mt())return!1;const e=v.html;if(!e||!a.lastWin)return!1;if(t===""){a.saveTimer&&(clearTimeout(a.saveTimer),a.saveTimer=null),a.twDirty=!1,a.twCss=null,a.twKey="",a.lastType=null,a.lastUid=null,a.lastParts={html:"",css:"",js:""},a.cssFull="",a.htmlFull="",a.applying=!0;try{De();for(const s of it){const r=v[s];if(!r)continue;const i=r.state.doc.toString();i!==""&&r.dispatch({changes:{from:0,to:i.length,insert:""}})}}finally{a.applying=!1}return!0}const o=a.htmlFull;if(a.htmlFull=t,a.htmlScopeActive)return a.htmlFocus=qd(a.htmlFocus,o,t),Pe(ws()),nt(a.lastWin),go("dock:html-changed"),!0;const n=e.state.doc.toString();if(n!==t){const[s,r,i]=vs(n,t);e.dispatch({changes:{from:s,to:r,insert:i}})}return!0});E("dock:show-empty",()=>St("dock:set-html",""));$e("row:removed",({parentPath:t,remaining:e,win:o})=>{e===0&&t===Kt(o)&&St("dock:show-empty")});function qd(t,e,o){const n=o.length-e.length;if(!t||!n)return t;let s=0;for(;s<e.length&&s<o.length&&e[s]===o[s];)s+=1;return s>=t.to?t:s<t.from?{from:Math.max(0,t.from+n),to:Math.max(0,t.to+n)}:{from:t.from,to:Math.max(t.from,t.to+n)}}const O="__sve-data-menu";let lo=null;function kt(t){const e=t?.getElementById(O);lo?.(),lo=null,e?._sveApp?.unmount(),e?.remove(),t?.querySelector("[data-sve-data-vars][data-open]")?.removeAttribute("data-open")}function Vd(t){if(!Gs(t))return{view:"",kind:""};const e=typeof G=="function"?G(t.document):[];for(const o of e){const n=pt(o.values)||o.values,s=typeof n?.source_collection=="string"?n.source_collection.trim():"";if(s)return{view:s,kind:String(n?.kind||"").trim()}}return{view:"",kind:""}}function Ud(t,e){const o=zt();if(Number.isFinite(e))return Zo(o,e);const n=v.html;if(!n)return[];const s=a.htmlScopeActive&&a.htmlFocus?a.htmlFocus.from:0;return Zo(o,s+n.state.selection.main.from)}function Kd(t,e){const{view:o,kind:n}=Vd(t);return{collection:ss(t)||"",set:rs(Tt()),view:o,kind:n,scope:mi(Ud(t,e))}}function Gd(t){const e=typeof G=="function"?G(t.document):[];for(const o of e){const n=pt(o.values)||o.values;if(n&&typeof n=="object")return n}return null}function Xd(t,e){return{scope:e?.scope?.groups||[],section:ls(e?.section||[],ys(t)),page:bi(e?.page||[],Gd(t)),site:e?.site||[]}}function Zd(t,e){const o=xi(t,e),n=v.html;if(!o||!n||n.state.readOnly)return;const s=n.state.selection.main,r=n.state.doc.lineAt(s.from),i=ct(r.text),l=yo(o.text,i);n.dispatch({changes:{from:s.from,to:s.to,insert:l},selection:{anchor:s.from+o.cursor+(o.text.includes(`
`)?i.length:0)}}),V()}function Ze(t,e,o){const n=e.getBoundingClientRect(),s=8,r=o.offsetWidth||368,i=o.offsetHeight||240,l=t.innerHeight-n.bottom-s,c=n.top-s,d=l>=i||l>=c?n.bottom+4:n.top-i-4;o.style.left=`${Math.max(s,Math.min(n.left,t.innerWidth-r-s))}px`,o.style.top=`${Math.max(s,Math.min(d,t.innerHeight-i-s))}px`}function Xs(t,e,o,n){const s=t.document;kt(s),e.setAttribute("data-open","");const r=s.createElement("div");r.id=O,s.body.appendChild(r);const i=Kd(t,n),l=p=>[p?.scope?.groups?.length?{id:"scope",label:p.scope.label||m(t,"data_vars_tab_loop")}:null,{id:"section",label:m(t,"data_vars_tab_section")},{id:"page",label:m(t,"data_vars_tab_page")},{id:"site",label:m(t,"data_vars_tab_site")}].filter(Boolean),c=p=>{s.getElementById(O)&&(r._sveApp?.unmount(),r._sveApp=q(pi,r,{title:m(t,"data_vars_title"),placeholder:m(t,"data_vars_placeholder"),emptyText:m(t,"data_vars_empty"),noSectionText:m(t,"data_vars_no_section"),loopText:m(t,"data_vars_loop"),tabs:l(p),data:Xd(t,p),onPick:(y,b)=>o?o(y,b):Zd(y,b)}),Ze(t,e,r))};c(as(wo(i))||{scope:null,section:[],page:[],site:[]}),is(t,i).then(c),Ze(t,e,r);const d=()=>Ze(t,e,r),h=p=>{!r.contains(p.target)&&!e.contains(p.target)&&kt(s)},f=p=>{p.key==="Escape"&&kt(s)};s.addEventListener("pointerdown",h,!0),s.addEventListener("keydown",f,!0),t.addEventListener("scroll",d,!0),t.addEventListener("resize",d),lo=()=>{s.removeEventListener("pointerdown",h,!0),s.removeEventListener("keydown",f,!0),t.removeEventListener("scroll",d,!0),t.removeEventListener("resize",d)}}function Yd(t,e){const o=e.querySelector("[data-sve-data-vars]");!o||o._sveBound||(o._sveBound=!0,o.addEventListener("mousedown",n=>n.preventDefault()),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),t.document.getElementById(O)){kt(t.document);return}w(t.document),Xs(t,o)}))}function Jd(t,e){const o=e.querySelector("[data-sve-antlers-tools]");!o||o._sveBound||(o._sveBound=!0,$t(o,ns,{label:m(t,"code_dock_antlers"),groups:Fa.map(n=>({id:n.id,label:m(t,n.lang),items:Ia.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>Qd(n)}))}function Qd(t){const e=Oa(t),o=v.html;if(!e||!o||o.state.readOnly)return;const n=o.state.selection.main.head,s=o.state.doc.lineAt(n),r=s.text.trim()?ct(s.text):Re(o,s)||ct(s.text),{text:i,cursor:l}=ve(e.snippet);Ot(yo(i,r),l),V()}function tu(t,e){const o=e.querySelector("[data-sve-visual-edit-tools]");!o||o._sveBound||(o._sveBound=!0,$t(o,ns,{label:m(t,"code_dock_visual_edit"),groups:ki.map(n=>({id:n.id,label:m(t,n.lang),items:cs.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>ou(n)}))}function eu(t,e,o,n){if(_i(o.inner,n.attr)){t.focus();return}const{text:s,cursor:r}=ve(n.attr);let i=o.closeIdx;for(;i>o.openIdx+2&&/\s/.test(e[i-1]);)i--;t.dispatch({changes:{from:i,to:o.closeIdx,insert:` ${s} `},selection:{anchor:i+1+r}}),V()}function ou(t){const e=Si(t),o=v.html;if(!e||!o||o.state.readOnly)return;const n=o.state.doc.toString(),s=ee();if(s?.open){const f=wi(n,s.open.from,s.open.to,ue);if(f){e.attr?eu(o,n,f,e):(o.dispatch({selection:{anchor:f.openIdx+2+ue.length}}),o.focus());return}const p=s.open.from+1+s.name.length,y=e.standalone||`{{ ${ue} ${e.attr} }}`,{text:b,cursor:B}=ve(y);o.dispatch({changes:{from:p,to:p,insert:` ${b}`},selection:{anchor:p+1+B}}),V();return}const r=o.state.selection.main.head,i=o.state.doc.lineAt(r),l=i.text.trim()?ct(i.text):Re(o,i)||ct(i.text),c=e.standalone||`{{ ${ue} ${e.attr} }}`,{text:d,cursor:h}=ve(c);Ot(yo(d,l),h),V()}function nu(t){return t==="css"?yr():t==="js"?br():vr({autoCloseTags:!0})}function Cn(t){if(t._sveShield)return;t._sveShield=!0;const e=o=>o.stopPropagation();for(const o of["keydown","keypress","keyup","pointerdown","pointerup","mousedown","mouseup","click","focusin"])t.addEventListener(o,e)}function su(t){try{return new URLSearchParams(t.defaultView?.location?.search||"").has("sve-panel")}catch{return!1}}function ru(t){const e=parseInt(tt(t,Sr)??"",10);return Number.isFinite(e)&&e>=Tr?e:wu}function au(t,e){K(t,Sr,String(e))}function Zs(t){try{const e=JSON.parse(tt(t,wr)||"null");if(e&&typeof e=="object")return{html:e.html!==!1,css:e.css!==!1,js:e.js===!0,alpine:e.alpine===!0}}catch{}return{html:!0,css:!0,js:!1,alpine:!1}}function iu(t,e){K(t,wr,JSON.stringify(e))}function Ys(t){try{const e=JSON.parse(tt(t,_r)||"null");if(e&&typeof e=="object"){const o=s=>Number.isFinite(s)&&s>0?s:1,n={};for(const s of _t)n[s]=o(e[s]);return n}}catch{}return Object.fromEntries(_t.map(e=>[e,1]))}function lu(t,e){K(t,_r,JSON.stringify(e))}function cu(t){sa(t,Su,`
