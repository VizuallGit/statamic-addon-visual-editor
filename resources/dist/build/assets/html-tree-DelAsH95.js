import{_ as ie,o as f,c as p,a as b,t as x,b as je,r as be,m as U,u as d,d as _,F as O,e as N,w as z,f as h,K as Ae,L as ze,n as xe,I as Te,j as v,i as A,M as g,l as Ue,x as le,s as k,h as Ne,B as we,R as Ve,C as We,N as qe,E as Ye,G as Ke,O as Xe}from"./addon-BJYv3p6P.js";import{i as _e,m as Ge,l as Je,B as Ze,C as Qe,p as et,f as tt}from"./tailwind-complete-CSJ8XaZ4.js";import{H as nt,a as ot}from"./html-pick-align-gkRPeJkt.js";const rt={class:"sve-html-tree"},st={class:"sve-pane-bar","data-sve-pane-bar":""},it={"data-sve-right-title":""},lt={__name:"HtmlTreePane",props:{title:{type:String,default:""}},setup(e){return(t,o)=>(f(),p("div",rt,[b("div",st,[b("div",it,x(e.title),1),o[0]||(o[0]=je('<div data-sve-right-actions data-v-7e4f6dc5><button type="button" data-sve-right-pin aria-pressed="false" data-v-7e4f6dc5></button><button type="button" data-sve-close aria-label="Close" data-v-7e4f6dc5><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" data-v-7e4f6dc5><path d="M18 6 6 18" data-v-7e4f6dc5></path><path d="m6 6 12 12" data-v-7e4f6dc5></path></svg></button></div>',1))]),o[1]||(o[1]=b("div",{"data-sve-html-tree-list":""},null,-1)),o[2]||(o[2]=b("div",{"data-sve-tw-classes":""},null,-1))]))}},Ce=ie(lt,[["__scopeId","data-v-7e4f6dc5"]]),l=be({emptyText:"",rows:[],editingId:null,draft:"",renameTitle:"",hideTitle:"",showTitle:"",duplicateTitle:"",deleteTitle:"",canEdit:!1,dragging:!1,dropId:null,dropPlace:null,onSelect:null,onTwist:null,onRename:null,onRenameCommit:null,onRenameCancel:null,onHide:null,onDuplicate:null,onDelete:null,onPointerDown:null}),at={key:0,class:"sve-ht-empty"},ct=["title","onClick","onDblclick","onKeydown","onPointerdown"],dt=["onClick"],ut={key:1,"data-sve-ht-letter":""},ft=["innerHTML"],pt=["title"],ht={"data-sve-ht-tag":""},mt={key:1,"data-sve-ht-name":""},vt={key:3,"data-sve-ht-actions":""},gt=["title","innerHTML","onClick"],yt=["title","onClick"],kt=["title","onClick"],bt='<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',xt='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>',Tt='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3l18 18"/><path d="M10.6 10.6a2 2 0 0 0 2.8 2.8"/><path d="M9.9 5.1A10.8 10.8 0 0 1 12 5c6 0 10 7 10 7a17.6 17.6 0 0 1-3.1 3.9"/><path d="M6.1 6.1A17.6 17.6 0 0 0 2 12s4 7 10 7a10.8 10.8 0 0 0 3.1-.5"/></svg>',wt='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="8" y="8" width="12" height="12" rx="2"/><path d="M4 16V6a2 2 0 0 1 2-2h10"/></svg>',_t='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6"/><path d="M10 11v6M14 11v6"/></svg>',Ct={__name:"HtmlTreeList",setup(e){function t(r){return r.name?`${r.tag} ${r.name}`:r.tag}function o(r){const s={"data-sve-ht-id":r.id};return r.current&&(s["data-sve-ht-current"]=""),r.hidden&&(s["data-sve-ht-hidden"]=""),l.dropId===r.id&&l.dropPlace&&(s["data-sve-ht-drop"]=l.dropPlace),s}function n(r){return!r.hidden||r.wrapFrom!=null}return(r,s)=>(f(),p("div",U({class:"sve-ht-root"},d(l).dragging?{"data-sve-ht-dragging":""}:{}),[d(l).rows.length?_("",!0):(f(),p("div",at,x(d(l).emptyText),1)),(f(!0),p(O,null,N(d(l).rows,i=>(f(),p("div",U({key:i.id,"data-sve-ht-row":""},{ref_for:!0},o(i),{role:"button",tabindex:"0",title:t(i),style:{marginLeft:i.depth*12+"px"},onClick:a=>d(l).onSelect?.(i.id),onDblclick:h(a=>d(l).onRename?.(i.id),["prevent"]),onKeydown:[z(h(a=>d(l).onSelect?.(i.id),["prevent"]),["enter"]),z(h(a=>d(l).onSelect?.(i.id),["prevent"]),["space"])],onPointerdown:a=>d(l).onPointerDown?.(a,i.id)}),[i.hasChildren?(f(),p("button",U({key:0,type:"button","data-sve-ht-twist":""},{ref_for:!0},i.shut?{"data-sve-ht-shut":""}:{},{innerHTML:bt,onClick:h(a=>d(l).onTwist?.(i.id),["stop","prevent"]),onPointerdown:s[0]||(s[0]=h(()=>{},["stop"])),onDblclick:s[1]||(s[1]=h(()=>{},["stop"]))}),null,16,dt)):_("",!0),i.letter?(f(),p("span",ut,x(i.letter),1)):(f(),p("span",{key:2,"data-sve-ht-icon":"",innerHTML:i.svg},null,8,ft)),b("span",{"data-sve-ht-text":"",title:d(l).renameTitle},[b("span",ht,x(i.tag),1),d(l).editingId===i.id?Ae((f(),p("input",{key:0,"data-sve-ht-rename":"","onUpdate:modelValue":s[2]||(s[2]=a=>d(l).draft=a),onMousedown:s[3]||(s[3]=h(()=>{},["stop"])),onPointerdown:s[4]||(s[4]=h(()=>{},["stop"])),onClick:s[5]||(s[5]=h(()=>{},["stop"])),onDblclick:s[6]||(s[6]=h(()=>{},["stop"])),onKeydown:[s[7]||(s[7]=h(()=>{},["stop"])),s[8]||(s[8]=z(h(a=>d(l).onRenameCommit?.(),["prevent"]),["enter"])),s[9]||(s[9]=z(h(a=>d(l).onRenameCancel?.(),["prevent"]),["escape"]))],onBlur:s[10]||(s[10]=a=>d(l).onRenameCommit?.())},null,544)),[[ze,d(l).draft]]):(f(),p("span",mt,x(i.name),1))],8,pt),d(l).canEdit?(f(),p("span",vt,[d(l).canEdit&&n(i)?(f(),p("button",{key:0,type:"button","data-sve-ht-eye":"",title:i.hidden?d(l).showTitle:d(l).hideTitle,innerHTML:i.hidden?Tt:xt,onClick:h(a=>d(l).onHide?.(i.id),["stop","prevent"]),onPointerdown:s[11]||(s[11]=h(()=>{},["stop"])),onDblclick:s[12]||(s[12]=h(()=>{},["stop"]))},null,40,gt)):_("",!0),d(l).canEdit?(f(),p("button",{key:1,type:"button","data-sve-ht-dup":"",title:d(l).duplicateTitle,innerHTML:wt,onClick:h(a=>d(l).onDuplicate?.(i.id),["stop","prevent"]),onPointerdown:s[13]||(s[13]=h(()=>{},["stop"])),onDblclick:s[14]||(s[14]=h(()=>{},["stop"]))},null,40,yt)):_("",!0),d(l).canEdit?(f(),p("button",{key:2,type:"button","data-sve-ht-del":"",title:d(l).deleteTitle,innerHTML:_t,onClick:h(a=>d(l).onDelete?.(i.id),["stop","prevent"]),onPointerdown:s[15]||(s[15]=h(()=>{},["stop"])),onDblclick:s[16]||(s[16]=h(()=>{},["stop"]))},null,40,kt)):_("",!0)])):_("",!0)],16,ct))),128))],16))}},Ht=ie(Ct,[["__scopeId","data-v-a292d01e"]]);function ne(e,t){for(const o of e||[]){if(o.id===t)return o;const n=ne(o.children,t);if(n)return n}return null}function He(e,t){return(e.children||[]).some(o=>o.id===t||He(o,t))}function D(e,t){let o=t.wrapFrom??t.from,n=t.wrapTo??t.to;return o>0&&e[o-1]===`
...
`,o+1);return e.slice(o+1,n===-1?e.length:n).trim()!==""?e:e.slice(0,o)+e.slice(n===-1?e.length:n)}function qt(e,t,o){const n=ae(e,t.from,t.openTo);return n?e.slice(0,n.from)+o+e.slice(n.to):e}const Yt=[...Object.keys(Ze),...Object.keys(Qe),"text","leading","font","rounded"].sort((e,t)=>t.length-e.length);let ee=null;function Kt(e){return ee||(ee=Je(e).then(Xt)),ee}function Me(e){const t=String(e||"");if(t.includes(";"))return"";const o=t.indexOf(":");return o===-1?"":t.slice(0,o).trim()}function Xt(e){const t=new Map,o=new Map,n=new Map;for(const r of e.items){const s=Me(r.css);s&&(t.has(s)||t.set(s,[]),t.get(s).push(r),o.set(r.label,s));const i=Le(r.label);i&&(n.has(i)||n.set(i,[]),n.get(i).push(r))}return{catalog:e,byProperty:t,propertyOfUtility:o,byPrefix:n}}function Le(e){for(const t of Yt)if(String(e).startsWith(`${t}-`))return t;return""}function Gt(e,t){if(!t||!e)return null;const o=t.propertyOfUtility.get(e);if(o)return{label:o,options:t.byProperty.get(o)||[]};const n=Le(e),r=n?t.byPrefix.get(n):null;return r?.length?{label:Me(r[0].css)||n,options:r}:null}function Jt(e,t){return t?.catalog?.byUtility?.get(e)?.css||""}function Zt(e,t){return t?.catalog?.byUtility?.get(e)?.color||""}const m=be({emptyText:"",tag:"",scope:"",scopeTitle:"",baseLabel:"",groups:[],canEdit:!1,onChip:null}),Qt={class:"sve-tw"},en={key:0,class:"sve-tw-head"},tn={class:"sve-tw-tag"},nn=["title"],on={key:1,class:"sve-tw-empty"},rn=["data-sve-tw-base"],sn={class:"sve-tw-chips"},ln=["title","onClick"],an={__name:"TwClassList",setup(e){function t(o){const n={"data-sve-tw-chip":o.id};return o.locked&&(n["data-sve-tw-locked"]=""),o.open&&(n["data-open"]=""),n}return(o,n)=>(f(),p("div",Qt,[d(m).tag?(f(),p("div",en,[b("span",tn,"<"+x(d(m).tag)+">",1),d(m).scope?(f(),p("span",{key:0,class:"sve-tw-scope",title:d(m).scopeTitle},x(d(m).scope),9,nn)):_("",!0)])):_("",!0),d(m).groups.length?_("",!0):(f(),p("div",on,x(d(m).emptyText),1)),(f(!0),p(O,null,N(d(m).groups,r=>(f(),p("div",{key:r.key,class:"sve-tw-group"},[b("span",{class:"sve-tw-variant","data-sve-tw-base":r.key===""?"":void 0},x(r.key===""?d(m).baseLabel:r.key),9,rn),b("div",sn,[(f(!0),p(O,null,N(r.chips,s=>(f(),p("button",U({key:s.id,type:"button"},{ref_for:!0},t(s),{title:s.title,onClick:h(i=>d(m).onChip?.(i,s.id),["prevent","stop"])}),[s.color?(f(),p("span",{key:0,class:"sve-tw-dot",style:xe({background:s.color})},null,4)):_("",!0),Te(" "+x(s.raw),1)],16,ln))),128))])]))),128))]))}},Ie=ie(an,[["__scopeId","data-v-bc11f8d2"]]),cn={key:0,"data-sve-tw-menu-title":""},dn={"data-sve-tw-menu-list":""},un=["data-active","title","onClick"],fn={"data-sve-tw-tick":""},pn={"data-sve-tw-label":""},hn={__name:"TwClassMenu",props:{title:{type:String,default:""},options:{type:Array,default:()=>[]},removeLabel:{type:String,default:""},onPick:{type:Function,required:!0},onRemove:{type:Function,required:!0}},setup(e){return(t,o)=>(f(),p(O,null,[e.title?(f(),p("div",cn,x(e.title),1)):_("",!0),b("div",dn,[(f(!0),p(O,null,N(e.options,n=>(f(),p("button",{key:n.label,type:"button","data-sve-tw-option":"","data-active":n.active?"":void 0,title:n.css,onClick:h(r=>e.onPick(n.label),["prevent","stop"])},[b("span",fn,x(n.active?"✓":""),1),n.color?(f(),p("span",{key:0,"data-sve-tw-dot":"",style:xe({background:n.color})},null,4)):_("",!0),b("span",pn,x(n.label),1)],8,un))),128))]),b("button",{type:"button","data-sve-tw-remove":"",onClick:o[0]||(o[0]=h(n=>e.onRemove(),["prevent","stop"]))},[o[1]||(o[1]=b("span",{"data-sve-tw-tick":""},"✕",-1)),Te(x(e.removeLabel),1)])],64))}},T="__sve-tw-menu",me="__sve-tw-style";let w=null,V=new Map,F=null,te=!1,G="",oe=null;function ce(e){return null}function Se(e){if(e.getElementById(me))return;const t=e.createElement("style");t.id=me,t.textContent=`
    #${T} {
      ...
      color: inherit;
      box-shadow: 0 0.5rem 1.5rem rgba(0,0,0,.24);
      font-size: 0.6875rem;
    }
