...
${l}
${f??""}${c.slice(d)}`}function _l(t,e){const o=me(t).find(n=>n.prelude.includes(e));return o?o.bodyTo:me(t)[0]?.bodyTo??-1}function $l(t,e,o){let n=e,s=o;const r=t.lastIndexOf(`
...
`,e-1)+1;return(t.slice(o,e).match(/^\s*/)||[""])[0]}function J(t){const e=g.css;if(!e||e.state.readOnly||!t.length)return;const o=Ie(),n=t.some(l=>l.value!=null)?ec(e,o):o;if(!n){const l=t.filter(c=>c.value!=null).map(c=>`${c.property}: ${c.value};`).join(`
