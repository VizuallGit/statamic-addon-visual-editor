...
import{_ as we,k as Z,l as bn,p as At,o as v,a as g,b as S,s as b,t as x,F as H,w as Ye,d as N,b4 as Tn,g as P,v as Rt,b5 as Mt,y,h as f,j as le,C as _n,i as st,b6 as vt,b7 as gt,b8 as xn,b9 as Sn,ba as wn,bb as Dt,z as se,ap as Cn,bc as o,u,f as $n,e as Pn,q as G,x as En,bd as Ce,be as Ln,B as ke,c as ge,N as Hn,G as In,aN as at,aq as Ze,am as An,aP as Ot,aQ as Bt,af as Rn,ag as kt,S as $e,V as Pe,O as Mn,aO as Dn,an as On,ao as Bn,bf as yt,bg as Fn,U as rt,A as Ft,a8 as Be,J as jt,K as qt,ax as Kt,ay as Ee,I as jn,bh as qn,aS as Kn,aT as Vn,aw as Nn,bi as zn,b0 as Un,ae as Vt,aK as Xn,aF as Wn}from"./addon-BRXzxCsD.js";import{M as ae,S as re}from"./protocol-D3FYhCm9.js";import{D as j,E as Yn,F as it,G as Zn,t as Gn,I as lt,v as Jn,z as Qn,b as Te,l as bt,J as Nt,q as eo,K as ct,L as to,H as zt,M as dt,N as Ut,O as no,h as oo,c as so,Q as ao,R as ro,S as io,T as lo,U as co,V as uo,W as ho,X as po,Y as fo,Z as mo}from"./tw-classes-D66FAKgV.js";import{canEditFields as vo,currentSetHandle as go,openFieldsetOverlay as ko}from"./section-fields-DjRLIsT7.js";import{a as yo}from"./html-pick-align-CK-9iH9_.js";import"./ai-text-icon-B7uCWIwa.js";import"./FieldsetOverlay-CJmESKQA.js";const bo={class:"sve-dialog__title"},To={for:"sve-new-section-group"},_o=["value"],xo={for:"sve-new-section-name"},So=["placeholder"],wo={key:1,class:"sve-dialog__note"},Co={class:"sve-dialog__actions"},$o=["disabled"],Po=["disabled"],Eo={__name:"NewSectionPrompt",props:{heading:{type:String,required:!0},groupLabel:{type:String,required:!0},nameLabel:{type:String,required:!0},placeholder:{type:String,default:""},note:{type:String,default:""},groups:{type:Array,required:!0},cancelLabel:{type:String,required:!0},saveLabel:{type:String,required:!0},onOk:{type:Function,required:!0},onClose:{type:Function,required:!0}},setup(e){const t=e,s=Z(""),n=Z(t.groups[0]?.key??""),a=Z(null),i=Z(!1);bn(()=>At(()=>a.value?.focus()));function r(){const h=s.value.trim();if(!h||t.groups.length&&!n.value||i.value){a.value?.focus();return}i.value=!0,t.onOk(h,n.value)}function c(h){h.target===h.currentTarget&&t.onClose()}function k(h){h.key==="Enter"?r():h.key==="Escape"&&t.onClose()}return(h,d)=>(v(),g("div",{class:"sve-dialog-overlay",onClick:c},[S("div",{class:"sve-dialog",onClick:d[3]||(d[3]=b(()=>{},["stop"]))},[S("div",bo,x(e.heading),1),e.groups.length?(v(),g(H,{key:0},[S("label",To,x(e.groupLabel),1),Ye(S("select",{id:"sve-new-section-group","onUpdate:modelValue":d[0]||(d[0]=l=>n.value=l),onKeydown:k},[(v(!0),g(H,null,N(e.groups,l=>(v(),g("option",{key:l.key,value:l.key},x(l.display),9,_o))),128))],544),[[Tn,n.value]])],64)):P("",!0),S("label",xo,x(e.nameLabel),1),Ye(S("input",{id:"sve-new-section-name",ref_key:"input",ref:a,"onUpdate:modelValue":d[1]||(d[1]=l=>s.value=l),type:"text",placeholder:e.placeholder,onKeydown:k},null,40,So),[[Rt,s.value]]),e.note?(v(),g("p",wo,x(e.note),1)):P("",!0),S("div",Co,[S("button",{type:"button",class:"is-cancel",disabled:i.value,onClick:d[2]||(d[2]=(...l)=>e.onClose&&e.onClose(...l))},x(e.cancelLabel),9,$o),S("button",{type:"button",class:"is-primary",disabled:i.value,onClick:r},x(e.saveLabel),9,Po)])])]))}},Xt=we(Eo,[["__scopeId","data-v-f3280273"]]),Wt="/!/sve/section-types";async function Lo(e){const t=await e.fetch(Wt,{headers:{Accept:"application/json"},credentials:"same-origin"});if(!t.ok)throw new Error(`section-types ${t.status}`);const s=await t.json(),n=new Map;for(const a of s.types||[])a?.group&&!n.has(a.group)&&n.set(a.group,a.group_display||a.group);return[...n].map(([a,i])=>({key:a,display:i}))}async function Ho(e,{display:t,group:s}){const n=await e.fetch(Wt,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":st(e),Accept:"application/json"},credentials:"same-origin",body:JSON.stringify({display:t,group:s})}),a=await n.json().catch(()=>({}));if(!n.ok){const i=new Error(a.error||`section-types ${n.status}`);throw i.reason=a.error,i}return a}async function Io(e,t,s=null){if(!t||typeof vt!="function"||typeof gt!="function")return null;const n=await vt(e,t);if(!n)return null;const a=xn(),i=Sn(e,"page",{handle:t},n?.defaults,a),r=wn(i,n?.new||{},n?.defaults);return gt(e,e.document,s,i,r)?i:null}const Tt=700,Ao=17;function Ro(e,t){const s=(t||[]).filter(Boolean);if(!s.length)return;let n=0;const a=()=>{n+=1;const i=Dt(e),r=i?s.some(c=>i.querySelector(`[data-sid="${CSS.escape(c)}"]`)):!0;r&&se({source:re,type:ae.SVE_ACTIVATE,ids:s},e),(r?!i&&n<6:n<Ao)&&e.setTimeout(a,Tt)};e.setTimeout(a,Tt)}function Mo(e){return e.Statamic?.$permissions?.has?.("configure fields")===!0}function Do(e){return new Promise(t=>{let s=!1;const n=i=>{s||(s=!0,a.dismiss(),t(i==="static"||i==="fields"?i:null))},a=le(e.document,_n,{title:f(e,"section_new_kind"),body:f(e,"section_new_kind_note"),buttons:[{value:"cancel",label:f(e,"cancel"),variant:"ghost"},{value:"static",label:f(e,"section_new_static"),variant:"primary"},{value:"fields",label:f(e,"section_new_with_fields"),variant:"primary"}],onPick:n,onClose:()=>n(null)})})}const Oo=`<section class="[ ] py-800">
...
`):t.join(`
`)}function Sa(e){return String(e||"").match(/^\n?[ \t]*/)[0]}async function wa(e,t){if(!Gn(e))return"";try{return await(await In(()=>import("./tw-compile-D8Xdoe3O.js"),__vite__mapDeps([0,1]),import.meta.url)).compileTailwind(e,t)||""}catch(s){return console.error("[sve] component tailwind compile",s),""}}async function Ca(e,t){const s=await e.fetch(_a,{method:"POST",credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest","X-CSRF-TOKEN":st(e),Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify(t)});if(!s.ok){const n=new Error(String(s.status));throw n.status=s.status,n}return s.json()}function wt(e,t){const{from:s,to:n}=Zn(e,t),a=e.slice(s,n);if(!a.trim())return null;const i=e.slice(0,s)+e.slice(n),r=y("dock:css"),c=on(typeof r=="string"?r:"",a,i);return{html:xa(a),css:c.move,keepCss:c.keep,lead:Sa(a),from:s,to:n}}function $a(e,t,{onDone:s,onError:n}={}){if(y("dock:is-locked")===!0)return;const a=y("dock:html");if(typeof a!="string"||!t)return;const i=wt(a,t);if(!i)return;const r=le(e.document,Hn,{heading:f(e,"component_new"),nameLabel:f(e,"component_name"),placeholder:f(e,"component_name_placeholder"),value:t.klass||t.tag||"",cancelLabel:f(e,"cancel"),saveLabel:f(e,"component_create"),onOk:c=>{r.dismiss(),(async()=>{try{const k=await wa(e,i.html),h=y("dock:html"),d=typeof h=="string"&&h===a?i:wt(h,t);if(!d)return;const l=await Ca(e,{name:c,html:d.html,css:d.css,js:"",tw:k}),m=y("dock:html"),$=m.slice(0,d.from)+d.lead+l.tag+m.slice(d.to);y("dock:set-html",$),d.css.trim()&&y("dock:set-css",d.keepCss),s?.(l)}catch(k){n?.(k)}})()}})}function Pa(e,t,s){const n=String(e||"");if(!t||t.kind!=="antlers")return n;const a=String(s||"").replace(/\s+/g," ").trim();return t.antlers==="loop"?Ia(n,t,a):t.tag==="else"||!a?n:n.slice(0,t.from)+`{{ ${t.tag} ${a} }}`+n.slice(t.openTo)}function Ge(e,t,s,n){return ye(e,t,{kind:s,name:n})}function ye(e,t,s={}){const n=String(e||"");if(!t||t.antlers!=="loop")return n;const a=t.loopKind==="collection"?"collection":"field",i=s.kind??a,r=String(s.name??t.expr??"").trim();if(!/^[A-Za-z_][A-Za-z0-9_-]*$/.test(r))return n;const c=s.sortDir??t.sortDir??"",k=String(s.sortField??t.sortField??"").trim(),h=String(s.limit??t.limit??"").trim(),d=sn(n,t);if(!d)return n;const l=i===a?t.params:"",m=i==="collection"?Ea(r,k,c,h,l):La(r,k,c,h,l),$=i==="collection"?"collection":r;return n.slice(0,t.from)+m+n.slice(t.openTo,d.from)+`{{ /${$} }}`+n.slice(d.to)}function Ea(e,t,s,n,a){const i=Ha(a).replace(/\bsort\s*=\s*["'][^"']*["']/g,"").replace(/\blimit\s*=\s*["']?\d+["']?/g,"").replace(/\s+/g," ").trim(),r=[`collection from="${e}"`];return s==="random"?r.push('sort="random"'):t&&r.push(`sort="${t}${s==="desc"?":desc":":asc"}"`),n&&r.push(`limit="${n}"`),i&&r.push(i),`{{ ${r.join(" ")} }}`}function La(e,t,s,n,a){const i=String(a||"").split("|").map(c=>c.trim()).filter(c=>c&&!/^from\s*=/.test(c)&&!/^sort\s*:/.test(c)&&!/^reverse$/.test(c)&&!/^shuffle$/.test(c)&&!/^limit\s*:/.test(c)),r=[e,...i];return s==="random"?r.push("shuffle"):t&&(r.push(`sort:${t}`),s==="desc"&&r.push("reverse")),n&&r.push(`limit:${n}`),`{{ ${r.join(" | ")} }}`}function Ha(e){return String(e||"").replace(/\bfrom\s*=\s*["'][A-Za-z0-9_-]+["']/,"").replace(/\s+/g," ").trim()}function sn(e,t){const n=e.slice(t.from,t.to).match(/\{\{\s*(?:\/[A-Za-z_][A-Za-z0-9_.:-]*|endif)\s*\}\}\s*$/);return n?{from:t.from+n.index,to:t.from+n.index+n[0].length}:null}function Ia(e,t,s){return ye(e,t,{name:s})}function Aa(e,t,s){const n=String(e||"");if(!t||t.antlers!=="if"||t.tag==="else")return n;const a=sn(n,t);if(!a)return n;const r=(n.slice(0,a.from).split(`
`).pop()||"").match(/^[ \t]*/)[0],c=s==="else"?"{{ else }}":"{{ elseif true }}";return`${n.slice(0,a.from)}${c}
${r}${n.slice(a.from)}`}const D=to("sve-call-values"),_e=new Set;let Ct=null;const Ra="__sve-html-tree-style",O=new Set;let Je="",he=!1,ze=null,pe=!0,z="",xe=0,an="";const q=new Map,X=new Set;let F="",rn=!1,I=null,He=null,Ie=0,Qe=null,Se=[],te=null,be=null,Ae=null,Re=null,et=null,Me=!1,ne=null,ee=null;function K(e){return e.getElementById($e)}function Ma(e){Rn(e,Ra,`
    [data-sve-ht-row] {
      all: unset;
  ...
  `)}function B(){const e=y("dock:html");return typeof e=="string"?e:""}function ln(e){return!!y("dock:is-open",e)}function me(e,{save:t=!1}={}){return ht()||y("dock:set-html",e)!==!0?!1:(t&&y("dock:save-now"),!0)}function $t(e){const t=y("dock:component-exit-state")||{};if(o.exitOpen=!!t.open,!t.open){o.onExit=null;return}o.exitName=t.name||"",o.exitLabel=f(e,"component_exit"),o.exitTitle=f(e,t.back?"component_exit_back":"component_exit_close"),o.onExit=()=>{y("dock:exit-component"),C(e)}}function Da(e,t){const s=Kn(e);if(!s||t.type!==s)return"";const n=Vn(t[s]);return n&&Nn(e,n)?.section_type||""}const ie=[];let Ue=!1,tt=!1;function Xe(e,t){if(typeof e.requestIdleCallback=="function"){e.requestIdleCallback(t,{timeout:2e3});return}e.setTimeout(t,200)}function Oa(e,t){for(const s of t){const n=s.type;!n||q.has(n)||X.has(n)||ie.includes(n)||ie.push(n)}at.htmlTreePrefetchArmed&&ut(e)}function Tr(e){at.htmlTreePrefetchArmed=!0,ut(e)}function ut(e){if(Ue||!ie.length)return;Ue=!0;const t=()=>{const s=ie.shift();if(!s){Ue=!1;return}if(q.has(s)||X.has(s)){Xe(e,t);return}X.add(s),e.fetch(`/!/sve/section-template?type=${encodeURIComponent(s)}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(n=>n.ok?n.json():null).then(n=>{typeof n?.html=="string"&&(q.set(s,n.html),tt&&(tt=!1,C(e)))}).catch(()=>{}).finally(()=>{X.delete(s),Xe(e,t)})};Xe(e,t)}function ht(){return!!F}function Ba(e){const t=new Map,s=Dt(e);if(!s)return t;for(const n of s.querySelectorAll("[data-sid]")){const a=n.getAttribute("data-sid");a&&!t.has(a)&&t.set(a,n.tagName.toLowerCase())}return t}function Fa(e,t){const s=Be(e)||"page_sections";for(const n of jt(t)||[]){const a=qt(n.values),i=a&&typeof a=="object"?a[s]:null;if(Array.isArray(i))return!0}return!1}function cn(e,t){const s=Be(e)||"page_sections",n=Ba(e),a=[];for(const i of jt(t)||[]){const r=qt(i.values),c=r&&typeof r=="object"?r[s]:null;if(Array.isArray(c)){c.forEach(k=>{if(!k||typeof k!="object"||Array.isArray(k)||typeof k.type!="string")return;const h=[k._visual_id,k.id,k._id].filter(w=>typeof w=="string"&&w!=="");if(!h.length)return;const d=Da(e,k)||k.type,l=typeof k._sve_label=="string"?k._sve_label.trim():"",m=h.map(w=>n.get(w)).find(Boolean)||"section",$=nn(k.type)[`0:${m}`];a.push({uid:h[0],ids:h,type:k.type,tag:m,label:(typeof $=="string"&&$.trim()?$.trim():"")||l||Kt(e,d)?.display||Ee(d)||d,svg:ct(m,"",null).svg||zt.section,cat:rt(m),enabled:k.enabled!==!1})});break}}return a}function ja(e,t,s){if(!s.length)return"";const n=y("dock:current-type")||"",a=y("dock:current-uid"),i=!!y("dock:component-exit-state")?.open;if(a){const r=jn(a,t),c=s.find(k=>k.ids.some(h=>r.includes(h)));if(c&&(i||c.type===n))return c.uid}return s.find(r=>r.type===n)?.uid||""}function qa(e,t,s,n){const a=t.find(w=>w.uid===s),i=y("dock:component-src"),r=y("dock:type-stack")||[];if(!a||!i||!r.length)return null;const c=r.map(w=>w.type).filter(w=>!q.get(w));if(c.length)return Ka(e,c),null;const k=[],h=new Set,d=new Set;let l=w=>k.push(...w),m=null,$=0;for(let w=0;w<r.length;w+=1){const M=w+1<r.length?r[w+1].src:i,J=R=>({...R,id:`ctx${w}:${R.id}`,path:`ctx${w}/${R.path}`,ctxLevel:w,children:R.children.map(J)}),ce=Te(q.get(r[w].type)).map(J),de=[],ue=(R,A)=>{for(const L of R){if(L.kind==="component"&&L.src===M)return de.push(...A,L),L;const ve=ue(L.children,[...A,L]);if(ve)return ve}return null};if(m=M?ue(ce,[]):null,!m)return null;const U=new Set(de.map(R=>R.id)),E=(R,A)=>{for(const L of R)L.children.length&&(U.has(L.id)?O.has(L.path):hn(L,A))&&h.add(L.id),E(L.children,A+1)};E(ce,$),l(ce),d.add(m.id),$+=de.length,l=(R=>A=>{R.children=A})(m)}for(const w of pn(n))h.add(w);return O.has(m.path)&&h.add(m.id),m.children=n,{tree:k,folds:h,hostId:m.id,hostIds:d,levels:r.length,rootId:k.find(w=>!w.kind)?.id||"",label:a.label,svg:a.svg,cat:a.cat}}function Ka(e,t){for(const s of t)!ie.includes(s)&&!X.has(s)&&ie.push(s);tt=!0,ut(e)}const We="partials/static/";function Va(e,t){const s=e.findIndex(i=>i.kind==="antlers"&&(i.tag===t||i.handle===t)),n=i=>{const r=String(i.src||"");if(i.kind!=="component"||!r.startsWith(We))return null;const c=`static-${r.slice(We.length)}`;return{uid:c,ids:[c],type:`view:${r}`,tag:"section",label:Ee(r.slice(We.length)),svg:ct("section","",null).svg||zt.section,cat:rt("section"),enabled:!0,static:!0}},a=i=>i.map(n).filter(Boolean);return s===-1?{above:[],below:a(e)}:{above:a(e.slice(0,s)),below:a(e.slice(s+1))}}function Na(e,t,s){const n=y("dock:component-exit-state");if(n?.open)return Ee(n.name)||n.name||"";if(s)return t.find(i=>i.uid===s)?.label||"";const a=y("dock:current-type")||"";return Kt(e,a)?.display||Ee(a)||""}function dn(e,t,s,n,a){const i=s.find(c=>c.uid===n);if(!i||n===a)return;if(O.clear(),I=null,pe=!1,fe(),Fe(),z=n,an=B(),F=q.get(i.type)||"",F&&(I=De(Te(F))||null),rn=(y("dock:current-type")||"")===i.type,e.clearTimeout(xe),xe=e.setTimeout(()=>{z="",he=!1,C(e)},4e3),C(e),i.static){y("dock:open-template",i.type),se({source:re,type:ae.SVE_ACTIVATE,ids:i.ids},e),e.setTimeout(()=>C(e),0);return}const r=()=>Xn(i.uid,t,e,{clampToSection:!0});qn(i.uid,t,e,r),se({source:re,type:ae.SVE_ACTIVATE,ids:i.ids},e),e.setTimeout(()=>C(e),0)}function un(e,t){if(!t)return!1;for(const s of e||[])if(s.id===t||un(s.children,t))return!0;return!1}function De(e){for(const t of e||[]){if(!t.kind)return t.id;const s=De(t.children);if(s)return s}return""}function hn(e,t){return O.has(e.path)?t===0:t>0}function pn(e){const t=new Set,s=(n,a)=>{for(const i of n)i.children.length&&hn(i,a)&&t.add(i.id),s(i.children,a+1)};return s(e,0),t}function C(e){const t=e.document,n=K(t)?.querySelector("[data-sve-html-tree-list]");if(!n)return;Ma(t),Qn(e);const a=B();F&&F===a&&(F="");const i=F||a,r=Te(i);Se=r;const c=y("dock:current-type")||"",k=nn(c),h=Fa(e,t),l=!!(y("dock:component-exit-state")||{}).open,m=h&&!l?Fo(e):"";h&&!l&&!m&&Yt(e).then(p=>{p&&C(e)});const $=!!m&&c===m;m&&!$&&!q.has(m)&&!X.has(m)&&(X.add(m),e.fetch(`/!/sve/section-template?type=${encodeURIComponent(m)}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(p=>p.ok?p.json():null).then(p=>{typeof p?.html=="string"&&(q.set(m,p.html),C(e))}).catch(()=>{}).finally(()=>X.delete(m)));const w=m?Va($?r:Te(q.get(m)||""),Be(e)||"page_sections"):{above:[],below:[]},M=[...w.above,...cn(e,t),...w.below];o.onStaticMade=p=>{m&&q.delete(m),p?.type&&(pe=!1,y("dock:open-template",p.type)),C(e)},c&&a&&!F&&q.set(c,a),Oa(e,M);const J=ja(e,t,M);if(h&&!M.length){Se=[],o.rows=[],o.sections=[],o.pageBuilder=!0,o.emptyText=f(e,"html_tree_empty"),o.canEdit=!y("dock:is-locked"),o.look=yt(e),o.onRefresh=()=>C(e),o.onSection=null,$t(e),Pe(n,_t),Pt(e,[]);return}o.pageBuilder=h;const ce=`${c}|${J}`;let de=!1;ce!==Je&&(Je=ce,O.clear(),ze!==null&&i!==ze?de=!0:he=i),(de||he!==!1&&i!==he)&&(he=!1,O.clear(),I=De(r)||null),ze=i,z&&(z===J||!M.length)&&(rn||i!==an)&&(e.clearTimeout(xe),z="",he=!1,un(r,I)||(O.clear(),I=De(r)||null));const ue=M.some(p=>p.uid===z)?z:"",U=pe?"":ue||J,E=l?qa(e,M,U,r):null,R=!!(ue||J)||$,A=E?bt(E.tree,o.query?new Set:E.folds):$?[]:bt(r,o.query?new Set:pn(r));!i.trim()&&!ln(t)?o.emptyText=f(e,"html_tree_need_dock"):o.emptyText=f(e,"html_tree_empty"),o.slotText=f(e,"antlers_drop_here"),o.dataTitle=f(e,"data_vars_title"),o.pageTitle=f(e,"component_props_page"),o.renameTitle=f(e,"html_tree_rename"),o.tagTitle=f(e,"tw_tag"),o.hideTitle=f(e,"html_tree_hide"),o.showTitle=f(e,"html_tree_show"),o.duplicateTitle=f(e,"html_tree_duplicate"),o.deleteTitle=f(e,"html_tree_delete"),o.lockedTitle=f(e,"html_tree_locked"),o.searchEmpty=f(e,"html_tree_search_empty"),o.canEdit=!y("dock:is-locked"),o.look=yt(e),Fn(e),o.onQuery=()=>C(e),$t(e),o.inComponent=l,o.onContextRow=p=>{if(!E||p===E.hostId)return;const T=A.find(_=>_.id===p)?.ctxLevel??E.levels-1;y("dock:exit-component",E.levels-T),C(e)},o.onSelect=p=>{const T=A.find(_=>_.id===p);T&&Nt(e,T.path)||ft(e,p,A)},o.onTwist=p=>{const T=A.find(_=>_.id===p)?.path;T&&(O.has(T)?O.delete(T):O.add(T),C(e))},o.onTagChange=(p,T)=>{const _=o.rows.find(W=>W.id===T);_&&!ht()&&eo(e,p.currentTarget,_)},o.onRename=p=>Ua(e,p),o.onRenameCommit=()=>Et(e,!0),o.onRenameCancel=()=>Et(e,!1),o.onHide=p=>Xa(e,p),o.onDuplicate=p=>Wa(e,p),o.onDelete=p=>Za(e,p),o.onPointerDown=(p,T)=>er(e,p,T),o.onContext=(p,T)=>Ja(e,p,T),o.onInspectCommit=p=>rr(e,p),o.onPropValue=(p,T,_)=>It(e,p,T,_),o.onPropPage=(p,T)=>fa(e,p,_=>It(e,T,_,!1)),o.onLoopKind=p=>ir(e,p),o.onAddBranch=p=>lr(e,p),o.onLoopSortField=p=>{const T=Oe(),_=String(p||"").trim();if(!T)return;const W=ee?.id===T.id?ee.dir:"",Y=T.sortDir||W||"asc";ee=null,oe(e,(kn,yn)=>ye(kn,yn,{sortField:_,sortDir:Y}))},o.onLoopSortDir=p=>{const T=Oe(),_=String(p||"");if(T){if((_==="asc"||_==="desc")&&!T.sortField){ee={id:T.id,dir:_},nt(e,T);return}ee=null,oe(e,(W,Y)=>ye(W,Y,{sortDir:_,sortField:_==="asc"||_==="desc"?Y.sortField:""}))}},o.onLoopLimit=p=>oe(e,(T,_)=>ye(T,_,{limit:String(p||"").replace(/\D/g,"")})),o.onPropHost=p=>p?D.mount(p):D.unmount(),o.onInspectData=(p,T)=>{y("dock:data-menu",{anchor:p,at:A.find(_=>_.id===I)?.from,onPick:_=>T(String(_?.var||"").trim())})};const L=A.find(p=>!p.kind)?.id,ve=l||$?"":Na(e,M,U),Q=U&&!l?M.find(p=>p.uid===U):null;o.rows=A.map(p=>{const T=ct(p.tag,p.kind,p.antlers),_=!!E&&p.id===E.rootId,W=p.id===L&&ve?ve:_?E.label:p.klass,Y=p.id===L;return{...p,base:W,name:va(W,p.path,k),current:p.id===I,letter:_?"":T.letter||"",svg:Y&&Q?Q.svg:_?E.svg:T.svg||"",cat:_?E.cat:rt(p.tag,p.kind,p.antlers),context:E?E.hostIds.has(p.id)?"host":p.id.startsWith("ctx")?"dim":"":"",sectionRoot:Y&&Q&&!Q.static?Q.uid:"",fieldsIcon:!!(Y&&Q&&!Q.static)}});const je=[];for(const p of o.rows)je.length=p.depth,p.guides=je.slice(),je[p.depth]=p.cat;o.sections=R?M.map(p=>{const T=!!U&&p.uid===U;return{...p,current:T,ready:T&&(!ue||!!F),row:{id:`sec:${p.uid}`,section:p.uid,tag:p.tag,name:p.label,kind:"",svg:p.svg,cat:p.cat,letter:"",depth:0,hasChildren:!0,shut:!0,current:T,hidden:!p.enabled}}}):[],o.onSection=p=>dn(e,t,M,p,U),o.onRefresh=()=>C(e),nt(e,o.rows.find(p=>p.id===I)),Pe(n,_t),Pt(e,r)}function Pt(e,t){K(e.document)&&fn(e,t)}function fn(e,t){const s=t[0],n=!!y("dock:component-src"),a=n?"":y("dock:current-uid")||"";se({source:re,type:ae.SVE_HTML_PICK,on:!0,uid:a,all:n,tag:s?.tag||"",klass:s?.klass||"",nodes:yo(t)},e)}function za(e){if(!e)return;const t=(s,n)=>{for(const a of s||[]){if(a.path===e)return!0;if(t(a.children,n+1))return n===0?O.delete(a.path):O.add(a.path),!0}return!1};t(Se,0)}function Ua(e,t){if(Me)return;const s=o.rows.find(n=>n.id===t);!s||s.kind||(I=t,o.rows.forEach(n=>{n.current=n.id===t}),o.editingId=t,o.draft=s.name,e.setTimeout(()=>{const n=K(e.document)?.querySelector("[data-sve-ht-rename]");n?.focus(),n?.select()},0))}function Et(e,t){const s=o.editingId;if(!s)return;const n=o.rows.find(a=>a.id===s);o.editingId=null,t&&n&&ga(y("dock:current-type")||"",n.path,o.draft,n.base||n.klass),o.draft="",C(e)}function Xa(e,t){pt(e,t,po)}function Wa(e,t){pt(e,t,fo)}function mn(e,t){zn(e,{titleKey:"remove_section_title",bodyKey:"remove_section_body",confirmKey:"remove_section_confirm"},()=>{const s=e.document;Wn({uid:t},s,e)})}function Ya(e,t,s){z===s&&(e.clearTimeout(xe),z="",F=""),I=null,pe=!1,Je="";const n=cn(e,t),a=n.find(i=>i.uid!==s)||n[0];a?dn(e,t,n,a.uid,""):(F="",o.rows=[],o.sections=[],o.pageBuilder=!0,C(e)),e.setTimeout(()=>{K(e.document)&&C(e)},0)}Ft("row:removed",({uid:e,parentPath:t,doc:s,win:n})=>{t!==Be(n)||!K(n.document)||Ya(n,s,e)});function Za(e,t){const s=o.sections?.find(a=>a.row?.id===t),n=s?s.row?.section||s.uid:o.rows.find(a=>a.id===t)?.sectionRoot;if(n){mn(e,n);return}pt(e,t,mo)}function pt(e,t,s){if(y("dock:is-locked"))return;const n=B(),a=o.rows.find(r=>r.id===t);if(!a)return;const i=s(n,a);i!==n&&me(i)}function fe(){ne?.dismiss(),ne=null}function Ga(e,t,s){const n=s.row?.section||s.uid;n&&(ne=le(e.document,it,{items:[{label:f(e,"html_tree_remove_section"),danger:!0,onPick:()=>{fe(),mn(e,n)}}],x:t.clientX,y:t.clientY,onClose:()=>{ne=null}}))}function Ja(e,t,s){fe();const n=o.sections?.find(c=>c.row?.id===s);if(n){Ga(e,t,n);return}const a=o.rows.find(c=>c.id===s);if(!a)return;ft(e,s,o.rows);const i={x:t.clientX,y:t.clientY},r=c=>{c.length&&(ne?.dismiss(),ne=le(e.document,it,{items:c,x:i.x,y:i.y,onClose:()=>{ne=null}}))};if(a.kind==="component"){Qa(e,a,r);return}o.canEdit&&r([{label:f(e,"component_make"),onPick:()=>{fe(),$a(e,a,{onDone:()=>C(e),onError:c=>{e.alert(c?.status===409?f(e,"component_exists"):f(e,"component_failed"))}})}}])}const Lt=(e,t)=>{fe(),y("dock:open-template",t)};function Qa(e,t,s){if(!oo(t.src)){s([{label:f(e,"component_open_named",{name:t.name||t.src}),onPick:()=>Lt(e,`view:partials/${t.src}`)}]);return}s([{label:f(e,"code_dock_loading"),onPick:null}]),e.fetch(`/!/sve/section-template/partials?src=${encodeURIComponent(t.src)}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest",Accept:"application/json"}}).then(n=>n.ok?n.json():{items:[]}).then(n=>{const a=Array.isArray(n.items)?n.items:[];s(a.length?a.map(i=>({label:f(e,"component_open_named",{name:i.label}),onPick:()=>Lt(e,i.type)})):[{label:f(e,"component_none"),onPick:null}])}).catch(()=>s([{label:f(e,"component_none"),onPick:null}]))}function er(e,t,s){if(t.button!==0||y("dock:is-locked")||o.editingId||t.target?.closest?.("button, input"))return;Fe(),te=s,be={x:t.clientX,y:t.clientY},Ae=t.currentTarget,Re=t.pointerId;const n=i=>tr(e,i),a=i=>nr(e,i);et=()=>{e.document.removeEventListener("pointermove",n,!0),e.document.removeEventListener("pointerup",a,!0),e.document.removeEventListener("pointercancel",a,!0),et=null},e.document.addEventListener("pointermove",n,!0),e.document.addEventListener("pointerup",a,!0),e.document.addEventListener("pointercancel",a,!0)}function tr(e,t){if(!te||!be)return;const s=t.clientX-be.x,n=t.clientY-be.y;if(!o.dragging&&s*s+n*n<25)return;if(!o.dragging){o.dragging=!0;try{Ae?.setPointerCapture?.(Re)}catch{}}t.preventDefault();const a=e.document.elementFromPoint(t.clientX,t.clientY),i=a?.closest?.("[data-sve-ht-slot]");if(i){const l=i.getAttribute("data-sve-ht-id");if(l&&l!==te){o.dropId=l,o.dropPlace="inside";return}}const r=a?.closest?.("[data-sve-ht-row]"),c=r?.getAttribute("data-sve-ht-id");if(!c||c===te){o.dropId=null,o.dropPlace=null;return}const k=o.rows.find(l=>l.id===c),h=o.rows.find(l=>l.id===te);if(!k||k.context||h&&k.path.startsWith(`${h.path}/`)){o.dropId=null,o.dropPlace=null;return}const d=r.getBoundingClientRect();o.dropId=c,o.dropPlace=uo(t.clientY-d.top,d.height,!Ut(k.tag)&&k.kind!=="component")}function nr(e,t){const s=te,n=o.dropId,a=o.dropPlace||"after",i=o.dragging;if(Fe(),i&&(Me=!0,e.setTimeout(()=>{Me=!1},0)),!i||y("dock:is-locked")||!s||!n||s===n)return;t?.preventDefault?.();const r=B(),c=ho(r,Se,s,n,a);c!==r&&me(c)}function Fe(){try{Ae?.releasePointerCapture?.(Re)}catch{}et?.(),te=null,be=null,Ae=null,Re=null,o.dragging=!1,o.dropId=null,o.dropPlace=null}function vn(e){const t=e.Statamic?.$config?.get?.("sveCollections");return Array.isArray(t)?t:[]}function nt(e,t){if(t?.kind==="component"){or(e,t);return}if(j.callOpen&&(j.callOpen=!1,j.callStore=null,D.forget(),lt(e)),t?.kind!=="antlers"){o.inspect=null;return}const s=t.id;if(t.tag==="else"){o.inspect={key:s,title:f(e,"antlers_condition"),mode:"note",note:f(e,"antlers_else_note")};return}if(t.antlers==="loop"){const n=t.loopKind==="collection",a=ee?.id===t.id?ee.dir:"",i=t.sortDir||a;o.inspect={key:s,title:f(e,"antlers_loop"),mode:"loop",loopKind:n?"collection":"field",kinds:[{id:"field",label:f(e,"antlers_loop_field")},{id:"collection",label:f(e,"antlers_loop_collection")}],collections:vn(e),value:t.expr||"",placeholder:f(e,n?"antlers_pick_collection":"antlers_loop_placeholder"),sort:{title:f(e,"antlers_sort"),dir:i,needsField:i==="asc"||i==="desc",field:t.sortField||"",pickable:!n,placeholder:f(e,n?"antlers_sort_field_entry":"antlers_sort_field"),dirs:[{id:"",label:f(e,"antlers_sort_none")},{id:"asc",label:f(e,"antlers_sort_asc")},{id:"desc",label:f(e,"antlers_sort_desc")},{id:"random",label:f(e,"antlers_sort_random")}]},limit:{title:f(e,"antlers_limit"),value:t.limit||"",placeholder:f(e,"antlers_limit_placeholder")},branches:[]};return}o.inspect={key:s,title:f(e,"antlers_condition"),mode:"condition",value:t.expr||"",placeholder:f(e,"antlers_condition_placeholder"),branches:[{id:"elseif",label:f(e,"antlers_add_elseif")},{id:"else",label:f(e,"antlers_add_else")}]}}function or(e,t){if(!so(e)){o.inspect=null;return}if(!t.src)return;const s=t.id;if(o.inspect={key:s,title:f(e,"component_props_values"),mode:"note",note:f(e,"code_dock_loading")},ao()){const n={},a={},i=new Map;for(const[r,c]of ro(B().slice(t.from,t.to))){const k=io(r);k&&(r!==k||!i.has(k))&&i.set(k,c)}for(const[r,c]of i)c.bound?a[r]=c.value:n[r]=c.value;Ct!==s&&(Ct=s,_e.clear());for(const r of _e)r in a||(a[r]="");o.inspect=null,j.callOpen=!0,j.title=j.title||f(e,"component_props"),j.callTitle=t.klass||t.name||t.src,j.callStore=D.ui,D.ui.canBind=!0,D.ui.dataTitle=f(e,"data_vars_title"),D.ui.exprPlaceholder=f(e,"component_props_expr"),D.ui.onToggleBind=(r,c)=>ar(e,r,c),D.ui.onExpr=(r,c)=>Ht(e,r,c),D.ui.onPickData=(r,c)=>y("dock:data-menu",{anchor:c,at:t.from,onPick:k=>Ht(e,r,String(k?.var||"").trim())}),D.load(e,{key:`${t.src}::${s}`,src:t.src,params:n,bindings:a,readOnly:y("dock:is-locked")===!0}),D.watch(e,{src:t.src,write:r=>sr(e,r,a)}),lt(e);return}lo(e,t.src).then(n=>{if(o.inspect?.key===s){if(!n.length){o.inspect={key:s,title:f(e,"component_props_values"),mode:"note",note:f(e,"component_props_values_none")};return}o.inspect={key:s,title:f(e,"component_props_values"),mode:"props",inheritLabel:f(e,"component_props_inherit"),rows:co(n,B().slice(t.from,t.to))}}})}function sr(e,t,s={}){const n=o.rows.find(r=>r.id===I);if(n?.kind!=="component"||y("dock:is-locked"))return;let a=B(),i=n.to;for(const[r,c]of Object.entries(t||{})){if(r in s)continue;const k=a.length,h=dt(a,{from:n.from,to:i},r,c);h!==a&&(i+=h.length-k,a=h)}a!==B()&&(me(a,{save:!0}),C(e))}function ar(e,t,s){s?_e.add(t):_e.delete(t),gn(e,t,"",s),C(e)}function Ht(e,t,s){_e.add(t),gn(e,t,s,!0),C(e)}function gn(e,t,s,n){const a=o.rows.find(c=>c.id===I);if(a?.kind!=="component"||y("dock:is-locked"))return;const i=B(),r=dt(i,a,t,s,{bound:n});r!==i&&me(r,{save:!0})}function Oe(){const e=o.rows.find(t=>t.id===I);return e?.kind==="antlers"&&!y("dock:is-locked")?e:null}function oe(e,t){const s=Oe();if(!s)return;const n=B(),a=t(n,s);a!==n&&(me(a),C(e))}function It(e,t,s,n){const a=o.rows.find(c=>c.id===I);if(a?.kind!=="component"||y("dock:is-locked"))return;const i=B(),r=dt(i,a,t,s,{bound:n});r!==i&&(me(r,{save:!0}),C(e))}function rr(e,t){oe(e,(s,n)=>n.antlers==="loop"?Ge(s,n,n.loopKind==="collection"?"collection":"field",t):Pa(s,n,t))}function ir(e,t){const s=Oe();if(!s||s.antlers!=="loop")return;const n=s.loopKind==="collection"?"collection":"field";if(t!==n){if(t==="collection"){const a=vn(e)[0]?.handle;if(!a)return;oe(e,(i,r)=>Ge(i,r,"collection",a));return}oe(e,(a,i)=>Ge(a,i,"field",i.handle||"items"))}}function lr(e,t){oe(e,(s,n)=>Aa(s,n,t))}function cr(e,t){if(!e||!t||t.kind==="component"||Ut(t.tag))return null;const s=no(e,t);if(s<t.openTo)return null;const n=e.lastIndexOf(`
`,s-1)+1;return e.slice(n,s).trim()===""&&n>t.openTo?n-1:s}function ft(e,t,s){if(Me)return;const n=(s||o.rows).find(a=>a.id===t);n&&(I=t,o.rows.forEach(a=>{a.current=a.id===t}),nt(e,n),!ht()&&(y("dock:reveal-html",{from:n.from,to:n.to,caret:cr(B(),n)}),y("dock:tw-follow"),se({source:re,type:ae.SVE_HTML_PICK_FOCUS,path:n.path},e)))}function dr(e,t){if(!t)return"";const s=[],n=(a,i)=>{for(const r of a||[]){const c=i||r.path===e;r.kind==="component"&&r.src===t&&s.push({path:r.path,inside:c}),n(r.children,c)}};return n(Se,!1),(s.find(a=>a.inside)||s[0])?.path||""}function ur(e,t){if(!t||!K(e.document))return;pe=!1,za(t),C(e);const s=o.rows.find(n=>n.path===t);s&&(ft(e,s.id,o.rows),e.setTimeout(()=>{K(e.document)?.querySelector("[data-sve-ht-row][data-sve-ht-current]")?.scrollIntoView({block:"nearest"})},0))}function ot(e){if(He)return;const t=()=>{o.editingId||o.dragging||(e.clearTimeout(Ie),Ie=e.setTimeout(()=>{K(e.document)&&C(e)},80))},s=()=>t();He=Ft("dock:html-changed",t),e.document.addEventListener("sve-page-structure",s),Qe=()=>{e.document.removeEventListener("sve-page-structure",s)}}function hr(e){He?.(),He=null,Qe?.(),Qe=null,e?.clearTimeout?.(Ie),Ie=0}function mt(e){const t=K(e.document);if(se({source:re,type:ae.SVE_HTML_PICK,on:!1},e),hr(e),D.forget(),j.callOpen=!1,j.callStore=null,lt(e),Fe(),fe(),Jn(e),I=null,o.inspect=null,o.editingId=null,o.draft="",o.sections=[],o.pageBuilder=!1,z="",e?.clearTimeout?.(xe),!t){Ze(e);return}t.remove(),at.headerTab==="html_tree"&&Un(e,null),An(e),Ot(e),Bt(e),Ze(e)}function _r(e,t){t.querySelector("[data-sve-html-tree-list]")||(t.id=$e,Pe(t,Zt,{title:f(e,"html_tree")}),t.querySelector("[data-sve-close]")?.addEventListener("click",()=>mt(e)))}function xr(e){ot(e),C(e)}function pr(e){const t=e.document;if(!Mn(e,"html_tree"))return;if(K(t)){ot(e),C(e);return}if(!ln(t))return;pe=!0,O.clear(),Dn(e,[$e]);const s=t.createElement("div");s.id=$e,s.style.cssText=On,Pe(s,Zt,{title:f(e,"html_tree")}),s.querySelector("[data-sve-close]")?.addEventListener("click",()=>mt(e)),Bn(e,s),Ot(e),Bt(e),Ze(e),ot(e),C(e)}function Sr(e){if(K(e.document)){mt(e);return}pr(e)}Vt("html-tree:from-preview",({path:e,src:t}={})=>{Nt(window,e)||ur(window,dr(e,t)||e)});Vt("html-tree:arm-pick",e=>{const t=window;return e?(fn(t,Te(B())),!0):(K(t.document)||se({source:re,type:ae.SVE_HTML_PICK,on:!1},t),!0)});function wr(){q.clear(),X.clear(),ie.length=0}export{Ra as HTML_TREE_STYLE_ID,Tr as armHtmlTreePrefetch,wr as clearHtmlTreeTemplates,fe as closeHtmlTreeMenu,mt as closeHtmlTreePanel,Ma as ensureHtmlTreeStyles,_r as fillHtmlTreePane,I as htmlTreeActiveId,K as htmlTreePanel,Ie as htmlTreeTimer,He as htmlTreeUnhook,pr as openHtmlTreePanel,C as renderHtmlTree,xr as showHtmlTreePane,hr as stopWatchHtmlTreeDock,Sr as toggleHtmlTreePanel,ot as watchHtmlTreeDock};
