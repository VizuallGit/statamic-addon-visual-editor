...
import{_ as Te,k as X,l as Pn,p as Dt,o as g,a as y,b as S,s as x,t as w,F as H,w as Pe,d as K,b4 as Ln,g as L,v as Ot,b5 as $n,y as b,h as p,j as oe,C as En,i as Bt,b6 as yt,b7 as kt,b8 as Hn,b9 as In,ba as An,bb as Mn,bc as Ft,z as ce,ap as Rn,bd as o,u,f as Dn,e as On,q as Y,x as Bn,be as Le,bf as Fn,B as fe,c as pe,N as jn,G as qn,aN as lt,aq as Je,am as Kn,aP as jt,aQ as qt,af as Vn,ag as bt,S as $e,V as Ee,O as Nn,aO as zn,an as Un,ao as Xn,bg as xt,bh as Yn,U as Kt,A as Vt,a8 as Se,J as qe,K as Ke,ax as ct,ay as He,I as Wn,bi as Gn,aS as Zn,aT as Jn,aw as Qn,bj as eo,b0 as to,ae as Nt,aK as no,aF as oo}from"./addon-BiHqc-kY.js";import{M as se,S as ae}from"./protocol-D3FYhCm9.js";import{canEditFields as so,currentSetHandle as ao,openFieldsetOverlay as zt}from"./section-fields-yLmAy3qi.js";import{D as F,E as io,F as dt,G as ro,t as lo,I as ut,v as co,z as uo,b as Ve,l as _t,J as Ut,q as ho,K as Xt,L as po,H as fo,M as ht,N as Yt,O as mo,h as vo,c as go,Q as yo,R as ko,S as bo,T as xo,U as _o,V as To,W as So,X as wo,Y as Co,Z as Po}from"./tw-classes-CbDx9jXo.js";import{a as Lo}from"./html-pick-align-CK-9iH9_.js";import"./ai-text-icon-B7uCWIwa.js";import"./FieldsetOverlay-Cy0QpG0m.js";const $o={class:"sve-dialog__title"},Eo={for:"sve-new-section-group"},Ho=["value"],Io={for:"sve-new-section-name"},Ao=["placeholder"],Mo={key:1,class:"sve-dialog__toggle"},Ro={key:2,class:"sve-dialog__note"},Do={class:"sve-dialog__actions"},Oo=["disabled"],Bo=["disabled"],Fo={__name:"NewSectionPrompt",props:{heading:{type:String,required:!0},groupLabel:{type:String,required:!0},nameLabel:{type:String,required:!0},placeholder:{type:String,default:""},note:{type:String,default:""},groups:{type:Array,required:!0},toggleLabel:{type:String,default:""},toggleOn:{type:Boolean,default:!0},cancelLabel:{type:String,required:!0},saveLabel:{type:String,required:!0},onOk:{type:Function,required:!0},onClose:{type:Function,required:!0}},setup(e){const t=e,s=X(""),n=X(t.groups[0]?.key??""),a=X(t.toggleOn),r=X(null),i=X(!1);Pn(()=>Dt(()=>r.value?.focus()));function c(){const h=s.value.trim();if(!h||t.groups.length&&!n.value||i.value){r.value?.focus();return}i.value=!0,t.onOk(h,n.value,a.value)}function f(h){h.target===h.currentTarget&&t.onClose()}function m(h){h.key==="Enter"?c():h.key==="Escape"&&t.onClose()}return(h,l)=>(g(),y("div",{class:"sve-dialog-overlay",onClick:f},[S("div",{class:"sve-dialog",onClick:l[4]||(l[4]=x(()=>{},["stop"]))},[S("div",$o,w(e.heading),1),e.groups.length?(g(),y(H,{key:0},[S("label",Eo,w(e.groupLabel),1),Pe(S("select",{id:"sve-new-section-group","onUpdate:modelValue":l[0]||(l[0]=d=>n.value=d),onKeydown:m},[(g(!0),y(H,null,K(e.groups,d=>(g(),y("option",{key:d.key,value:d.key},w(d.display),9,Ho))),128))],544),[[Ln,n.value]])],64)):L("",!0),S("label",Io,w(e.nameLabel),1),Pe(S("input",{id:"sve-new-section-name",ref_key:"input",ref:r,"onUpdate:modelValue":l[1]||(l[1]=d=>s.value=d),type:"text",placeholder:e.placeholder,onKeydown:m},null,40,Ao),[[Ot,s.value]]),e.toggleLabel?(g(),y("label",Mo,[Pe(S("input",{"onUpdate:modelValue":l[2]||(l[2]=d=>a.value=d),type:"checkbox",onKeydown:m},null,544),[[$n,a.value]]),S("span",null,w(e.toggleLabel),1)])):L("",!0),e.note?(g(),y("p",Ro,w(e.note),1)):L("",!0),S("div",Do,[S("button",{type:"button",class:"is-cancel",disabled:i.value,onClick:l[3]||(l[3]=(...d)=>e.onClose&&e.onClose(...d))},w(e.cancelLabel),9,Oo),S("button",{type:"button",class:"is-primary",disabled:i.value,onClick:c},w(e.saveLabel),9,Bo)])])]))}},Wt=Te(Fo,[["__scopeId","data-v-3ef3bbc9"]]),Gt="/!/sve/section-types",jo="static_sections";async function qo(e){const t=await e.fetch(Gt,{headers:{Accept:"application/json"},credentials:"same-origin"});if(!t.ok)throw new Error(`section-types ${t.status}`);const s=await t.json(),n=new Map;for(const a of s.types||[])a?.group&&a.group!==jo&&!n.has(a.group)&&n.set(a.group,a.group_display||a.group);return[...n].map(([a,r])=>({key:a,display:r}))}const ye=new Map;function Ko(e){e?.handle&&ye.set(e.handle,{static:!!e.static,hidden:!!e.hidden})}function Vo(e,t){return t?ye.has(t)?ye.get(t).static:e.Statamic?.$config?.get?.("sveSetMeta")?.[t]?.static===!0:!1}function No(e,t){if(!t)return!1;if(ye.has(t))return ye.get(t).hidden;const s=e.Statamic?.$config?.get?.("sveSectionTypes");return Array.isArray(s)&&s.some(n=>n?.handle===t&&n.hidden===!0)}async function Zt(e,t,s){const n=await e.fetch(Gt,{method:t,headers:{"Content-Type":"application/json","X-CSRF-TOKEN":Bt(e),Accept:"application/json"},credentials:"same-origin",body:JSON.stringify(s)}),a=await n.json().catch(()=>({}));if(!n.ok){const r=new Error(a.error||`section-types ${n.status}`);throw r.reason=a.error,r}return Ko(a.section),a}function zo(e,{display:t,group:s="",static:n=!1,hidden:a=!1}){return Zt(e,"POST",{display:t,group:s,static:n,hidden:a})}function Tt(e,{handle:t,hidden:s,fields:n=!1}){const a={handle:t,fields:n};return typeof s=="boolean"&&(a.hidden=s),Zt(e,"PATCH",a)}async function Uo(e,t,s=null,n=null){if(!t||typeof yt!="function"||typeof kt!="function")return null;const a=await yt(e,t);if(!a)return null;n&&Array.isArray(a.definitions)&&Hn(t,{display:n.display||t,icon:n.icon||null,hide:n.hidden===!0,fields:a.definitions,group_display:n.group_display||n.group||""},n.group||"");const r=In(),i=An(e,"page",{handle:t},a?.defaults,r),c=Mn(i,a?.new||{},a?.defaults);return kt(e,e.document,s,i,c)?i:null}const St=700,Xo=17;function Yo(e,t){const s=(t||[]).filter(Boolean);if(!s.length)return;let n=0;const a=()=>{n+=1;const r=Ft(e),i=r?s.some(c=>r.querySelector(`[data-sid="${CSS.escape(c)}"]`)):!0;i&&ce({source:ae,type:se.SVE_ACTIVATE,ids:s},e),(i?!r&&n<6:n<Xo)&&e.setTimeout(a,St)};e.setTimeout(a,St)}function Jt(e){return e.Statamic?.$permissions?.has?.("configure fields")===!0}function Wo(e){return new Promise(t=>{let s=!1;const n=r=>{s||(s=!0,a.dismiss(),t(r==="static"||r==="fields"?r:null))},a=oe(e.document,En,{title:p(e,"section_new_kind"),body:p(e,"section_new_kind_note"),buttons:[{value:"cancel",label:p(e,"cancel"),variant:"ghost"},{value:"static",label:p(e,"section_new_static"),variant:"primary"},{value:"fields",label:p(e,"section_new_with_fields"),variant:"primary"}],onPick:n,onClose:()=>n(null)})})}const Go=`<section class="[ ] py-800">
