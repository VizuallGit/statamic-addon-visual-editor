...
`)}function Ra(t,e){const o=Z(t,e);return o?String(t).slice(o.brace+1,o.close):""}function ts(t,e,o){const n=Ha(Ra(e,t.className)),s="    ".repeat(o),r=[];n.decls&&r.push(Qo(n.decls.replace(/;+\s*$/,";"),o+1));for(const l of n.other)r.push(Qo(l,o+1));for(const l of t.children)r.push(ts(l,e,o+1));const i=r.filter(Boolean).join(`
...
`):t}function qa(t,e){let o=0;for(let n=0;n<e.from;n+=1){if(t.startsWith("/*",n)){n=xo(t,n)-1;continue}t[n]==="{"?o+=1:t[n]==="}"&&(o-=1)}return o===0}function So(t,e,o){const n=es(e)||o;if(!n)return String(t||"");let s=String(e||"").trim();s?new RegExp(`^\\.${ve(n)}\\s*\\{`).test(s)||(s=`.${n} {
${s}
}`):s=`.${n} {
}`;let r=String(t||"");const i=Z(r,n),l=ja(s);if(i){const d=Na(r,i.from);r=r.slice(0,i.from)+Wa(s,d)+r.slice(i.to)}else r=`${r.trimEnd()}${r.trim()?`
`:""}${s}
`;const c=Z(r,n);if(!c)return r;for(const d of[...new Set(l)].reverse()){const h=new RegExp(`(^|[^\\w-])\\.${ve(d)}\\s*\\{`,"g"),f=[];let p;for(;p=h.exec(r);){const y=p.index+p[1].length,b=r.indexOf("{",y),E=Pt(r,b);E!==-1&&f.push({from:y,to:E+1})}for(const y of f.reverse()){if(y.from>=c.from&&y.to<=c.to||!qa(r,y))continue;let b=y.from;const E=r.lastIndexOf(`
...
${l}
${h??""}${c.slice(d)}`}function Ll(t,e){const o=be(t).find(n=>n.prelude.includes(e));return o?o.bodyTo:be(t)[0]?.bodyTo??-1}function Fl(t,e,o){let n=e,s=o;const r=t.lastIndexOf(`
...
`,e-1)+1;return(t.slice(o,e).match(/^\s*/)||[""])[0]}function J(t){const e=v.css;if(!e||e.state.readOnly||!t.length)return;const o=ze(),n=t.some(l=>l.value!=null)?cc(e,o):o;if(!n){const l=t.filter(c=>c.value!=null).map(c=>`${c.property}: ${c.value};`).join(`
...
${bt(e,i.open)}`}),s=ze();if(s)return n(s);const r=vd(e);return r?n(r):{at:e.length,indent:"",suffix:""}}function vd(t){const e=String(t||"");let o=null,n=0,s=0;for(;n<e.length;){if(e[n]==="}"||e[n]===";"){n+=1,s=n;continue}if(e[n]!=="{"){n+=1;continue}const r=Pt(e,n);if(r===-1||o||(o=e.slice(s,n).trim().startsWith("@")?null:{from:s,open:n,to:r},!o))return null;n=r+1,s=n}return o}function yd(t,e){const o=e===a.cssSize?"":e;a.cssSize=o,K(t,zo,o),kt("lp:set-device",{win:t,key:o?Wr(o,t):"Responsive"}),o&&gd(t,o),a.cssValues&&Ws(t),ne(t,!0),Oo(),se(t),P(t)}function bd(t,e){a.cssState=Ho.includes(e)?e:"",K(t,io,a.cssState),w(t.document),se(t),P(t)}function xd(t,e){const o=t.document;w(o),e.setAttribute("data-open","");const n=o.createElement("div");n.id=$,o.body.appendChild(n),W(t,e,n),n._sveApp=q(ot,n,{kind:"choices",choices:[{value:"",label:m(t,"css_state_none"),active:!a.cssState},...Ho.map(s=>({value:s,label:je(s),active:s===a.cssState}))],onPick:s=>bd(t,s)})}function se(t){const o=t?.document.getElementById(u)?.querySelector("[data-sve-css-head]");if(!o)return;const n=Ct(),s=mt(t),r=v.css?.state.doc.toString()??"";F.tag=n?.tag||"",F.scope=Pa(n?zt().slice(n.from,n.openTo):"")||"",F.canEdit=!a.lastLocked,F.onTag=i=>ka(t,i.currentTarget,n),F.state=a.cssState,F.stateLabel=a.cssState?je(a.cssState):m(t,"css_state"),F.onState=i=>xd(t,i.currentTarget),F.onSize=i=>yd(t,i),F.sizes=[{key:"",label:m(t,"tw_size_all"),title:m(t,"css_size_all_title"),active:!a.cssSize},...s.map(i=>{const l=i.base||$o(r,s,i.handle).length>0;return{key:i.handle,label:i.label,title:i.base?m(t,"css_size_base_title"):`@media ${i.media}${l?"":`  ·  ${m(t,"css_size_new")}`}`,active:a.cssSize===i.handle}})],o._sveMounted||(o._sveMounted=!0,$t(o,xl))}_e("lp:device",t=>{const e=a.lastWin;if(!e||!Us(e.document))return;const o=vo(e).find(n=>n.device===t)?.handle||"";o!==a.cssSize&&(a.cssSize=o,K(e,zo,o),ne(e,!0),Oo(),se(e),P(e))});function kd(t){const e=Math.max(0,Math.round(Date.now()/1e3-t)),o=new Date(t*1e3).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});let n=o;try{const s=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"});e<90?n=s.format(-e,"second"):e<5400?n=s.format(-Math.round(e/60),"minute"):e<86400?n=s.format(-Math.round(e/3600),"hour"):n=s.format(-Math.round(e/86400),"day")}catch{}return`${n} · ${o}`}function Ns(t,e){return t.fetch(e,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}})}async function Sd(t,e){const o=t.document,n=Tt();if(w(o),!n)return;let s=[];try{const i=await Ns(t,`/!/sve/section-template/history?type=${encodeURIComponent(n)}`);i.ok&&(s=(await i.json())?.entries||[])}catch{s=[]}if(!o.getElementById(u)||!o.contains(e))return;e.setAttribute("data-open","");const r=o.createElement("div");r.id=$,o.body.appendChild(r),W(t,e,r),r._sveApp=q(ot,r,{kind:"choices",choices:s.length?s.map(i=>({value:i.id,label:kd(i.at)})):[{value:"",label:m(t,"code_dock_history_empty")}],onPick:i=>{w(o),i&&wd(t,n,i)}})}async function wd(t,e,o){if(pt())return;let n=null;try{const s=await Ns(t,`/!/sve/section-template/history/entry?type=${encodeURIComponent(e)}&id=${encodeURIComponent(o)}`);s.ok&&(n=await s.json())}catch{n=null}!n||pt()||(ee({html:n.html??"",css:n.css??"",js:n.js??""},a.lastLocked),nt(t),re(t))}function Xt(t){const e=t?.document.getElementById(u)?.querySelector("[data-sve-code-strip]");if(!e)return;e.hidden=a.styleMode!=="tw";const o=Wn(t);e.innerHTML=Fu,e.title=m(t,o?"tw_strip_on":"tw_strip_off"),e.setAttribute("aria-label",e.title),e.setAttribute("aria-pressed",o?"true":"false")}function _d(t,e){const o=e.querySelector("[data-sve-code-strip]");!o||o._sveBound||(o._sveBound=!0,o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Sa(t,!Wn(t)),Xt(t),wa(t)}),Xt(t))}function $d(t,e){const o=e.querySelector("[data-sve-code-history]");!o||o._sveBound||(o._sveBound=!0,o.innerHTML=Iu,o.title=m(t,"code_dock_history"),o.setAttribute("aria-label",o.title),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),o.hasAttribute("data-open")){w(t.document);return}Sd(t,o)}))}function lf(){return a.styleMode}function Cd(t){return a.styleMode==="tw"?Ct():null}function Ct(t){const e=v.html;if(!e)return null;const o=a.htmlScopeActive&&!!a.htmlFocus,n=o?a.htmlFull:e.state.doc.toString(),r=(o?a.htmlFocus.from:0)+e.state.selection.main.from,i=Nn($e(n),new Set);let l=null;for(const c of i)c.from<=r&&r<c.to&&(l=c);return l}function re(t){a.styleMode==="tw"&&_a(t,Cd())}function Po(t){const e=t?.document.getElementById(u),o=e?.querySelector("[data-sve-values-mode]");if(!e||!o)return;e.setAttribute("data-sve-values",a.cssValues?"on":"off");const n=t.document.createElement("span");n.textContent=m(t,"code_dock_values"),o.innerHTML=Pu,o.appendChild(n),o.title=m(t,a.cssValues?"code_dock_values_off":"code_dock_values_on"),o.setAttribute("aria-label",o.title),o.setAttribute("aria-pressed",a.cssValues?"true":"false")}function Ws(t){const e=v.css;if(!e||e.state.readOnly)return;const o=mt(t),n=e.state.doc.toString(),s=ye(n,o,a.cssSize);if(e.focus(),s.length){const p=s[0],y=Math.min(p.bodyTo,p.bodyFrom+(n.slice(p.bodyFrom).match(/^[^\S\n]*\n?/)||[""])[0].length);e.dispatch({selection:{anchor:y},scrollIntoView:!0});return}const r=Rs(t,a.cssSize);if(!r||r.base){const p=`#id-{{ id }} {
...
`:n?`
`:""}${e}
`;return o.dispatch({changes:{from:n,insert:r},selection:{anchor:n+r.length}}),!0}function Dd(t){if(xe(t),!a.lastType||!t.document.getElementById(u))return;const e=a.lastType;a.lastType=null,Ne(t,e,"keep")}function Ks(t){xt(t),a.loadGen+=1,Y(t),a.lastUid=null,a.lastType=null,a.typeStack=[],a.lastParts={html:"",css:"",js:""},a.lastLocked=!1,a.lockReady=!1,a.lastBracketNames=null,a.lastCssSelectorNames=null,Pe(),a.lastWin=t?.defaultView||a.lastWin,w(t),jn(t),rt(t),t?.getElementById(X)?.remove();for(const o of it)v[o]?.destroy(),v[o]=null;t?.getElementById(u)?.remove(),uu(),t&&jo(t,0);const e=t?.defaultView||a.lastWin;e?.document.getElementById(zn)&&Dn(e),e&&(fs(e),_o(e),Vn(e))}function zd(t){if(a.dragging)return;const e=t.document.getElementById(u);e&&(Ro(t),Zt(t,e))}function Hd(t,e,o){if(o){const r=Ko(o,e)||Ko(o,t.document)||o;return String(typeof Ve=="function"&&(Ve(r,e)||Ve(r,t.document))||"").trim()}const n=typeof Je=="function"?Je(t):"page_sections",s=typeof et=="function"?et(t.document):[];for(const r of s){const l=(St(r.values)||r.values)?.[n];if(Array.isArray(l))for(const c of l){const d=typeof c?.type=="string"?c.type.trim():"";if(d)return d}}return""}function Gs(t){if((t.Statamic?.$config?.get?.("sveFeatures")||{}).collection_templates!==!0)return"";const o=t.Statamic?.$config?.get?.("sveCollectionTemplatesCollection")||"templates";if(!(t.location?.pathname||"").includes(`/collections/${o}/entries/`))return"";const s=typeof et=="function"?et(t.document):[];for(const r of s){const i=St(r.values)||r.values,l=typeof i?.view=="string"?i.view.trim():"";if(!l||l.includes(".."))continue;const c=l.replace(/\.(antlers\.html|blade\.php)$/i,"").replace(/^\/+|\/+$/g,"");if(c)return`view:${c}`}return""}function Rd(t,e){const o=Zr||Yr;if(o!=="header"&&o!=="footer"||!Kr(e)&&!Gr(e))return"";const s=(St(Xr()?.values)||{})[o==="footer"?"footer_style":"header_style"]||"style_1";return`${o}/${s}`}function jd(t){const e=Qr(t);if(!e)return"";const o=["header","footer"].find(r=>e.querySelector(`[data-sve-chrome="${r}"]`));if(!o)return"";const n=t.Statamic?.$config?.get?.("sveChromeStyles")||{},s=typeof n[o]=="string"&&n[o]!==""?n[o]:"style_1";return`${o}/${s}`}function Nd(t){const e=Jr(t)||t.getElementById("__sve-global-section-host");return e&&e.querySelector("[data-replicator-set][data-type]")?.getAttribute("data-type")||""}function cf(t,e,o){if(a.dragging)return;if(!t||!e||nu(e)||!Vr(t)||!Ur(t)){e&&Ks(e);return}const n=Rd(t,e)||Nd(e)||Hd(t,e,o)||Gs(t)||(o?"":a.lastType)||jd(t),s=!!(o&&o!==a.lastUid);if(a.lastWin=t,o&&(a.lastUid=o),!!n&&!(n===a.lastType&&e.getElementById(u))){if(a.typeStack.length&&a.lastType&&a.lastType!==n){const r=a.typeStack[0];if(n===r&&!s)return;a.typeStack=[]}Y(e),Ne(t,n,"replace")}}_e("tw:changed",()=>{a.lastWin&&a.styleMode==="tw"&&P(a.lastWin)});B("dock:is-open",t=>Us(t));B("dock:is-locked",()=>pt());B("dock:html",()=>zt());B("dock:reveal-html",({from:t,to:e,caret:o}={})=>{const n=v.html;if(!n||t==null)return;a.htmlScopePref=Jt(a.lastWin),Le(),dt();const s=a.htmlFull.length,r=Math.max(0,Math.min(t,s)),i=Math.max(r,Math.min(e??t,s));a.htmlFocus=i>r?{from:r,to:i}:null;const l=o==null?null:Math.max(0,Math.min(o,s));if(a.htmlScopePref&&a.htmlFocus){Eo(l),G(a.lastWin);return}if(a.htmlScopeActive){Bo(!0,l),G(a.lastWin);return}n.dispatch({selection:l==null?{anchor:r,head:i}:{anchor:l},scrollIntoView:!0}),n.focus()});B("dock:insert-snippet",({win:t,parts:e})=>Od(t,e));B("dock:refresh",t=>Dd(t));B("dock:tw-follow",()=>{a.lastWin&&re(a.lastWin)});B("dock:css",()=>(dt(),a.cssFull));B("dock:set-css",t=>typeof t!="string"||pt()||!v.css||!a.lastWin?!1:(dt(),a.cssFull=t,Ie("css",As()),nt(a.lastWin),!0));B("dock:data-menu",({anchor:t,onPick:e,at:o}={})=>!t||!a.lastWin?!1:(xt(a.lastWin.document),w(a.lastWin.document),Xs(a.lastWin,t,e,o),!0));B("dock:props",()=>a.lastProps.map(t=>({...t})));B("dock:set-props",({win:t,props:e}={})=>!Array.isArray(e)||pt()?!1:(a.lastProps=e,a.propsDirty=!0,Aa(ae(Tt())),Y((t||a.lastWin)?.document),!0));function ae(t){const e=/^view:partials\/(components\/[A-Za-z0-9_-]+)$/.exec(String(t||""));return e?e[1]:""}B("dock:component-src",()=>ae(Tt()));B("dock:type-stack",()=>a.typeStack.map(t=>({type:t,src:ae(t)})));B("dock:component-exit-state",()=>{const t=ae(Tt());return{open:!!t,name:t?t.split("/").pop():"",back:a.typeStack.length>0}});B("dock:exit-component",(t=1)=>{if(!a.lastWin||!ae(Tt()))return!1;if(a.typeStack.length){for(let e=Number(t)||1;e>1&&a.typeStack.length>1;e-=1)a.typeStack.pop();xs(a.lastWin)}else Ks(a.lastWin.document);return!0});B("dock:current-type",()=>Tt());B("dock:current-uid",()=>a.lastUid);B("dock:save-settled",()=>a.saveInFlight||null);B("dock:load-settled",()=>a.loadInFlight||null);B("dock:reset-data-vars",t=>(gi(typeof t=="string"&&t?t:void 0),!0));B("dock:refresh-preview",()=>a.lastWin?(xe(a.lastWin),!0):!1);B("dock:open-template",t=>typeof t!="string"||!t||!a.lastWin?!1:(bs(a.lastWin,t),!0));B("dock:set-html",t=>{if(typeof t!="string"||pt())return!1;const e=v.html;if(!e||!a.lastWin)return!1;if(t===""){a.saveTimer&&(clearTimeout(a.saveTimer),a.saveTimer=null),a.twDirty=!1,a.twCss=null,a.twKey="",a.lastType=null,a.lastUid=null,a.lastParts={html:"",css:"",js:""},a.cssFull="",a.htmlFull="",a.applying=!0;try{Pe();for(const s of it){const r=v[s];if(!r)continue;const i=r.state.doc.toString();i!==""&&r.dispatch({changes:{from:0,to:i.length,insert:""}})}}finally{a.applying=!1}return!0}const o=a.htmlFull;if(a.htmlFull=t,a.htmlScopeActive)return a.htmlFocus=Wd(a.htmlFocus,o,t),Oe(ws()),nt(a.lastWin),go("dock:html-changed"),!0;const n=e.state.doc.toString();if(n!==t){const[s,r,i]=vs(n,t);e.dispatch({changes:{from:s,to:r,insert:i}})}return!0});B("dock:show-empty",()=>kt("dock:set-html",""));_e("row:removed",({parentPath:t,remaining:e,win:o})=>{e===0&&t===Je(o)&&kt("dock:show-empty")});function Wd(t,e,o){const n=o.length-e.length;if(!t||!n)return t;let s=0;for(;s<e.length&&s<o.length&&e[s]===o[s];)s+=1;return s>=t.to?t:s<t.from?{from:Math.max(0,t.from+n),to:Math.max(0,t.to+n)}:{from:t.from,to:Math.max(t.from,t.to+n)}}const O="__sve-data-menu";let lo=null;function xt(t){const e=t?.getElementById(O);lo?.(),lo=null,e?._sveApp?.unmount(),e?.remove(),t?.querySelector("[data-sve-data-vars][data-open]")?.removeAttribute("data-open")}function qd(t){if(!Gs(t))return{view:"",kind:""};const e=typeof et=="function"?et(t.document):[];for(const o of e){const n=St(o.values)||o.values,s=typeof n?.source_collection=="string"?n.source_collection.trim():"";if(s)return{view:s,kind:String(n?.kind||"").trim()}}return{view:"",kind:""}}function Vd(t,e){const o=zt();if(Number.isFinite(e))return Zo(o,e);const n=v.html;if(!n)return[];const s=a.htmlScopeActive&&a.htmlFocus?a.htmlFocus.from:0;return Zo(o,s+n.state.selection.main.from)}function Ud(t,e){const{view:o,kind:n}=qd(t);return{collection:ss(t)||"",set:rs(Tt()),view:o,kind:n,scope:mi(Vd(t,e))}}function Kd(t){const e=typeof et=="function"?et(t.document):[];for(const o of e){const n=St(o.values)||o.values;if(n&&typeof n=="object")return n}return null}function Gd(t,e){return{scope:e?.scope?.groups||[],section:ls(e?.section||[],ys(t)),page:bi(e?.page||[],Kd(t)),site:e?.site||[]}}function Xd(t,e){const o=xi(t,e),n=v.html;if(!o||!n||n.state.readOnly)return;const s=n.state.selection.main,r=n.state.doc.lineAt(s.from),i=ct(r.text),l=yo(o.text,i);n.dispatch({changes:{from:s.from,to:s.to,insert:l},selection:{anchor:s.from+o.cursor+(o.text.includes(`
`)?i.length:0)}}),V()}function Xe(t,e,o){const n=e.getBoundingClientRect(),s=8,r=o.offsetWidth||368,i=o.offsetHeight||240,l=t.innerHeight-n.bottom-s,c=n.top-s,d=l>=i||l>=c?n.bottom+4:n.top-i-4;o.style.left=`${Math.max(s,Math.min(n.left,t.innerWidth-r-s))}px`,o.style.top=`${Math.max(s,Math.min(d,t.innerHeight-i-s))}px`}function Xs(t,e,o,n){const s=t.document;xt(s),e.setAttribute("data-open","");const r=s.createElement("div");r.id=O,s.body.appendChild(r);const i=Ud(t,n),l=p=>[p?.scope?.groups?.length?{id:"scope",label:p.scope.label||m(t,"data_vars_tab_loop")}:null,{id:"section",label:m(t,"data_vars_tab_section")},{id:"page",label:m(t,"data_vars_tab_page")},{id:"site",label:m(t,"data_vars_tab_site")}].filter(Boolean),c=p=>{s.getElementById(O)&&(r._sveApp?.unmount(),r._sveApp=q(pi,r,{title:m(t,"data_vars_title"),placeholder:m(t,"data_vars_placeholder"),emptyText:m(t,"data_vars_empty"),noSectionText:m(t,"data_vars_no_section"),loopText:m(t,"data_vars_loop"),tabs:l(p),data:Gd(t,p),onPick:(y,b)=>o?o(y,b):Xd(y,b)}),Xe(t,e,r))};c(as(wo(i))||{scope:null,section:[],page:[],site:[]}),is(t,i).then(c),Xe(t,e,r);const d=()=>Xe(t,e,r),h=p=>{!r.contains(p.target)&&!e.contains(p.target)&&xt(s)},f=p=>{p.key==="Escape"&&xt(s)};s.addEventListener("pointerdown",h,!0),s.addEventListener("keydown",f,!0),t.addEventListener("scroll",d,!0),t.addEventListener("resize",d),lo=()=>{s.removeEventListener("pointerdown",h,!0),s.removeEventListener("keydown",f,!0),t.removeEventListener("scroll",d,!0),t.removeEventListener("resize",d)}}function Zd(t,e){const o=e.querySelector("[data-sve-data-vars]");!o||o._sveBound||(o._sveBound=!0,o.addEventListener("mousedown",n=>n.preventDefault()),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),t.document.getElementById(O)){xt(t.document);return}w(t.document),Xs(t,o)}))}function Yd(t,e){const o=e.querySelector("[data-sve-antlers-tools]");!o||o._sveBound||(o._sveBound=!0,$t(o,ns,{label:m(t,"code_dock_antlers"),groups:Fa.map(n=>({id:n.id,label:m(t,n.lang),items:Ia.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>Jd(n)}))}function Jd(t){const e=Oa(t),o=v.html;if(!e||!o||o.state.readOnly)return;const n=o.state.selection.main.head,s=o.state.doc.lineAt(n),r=s.text.trim()?ct(s.text):He(o,s)||ct(s.text),{text:i,cursor:l}=ge(e.snippet);Ot(yo(i,r),l),V()}function Qd(t,e){const o=e.querySelector("[data-sve-visual-edit-tools]");!o||o._sveBound||(o._sveBound=!0,$t(o,ns,{label:m(t,"code_dock_visual_edit"),groups:ki.map(n=>({id:n.id,label:m(t,n.lang),items:cs.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>eu(n)}))}function tu(t,e,o,n){if(_i(o.inner,n.attr)){t.focus();return}const{text:s,cursor:r}=ge(n.attr);let i=o.closeIdx;for(;i>o.openIdx+2&&/\s/.test(e[i-1]);)i--;t.dispatch({changes:{from:i,to:o.closeIdx,insert:` ${s} `},selection:{anchor:i+1+r}}),V()}function eu(t){const e=Si(t),o=v.html;if(!e||!o||o.state.readOnly)return;const n=o.state.doc.toString(),s=te();if(s?.open){const f=wi(n,s.open.from,s.open.to,de);if(f){e.attr?tu(o,n,f,e):(o.dispatch({selection:{anchor:f.openIdx+2+de.length}}),o.focus());return}const p=s.open.from+1+s.name.length,y=e.standalone||`{{ ${de} ${e.attr} }}`,{text:b,cursor:E}=ge(y);o.dispatch({changes:{from:p,to:p,insert:` ${b}`},selection:{anchor:p+1+E}}),V();return}const r=o.state.selection.main.head,i=o.state.doc.lineAt(r),l=i.text.trim()?ct(i.text):He(o,i)||ct(i.text),c=e.standalone||`{{ ${de} ${e.attr} }}`,{text:d,cursor:h}=ge(c);Ot(yo(d,l),h),V()}function ou(t){return t==="css"?yr():t==="js"?br():vr({autoCloseTags:!0})}function Cn(t){if(t._sveShield)return;t._sveShield=!0;const e=o=>o.stopPropagation();for(const o of["keydown","keypress","keyup","pointerdown","pointerup","mousedown","mouseup","click","focusin"])t.addEventListener(o,e)}function nu(t){try{return new URLSearchParams(t.defaultView?.location?.search||"").has("sve-panel")}catch{return!1}}function su(t){const e=parseInt(Q(t,Sr)??"",10);return Number.isFinite(e)&&e>=Tr?e:Su}function ru(t,e){K(t,Sr,String(e))}function Zs(t){try{const e=JSON.parse(Q(t,wr)||"null");if(e&&typeof e=="object")return{html:e.html!==!1,css:e.css!==!1,js:e.js===!0,alpine:e.alpine===!0}}catch{}return{html:!0,css:!0,js:!1,alpine:!1}}function au(t,e){K(t,wr,JSON.stringify(e))}function Ys(t){try{const e=JSON.parse(Q(t,_r)||"null");if(e&&typeof e=="object"){const o=s=>Number.isFinite(s)&&s>0?s:1,n={};for(const s of _t)n[s]=o(e[s]);return n}}catch{}return Object.fromEntries(_t.map(e=>[e,1]))}function iu(t,e){K(t,_r,JSON.stringify(e))}function lu(t){sa(t,ku,`
