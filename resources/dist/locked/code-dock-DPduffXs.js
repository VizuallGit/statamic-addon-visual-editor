...
`):t}function Fa(t,e){let o=0;for(let n=0;n<e.from;n+=1){if(t.startsWith("/*",n)){n=vo(t,n)-1;continue}t[n]==="{"?o+=1:t[n]==="}"&&(o-=1)}return o===0}function yo(t,e,o){const n=Kn(e)||o;if(!n)return String(t||"");let s=String(e||"").trim();s?new RegExp(`^\\.${fe(n)}\\s*\\{`).test(s)||(s=`.${n} {
${s}
}`):s=`.${n} {
...
`:""}${s}
`;const c=X(r,n);if(!c)return r;for(const d of[...new Set(l)].reverse()){const f=new RegExp(`(^|[^\\w-])\\.${fe(d)}\\s*\\{`,"g"),h=[];let p;for(;p=f.exec(r);){const x=p.index+p[1].length,k=r.indexOf("{",x),z=Ft(r,k);z!==-1&&h.push({from:x,to:z+1})}for(const x of h.reverse()){if(x.from>=c.from&&x.to<=c.to||!Fa(r,x))continue;let k=x.from;const z=r.lastIndexOf(`
...
${l}${t}`,d=1+l.length;else if(!r.text.trim()){c=`${l}${t}`,d=l.length,n.dispatch({changes:{from:r.from,to:r.to,insert:c},selection:sn(r.from+d+e,o)});return}n.dispatch({changes:{from:s,to:n.state.selection.main.to,insert:c},selection:sn(s+d+e,o)})}function sn(t,e){return e?{anchor:t,head:t+e}:{anchor:t}}const Vl=new Set(["section","article","header","footer","main","nav","aside"]);function rn(t){if(t!=="section")return`<${t}>`;const e=a.lastWin?.Statamic?.$config?.get?.("sveSectionTag");return typeof e=="string"&&e.trim()?`<${t} ${e.trim()}>`:`<${t}>`}function ms(){const t=g.html;if(!t||t.state.readOnly)return;const e=t.state.doc.toString(),o=(e.match(/^[ \t]*/)||[""])[0],n=ql(e).split(`
`).map(s=>s&&o+s).join(`
...
`,e-1)+1;return(t.slice(o,e).match(/^\s*/)||[""])[0]}function Z(t){const e=g.css;if(!e||e.state.readOnly||!t.length)return;const o=Le(),n=t.some(l=>l.value!=null)?ec(e,o):o;if(!n){const l=t.filter(c=>c.value!=null).map(c=>`${c.property}: ${c.value};`).join(`
`);l&&sc(l),cn();return}const s=[],r=[],i=ks(e,n);for(const l of t){const c=Jl(e,n,l.property);if(l.value==null){if(!c)continue;let d=c.from,f=c.to;e.state.doc.sliceString(f,f+1)===`
...
${yt(e,i.open)}`}),s=Le();if(s)return n(s);const r=Wc(e);return r?n(r):{at:e.length,indent:"",suffix:""}}function Wc(t){const e=String(t||"");let o=null,n=0,s=0;for(;n<e.length;){if(e[n]==="}"||e[n]===";"){n+=1,s=n;continue}if(e[n]!=="{"){n+=1;continue}const r=Ft(e,n);if(r===-1||o||(o=e.slice(s,n).trim().startsWith("@")?null:{from:s,open:n,to:r},!o))return null;n=r+1,s=n}return o}function qc(t,e){const o=e===a.cssSize?"":e;a.cssSize=o,U(t,Lo,o),xt("lp:set-device",{win:t,key:o?Fr(o,t):"Responsive"}),o&&Nc(t,o),a.cssValues&&Bs(t),oe(t,!0),Eo(),ne(t),O(t)}function Vc(t,e){a.cssState=Io.includes(e)?e:"",U(t,no,a.cssState),w(t.document),ne(t),O(t)}function Uc(t,e){const o=t.document;w(o),e.setAttribute("data-open","");const n=o.createElement("div");n.id=$,o.body.appendChild(n),N(t,e,n),n._sveApp=W(ot,n,{kind:"choices",choices:[{value:"",label:m(t,"css_state_none"),active:!a.cssState},...Io.map(s=>({value:s,label:Pe(s),active:s===a.cssState}))],onPick:s=>Vc(t,s)})}function ne(t){const o=t?.document.getElementById(u)?.querySelector("[data-sve-css-head]");if(!o)return;const n=$t(),s=pt(t),r=g.css?.state.doc.toString()??"";B.tag=n?.tag||"",B.scope=_a(n?It().slice(n.from,n.openTo):"")||"",B.canEdit=!a.lastLocked,B.onTag=i=>ca(t,i.currentTarget,n),B.state=a.cssState,B.stateLabel=a.cssState?Pe(a.cssState):m(t,"css_state"),B.onState=i=>Uc(t,i.currentTarget),B.onSize=i=>qc(t,i),B.sizes=[{key:"",label:m(t,"tw_size_all"),title:m(t,"css_size_all_title"),active:!a.cssSize},...s.map(i=>{const l=i.base||xo(r,s,i.handle).length>0;return{key:i.handle,label:i.label,title:i.base?m(t,"css_size_base_title"):`@media ${i.media}${l?"":`  ·  ${m(t,"css_size_new")}`}`,active:a.cssSize===i.handle}})],o._sveMounted||(o._sveMounted=!0,_t(o,fl))}be("lp:device",t=>{const e=a.lastWin;if(!e||!Is(e.document))return;const o=ho(e).find(n=>n.device===t)?.handle||"";o!==a.cssSize&&(a.cssSize=o,U(e,Lo,o),oe(e,!0),Eo(),ne(e),O(e))});function Kc(t){const e=Math.max(0,Math.round(Date.now()/1e3-t)),o=new Date(t*1e3).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});let n=o;try{const s=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"});e<90?n=s.format(-e,"second"):e<5400?n=s.format(-Math.round(e/60),"minute"):e<86400?n=s.format(-Math.round(e/3600),"hour"):n=s.format(-Math.round(e/86400),"day")}catch{}return`${n} · ${o}`}function Es(t,e){return t.fetch(e,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}})}async function Gc(t,e){const o=t.document,n=Ct();if(w(o),!n)return;let s=[];try{const i=await Es(t,`/!/sve/section-template/history?type=${encodeURIComponent(n)}`);i.ok&&(s=(await i.json())?.entries||[])}catch{s=[]}if(!o.getElementById(u)||!o.contains(e))return;e.setAttribute("data-open","");const r=o.createElement("div");r.id=$,o.body.appendChild(r),N(t,e,r),r._sveApp=W(ot,r,{kind:"choices",choices:s.length?s.map(i=>({value:i.id,label:Kc(i.at)})):[{value:"",label:m(t,"code_dock_history_empty")}],onPick:i=>{w(o),i&&Xc(t,n,i)}})}async function Xc(t,e,o){if(ht())return;let n=null;try{const s=await Es(t,`/!/sve/section-template/history/entry?type=${encodeURIComponent(e)}&id=${encodeURIComponent(o)}`);s.ok&&(n=await s.json())}catch{n=null}!n||ht()||(te({html:n.html??"",css:n.css??"",js:n.js??""},a.lastLocked),nt(t),se(t))}function Gt(t){const e=t?.document.getElementById(u)?.querySelector("[data-sve-code-strip]");if(!e)return;e.hidden=a.styleMode!=="tw";const o=On(t);e.innerHTML=su,e.title=m(t,o?"tw_strip_on":"tw_strip_off"),e.setAttribute("aria-label",e.title),e.setAttribute("aria-pressed",o?"true":"false")}function Yc(t,e){const o=e.querySelector("[data-sve-code-strip]");!o||o._sveBound||(o._sveBound=!0,o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),da(t,!On(t)),Gt(t),ua(t)}),Gt(t))}function Zc(t,e){const o=e.querySelector("[data-sve-code-history]");!o||o._sveBound||(o._sveBound=!0,o.innerHTML=ru,o.title=m(t,"code_dock_history"),o.setAttribute("aria-label",o.title),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),o.hasAttribute("data-open")){w(t.document);return}Gc(t,o)}))}function Fu(){return a.styleMode}function Jc(t){return a.styleMode==="tw"?$t():null}function $t(t){const e=g.html;if(!e)return null;const o=a.htmlScopeActive&&!!a.htmlFocus,n=o?a.htmlFull:e.state.doc.toString(),r=(o?a.htmlFocus.from:0)+e.state.selection.main.from,i=In(xe(n),new Set);let l=null;for(const c of i)c.from<=r&&r<c.to&&(l=c);return l}function se(t){a.styleMode==="tw"&&fa(t,Jc())}function Bo(t){const e=t?.document.getElementById(u),o=e?.querySelector("[data-sve-values-mode]");if(!e||!o)return;e.setAttribute("data-sve-values",a.cssValues?"on":"off");const n=t.document.createElement("span");n.textContent=m(t,"code_dock_values"),o.innerHTML=iu,o.appendChild(n),o.title=m(t,a.cssValues?"code_dock_values_off":"code_dock_values_on"),o.setAttribute("aria-label",o.title),o.setAttribute("aria-pressed",a.cssValues?"true":"false")}function Bs(t){const e=g.css;if(!e||e.state.readOnly)return;const o=pt(t),n=e.state.doc.toString(),s=he(n,o,a.cssSize);if(e.focus(),s.length){const p=s[0],x=Math.min(p.bodyTo,p.bodyFrom+(n.slice(p.bodyFrom).match(/^[^\S\n]*\n?/)||[""])[0].length);e.dispatch({selection:{anchor:x},scrollIntoView:!0});return}const r=As(t,a.cssSize);if(!r||r.base){const p=`#id-{{ id }} {
...
${l.indent}}${l.suffix}`:`
${c}}
${l.indent}}${l.suffix}`;e.dispatch({changes:{from:l.at,to:l.at,insert:`${f}${h}`},selection:{anchor:l.at+f.length},scrollIntoView:!0})}function Qc(t,e){a.cssValues=!!e,U(t,zo,a.cssValues?"1":"0"),w(t.document),a.cssOpenTool="",Bo(t),ct(),Jt(),a.cssValues&&Bs(t),oe(t,!0),Eo(),ne(t),O(t)}function Fo(t){const e=t?.document.getElementById(u);if(!e)return;const o=a.styleMode==="tw";e.setAttribute("data-sve-style",a.styleMode);const n=e.querySelector("[data-sve-css-label]");n&&(n.textContent=o?m(t,"code_dock_style_tw"):m(t,"code_dock_css"));const s=e.querySelector("[data-sve-style-mode]");if(!s)return;const r=t.document.createElement("span");r.textContent=o?m(t,"code_dock_style_tw"):m(t,"code_dock_css"),s.innerHTML=o?lu:au,s.appendChild(r),s.title=m(t,o?"code_dock_style_to_css":"code_dock_style_to_tw"),s.setAttribute("aria-label",s.title),s.setAttribute("aria-pressed",o?"true":"false")}function Fs(t){t?.document.getElementById(u),w(t.document),Ye(t),a.cssOpenTool="",a.cssOpenMenu="",a.styleMode==="tw"&&a.cssValues&&(a.cssValues=!1,U(t,zo,"0")),Fo(t),Bo(t),Gt(t),a.cssToolRow?.(),a.styleMode==="tw"&&(a.htmlScopePref=!0,U(t,Re,"1"),Ze(t,!0)),se(t),Oe(t),O(t)}const Lo="sve-css-size",no="sve-css-state",Io=["hover","focus","focus-visible","active","disabled","before","after"];function td(t,e){a.styleMode=e==="tw"?"tw":"css",U(t,mr,a.styleMode),Fs(t)}function ed(t,e){if(e._sveStyleModeBound)return;e._sveStyleModeBound=!0,a.styleMode=J(t,mr)==="tw"?"tw":"css";const o=J(t,Lo)||"";a.cssSize=ho(t).some(n=>n.handle===o)?o:"",a.cssState=Io.includes(J(t,no))?J(t,no):"",a.cssValues=J(t,zo)==="1",e.querySelector("[data-sve-style-mode]")?.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),td(t,a.styleMode==="tw"?"css":"tw")}),e.querySelector("[data-sve-values-mode]")?.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Qc(t,!a.cssValues)}),Fs(t),Bo(t)}function od(t,e){const o=e.querySelector("[data-sve-css-tools]");if(!o||o._sveBound)return;o._sveBound=!0;const n=r=>e.querySelector(`[data-sve-css-tool="${r}"], [data-sve-css-kid="${r}"]`),s=r=>{const i=n(r.id),l=a.cssOpenMenu===r.id;if(w(t.document),l){Ye(t),O(t);return}if(!i)return;const c=a.styleMode==="tw"?!r.twClass&&!!r.tw:!r.kind&&!r.value&&!(r.css in Q())&&!!r.menu,d=()=>{c&&(a.cssOpenMenu=r.id)};if(a.styleMode==="tw"){Ye(t),r.twClass?(ha(t,r.twClass),O(t)):r.tw&&(pa(t,i,r.tw,()=>O(t)),d(),O(t));return}if(r.kind==="flexDir"){oc(r.value);return}if(r.kind==="display"){nc(r.value);return}if(r.value){const f=D(Q()[r.css])===D(r.value);Z([{property:r.css,value:f?null:r.value}]);return}if(r.css in Q()){Z([{property:r.css,value:null}]),O(t);return}r.menu==="colors"?ac(t,i,r.css):r.menu==="spacing"?lc(t,i,r.css):r.menu==="sizes"?dn(t,i,r.css,hu):r.menu==="choices"?ic(t,i,r.css,r.choices):r.menu==="values"&&dn(t,i,r.css),d(),O(t)};ut.onTool=r=>{const i=ye.get(r)?.tool;if(i){if(i.kids?.length){a.cssOpenTool=a.cssOpenTool===i.id?"":i.id,w(t.document),O(t);return}s(i)}},ut.onKid=(r,i)=>{const l=ye.get(i);l?.kid&&s(l.kid)},a.cssToolRow=()=>{_t(o,Ji),O(t)},a.cssToolRow(),t.document.addEventListener("mousedown",r=>{r.target.closest(`#${$}, [data-sve-css-tools], [data-sve-html-tools], [data-sve-css-add-class]`)||w(t.document)},!0)}function nd(t,e){const o=e.querySelector("[data-sve-html-tidy]");o&&(o.innerHTML=Pn.tidy,o.title=m(t,"code_dock_html_tidy"),o.setAttribute("aria-label",o.title),o.setAttribute("data-tip",o.title))}function sd(t,e){const o=e.querySelector("[data-sve-html-tidy]");nd(t,e),!(!o||o._sveBound)&&(o._sveBound=!0,o.addEventListener("mousedown",n=>n.preventDefault()),o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),ms()}))}function rd(t,e){const o=e.querySelector("[data-sve-html-tools]");!o||o._sveBound||(o._sveBound=!0,_t(o,Ui,{tools:lo.map(n=>({...n,icon:Pn[n.id]||""})),onTool:n=>{const s=lo.find(i=>i.id===n),r=o.querySelector(`[data-sve-html-tool="${n}"]`);if(s){if(s.menu==="heading"){an(t,r,yr);return}if(s.menu==="text"){an(t,r,Lr);return}if(s.tidy){ms();return}if(s.menu==="component"){Kl(t,r);return}if(w(t.document),s.snippet){Bt(s.snippet,s.caret??s.snippet.length,s.select),q();return}vs(s.tag)}}}),Sd(t,e),_d(t,e),kd(t,e))}let ce=null;async function ad(t){const e=t.document;Ld(e);let o=e.getElementById(u);if(o&&!(o.querySelector('[data-sve-css-chrome="subrow-2"]')&&o.querySelector("[data-sve-css-add-class]")&&o.querySelector("[data-sve-html-tools]")&&o.querySelector("[data-sve-html-tidy]")&&o.querySelector("[data-sve-data-vars]")&&o.querySelector("[data-sve-visual-edit-tools]")&&o.querySelector("[data-sve-html-scope]")&&o.querySelector("[data-sve-code-lock]")&&o.querySelector("[data-sve-code-back]")&&o.querySelector("[data-sve-code-autosave]")&&o.querySelector("[data-sve-code-save]")&&o.getAttribute("data-sve-code-chrome")==="scope-9")){for(const s of at)g[s]?.destroy(),g[s]=null;o.remove(),o=null}if(!o){o=e.createElement("div"),o.id=u,o.setAttribute("data-sve-code-chrome","scope-9"),Dr(o,zr(t)),_t(o,zi,{htmlLabel:m(t,"code_dock_html"),cssLabel:m(t,"code_dock_css"),jsLabel:m(t,"code_dock_js"),alpineLabel:m(t,"code_dock_alpine"),treeIcon:gr,dataIcon:Jd,dataLabel:m(t,"data_vars_title")}),Xe(e,o),yn(o),Ns(o,zs(t)),Rd(t,o),Nd(t,o),jd(t,o),od(t,o),Yl(t,o),ed(t,o),Zc(t,o),Yc(t,o),Hr(t,o),rd(t,o),on(t,o),tn(t,o),bn(t,o),en(t,o);for(const n of at){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);jc(s)}Rr(t)}if(Xe(e,o),yn(o),sd(t,o),on(t,o),tn(t,o),bn(t,o),en(t,o),Dd(t),Oo(t),Et(t),K(t),Yt(t),it(t),Fo(t),Gt(t),await qd(),!g.html){for(const n of at){const s=o.querySelector(`[data-sve-code-pane="${n}"] [data-sve-code-host]`);s?.replaceChildren(),Rc(t,n,s)}for(const n of["html","css"])g[n]&&ma(t,g[n],{onOpen:s=>ls(t,s),emptyLabel:m(t,"code_dock_partials_empty"),openLabel:s=>m(t,"component_open_named",{name:s}),sectionValues:()=>is(t),isLocked:()=>ht(),setHover:(s,r)=>a.htmlPartialUi?.setHover(s,r)});Ra(t,g.html,{onRename:n=>Hl(t,n),isLocked:()=>ht(),setHover:(n,s)=>a.htmlClassTokenUi?.setHover(n,s),title:m(t,"code_dock_css_rename_class")})}return o}function Ls(t){return ce||(ce=ad(t).finally(()=>{ce=null})),ce}async function vn(t,e){const o=await Ls(t);a.lastType=e,a.lastLocked=!0,a.lockReady=!0,a.lastParts={html:"",css:"",js:""},Be(),Et(t),te(a.lastParts,!0),Vs(t.document,e),R(t.document,m(t,"code_dock_missing")),K(t),Yt(t),it(t),Xt(t,o)}async function De(t,e,o="replace"){o==="replace"?a.typeStack=[]:o==="push"&&a.lastType&&a.lastType!==e&&a.typeStack.push(a.lastType);const n=++a.loadGen;a.lastType=e,a.lockReady=!1,Be(),R(t.document,m(t,"code_dock_loading"));const s=await Ls(t);Et(t),K(t),Yt(t),it(t),Fo(t),Gt(t),Xt(t,s),t.fetch(`/!/sve/section-template?type=${encodeURIComponent(e)}`,{credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest"}}).then(async r=>{if(n!==a.loadGen)return;if(r.status===404){vn(t,e);return}if(!r.ok)throw new Error(String(r.status));const i=await r.json();n===a.loadGen&&(a.lastParts={html:typeof i.html=="string"?i.html:"",css:typeof i.css=="string"?i.css:"",js:typeof i.js=="string"?i.js:""},a.lastProps=Array.isArray(i.props)?i.props:[],a.propsDirty=!1,a.lastType=e,a.lastLocked=!!i.locked,a.lockReady=!0,Ll(),typeof i.tw=="string"&&i.tw!==""&&Il(a.lastParts.html,i.tw),Et(t),te(a.lastParts,a.lastLocked),Dn(t),a.lastLocked||ss(t,a.lastParts.html),Vs(t.document,i.path||e),R(t.document,a.lastLocked?m(t,"code_dock_locked"):""),i.writable?.template===!1?R(t.document,m(t,"code_dock_not_writable")):i.writable?.tw===!1&&R(t.document,m(t,"code_dock_tw_not_writable")),es(t),Wi(t),bo(t),K(t),Yt(t),it(t),Xt(t,s))}).catch(()=>{n===a.loadGen&&(vn(t,e),R(t.document,m(t,"code_dock_error")))})}function Ct(){return a.lastType||""}function Is(t){return!!t?.getElementById(u)}function ht(){return a.lastLocked}function id(t,e){const o=typeof e?.html=="string"?e.html.trim():"",n=typeof e?.css=="string"?e.css.trim():"",s=typeof e?.js=="string"?e.js.trim():"";if(!o&&!n&&!s||!t?.document?.getElementById(u))return!1;let r=!1;return o&&(r=ld("html",o)||r),n&&(r=gn("css",n)||r),s&&(r=gn("js",s)||r),r&&nt(t),r}function ld(t,e){const o=g[t];if(!o||o.state.readOnly)return!1;const n=o.state.selection.main,s=n.from>0?o.state.doc.sliceString(n.from-1,n.from):`
...
`:n?`
`:""}${e}
`;return o.dispatch({changes:{from:n,insert:r},selection:{anchor:n+r.length}}),!0}function cd(t){if(me(t),!a.lastType||!t.document.getElementById(u))return;const e=a.lastType;a.lastType=null,De(t,e,"keep")}function Os(t){bt(t),a.loadGen+=1,et(t),a.lastUid=null,a.lastType=null,a.typeStack=[],a.lastParts={html:"",css:"",js:""},a.lastLocked=!1,a.lockReady=!1,a.lastBracketNames=null,a.lastCssSelectorNames=null,Be(),a.lastWin=t?.defaultView||a.lastWin,w(t),Ln(t),rt(t),t?.getElementById(G)?.remove();for(const o of at)g[o]?.destroy(),g[o]=null;t?.getElementById(u)?.remove(),Pd(),t&&Po(t,0);const e=t?.defaultView||a.lastWin;e?.document.getElementById(En)&&Mn(e),e&&(es(e),bo(e),Dn(e))}function dd(t){if(a.dragging)return;const e=t.document.getElementById(u);e&&(Oo(t),Xt(t,e))}function ud(t,e,o){if(o){const r=jo(o,e)||jo(o,t.document)||o;return String(typeof Ne=="function"&&(Ne(r,e)||Ne(r,t.document))||"").trim()}const n=typeof Ge=="function"?Ge(t):"page_sections",s=typeof tt=="function"?tt(t.document):[];for(const r of s){const l=(kt(r.values)||r.values)?.[n];if(Array.isArray(l))for(const c of l){const d=typeof c?.type=="string"?c.type.trim():"";if(d)return d}}return""}function Ps(t){if((t.Statamic?.$config?.get?.("sveFeatures")||{}).collection_templates!==!0)return"";const o=t.Statamic?.$config?.get?.("sveCollectionTemplatesCollection")||"templates";if(!(t.location?.pathname||"").includes(`/collections/${o}/entries/`))return"";const s=typeof tt=="function"?tt(t.document):[];for(const r of s){const i=kt(r.values)||r.values,l=typeof i?.view=="string"?i.view.trim():"";if(!l||l.includes(".."))continue;const c=l.replace(/\.(antlers\.html|blade\.php)$/i,"").replace(/^\/+|\/+$/g,"");if(c)return`view:${c}`}return""}function fd(t,e){const o=qr||Vr;if(o!=="header"&&o!=="footer"||!jr(e)&&!Nr(e))return"";const s=(kt(Wr()?.values)||{})[o==="footer"?"footer_style":"header_style"]||"style_1";return`${o}/${s}`}function hd(t){const e=Pr(t)||t.getElementById("__sve-global-section-host");return e&&e.querySelector("[data-replicator-set][data-type]")?.getAttribute("data-type")||""}function Lu(t,e,o){if(a.dragging)return;if(!t||!e||Ad(e)||!Ir(t)||!Or(t)){e&&Os(e);return}const n=fd(t,e)||hd(e)||ud(t,e,o)||Ps(t)||(o?"":a.lastType),s=!!(o&&o!==a.lastUid);if(a.lastWin=t,o&&(a.lastUid=o),!!n&&!(n===a.lastType&&e.getElementById(u))){if(a.typeStack.length&&a.lastType&&a.lastType!==n){const r=a.typeStack[0];if(n===r&&!s)return;a.typeStack=[]}et(e),De(t,n,"replace")}}be("tw:changed",()=>{a.lastWin&&a.styleMode==="tw"&&O(a.lastWin)});I("dock:is-open",t=>Is(t));I("dock:is-locked",()=>ht());I("dock:html",()=>It());I("dock:reveal-html",({from:t,to:e,caret:o}={})=>{const n=g.html;if(!n||t==null)return;a.htmlScopePref=Zt(a.lastWin),Te(),ct();const s=a.htmlFull.length,r=Math.max(0,Math.min(t,s)),i=Math.max(r,Math.min(e??t,s));a.htmlFocus=i>r?{from:r,to:i}:null;const l=o==null?null:Math.max(0,Math.min(o,s));if(a.htmlScopePref&&a.htmlFocus){$o(l),K(a.lastWin);return}if(a.htmlScopeActive){Co(!0,l),K(a.lastWin);return}n.dispatch({selection:l==null?{anchor:r,head:i}:{anchor:l},scrollIntoView:!0}),n.focus()});I("dock:insert-snippet",({win:t,parts:e})=>id(t,e));I("dock:refresh",t=>cd(t));I("dock:tw-follow",()=>{a.lastWin&&se(a.lastWin)});I("dock:css",()=>(ct(),a.cssFull));I("dock:set-css",t=>typeof t!="string"||ht()||!g.css||!a.lastWin?!1:(ct(),a.cssFull=t,Me("css",gs()),nt(a.lastWin),!0));I("dock:data-menu",({anchor:t,onPick:e,at:o}={})=>!t||!a.lastWin?!1:(bt(a.lastWin.document),w(a.lastWin.document),Ds(a.lastWin,t,e,o),!0));I("dock:props",()=>a.lastProps.map(t=>({...t})));I("dock:set-props",({win:t,props:e}={})=>!Array.isArray(e)||ht()?!1:(a.lastProps=e,a.propsDirty=!0,va(ze(Ct())),et((t||a.lastWin)?.document),!0));function ze(t){const e=/^view:partials\/(components\/[A-Za-z0-9_-]+)$/.exec(String(t||""));return e?e[1]:""}I("dock:component-src",()=>ze(Ct()));I("dock:component-exit-state",()=>{const t=ze(Ct());return{open:!!t,name:t?t.split("/").pop():"",back:a.typeStack.length>0}});I("dock:exit-component",()=>!a.lastWin||!ze(Ct())?!1:(a.typeStack.length?cs(a.lastWin):Os(a.lastWin.document),!0));I("dock:current-type",()=>Ct());I("dock:current-uid",()=>a.lastUid);I("dock:reset-data-vars",t=>(li(typeof t=="string"&&t?t:void 0),!0));I("dock:refresh-preview",()=>a.lastWin?(me(a.lastWin),!0):!1);I("dock:open-template",t=>typeof t!="string"||!t||!a.lastWin?!1:(ls(a.lastWin,t),!0));I("dock:set-html",t=>{if(typeof t!="string"||ht())return!1;const e=g.html;if(!e||!a.lastWin)return!1;if(t===""){a.saveTimer&&(clearTimeout(a.saveTimer),a.saveTimer=null),a.twDirty=!1,a.twCss=null,a.twKey="",a.lastType=null,a.lastUid=null,a.lastParts={html:"",css:"",js:""},a.cssFull="",a.htmlFull="",a.applying=!0;try{Be();for(const s of at){const r=g[s];if(!r)continue;const i=r.state.doc.toString();i!==""&&r.dispatch({changes:{from:0,to:i.length,insert:""}})}}finally{a.applying=!1}return!0}const o=a.htmlFull;if(a.htmlFull=t,a.htmlScopeActive)return a.htmlFocus=pd(a.htmlFocus,o,t),Ee(fs()),nt(a.lastWin),fo("dock:html-changed"),!0;const n=e.state.doc.toString();if(n!==t){const[s,r,i]=as(n,t);e.dispatch({changes:{from:s,to:r,insert:i}})}return!0});I("dock:show-empty",()=>xt("dock:set-html",""));be("row:removed",({parentPath:t,remaining:e,win:o})=>{e===0&&t===Ge(o)&&xt("dock:show-empty")});function pd(t,e,o){const n=o.length-e.length;if(!t||!n)return t;let s=0;for(;s<e.length&&s<o.length&&e[s]===o[s];)s+=1;return s>=t.to?t:s<t.from?{from:Math.max(0,t.from+n),to:Math.max(0,t.to+n)}:{from:t.from,to:Math.max(t.from,t.to+n)}}const L="__sve-data-menu";let so=null;function bt(t){const e=t?.getElementById(L);so?.(),so=null,e?._sveApp?.unmount(),e?.remove(),t?.querySelector("[data-sve-data-vars][data-open]")?.removeAttribute("data-open")}function md(t){if(!Ps(t))return{view:"",kind:""};const e=typeof tt=="function"?tt(t.document):[];for(const o of e){const n=kt(o.values)||o.values,s=typeof n?.source_collection=="string"?n.source_collection.trim():"";if(s)return{view:s,kind:String(n?.kind||"").trim()}}return{view:"",kind:""}}function vd(t,e){const o=It();if(Number.isFinite(e))return qo(o,e);const n=g.html;if(!n)return[];const s=a.htmlScopeActive&&a.htmlFocus?a.htmlFocus.from:0;return qo(o,s+n.state.selection.main.from)}function gd(t,e){const{view:o,kind:n}=md(t);return{collection:ni(t)||"",set:si(Ct()),view:o,kind:n,scope:ri(vd(t,e))}}function yd(t){const e=typeof tt=="function"?tt(t.document):[];for(const o of e){const n=kt(o.values)||o.values;if(n&&typeof n=="object")return n}return null}function bd(t,e){return{scope:e?.scope?.groups||[],section:Zn(e?.section||[],is(t)),page:ui(e?.page||[],yd(t)),site:e?.site||[]}}function xd(t,e){const o=fi(t,e),n=g.html;if(!o||!n||n.state.readOnly)return;const s=n.state.selection.main,r=n.state.doc.lineAt(s.from),i=lt(r.text),l=po(o.text,i);n.dispatch({changes:{from:s.from,to:s.to,insert:l},selection:{anchor:s.from+o.cursor+(o.text.includes(`
`)?i.length:0)}}),q()}function Ve(t,e,o){const n=e.getBoundingClientRect(),s=8,r=o.offsetWidth||368,i=o.offsetHeight||240,l=t.innerHeight-n.bottom-s,c=n.top-s,d=l>=i||l>=c?n.bottom+4:n.top-i-4;o.style.left=`${Math.max(s,Math.min(n.left,t.innerWidth-r-s))}px`,o.style.top=`${Math.max(s,Math.min(d,t.innerHeight-i-s))}px`}function Ds(t,e,o,n){const s=t.document;bt(s),e.setAttribute("data-open","");const r=s.createElement("div");r.id=L,s.body.appendChild(r);const i=gd(t,n),l=p=>[p?.scope?.groups?.length?{id:"scope",label:p.scope.label||m(t,"data_vars_tab_loop")}:null,{id:"section",label:m(t,"data_vars_tab_section")},{id:"page",label:m(t,"data_vars_tab_page")},{id:"site",label:m(t,"data_vars_tab_site")}].filter(Boolean),c=p=>{s.getElementById(L)&&(r._sveApp?.unmount(),r._sveApp=W(oi,r,{title:m(t,"data_vars_title"),placeholder:m(t,"data_vars_placeholder"),emptyText:m(t,"data_vars_empty"),noSectionText:m(t,"data_vars_no_section"),loopText:m(t,"data_vars_loop"),tabs:l(p),data:bd(t,p),onPick:(x,k)=>o?o(x,k):xd(x,k)}),Ve(t,e,r))};c(ai(Yn(i))||{scope:null,section:[],page:[],site:[]}),ii(t,i).then(c),Ve(t,e,r);const d=()=>Ve(t,e,r),f=p=>{!r.contains(p.target)&&!e.contains(p.target)&&bt(s)},h=p=>{p.key==="Escape"&&bt(s)};s.addEventListener("pointerdown",f,!0),s.addEventListener("keydown",h,!0),t.addEventListener("scroll",d,!0),t.addEventListener("resize",d),so=()=>{s.removeEventListener("pointerdown",f,!0),s.removeEventListener("keydown",h,!0),t.removeEventListener("scroll",d,!0),t.removeEventListener("resize",d)}}function kd(t,e){const o=e.querySelector("[data-sve-data-vars]");!o||o._sveBound||(o._sveBound=!0,o.addEventListener("mousedown",n=>n.preventDefault()),o.addEventListener("click",n=>{if(n.preventDefault(),n.stopPropagation(),t.document.getElementById(L)){bt(t.document);return}w(t.document),Ds(t,o)}))}function Sd(t,e){const o=e.querySelector("[data-sve-antlers-tools]");!o||o._sveBound||(o._sveBound=!0,_t(o,Xn,{label:m(t,"code_dock_antlers"),groups:ka.map(n=>({id:n.id,label:m(t,n.lang),items:Sa.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>wd(n)}))}function wd(t){const e=wa(t),o=g.html;if(!e||!o||o.state.readOnly)return;const n=o.state.selection.main.head,s=o.state.doc.lineAt(n),r=s.text.trim()?lt(s.text):Ie(o,s)||lt(s.text),{text:i,cursor:l}=ue(e.snippet);Bt(po(i,r),l),q()}function _d(t,e){const o=e.querySelector("[data-sve-visual-edit-tools]");!o||o._sveBound||(o._sveBound=!0,_t(o,Xn,{label:m(t,"code_dock_visual_edit"),groups:hi.map(n=>({id:n.id,label:m(t,n.lang),items:Jn.filter(s=>s.group===n.id).map(s=>({id:s.id,label:s.label}))})),onPick:n=>Cd(n)}))}function $d(t,e,o,n){if(vi(o.inner,n.attr)){t.focus();return}const{text:s,cursor:r}=ue(n.attr);let i=o.closeIdx;for(;i>o.openIdx+2&&/\s/.test(e[i-1]);)i--;t.dispatch({changes:{from:i,to:o.closeIdx,insert:` ${s} `},selection:{anchor:i+1+r}}),q()}function Cd(t){const e=pi(t),o=g.html;if(!e||!o||o.state.readOnly)return;const n=o.state.doc.toString(),s=Qt();if(s?.open){const h=mi(n,s.open.from,s.open.to,ie);if(h){e.attr?$d(o,n,h,e):(o.dispatch({selection:{anchor:h.openIdx+2+ie.length}}),o.focus());return}const p=s.open.from+1+s.name.length,x=e.standalone||`{{ ${ie} ${e.attr} }}`,{text:k,cursor:z}=ue(x);o.dispatch({changes:{from:p,to:p,insert:` ${k}`},selection:{anchor:p+1+z}}),q();return}const r=o.state.selection.main.head,i=o.state.doc.lineAt(r),l=i.text.trim()?lt(i.text):Ie(o,i)||lt(i.text),c=e.standalone||`{{ ${ie} ${e.attr} }}`,{text:d,cursor:f}=ue(c);Bt(po(d,l),f),q()}function Td(t){return t==="css"?ir():t==="js"?lr():ar({autoCloseTags:!0})}function yn(t){if(t._sveShield)return;t._sveShield=!0;const e=o=>o.stopPropagation();for(const o of["keydown","keypress","keyup","pointerdown","pointerup","mousedown","mouseup","click","focusin"])t.addEventListener(o,e)}function Ad(t){try{return new URLSearchParams(t.defaultView?.location?.search||"").has("sve-panel")}catch{return!1}}function Md(t){const e=parseInt(J(t,ur)??"",10);return Number.isFinite(e)&&e>=vr?e:Kd}function Ed(t,e){U(t,ur,String(e))}function zs(t){try{const e=JSON.parse(J(t,fr)||"null");if(e&&typeof e=="object")return{html:e.html!==!1,css:e.css!==!1,js:e.js===!0,alpine:e.alpine===!0}}catch{}return{html:!0,css:!0,js:!1,alpine:!1}}function Bd(t,e){U(t,fr,JSON.stringify(e))}function Hs(t){try{const e=JSON.parse(J(t,hr)||"null");if(e&&typeof e=="object"){const o=s=>Number.isFinite(s)&&s>0?s:1,n={};for(const s of wt)n[s]=o(e[s]);return n}}catch{}return Object.fromEntries(wt.map(e=>[e,1]))}function Fd(t,e){U(t,hr,JSON.stringify(e))}function Ld(t){Ur(t,Ud,`
