...
class LivePreviewViteTest extends TestCase
{
    ...
    public function test_hot_tags_point_at_the_vite_server_with_the_hmr_client()
    {
    ...
    public function test_statamic_cloning_the_instance_keeps_the_hot_file_and_the_client()
    {
        $vite = LivePreviewVite::lock(app(Vite::class), $this->hotFile);
        $clone = clone $vite;
